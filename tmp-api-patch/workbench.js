...
import { UNKNOWN_EMPTY_WINDOW_WORKSPACE } from './vscode/src/vs/platform/workspace/common/workspace.js';
import { isWorkspaceToOpen, isFolderToOpen } from './vscode/src/vs/platform/window/common/window.js';
import { getWorkspaceIdentifier as getWorkspaceIdentifier$1, getSingleFolderWorkspaceIdentifier } from './vscode/src/vs/platform/workspaces/common/workspaceIdentifier.js';
...
export { getEnvironmentOverride, getWorkbenchConstructionOptions, getWorkbenchContainer, getWorkspaceIdentifier, initialize, logsPath };
