...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    static {
        CodeEditorWidget_1 = this;
    }
    static {
        this.dropIntoEditorDecorationOptions = ModelDecorationOptions.register({
    ...
    constructor(
        ...
        this._domElement.style?.setProperty(
            "--editor-font-size",
            this._configuration.options.get(EditorOption.fontSize) + "px"
        );
    ...
    edit(edit, reason) {
        return this.executeEdits(reason, ( edit.replacements.map(e => ({
            range: e.range,
            text: e.text
        }))), undefined);
    }
    ...
    getLineDecorations(lineNumber) {
        ...
        return this._modelData.model.getLineDecorations(
            lineNumber,
            this._id,
            filterValidationDecorations(options),
            filterFontDecorations(options)
        );
    }
    ...
    setDecorationsByType(description, decorationTypeKey, decorationOptions) {
        ...
        this.changeDecorations(
            accessor => this._decorationTypeKeysToIds[decorationTypeKey] = accessor.deltaDecorations(oldDecorationsIds, newModelDecorations)
        );
            ...
            case OutgoingViewModelEventKind.CursorStateChanged:
                {
                    if (e.reachedMaxCursorCount) {
                        ...
                        this._notificationService.prompt(Severity$1.Warning, message, [{
                            ...
                            label: ( localize(178, "Increase Multi Cursor Limit")),
                            run: () => {
...
CodeEditorWidget = CodeEditorWidget_1 = ( __decorate([( __param(3, IInstantiationService)), ( __param(4, ICodeEditorService)), ( __param(5, ICommandService)), ( __param(6, IContextKeyService)), ( __param(7, IThemeService)), ( __param(8, INotificationService)), ( __param(9, IAccessibilityService)), ( __param(10, ILanguageConfigurationService)), ( __param(11, ILanguageFeaturesService)), ( __param(12, IUserInteractionService)), ( __param(13, IKeybindingService))], CodeEditorWidget));
let EDITOR_ID = 0;
class ModelData {
...
class EditorContextKeysManager extends Disposable {
    constructor(editor, contextKeyService) {
        ...
        this._register(
            TabFocus.onDidChangeTabFocus(tabFocusMode => this._tabMovesFocus.set(tabFocusMode))
        );
...
class EditorModeContext extends Disposable {
    constructor(_editor, _contextKeyService, _languageFeaturesService) {
        ...
        this._register(
            _languageFeaturesService.documentFormattingEditProvider.onDidChange(update)
        );
        this._register(
            _languageFeaturesService.documentRangeFormattingEditProvider.onDidChange(update)
        );
    ...
    _update() {
        ...
        this._contextKeyService.bufferChangeEvents(() => {
            ...
            this._hasMultipleDocumentFormattingProvider.set(
                this._languageFeaturesService.documentFormattingEditProvider.all(model).length + this._languageFeaturesService.documentRangeFormattingEditProvider.all(model).length > 1
            );
            this._hasMultipleDocumentSelectionFormattingProvider.set(
                this._languageFeaturesService.documentRangeFormattingEditProvider.all(model).length > 1
            );
...
registerThemingParticipant((theme, collector) => {
    ...
    if (errorForeground) {
        ...
        collector.addRule(
            `:root, :host { --monaco-editor-error-decoration: url("data:image/svg+xml,${getSquigglySVGData(errorForeground)}"); }`
        );
    }
    ...
    if (warningForeground) {
        ...
        collector.addRule(
            `:root, :host { --monaco-editor-warning-decoration: url("data:image/svg+xml,${getSquigglySVGData(warningForeground)}"); }`
        );
    }
    ...
    if (infoForeground) {
        ...
        collector.addRule(
            `:root, :host { --monaco-editor-info-decoration: url("data:image/svg+xml,${getSquigglySVGData(infoForeground)}"); }`
        );
    }
    ...
    if (hintForeground) {
        ...
        collector.addRule(
            `:root, :host { --monaco-editor-hint-decoration: url("data:image/svg+xml,${getDotDotDotSVGData(hintForeground)}"); }`
        );
    }
    ...
    if (unnecessaryForeground) {
        ...
        collector.addRule(
            `:root, :host { --monaco-editor-unnecessary-decoration-opacity: ${unnecessaryForeground.rgba.a}; }`
        );
    }
});
