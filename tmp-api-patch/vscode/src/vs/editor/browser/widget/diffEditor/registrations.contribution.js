...
registerColor("diffEditor.move.border", "#8b8b8b9c", ( localize(230, "The border color for text that got moved in the diff editor.")));
registerColor("diffEditor.moveActive.border", "#FFA500", ( localize(231, "The active border color for text that got moved in the diff editor.")));
registerColor("diffEditor.unchangedRegionShadow", {
    dark: "#000000",
    light: "#737373BF",
    hcDark: "#000000",
    hcLight: "#737373BF"
}, ( localize(232, "The color of the shadow around unchanged region widgets.")));
const diffInsertIcon = registerIcon("diff-insert", Codicon.add, ( localize(233, "Line decoration for inserts in the diff editor.")));
const diffRemoveIcon = registerIcon("diff-remove", Codicon.remove, ( localize(234, "Line decoration for removals in the diff editor.")));
