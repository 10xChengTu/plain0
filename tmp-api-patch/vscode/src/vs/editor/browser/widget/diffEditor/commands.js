...
class ToggleCollapseUnchangedRegions extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(179, "Toggle Collapse Unchanged Regions")),
            icon: Codicon.map,
...
class ToggleShowMovedCodeBlocks extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(180, "Toggle Show Moved Code Blocks")),
            precondition: ( ContextKeyExpr.has("isInDiffEditor"))
        });
    }
    run(accessor, ...args) {
...
class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(181, "Toggle Use Inline View When Space Is Limited")),
            precondition: ( ContextKeyExpr.has("isInDiffEditor"))
        });
    }
    run(accessor, ...args) {
...
const diffEditorCategory = ( localize2(182, "Diff Editor"));
class SwitchSide extends EditorAction2 {
    constructor() {
        super({
            id: "diffEditor.switchSide",
            title: ( localize2(183, "Switch Side")),
...
class ExitCompareMove extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(184, "Exit Compare Move")),
            icon: Codicon.close,
...
class CollapseAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(185, "Collapse All Unchanged Regions")),
            icon: Codicon.fold,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            f1: true,
            category: diffEditorCategory
...
class ShowAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(186, "Show All Unchanged Regions")),
            icon: Codicon.unfold,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            f1: true,
            category: diffEditorCategory
...
const accessibleDiffViewerCategory = ( localize2(188, "Accessible Diff Viewer"));
class AccessibleDiffViewerNext extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(189, "Go to Next Difference")),
...
class AccessibleDiffViewerPrev extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(190, "Go to Previous Difference")),
            category: accessibleDiffViewerCategory,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            keybinding: {
