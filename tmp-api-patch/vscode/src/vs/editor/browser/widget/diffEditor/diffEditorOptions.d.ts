...
export declare class DiffEditorOptions {
    ...
    readonly diffWordWrap: IObservableWithChange<"on" | "inherit" | "off", void>;
    ...
    readonly diffAlgorithm: IObservableWithChange<"advanced" | "legacy" | "advanced-external" | "advanced-wasm", void>;
