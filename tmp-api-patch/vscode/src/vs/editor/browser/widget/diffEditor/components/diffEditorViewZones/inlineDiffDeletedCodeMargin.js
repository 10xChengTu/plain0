            ...
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    actions.push(( new Action(
                        ...
                        isDeletion ? (_diff.original.length > 1 ? ( localize(206, "Copy deleted lines")) : ( localize(207, "Copy deleted line"))) : (_diff.original.length > 1 ? ( localize(208, "Copy changed lines")) : ( localize(209, "Copy changed line"))),
                        undefined,
                        true,
                        async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(( new Action("diff.clipboard.copyDeletedLineContent", isDeletion ? ( localize(
                            210,
                            "Copy deleted line ({0})",
                    ...
                    if (!readOnly) {
                        actions.push(( new Action("diff.inline.revertChange", ( localize(212, "Revert this change")), undefined, true, async () => {
