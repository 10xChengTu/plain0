...
export declare class MultiDiffEditorViewModel extends Disposable {
    ...
    private readonly _waitForNewDiffs;
    ...
    waitForDiffOr1s(): Promise<void>;
    collapseAll(): void;
    expandAll(): void;
    collapse(item: DocumentDiffItemViewModel): void;
    expand(item: DocumentDiffItemViewModel): void;
...
export declare class DocumentDiffItemViewModel extends Disposable {
    ...
    */
    ...
    readonly waitForInitialDiffOr1s: ObservablePromise<void>;
    ...
    private readonly _documentDiffItemRef;
