...
class MouseHandler extends ViewEventHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._register(
            mouseEvents.onContextMenu(this.viewHelper.viewDomNode, e => this._onContextMenu(e, true))
        );
        ...
        this._register(
            mouseEvents.onMouseUp(this.viewHelper.viewDomNode, e => this._onMouseUp(e))
        );
        this._register(
            mouseEvents.onMouseLeave(this.viewHelper.viewDomNode, e => this._onMouseLeave(e))
        );
        ...
        this._register(
            addDisposableListener(this.viewHelper.viewDomNode, EventType.POINTER_UP, e => {
                this._mouseDownOperation.onPointerUp();
            })
        );
        this._register(
            mouseEvents.onMouseDown(this.viewHelper.viewDomNode, e => this._onMouseDown(e, capturePointerId))
        );
    ...
    _setupMouseWheelZoomListener() {
        ...
        function hasMouseWheelZoomModifiers(browserEvent) {
            return (
            isMacintosh ? ((browserEvent.metaKey || browserEvent.ctrlKey) && !browserEvent.shiftKey && !browserEvent.altKey) : (browserEvent.ctrlKey && !browserEvent.metaKey && !browserEvent.shiftKey && !browserEvent.altKey));
        }
    }
    dispose() {
...
class MouseDownOperation extends Disposable {
    ...
    start(targetType, e, pointerId) {
        ...
        if (
        !options.get(EditorOption.readOnly) && options.get(EditorOption.dragAndDrop) && !options.get(EditorOption.columnSelection) && !this._mouseState.altKey && e.detail < 2 && !this._isActive && !this._currentSelection.isEmpty() && (position.type === MouseTargetType.CONTENT_TEXT) && position.position && this._currentSelection.containsPosition(position.position)) {
    ...
    _getPositionOutsideEditor(e) {
        ...
        layoutInfo.width - layoutInfo.verticalScrollbarWidth : layoutInfo.minimap.minimapLeft);
