...
import { getDomNodePagePosition, getWindow, addDisposableListener, EventType, addStandardDisposableListener, isInShadowDOM } from '../../base/browser/dom.js';
    ...
    getOrCreateRule(properties) {
        ...
        if (!existingRule) {
            ...
            existingRule = ( new RefCountedCssRule(
                ...
                isInShadowDOM(this._editor.getContainerDomNode()) ? this._editor.getContainerDomNode() : undefined,
                properties
            ));
