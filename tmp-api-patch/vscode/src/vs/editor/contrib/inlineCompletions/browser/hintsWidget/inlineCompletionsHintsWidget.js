...
const inlineSuggestionHintsNextIcon = registerIcon("inline-suggestion-hints-next", Codicon.chevronRight, ( localize(1355, "Icon for show next parameter hint.")));
const inlineSuggestionHintsPreviousIcon = registerIcon("inline-suggestion-hints-previous", Codicon.chevronLeft, ( localize(1356, "Icon for show previous parameter hint.")));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    constructor(
        ...
        }, [this._warningMessageNode.element, h("div@toolBar")]);
        this.previousAction = this._register(
            this.createCommandAction(showPreviousInlineSuggestionActionId, ( localize(1357, "Previous")), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon))
        );
        ...
        this.nextAction = this._register(this.createCommandAction(showNextInlineSuggestionActionId, ( localize(1358, "Next")), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon)));
        this.inlineCompletionsActionsMenus = this._register(
            this._menuService.createMenu(MenuId.InlineCompletionsActions, this._contextKeyService)
        );
        ...
        this.toolBar.setPrependedPrimaryActions(
            [this.previousAction, this.availableSuggestionCountAction, this.nextAction]
        );
...
InlineSuggestionHintsContentWidget = InlineSuggestionHintsContentWidget_1 = ( __decorate([( __param(8, ICommandService)), ( __param(9, IInstantiationService)), ( __param(10, IKeybindingService)), ( __param(11, IContextKeyService)), ( __param(12, IMenuService))], InlineSuggestionHintsContentWidget));
