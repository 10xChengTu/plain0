...
import { vUnion, vObj, vOptionalProp, vUnchecked, vBoolean, vWithJsonSchemaRef, vString, vUndefined } from '../../../../../base/common/validation.js';
...
import { showNextInlineSuggestionActionId, showPreviousInlineSuggestionActionId, inlineSuggestCommitId, inlineSuggestCommitAlternativeActionId, jumpToNextInlineEditId, hideInlineCompletionId, toggleShowCollapsedId } from './commandIds.js';
import { InlineCompletionContextKeys } from './inlineCompletionContextKeys.js';
import { InlineCompletionsController } from './inlineCompletionsController.js';
import { asyncTransaction, transaction } from '../../../../../base/common/observableInternal/transaction.js';
...
class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1319, "Show Next Inline Suggestion")),
...
class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1320, "Show Previous Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
...
class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1321, "Trigger Inline Suggestion")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize(1322, "Triggers an inline suggestion in the editor.")),
                args: [{
                    name: "args",
                    description: ( localize(1323, "Options for triggering inline suggestions.")),
                    isOptional: true,
    ...
    async run(accessor, editor, args) {
        ...
        const provider = validatedArgs?.providerId ? languageFeaturesService.inlineCompletionsProvider.all(editor.getModel()).find(p => ( inlineCompletionProviderGetMatcher(p).some(m => m === validatedArgs.providerId))) : undefined;
        ...
        if (validatedArgs?.showNoResultNotification) {
            if (!controller?.model.get()?.state.get()) {
                notificationService.notify({
                    ...
                    message: ( localize(1324, "No inline suggestion is available."))
                });
            }
        }
    }
...
class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1325, "Accept Next Word Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                ...
                title: ( localize(1326, "Accept Word")),
                group: "primary",
                order: 2
            }]
        });
...
class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1327, "Accept Next Line Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                menuId: MenuId.InlineSuggestionToolbar,
                title: ( localize(1328, "Accept Line")),
                group: "secondary",
                order: 2
            }]
        });
...
class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1329, "Accept Inline Suggestion")),
...
class AcceptInlineCompletionAlternativeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1331, "Accept Inline Suggestion Alternative Action")),
            precondition: ( ContextKeyExpr.and(
                InlineCompletionContextKeys.inlineSuggestionAlternativeActionVisible,
                InlineCompletionContextKeys.inlineEditVisible
            )),
            menuOpts: [],
            kbOpts: [{
...
class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1332, "Jump to next inline edit")),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                menuId: MenuId.InlineEditsActions,
                title: ( localize(1333, "Jump")),
                group: "primary",
                order: 1,
...
class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1334, "Hide Inline Suggestion")),
            precondition: ( ContextKeyExpr.or(
                InlineCompletionContextKeys.inlineSuggestionVisible,
                InlineCompletionContextKeys.inlineEditVisible
            )),
...
class ToggleInlineCompletionShowCollapsed extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1336, "Toggle Inline Suggestions Show Collapsed")),
...
class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize(1337, "Always Show Toolbar")),
            f1: false,
...
class DevExtractReproSample extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1338, "Developer: Extract Inline Suggest State")),
    ...
    async run(accessor, editor) {
        ...
        const inlineCompletionLines = splitLines(JSON.stringify({
