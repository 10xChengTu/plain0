...
const originalBackgroundColor = registerColor("inlineEdit.originalBackground", ( transparent(diffRemoved, 0.2)), ( localize(1370, "Background color for the original text in inline edits.")), true);
const modifiedBackgroundColor = registerColor("inlineEdit.modifiedBackground", ( transparent(diffInserted, 0.3)), ( localize(1371, "Background color for the modified text in inline edits.")), true);
...
const inlineEditIndicatorPrimaryForeground = registerColor(
    ...
    buttonForeground,
    ( localize(1376, "Foreground color for the primary inline edit gutter indicator."))
);
const inlineEditIndicatorPrimaryBorder = registerColor(
    "inlineEdit.gutterIndicator.primaryBorder",
    buttonBackground,
    ( localize(1377, "Border color for the primary inline edit gutter indicator."))
);
...
}, ( localize(1378, "Background color for the primary inline edit gutter indicator.")));
const inlineEditIndicatorSecondaryForeground = registerColor(
    ...
    ( localize(1379, "Foreground color for the secondary inline edit gutter indicator."))
);
const inlineEditIndicatorSecondaryBorder = registerColor(
    "inlineEdit.gutterIndicator.secondaryBorder",
    editorHoverBorder,
    ( localize(1380, "Border color for the secondary inline edit gutter indicator."))
);
const inlineEditIndicatorSecondaryBackground = registerColor(
    ...
    ( localize(1381, "Background color for the secondary inline edit gutter indicator."))
);
const inlineEditIndicatorSuccessfulForeground = registerColor(
    "inlineEdit.gutterIndicator.successfulForeground",
    buttonForeground,
    ( localize(1382, "Foreground color for the successful inline edit gutter indicator."))
);
const inlineEditIndicatorSuccessfulBorder = registerColor(
    "inlineEdit.gutterIndicator.successfulBorder",
    buttonBackground,
    ( localize(1383, "Border color for the successful inline edit gutter indicator."))
);
const inlineEditIndicatorSuccessfulBackground = registerColor(
    ...
    ( localize(1384, "Background color for the successful inline edit gutter indicator."))
);
const inlineEditIndicatorBackground = registerColor("inlineEdit.gutterIndicator.background", {
    ...
    light: "#5f5f5f18"
}, ( localize(1385, "Background color for the inline edit gutter indicator.")));
const originalBorder = registerColor("inlineEdit.originalBorder", {
    light: diffRemoved,
    dark: diffRemoved,
    hcDark: diffRemoved,
    hcLight: diffRemoved
}, ( localize(1386, "Border color for the original text in inline edits.")));
const modifiedBorder = registerColor("inlineEdit.modifiedBorder", {
    light: ( darken(diffInserted, 0.6)),
    dark: diffInserted,
    hcDark: diffInserted,
    hcLight: diffInserted
}, ( localize(1387, "Border color for the modified text in inline edits.")));
...
function getEditorBlendedColor(colorIdentifier, themeService) {
    ...
    if (typeof colorIdentifier === "string") {
        ...
        color = ( colorIdentifier.map(
            (identifier, reader) => observeColor(identifier, themeService).read(reader)
        ));
    }
