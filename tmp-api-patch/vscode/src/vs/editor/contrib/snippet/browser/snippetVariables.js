...
class TimeBasedVariableResolver {
    ...
    static {
        this.dayNames = [( localize(1554, "Sunday")), ( localize(1555, "Monday")), ( localize(1556, "Tuesday")), ( localize(1557, "Wednesday")), ( localize(1558, "Thursday")), ( localize(1559, "Friday")), ( localize(1560, "Saturday"))];
    }
    static {
        this.dayNamesShort = [( localize(1561, "Sun")), ( localize(1562, "Mon")), ( localize(1563, "Tue")), ( localize(1564, "Wed")), ( localize(1565, "Thu")), ( localize(1566, "Fri")), ( localize(1567, "Sat"))];
    }
    static {
        this.monthNames = [( localize(1568, "January")), ( localize(1569, "February")), ( localize(1570, "March")), ( localize(1571, "April")), ( localize(1572, "May")), ( localize(1573, "June")), ( localize(1574, "July")), ( localize(1575, "August")), ( localize(1576, "September")), ( localize(1577, "October")), ( localize(1578, "November")), ( localize(1579, "December"))];
    }
    static {
        this.monthNamesShort = [( localize(1580, "Jan")), ( localize(1581, "Feb")), ( localize(1582, "Mar")), ( localize(1583, "Apr")), ( localize(1584, "May")), ( localize(1585, "Jun")), ( localize(1586, "Jul")), ( localize(1587, "Aug")), ( localize(1588, "Sep")), ( localize(1589, "Oct")), ( localize(1590, "Nov")), ( localize(1591, "Dec"))];
    }
    resolve(variable) {
        const {
            name
