...
import { registerEditorContribution, EditorContributionInstantiation, EditorCommand, registerEditorCommand } from '../../../browser/editorExtensions.js';
...
let SnippetController2 = class SnippetController2 {
    ...
    static {
        this.InSnippetMode = ( new RawContextKey("inSnippetMode", false, ( localize(1549, "Whether the editor in current in snippet mode"))));
    }
    static {
        this.HasNextTabstop = ( new RawContextKey("hasNextTabstop", false, ( localize(1550, "Whether there is a next tab stop when in snippet mode"))));
    }
    static {
        this.HasPrevTabstop = ( new RawContextKey("hasPrevTabstop", false, ( localize(1551, "Whether there is a previous tab stop when in snippet mode"))));
    }
    static {
        this.InSnippetChoice = ( new RawContextKey("inSnippetChoice", false, ( localize(1552, "Whether the current snippet tab stop is a choice"))));
    }
    constructor(
        _editor,
        _logService,
        ...
        this._inSnippetChoice = SnippetController2_1.InSnippetChoice.bindTo(contextKeyService);
    }
    dispose() {
    ...
    apply(edits, opts) {
        try {
            this._doInsert(edits, typeof opts === "undefined" ? _defaultOptions : {
                ..._defaultOptions,
                ...opts
            });
        } catch (e) {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: {
                                ...
                                title: ( localize(1553, "Go to next placeholder..."))
                            }
                        });
                    }
                    return {
...
KeybindingsRegistry.registerKeybindingRule({
    ...
    when: ( ContextKeyExpr.and(
        ...
        SnippetController2.InSnippetChoice,
