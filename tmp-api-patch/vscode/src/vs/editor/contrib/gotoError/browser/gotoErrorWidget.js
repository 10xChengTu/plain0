...
import * as gotoErrorWidget from './media/gotoErrorWidget.css';
...
class MessageWidget {
    ...
    update(marker) {
        ...
        status(this.getAriaLabel(marker));
    ...
    getAriaLabel(marker) {
        ...
        case MarkerSeverity.Error:
            severityLabel = ( localize(1171, "Error"));
            break;
        case MarkerSeverity.Warning:
            severityLabel = ( localize(1172, "Warning"));
            break;
        case MarkerSeverity.Info:
            severityLabel = ( localize(1173, "Info"));
            break;
        case MarkerSeverity.Hint:
            severityLabel = ( localize(1174, "Hint"));
            break;
        }
...
let MarkerNavigationWidget = class MarkerNavigationWidget extends PeekViewWidget {
    ...
    showAtMarker(marker, markerIdx, markerCount) {
        ...
        if (model) {
            const detail = markerCount > 1 ? ( localize(1176, "{0} of {1} problems", markerIdx, markerCount)) : ( localize(1177, "{0} of {1} problem", markerIdx, markerCount));
...
}, ( localize(1178, "Editor marker navigation widget error color.")));
const editorMarkerNavigationErrorHeader = registerColor("editorMarkerNavigationError.headerBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(1179, "Editor marker navigation widget error heading background.")));
const editorMarkerNavigationWarning = registerColor("editorMarkerNavigationWarning.background", {
    dark: warningDefault,
    light: warningDefault,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(1180, "Editor marker navigation widget warning color.")));
...
}, ( localize(1181, "Editor marker navigation widget warning heading background.")));
const editorMarkerNavigationInfo = registerColor("editorMarkerNavigationInfo.background", {
    dark: infoDefault,
    light: infoDefault,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(1182, "Editor marker navigation widget info color.")));
const editorMarkerNavigationInfoHeader = registerColor("editorMarkerNavigationInfo.headerBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(1183, "Editor marker navigation widget info heading background.")));
const editorMarkerNavigationBackground = registerColor("editorMarkerNavigation.background", editorBackground, ( localize(1184, "Editor marker navigation widget background.")));
