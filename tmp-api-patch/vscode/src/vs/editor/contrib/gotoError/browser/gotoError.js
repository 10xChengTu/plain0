...
class NextMarkerAction extends MarkerNavigationAction {
    ...
    static {
        this.LABEL = ( localize2(1163, "Go to Next Problem (Error, Warning, Info)"));
    }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon("marker-navigation-next", Codicon.arrowDown, ( localize(1164, "Icon for goto next marker."))),
                group: "navigation",
                order: 1
            }
        });
...
class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static {
        this.LABEL = ( localize2(1165, "Go to Previous Problem (Error, Warning, Info)"));
    }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon("marker-navigation-previous", Codicon.arrowUp, ( localize(1166, "Icon for goto previous marker."))),
                group: "navigation",
                order: 2
            }
        });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
    static {
        this.ID = "editor.action.marker.nextInFiles";
    }
    constructor() {
        super(true, true, {
            id: NextMarkerInFilesAction.ID,
            label: ( localize2(1167, "Go to Next Problem in Files (Error, Warning, Info)")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyCode.F8,
            ...
            menuOpts: {
                ...
                title: ( localize(1168, "Next &&Problem")),
                group: "6_problem_nav",
                order: 1
            }
        });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    static {
        this.ID = "editor.action.marker.prevInFiles";
    }
    constructor() {
        super(false, true, {
            id: PrevMarkerInFilesAction.ID,
            label: ( localize2(1169, "Go to Previous Problem in Files (Error, Warning, Info)")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarGoMenu,
                title: ( localize(1170, "Previous &&Problem")),
                group: "6_problem_nav",
                order: 2
            }
        });
...
export { MarkerController, NextMarkerAction, NextMarkerInFilesAction, PrevMarkerAction, PrevMarkerInFilesAction };
