...
import * as highlightDecorations from './highlightDecorations.css';
...
registerColor("editor.wordHighlightTextBorder", wordHighlightBorder, ( localize(1715, "Border color of a textual occurrence for a symbol.")));
