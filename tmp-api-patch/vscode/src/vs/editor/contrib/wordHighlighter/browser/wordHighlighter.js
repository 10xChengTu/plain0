...
function getOccurrencesAcrossMultipleModels(registry, model, position, token, otherModels) {
    ...
    return first(( orderedByScore.map(provider => () => {
        ...
        return Promise.resolve(
            provider.provideMultiDocumentHighlights(model, position, filteredModels, token)
    ...
    get result() {
        if (!this._result) {
            this._result = createCancelablePromise(
                token => this._compute(this._model, this._selection, this._wordSeparators, token)
            );
        }
        return this._result;
    }
        ...
        if (isEqual(this.editor.getModel().uri, WordHighlighter_1.query.modelInfo?.modelURI)) {
            ...
            try {
                this.workerRequest = this.computeWithModel(
                    ...
                    WordHighlighter_1.query.modelInfo.selection,
...
WordHighlighter = WordHighlighter_1 = ( __decorate([( __param(4, ITextModelService)), ( __param(5, ICodeEditorService)), ( __param(6, IConfigurationService)), ( __param(7, ILogService))], WordHighlighter));
...
WordHighlighterContribution = WordHighlighterContribution_1 = ( __decorate([( __param(1, IContextKeyService)), ( __param(2, ILanguageFeaturesService)), ( __param(3, ICodeEditorService)), ( __param(4, ITextModelService)), ( __param(5, IConfigurationService)), ( __param(6, ILogService))], WordHighlighterContribution));
...
class NextWordHighlightAction extends WordHighlightNavigationAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1719, "Go to Next Symbol Highlight")),
...
class PrevWordHighlightAction extends WordHighlightNavigationAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1720, "Go to Previous Symbol Highlight")),
            precondition: ctxHasWordHighlights,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class TriggerWordHighlightAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1721, "Trigger Symbol Highlight")),
