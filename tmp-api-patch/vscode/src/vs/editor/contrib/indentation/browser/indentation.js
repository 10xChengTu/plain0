...
class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1291, "Convert Indentation to Spaces")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1292, "Convert the tab indentation to spaces."))
            }
        });
    }
    run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1293, "Convert Indentation to Tabs")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1294, "Convert the spaces indentation to tabs."))
            }
        });
    }
    run(accessor, editor) {
...
class ChangeIndentationSizeAction extends EditorAction {
    ...
    run(accessor, editor) {
        ...
        const picks = ( [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            id: ( n.toString()),
            label: ( n.toString()),
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize ? ( localize(1295, "Configured Tab Size")) : n === creationOpts.tabSize ? ( localize(1296, "Default Tab Size")) : n === modelOpts.tabSize ? ( localize(1297, "Current Tab Size")) : undefined)
        })));
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, {
                placeHolder: ( localize(1298, "Select Tab Size for Current File")),
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: ( localize2(1299, "Indent Using Tabs")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1300, "Use indentation with tabs."))
            }
        });
    }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: ( localize2(1301, "Indent Using Spaces")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1302, "Use indentation with spaces."))
            }
        });
    }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: ( localize2(1303, "Change Tab Display Size")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1304, "Change the space size equivalent of the tab."))
            }
        });
    }
}
class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1305, "Detect Indentation from Content")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1306, "Detect the indentation from content."))
            }
        });
    }
    run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1307, "Reindent Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1308, "Reindent the lines of the editor."))
            },
...
class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1309, "Reindent Selected Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1310, "Reindent the selected lines of the editor."))
            },
            canTriggerInlineEdits: true
        });
    }
    ...
    trigger(range) {
        ...
        if (startLineNumber !== range.endLineNumber) {
            ...
            if (indentOfSecondLine !== null) {
                ...
                const oldSpaceCntOfSecondLine = getSpaceCnt(
                    getLeadingWhitespace(model.getLineContent(startLineNumber + 1)),
                    tabSize
                );
