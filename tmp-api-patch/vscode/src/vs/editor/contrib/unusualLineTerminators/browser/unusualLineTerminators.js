    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: ( localize(1705, "Unusual Line Terminators")),
                message: ( localize(1706, "Detected unusual line terminators")),
                detail: ( localize(
                    1707,
                ...
                primaryButton: ( localize(1708, "&&Remove Unusual Line Terminators")),
                cancelButton: ( localize(1709, "Ignore"))
            });
        } finally {
            this._isPresentingDialog = false;
        }
