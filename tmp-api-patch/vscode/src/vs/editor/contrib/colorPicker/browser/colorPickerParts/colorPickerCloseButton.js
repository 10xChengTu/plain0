...
class CloseButton extends Disposable {
    constructor(container) {
        ...
        const closeButton = append(innerDiv, $(
            ".button" + ThemeIcon.asCSSSelector(registerIcon("color-picker-close", Codicon.close, ( localize(1026, "Icon to close the color picker"))))
        ));
