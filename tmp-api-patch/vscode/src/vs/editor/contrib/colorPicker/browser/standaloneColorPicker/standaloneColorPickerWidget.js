...
import { createElement, trackFocus, createDocumentFragment } from '../../../../../base/browser/dom.js';
import { IHoverService } from '../../../../../platform/hover/browser/hover.service.js';

var StandaloneColorPickerWidget_1;
registerCss(colorPicker);
...
StandaloneColorPickerWidget = StandaloneColorPickerWidget_1 = ( __decorate([( __param(3, IInstantiationService)), ( __param(4, IKeybindingService)), ( __param(5, ILanguageFeaturesService)), ( __param(6, IEditorWorkerService)), ( __param(7, IHoverService))], StandaloneColorPickerWidget));
