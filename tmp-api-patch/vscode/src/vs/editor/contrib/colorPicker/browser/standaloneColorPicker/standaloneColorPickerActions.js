...
class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1029, "Show or Focus Standalone Color Picker")),
                mnemonicTitle: ( localize(1030, "&&Show or Focus Standalone Color Picker"))
            },
...
class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1032, "Hide the Color Picker")),
            ...
            metadata: {
                description: ( localize2(1033, "Hide the standalone color picker."))
            }
        });
    }
...
class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1034, "Insert Color with Standalone Color Picker")),
