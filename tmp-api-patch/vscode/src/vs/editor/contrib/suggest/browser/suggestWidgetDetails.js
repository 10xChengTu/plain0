...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    constructor(_editor, _themeService, _markdownRendererService) {
        ...
        this._close.title = ( localize(1637, "Close"));
    ...
    renderLoading() {
        this._type.textContent = ( localize(1638, "Loading..."));
...
SuggestDetailsWidget = ( __decorate([( __param(1, IThemeService)), ( __param(2, IMarkdownRendererService))], SuggestDetailsWidget));
class SuggestDetailsOverlay {
    ...
    _placeAtAnchor(anchorBox, size, preferAlignAtTop) {
        ...
        const southPlacement = (function() {
            ...
            const maxSizeBottom = new Dimension(
