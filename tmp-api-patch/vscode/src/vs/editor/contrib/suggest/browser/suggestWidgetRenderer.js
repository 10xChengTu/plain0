...
const suggestMoreInfoIcon = registerIcon("suggest-more-info", Codicon.chevronRight, ( localize(1639, "Icon for more information in the suggest widget.")));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = ( localize(1640, "Read More"));
        const configureFont = () => {
