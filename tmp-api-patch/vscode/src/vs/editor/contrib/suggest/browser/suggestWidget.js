...
import { Dimension, append, $, trackFocus, addStandardDisposableListener, hide, show, runAtThisOrScheduleAtNextAnimationFrame, getWindow, getClientArea, getDomNodePagePosition } from '../../../../base/browser/dom.js';
...
import * as suggest from './media/suggest.css';
...
var SuggestWidget_1;
registerCss(suggest);
registerColor("editorSuggestWidget.background", editorWidgetBackground, ( localize(1620, "Background color of the suggest widget.")));
registerColor("editorSuggestWidget.border", editorWidgetBorder, ( localize(1621, "Border color of the suggest widget.")));
const editorSuggestWidgetForeground = registerColor("editorSuggestWidget.foreground", editorForeground, ( localize(1622, "Foreground color of the suggest widget.")));
registerColor(
    "editorSuggestWidget.selectedForeground",
    quickInputListFocusForeground,
    ( localize(1623, "Foreground color of the selected entry in the suggest widget."))
);
registerColor(
    "editorSuggestWidget.selectedIconForeground",
    quickInputListFocusIconForeground,
    ( localize(1624, "Icon foreground color of the selected entry in the suggest widget."))
);
const editorSuggestWidgetSelectedBackground = registerColor(
    "editorSuggestWidget.selectedBackground",
    quickInputListFocusBackground,
    ( localize(1625, "Background color of the selected entry in the suggest widget."))
);
registerColor(
    "editorSuggestWidget.highlightForeground",
    listHighlightForeground,
    ( localize(1626, "Color of the match highlights in the suggest widget."))
);
registerColor(
...
registerColor("editorSuggestWidgetStatus.foreground", ( transparent(editorSuggestWidgetForeground, .5)), ( localize(1628, "Foreground color of the suggest widget status.")));
var State;
(function(State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static {
        this.LOADING_MESSAGE = ( localize(1629, "Loading..."));
    }
    static {
        this.NO_SUGGESTIONS_MESSAGE = ( localize(1630, "No suggestions."));
    }
    constructor(
        editor,
        _storageService,
        ...
        this._list = ( new List("SuggestWidget", this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => ( localize(1631, "Suggest")),
                ...
                getAriaLabel: item => {
                    ...
                    if (typeof item.completion.label !== "string") {
                        ...
                        if (detail && description) {
                            label = ( localize(1632, "{0} {1}, {2}, {3}", label, detail, description, kindLabel));
                        } else if (detail) {
                            label = ( localize(1633, "{0} {1}, {2}", label, detail, kindLabel));
                        } else if (description) {
                            label = ( localize(1634, "{0}, {1}, {2}", label, description, kindLabel));
                        }
                    } else {
                        label = ( localize(1635, "{0}, {1}", label, kindLabel));
                    }
                    ...
                    return localize(1636, "{0}, docs: {1}", label, docs);
                }
            }
        }));
        ...
        const applyStatusBarStyle = () => this.element.domNode.classList.toggle(
            "with-status-bar",
        ...
        this._disposables.add(
            this.editor.onDidChangeCursorSelection(() => this._onCursorSelectionChanged())
        );
        ...
        this._ctxSuggestWidgetDetailsFocused = Context.DetailsFocused.bindTo(_contextKeyService);
        const detailsFocusTracker = trackFocus(this._details.widget.domNode);
        this._disposables.add(detailsFocusTracker);
        this._disposables.add(
            detailsFocusTracker.onDidFocus(() => this._ctxSuggestWidgetDetailsFocused.set(true))
        );
        this._disposables.add(
            detailsFocusTracker.onDidBlur(() => this._ctxSuggestWidgetDetailsFocused.set(false))
        );
        this._disposables.add(
    ...
    _onListFocus(e) {
        ...
        if (item !== this._focusedItem) {
            ...
            this._currentSuggestionDetails.then(() => {
                ...
                this.editor.setAriaOptions({
                    activeDescendant: this._list.getElementID(index)
                });
    ...
    showSuggestions(completionModel, selectionIndex, isFrozen, isAuto, noFocus) {
        ...
        try {
            ...
            this._list.reveal(
                selectionIndex,
                0,
                selectionIndex === 0 ? 0 : this.getLayoutInfo().itemHeight * 0.33
            );
    ...
    getFocusedItem() {
        if (this._state !== State.Hidden && this._state !== State.Empty && this._state !== State.Loading && this._completionModel && this._list.getFocus().length > 0) {
            return {
