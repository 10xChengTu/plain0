...
import { ISuggestMemoryService } from './suggestMemory.service.js';
...
let SuggestController = class SuggestController {
    ...
    constructor(
        ...
        this.widget = this._toDispose.add(new WindowIdleValue(getWindow(editor.getDomNode()), () => {
            ...
            this._toDispose.add(
                widget.onDidSelect(item => this._insertSuggestion(item, InsertFlags.None), this)
            );
    ...
    _insertSuggestion(event, flags) {
        ...
        snippetController.insert(insertText, {
            ...
            reason: EditSources.suggest({
                providerId: ProviderId.fromExtensionId(item.extensionId?.value)
            })
        });
        ...
        if (item.completion.command) {
            if (item.completion.command.id === TriggerSuggestAction.id) {
                ...
                const sw = ( new StopWatch());
                tasks.push(this._commandService.executeCommand(
    ...
    _reportSuggestionAcceptedTelemetry(
        ...
        model,
        itemResolved,
        commandExectionDuration,
        additionalEditsAppliedAsync,
        index,
        completionItems
    ) {
    ...
    triggerSuggestAndAcceptBest(arg) {
        ...
        Event.once(this.model.onDidTrigger)(_ => {
            ...
            this.model.onDidSuggest((
                ...
                }, InsertFlags.KeepAlternativeSuggestions | InsertFlags.NoBeforeUndoStop | InsertFlags.NoAfterUndoStop);
            }, undefined, listener);
        });
        this.model.trigger({
            auto: false,
...
class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1613, "Trigger Suggest")),
            ...
            kbOpts: {
                ...
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.Space,
                    secondary: [KeyMod$1.Alt | KeyCode.Escape, KeyMod$1.CtrlCmd | KeyCode.KeyI]
                },
...
registerEditorCommand(( new SuggestCommand({
    ...
    kbOpts: {
        ...
        mac: {
            primary: KeyMod$1.WinCtrl | KeyMod$1.Alt | KeyCode.Space
        }
    }
})));
registerEditorCommand(( new SuggestCommand({
...
registerEditorCommand(new (class extends EditorCommand {
    constructor() {
        super({
            ...
            precondition: Context.DetailsFocused,
            kbOpts: {
                weight: weight + 10,
                kbExpr: Context.DetailsFocused,
                primary: KeyMod$1.CtrlCmd | KeyCode.KeyC,
                win: {
                    primary: KeyMod$1.CtrlCmd | KeyCode.KeyC,
                    secondary: [KeyMod$1.CtrlCmd | KeyCode.Insert]
                }
            }
        });
    }
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1619, "Reset Suggest Widget Size")),
