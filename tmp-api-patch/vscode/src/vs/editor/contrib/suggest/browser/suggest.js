...
const Context = {
    ...
    HasFocusedSuggestion: ( new RawContextKey("suggestWidgetHasFocusedSuggestion", false, ( localize(1603, "Whether any suggestion is focused")))),
    DetailsVisible: ( new RawContextKey("suggestWidgetDetailsVisible", false, ( localize(1604, "Whether suggestion details are visible")))),
    DetailsFocused: ( new RawContextKey("suggestWidgetDetailsFocused", false, ( localize(1605, "Whether the details pane of the suggest widget has focus")))),
    MultipleSuggestions: ( new RawContextKey("suggestWidgetMultipleSuggestions", false, ( localize(1606, "Whether there are multiple suggestions to pick from")))),
    ...
    AcceptSuggestionsOnEnter: ( new RawContextKey("acceptSuggestionOnEnter", true, ( localize(1608, "Whether suggestions are inserted when pressing Enter")))),
    HasInsertAndReplaceRange: ( new RawContextKey("suggestionHasInsertAndReplaceRange", false, ( localize(1609, "Whether the current suggestion has insert and replace behaviour")))),
    InsertMode: ( new RawContextKey("suggestionInsertMode", undefined, {
        type: "string",
        description: ( localize(1610, "Whether the default behaviour is to insert or replace"))
    })),
    CanResolve: ( new RawContextKey("suggestionCanResolve", false, ( localize(1611, "Whether the current suggestion supports to resolve further details"))))
};
...
async function provideSuggestionItems(
    registry,
    model,
    position,
