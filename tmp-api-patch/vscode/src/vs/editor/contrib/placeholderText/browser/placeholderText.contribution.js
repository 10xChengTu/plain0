...
import * as placeholderText from './placeholderText.css';
...
registerColor("editor.placeholder.foreground", ghostTextForeground, ( localize(1482, "Foreground color of the placeholder text in the editor.")));
