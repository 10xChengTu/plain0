...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createAction({
            label: ( localize(1043, "Render Characters")),
        ...
        actions.push(createEnumAction(( localize(1044, "Vertical size")), minimapOptions.enabled, "editor.minimap.size", minimapOptions.size, [{
            label: ( localize(1045, "Proportional")),
            value: "proportional"
        }, {
            label: ( localize(1046, "Fill")),
            value: "fill"
        }, {
            label: ( localize(1047, "Fit")),
            value: "fit"
        }]));
        actions.push(createEnumAction(( localize(1048, "Slider")), minimapOptions.enabled, "editor.minimap.showSlider", minimapOptions.showSlider, [{
            label: ( localize(1049, "Mouse Over")),
            value: "mouseover"
        }, {
            label: ( localize(1050, "Always")),
            value: "always"
        }]));
        actions.push(createEnumAction(( localize(1051, "Side")), minimapOptions.enabled, "editor.minimap.side", minimapOptions.side, [{
            label: ( localize(1052, "Right")),
            value: "right"
        }, {
            label: ( localize(1053, "Left")),
            value: "left"
        }]));
        const useShadowDOM = this._editor.getOption(EditorOption.useShadowDOM) && !isIOS;
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1054, "Show Editor Context Menu")),
