...
let ParameterHintsController = class ParameterHintsController extends Disposable {
    ...
    constructor(editor, instantiationService, languageFeaturesService) {
        ...
        this.widget = ( new Lazy(() => this._register(
            instantiationService.createInstance(ParameterHintsWidget, this.editor, this.model)
        )));
    }
    cancel() {
        this.model.cancel();
...
class TriggerParameterHintsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1459, "Trigger Parameter Hints")),
...
registerEditorCommand(( new ParameterHintsCommand({
    ...
    kbOpts: {
        ...
        mac: {
            primary: KeyCode.UpArrow,
            secondary: [KeyMod$1.Alt | KeyCode.UpArrow, KeyMod$1.WinCtrl | KeyCode.KeyP]
        }
    }
})));
registerEditorCommand(( new ParameterHintsCommand({
    ...
    kbOpts: {
        ...
        mac: {
            primary: KeyCode.DownArrow,
            secondary: [KeyMod$1.Alt | KeyCode.DownArrow, KeyMod$1.WinCtrl | KeyCode.KeyN]
        }
    }
})));
