...
const $ = $$1;
const parameterHintsNextIcon = registerIcon("parameter-hints-next", Codicon.chevronDown, ( localize(1460, "Icon for show next parameter hint.")));
const parameterHintsPreviousIcon = registerIcon("parameter-hints-previous", Codicon.chevronUp, ( localize(1461, "Icon for show previous parameter hint.")));
...
ParameterHintsWidget = ParameterHintsWidget_1 = ( __decorate([( __param(2, IContextKeyService)), ( __param(3, IMarkdownRendererService))], ParameterHintsWidget));
registerColor(
    "editorHoverWidget.highlightForeground",
    listHighlightForeground,
    ( localize(1463, "Foreground color of the active item in the parameter hint."))
);
