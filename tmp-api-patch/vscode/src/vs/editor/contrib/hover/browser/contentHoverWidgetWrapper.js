...
let ContentHoverWidgetWrapper = class ContentHoverWidgetWrapper extends Disposable {
    ...
    _registerListeners() {
        ...
        this._register(
            addStandardDisposableListener(contentHoverWidgetNode, "keydown", e => {
        ...
        this._register(
            addStandardDisposableListener(contentHoverWidgetNode, "mouseleave", e => {
...
ContentHoverWidgetWrapper = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IKeybindingService)), ( __param(3, IHoverService)), ( __param(4, IClipboardService))], ContentHoverWidgetWrapper));
