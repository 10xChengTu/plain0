...
ContentHoverController = ContentHoverController_1 = ( __decorate([( __param(1, IContextMenuService)), ( __param(2, IInstantiationService)), ( __param(3, IKeybindingService))], ContentHoverController));
