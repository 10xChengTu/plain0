...
import { INCREASE_HOVER_VERBOSITY_ACTION_ID, DECREASE_HOVER_VERBOSITY_ACTION_ID, DECREASE_HOVER_VERBOSITY_ACCESSIBLE_ACTION_ID, INCREASE_HOVER_VERBOSITY_ACCESSIBLE_ACTION_ID } from './hoverActionIds.js';
        ...
        return ( new Action(
            ...
            () => {
                editor.getAction(actionId)?.run({
                    index: this._focusedHoverPartIndex,
                    focus: false
                });
            }
        ));
...
class ExtHoverAccessibleView {
    ...
    getProvider(accessor) {
        ...
        return ( new AccessibleContentProvider(AccessibleViewProviderId.Hover, {
            language: "typescript",
            type: AccessibleViewType.View
        }, () => {
