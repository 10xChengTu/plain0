...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1252, "Show or Focus Hover")),
            metadata: {
                    ...
                    schema: {
                        ...
                        properties: {
                            "focus": {
                                ...
                                enumDescriptions: [( localize(1254, "The hover will not automatically take focus.")), ( localize(1255, "The hover will take focus only if it is already visible.")), ( localize(1256, "The hover will automatically take focus when it appears."))],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1257, "Show Definition Preview Hover")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1258, "Show the definition preview hover in the editor."))
            }
        });
    }
    run(accessor, editor) {
...
class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1259, "Hide Hover")),
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1260, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(1261, "Scroll up the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1262, "Scroll Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1263, "Scroll down the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1264, "Scroll Left Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1265, "Scroll left the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1266, "Scroll Right Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1267, "Scroll right the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1268, "Page Up Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1269, "Page up the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1270, "Page Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1271, "Page down the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1272, "Go To Top Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1273, "Go to the top of the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1274, "Go To Bottom Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
                primary: KeyCode.End,
            ...
            metadata: {
                description: ( localize2(1275, "Go to the bottom of the editor hover."))
            }
        });
    }
    run(accessor, editor) {
