...
let HoverCopyButton = class HoverCopyButton extends Disposable {
    ...
    async _copyContent() {
        ...
        if (content) {
            ...
            status(( localize(1277, "Copied to clipboard")));
        }
    }
};
HoverCopyButton = ( __decorate([( __param(2, IClipboardService)), ( __param(3, IHoverService))], HoverCopyButton));
