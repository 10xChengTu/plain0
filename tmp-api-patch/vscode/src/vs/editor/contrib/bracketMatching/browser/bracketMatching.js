...
import * as bracketMatching from './bracketMatching.css';
...
registerCss(bracketMatching);
const overviewRulerBracketMatchForeground = registerColor("editorOverviewRuler.bracketMatchForeground", "#A0A0A0", ( localize(953, "Overview ruler marker color for matching brackets.")));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: "editor.action.jumpToBracket",
            label: ( localize2(954, "Go to Bracket")),
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(955, "Select to Bracket")),
            precondition: undefined,
            metadata: {
                description: ( localize2(956, "Select the text inside and including the brackets or curly braces")),
                args: [{
                    name: "args",
                    schema: {
                        type: "object",
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(957, "Remove Brackets")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: "editor.action.jumpToBracket",
        title: ( localize(958, "Go to &&Bracket"))
    },
    order: 2
});
registerThemingParticipant((theme, collector) => {
    ...
    if (bracketMatchForeground) {
        collector.addRule(
            `.monaco-editor .bracket-match-inline { color: ${bracketMatchForeground} !important; }`
        );
    }
});
