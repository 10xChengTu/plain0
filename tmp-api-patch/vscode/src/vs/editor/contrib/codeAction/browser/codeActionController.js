...
import { autoFixCommandId, quickFixCommandId, ApplyCodeActionReason, applyCodeAction } from './codeAction.js';
...
import { LightBulbWidget, computeLightBulbInfo } from './lightBulbWidget.js';
...
let CodeActionController = class CodeActionController extends Disposable {
    ...
    async update(newState) {
        ...
        this._lightBulbInfoObs.set(computeLightBulbInfo(
            actions,
            newState.trigger,
            this._preferredKbLabel.get(),
            this._quickFixKbLabel.get()
        ), undefined);
    ...
    _getActionBarActions(actions, at, options) {
        ...
        if (options.includeDisabledActions && actions.validActions.length > 0 && actions.allActions.length !== actions.validActions.length) {
            resultActions.push(this._showDisabled ? {
                id: "hideMoreActions",
                label: ( localize(1005, "Hide Disabled")),
                enabled: true,
                tooltip: "",
                class: undefined,
                run: () => {
                ...
                id: "showMoreActions",
                label: ( localize(1006, "Show Disabled")),
                enabled: true,
                tooltip: "",
                class: undefined,
                run: () => {
