...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(Type.Toggle, {
            ...
            label: ( localize2(1036, "Toggle Line Comment")),
            ...
            menuOpts: {
                ...
                group: "5_insert",
                title: ( localize(1037, "&&Toggle Line Comment")),
                order: 1
            },
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceAdd, {
            ...
            label: ( localize2(1038, "Add Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceRemove, {
            ...
            label: ( localize2(1039, "Remove Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class BlockCommentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1040, "Toggle Block Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarEditMenu,
                group: "5_insert",
                title: ( localize(1041, "Toggle &&Block Comment")),
                order: 2
            },
            canTriggerInlineEdits: true
        });
