...
function getSelectionSearchString(
    editor,
    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(( localize(1084, "The file is too large to perform a replace all operation.")));
                return false;
            }
...
FindController = ( __decorate([( __param(1, IContextViewService)), ( __param(2, IContextKeyService)), ( __param(3, IKeybindingService)), ( __param(4, INotificationService)), ( __param(5, IStorageService)), ( __param(6, IClipboardService)), ( __param(7, IHoverService)), ( __param(8, IConfigurationService)), ( __param(9, IAccessibilityService))], FindController));
const StartFindAction = registerMultiEditorAction(( new MultiEditorAction({
    id: FIND_IDS.StartFindAction,
    label: ( localize2(1085, "Find")),
...
class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1087, "Find with Arguments")),
...
class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1088, "Find with Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
...
const NextMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1090, "Find Next")),
    precondition: undefined,
    kbOpts: [{
        kbExpr: EditorContextKeys.focus,
        primary: KeyCode.F3,
        mac: {
            primary: KeyMod$1.CtrlCmd | KeyCode.KeyG,
...
const PreviousMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1091, "Find Previous")),
    precondition: undefined,
    kbOpts: [{
        kbExpr: EditorContextKeys.focus,
        primary: KeyMod$1.Shift | KeyCode.F3,
        mac: {
            primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyG,
            secondary: [KeyMod$1.Shift | KeyCode.F3]
        },
        weight: KeybindingWeight.EditorContrib
    }, {
        kbExpr: ( ContextKeyExpr.and(EditorContextKeys.focus, CONTEXT_FIND_INPUT_FOCUSED)),
...
class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1092, "Go to Match...")),
    ...
    run(accessor, editor) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: ( localize(1093, "No matches. Try searching for something else."))
            });
            return;
        }
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1096, "Find Next Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1097, "Find Previous Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
StartFindReplaceAction.addImplementation(0, (accessor, editor, args) => {
    ...
    const shouldFocus = (findInputFocused || seedSearchStringFromSelection) ? FindStartFocusAction.FocusReplaceInput : FindStartFocusAction.FocusFindInput;
    return controller.start({
...
export { CommonFindController, FindController, FindStartFocusAction, MoveToMatchFindAction, NextMatchFindAction, NextSelectionMatchFindAction, PreviousMatchFindAction, PreviousSelectionMatchFindAction, SelectionMatchFindAction, StartFindAction, StartFindReplaceAction, StartFindWithArgsAction, StartFindWithSelectionAction, getSelectionSearchString };
