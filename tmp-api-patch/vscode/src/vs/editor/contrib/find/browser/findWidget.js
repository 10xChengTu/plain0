...
import { createElement, trackFocus, addDisposableListener, isHTMLElement, getWindow, getTotalWidth, createTextNode, getDomNodePagePosition, getTopLeftOffset, getComputedStyle } from '../../../../base/browser/dom.js';
...
import { MATCHES_LIMIT, CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_REPLACE_INPUT_FOCUSED, CONTEXT_FIND_WIDGET_FOCUSED, FIND_IDS } from './findModel.js';
...
const findCollapsedIcon = registerIcon("find-collapsed", Codicon.chevronRight, ( localize(1100, "Icon to indicate that the editor find widget is collapsed.")));
const findExpandedIcon = registerIcon("find-expanded", Codicon.chevronDown, ( localize(1101, "Icon to indicate that the editor find widget is expanded.")));
const findSelectionIcon = registerIcon("find-selection", Codicon.selection, ( localize(1102, "Icon for 'Find in Selection' in the editor find widget.")));
const findReplaceIcon = registerIcon("find-replace", Codicon.replace, ( localize(1103, "Icon for 'Replace' in the editor find widget.")));
const findReplaceAllIcon = registerIcon("find-replace-all", Codicon.replaceAll, ( localize(1104, "Icon for 'Replace All' in the editor find widget.")));
const findPreviousMatchIcon = registerIcon("find-previous-match", Codicon.arrowUp, ( localize(1105, "Icon for 'Find Previous' in the editor find widget.")));
const findNextMatchIcon = registerIcon("find-next-match", Codicon.arrowDown, ( localize(1106, "Icon for 'Find Next' in the editor find widget.")));
const NLS_FIND_DIALOG_LABEL = ( localize(1107, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(1108, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(1109, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(1110, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(1111, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(1112, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(1113, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(1114, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(1115, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(1116, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(1117, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(1118, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(1120, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(1121, "No results"));
...
class FindWidget extends Widget {
    ...
    constructor(
        ...
        this._widgetFocusTracker = this._register(trackFocus(this._domNode));
        ...
        this._register(addDisposableListener(this._domNode, "focusin", e => {
    ...
    focusLastElement() {
        ...
        if (this._lastFocusedElement && this._domNode.contains(this._lastFocusedElement) && getWindow(this._lastFocusedElement).document.body.contains(this._lastFocusedElement)) {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        ...
        if (label === NLS_NO_RESULTS) {
            result = searchString === "" ? ( localize(1122, "{0} found", label)) : ( localize(1123, "{0} found for '{1}'", label, searchString));
            ...
            result = ( localize(1125, "{0} found for '{1}'", label, searchString));
        }
        return result;
    }
    ...
    _updateFindInputAriaLabel() {
        ...
        if (!this._accessibilityHelpHintAnnounced && this._configurationService.getValue("accessibility.verbosity.find") && this._accessibilityService.isScreenReaderOptimized()) {
            ...
            if (accessibilityHelpKeybinding) {
                const hint = ( localize(1126, "Press {0} for accessibility help", accessibilityHelpKeybinding));
                findLabel = ( localize(1127, "{0}, {1}", findLabel, hint));
                replaceLabel = ( localize(1128, "{0}, {1}", replaceLabel, hint));
            }
