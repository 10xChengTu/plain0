...
let FileReferencesTemplate = class FileReferencesTemplate extends Disposable {
    ...
    set(element, matches) {
        ...
        this.file.setLabel(
            ...
            this._labelService.getUriLabel(parent, {
                relative: true
            }),
            {
        ...
        if (len > 1) {
            this.badge.setTitleFormat(( localize(1224, "{0} references", len)));
        } else {
            this.badge.setTitleFormat(( localize(1225, "{0} reference", len)));
        }
    }
};
...
class AccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(1226, "References");
    }
