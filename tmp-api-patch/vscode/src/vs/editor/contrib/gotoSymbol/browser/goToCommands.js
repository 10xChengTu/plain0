        ...
        const promise = raceCancellation(
            ...
            if (referenceCount === 0) {
                ...
                instaService.invokeFunction(
                    accessor => altAction.runEditorCommand(accessor, editor, arg, range).finally(() => {
...
class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1186, "Definitions")
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word ? ( localize(1187, "No definition found for '{0}'", info.word)) : ( localize(1188, "No definition found"));
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1189, "Go to Definition")),
                mnemonicTitle: ( localize(1190, "Go to &&Definition"))
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1191, "Open Definition to the Side")),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1192, "Peek Definition")),
            ...
            keybinding: {
                ...
                linux: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.F10
                },
                weight: KeybindingWeight.EditorContrib
            },
            menu: {
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1193, "Declarations")
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word ? ( localize(1194, "No declaration found for '{0}'", info.word)) : ( localize(1195, "No declaration found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1196, "Go to Declaration")),
                mnemonicTitle: ( localize(1197, "Go to &&Declaration"))
            },
...
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: ( localize2(1198, "Peek Declaration")),
            precondition: ( ContextKeyExpr.and(
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(await getTypeDefinitionsAtPosition(
            languageFeaturesService.typeDefinitionProvider,
            model,
            position,
            false,
            token
        ), localize(1199, "Type Definitions")));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word ? ( localize(1200, "No type definition found for '{0}'", info.word)) : ( localize(1201, "No type definition found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1202, "Go to Type Definition")),
                mnemonicTitle: ( localize(1203, "Go to &&Type Definition"))
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1204, "Peek Type Definition")),
            precondition: ( ContextKeyExpr.and(
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(await getImplementationsAtPosition(
            languageFeaturesService.implementationProvider,
            model,
            position,
            false,
            token
        ), localize(1205, "Implementations")));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word ? ( localize(1206, "No implementation found for '{0}'", info.word)) : ( localize(1207, "No implementation found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1208, "Go to Implementations")),
                mnemonicTitle: ( localize(1209, "Go to &&Implementations"))
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1210, "Peek Implementations")),
            precondition: ( ContextKeyExpr.and(
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info ? ( localize(1211, "No references found for '{0}'", info.word)) : ( localize(1212, "No references found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1213, "Go to References")),
                mnemonicTitle: ( localize(1214, "Go to &&References"))
            },
            precondition: ( ContextKeyExpr.and(
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(await getReferencesAtPosition(
...
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: ( localize2(1216, "Peek References")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.hasReferenceProvider,
                PeekContext.notInPeekEditor,
                ( EditorContextKeys.isInEmbeddedEditor.toNegated())
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: ( localize2(1217, "Go to Any Symbol")),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return (new ReferencesModel(this._references, localize(1218, "Locations")));
    }
    _getNoResultFoundMessage(info) {
        return info && ( localize(1219, "No results for '{0}'", info.word)) || "";
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(
                languageFeaturesService.referenceProvider,
                control.getModel(),
                ...
                false,
                token
            ).then(references => ( new ReferencesModel(references, ( localize(1215, "References"))))));
