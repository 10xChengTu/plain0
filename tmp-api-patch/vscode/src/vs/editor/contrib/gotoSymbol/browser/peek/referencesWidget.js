...
import * as referencesWidget from './referencesWidget.css';
...
import { IdentityProvider, StringRepresentationProvider, AccessibilityProvider, Delegate, FileReferencesRenderer, OneReferenceRenderer, DataSource } from './referencesTree.js';
...
import { PeekViewWidget, peekViewBorder, peekViewTitleInfoForeground, peekViewTitleForeground, peekViewTitleBackground, peekViewResultsBackground } from '../../../peekView/browser/peekView.js';
import { IPeekViewService } from '../../../peekView/browser/peekView.service.js';

registerCss(referencesWidget);
...
ReferencesDragAndDrop = ( __decorate([( __param(0, ILabelService))], ReferencesDragAndDrop));
let ReferenceWidget = class ReferenceWidget extends PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = this._instantiationService.createInstance(TextModel, ( localize(1227, "no preview available")), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null);
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle("");
            this._messageContainer.innerText = ( localize(1228, "No results"));
        ...
        this._disposeOnNewModel.add(
            this._model.onDidChangeReferenceRange(reference => this._tree.rerender(reference))
        );
    ...
    async _revealReference(reference, revealParent) {
        ...
        if (reference.uri.scheme !== Schemas.inMemory) {
            ...
            this.setTitle(( localize(1229, "References")));
        }
...
ReferenceWidget = ( __decorate([( __param(3, IThemeService)), ( __param(4, ITextModelService)), ( __param(5, IInstantiationService)), ( __param(6, IPeekViewService)), ( __param(7, ILabelService)), ( __param(8, IKeybindingService))], ReferenceWidget));
