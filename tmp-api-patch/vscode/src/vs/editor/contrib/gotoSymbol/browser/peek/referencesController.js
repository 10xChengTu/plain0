...
let ReferencesController = class ReferencesController {
    ...
    toggleWidget(range, modelPromise, peekMode) {
        ...
        this._widget.setTitle(( localize(1222, "Loading...")));
            ...
            return this._widget.setModel(this._model).then(() => {
                if (this._widget && this._model && this._editor.hasModel()) {
                    if (!this._model.isEmpty) {
                        this._widget.setMetaTitle(( localize(1223, "{0} ({1})", this._model.title, this._model.references.length)));
                    } else {
...
KeybindingsRegistry.registerKeybindingRule({
    ...
    when: ( ContextKeyExpr.and(
        ...
        ( ContextKeyExpr.or(EditorContextKeys.editorTextFocus, ( InputFocusedContext.negate())))
    ))
});
KeybindingsRegistry.registerCommandAndKeybindingRule({
    id: "revealReference",
