...
import * as bannerController from './bannerController.css';
    ...
    show(item) {
        ...
        if (item.actions) {
            for (const action of item.actions) {
                this._register(
                    this.instantiationService.createInstance(Link, this.messageActionsContainer, {
                        ...action,
                        tabIndex: -1
                    }, {})
                );
        ...
        this.actionBar.push(this._register(( new Action("banner.close", ( localize(1680, "Close Banner")), ThemeIcon.asClassName(widgetClose), true, () => {
...
Banner = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IMarkdownRendererService))], Banner));
