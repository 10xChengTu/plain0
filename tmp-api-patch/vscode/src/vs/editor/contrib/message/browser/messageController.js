...
import * as messageController from './messageController.css';
import { ContentWidgetPositionPreference } from '../../../browser/editorBrowser.js';
import { EditorCommand, registerEditorCommand, registerEditorContribution, EditorContributionInstantiation } from '../../../browser/editorExtensions.js';
...
let MessageController = class MessageController {
    ...
    static {
        this.MESSAGE_VISIBLE = ( new RawContextKey("messageVisible", false, ( localize(1435, "Whether the editor is currently showing an inline message"))));
    }
    static get(editor) {
    ...
    showMessage(message, position) {
        ...
        this._messageListeners.add(
            Event.debounce(this._editor.onDidBlurEditorText, (last, event) => event, 0)(() => {
        ...
        this._messageListeners.add(addDisposableListener(
