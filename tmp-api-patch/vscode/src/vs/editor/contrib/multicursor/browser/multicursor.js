...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? ( localize(1436, "Cursor added: {0}", cursorPositions)) : ( localize(1437, "Cursors added: {0}", cursorPositions));
        status(msg);
    }
}
class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1438, "Add Cursor Above")),
            ...
            menuOpts: {
                ...
                group: "3_multi",
                title: ( localize(1439, "&&Add Cursor Above")),
                order: 2
            }
        });
    }
...
class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1440, "Add Cursor Below")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "3_multi",
                title: ( localize(1441, "A&&dd Cursor Below")),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1442, "Add Cursors to Line Ends")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "3_multi",
                title: ( localize(1443, "Add C&&ursors to Line Ends")),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1444, "Add Cursors to Bottom")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1445, "Add Cursors to Top")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1446, "Add Selection to Next Find Match")),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "3_multi",
                title: ( localize(1447, "Add &&Next Occurrence")),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1448, "Add Selection to Previous Find Match")),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "3_multi",
                title: ( localize(1449, "Add P&&revious Occurrence")),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1450, "Move Last Selection to Next Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1451, "Move Last Selection to Previous Find Match")),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1452, "Select All Occurrences of Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "3_multi",
                title: ( localize(1453, "Select All &&Occurrences")),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1454, "Change All Occurrences")),
...
let SelectionHighlighter = class SelectionHighlighter extends Disposable {
    ...
    _update() {
        this._setState(SelectionHighlighter_1._createState(
            this.state,
            this._isEnabled,
            this._isEnabledMultiline,
            this._maxLength,
            this.editor
        ));
    }
...
class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1455, "Focus Next Cursor")),
            metadata: {
                description: ( localize(1456, "Focuses the next cursor")),
                args: []
            },
            precondition: undefined
        });
...
class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1457, "Focus Previous Cursor")),
            metadata: {
                description: ( localize(1458, "Focuses the previous cursor")),
                args: []
            },
            precondition: undefined
        });
