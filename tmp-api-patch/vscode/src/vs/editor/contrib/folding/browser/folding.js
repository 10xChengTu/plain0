...
import * as folding from './folding.css';
import { StableEditorScrollState } from '../../../browser/stableEditorScroll.js';
import { MouseTargetType } from '../../../browser/editorBrowser.js';
import { EditorAction, registerEditorContribution, EditorContributionInstantiation, registerEditorAction, registerInstantiatedEditorAction } from '../../../browser/editorExtensions.js';
...
import { FoldingModel, setCollapseStateLevelsUp, setCollapseStateLevelsDown, setCollapseStateUp, toggleCollapseState, setCollapseStateForType, setCollapseStateForMatchingLines, setCollapseStateForRest, setCollapseStateAtLevel, getParentFoldLine, getPreviousFoldLine, getNextFoldLine } from './foldingModel.js';
...
import { FoldSource, FoldingRegions } from './foldingRanges.js';
...
let FoldingController = class FoldingController extends Disposable {
    ...
    onModelChanged() {
        ...
        this.localToDispose.add(
            this.languageFeaturesService.foldingRangeProvider.onDidChange(() => this.onFoldingStrategyChanged())
        );
        this.localToDispose.add(
            this.editor.onDidChangeModelLanguageConfiguration(() => this.onFoldingStrategyChanged())
        );
        this.localToDispose.add(this.editor.onDidChangeModelContent(e => this.onDidChangeModelContent(e)));
        this.localToDispose.add(
            this.editor.onDidChangeCursorPosition(() => this.onCursorPositionChanged())
        );
                ...
                if (selections && selections.length > 0) {
                    ...
                    for (const selection of selections) {
                        ...
                        if (this.hiddenRangeModel && this.hiddenRangeModel.isHidden(lineNumber)) {
                            toToggle.push(
                                ...foldingModel.getAllRegionsAtLine(lineNumber, r => r.isCollapsed && lineNumber > r.startLineNumber)
                            );
                        }
                    }
                    if (toToggle.length) {
...
class UnFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1130, "Unfold Recursively")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1132, "Toggle Fold")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1133, "Fold Recursively")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1134, "Toggle Fold Recursively")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(
                    KeyMod$1.CtrlCmd | KeyCode.KeyK,
                    KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyL
                ),
                weight: KeybindingWeight.EditorContrib
            }
        });
...
class FoldAllBlockCommentsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1135, "Fold All Block Comments")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1136, "Fold All Regions")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1137, "Unfold All Regions")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1138, "Fold All Except Selected")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1139, "Unfold All Except Selected")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllAction extends FoldingAction {
    constructor() {
        super({
            id: "editor.unfoldAll",
            label: ( localize2(1141, "Unfold All")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class GotoParentFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1142, "Go to Parent Fold")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: KeybindingWeight.EditorContrib
...
class GotoPreviousFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1143, "Go to Previous Folding Range")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: KeybindingWeight.EditorContrib
...
class GotoNextFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1144, "Go to Next Folding Range")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: KeybindingWeight.EditorContrib
...
class FoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1145, "Create Folding Range from Selection")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1146, "Remove Manual Folding Ranges")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleImportFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize2(1147, "Toggle Import Fold")),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: KeybindingWeight.EditorContrib
...
for (let i = 1; i <= 7; i++) {
    registerInstantiatedEditorAction(( new FoldLevelAction({
        ...
        label: ( localize2(1148, "Fold Level {0}", i)),
        precondition: CONTEXT_FOLDING_ENABLED,
        kbOpts: {
            kbExpr: EditorContextKeys.editorTextFocus,
