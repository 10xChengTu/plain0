...
registerColor("editorGutter.foldingControlForeground", iconForeground, ( localize(1151, "Color of the folding control in the editor gutter.")));
const foldingExpandedIcon = registerIcon("folding-expanded", Codicon.chevronDown, ( localize(1152, "Icon for expanded ranges in the editor glyph margin.")));
const foldingCollapsedIcon = registerIcon("folding-collapsed", Codicon.chevronRight, ( localize(1153, "Icon for collapsed ranges in the editor glyph margin.")));
const foldingManualCollapsedIcon = registerIcon("folding-manual-collapsed", foldingCollapsedIcon, ( localize(1154, "Icon for manually collapsed ranges in the editor glyph margin.")));
const foldingManualExpandedIcon = registerIcon("folding-manual-expanded", foldingExpandedIcon, ( localize(1155, "Icon for manually expanded ranges in the editor glyph margin.")));
const foldedBackgroundMinimap = {
    color: themeColorFromId(foldBackground),
    position: MinimapPosition.Inline
};
const collapsed = ( localize(1156, "Click to expand the range."));
const expanded = ( localize(1157, "Click to collapse the range."));
