...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1392, "Copy Line Up")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.UpArrow,
                linux: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.UpArrow
                },
            ...
            menuOpts: {
                ...
                group: "2_line",
                title: ( localize(1393, "&&Copy Line Up")),
                order: 1
            },
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1394, "Copy Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.DownArrow,
                linux: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.DownArrow
                },
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1395, "Co&&py Line Down")),
                order: 2
            },
            canTriggerInlineEdits: true
        });
...
class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1396, "Duplicate Selection")),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1397, "&&Duplicate Selection")),
                order: 5
            },
            canTriggerInlineEdits: true
        });
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1398, "Move Line Up")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1399, "Mo&&ve Line Up")),
                order: 3
            },
            canTriggerInlineEdits: true
        });
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1400, "Move Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1401, "Move &&Line Down")),
                order: 4
            },
            canTriggerInlineEdits: true
        });
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1402, "Sort Lines Ascending")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1403, "Sort Lines Descending")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1404, "Delete Duplicate Lines")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class ReverseLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1405, "Reverse lines")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
            ...
            const updateSelection = function(sel) {
                if (sel.isEmpty()) {
                    return ( new Selection(
                        updateLineNumber(sel.positionLineNumber),
                        sel.positionColumn,
                        updateLineNumber(sel.positionLineNumber),
                        sel.positionColumn
                    ));
...
class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1406, "Trim Trailing Whitespace")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1407, "Delete Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1408, "Indent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
    ...
    run(_accessor, editor) {
        ...
        editor.executeCommands(
            this.id,
            TypeOperations.indent(viewModel.cursorConfig, editor.getModel(), editor.getSelections())
        );
        editor.pushUndoStop();
    }
}
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1409, "Outdent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1410, "Insert Line Above")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
    ...
    run(_accessor, editor) {
        ...
        editor.executeCommands(
            this.id,
            EnterOperation.lineInsertBefore(viewModel.cursorConfig, editor.getModel(), editor.getSelections())
        );
    }
}
class InsertLineAfterAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1411, "Insert Line Below")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
    ...
    run(_accessor, editor) {
        ...
        editor.executeCommands(
            this.id,
            EnterOperation.lineInsertAfter(viewModel.cursorConfig, editor.getModel(), editor.getSelections())
        );
    }
}
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: "deleteAllLeft",
            label: ( localize2(1412, "Delete All Left")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: "deleteAllRight",
            label: ( localize2(1413, "Delete All Right")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.KeyK,
                    secondary: [KeyMod$1.CtrlCmd | KeyCode.Delete]
                },
                weight: KeybindingWeight.EditorContrib
            },
            canTriggerInlineEdits: true
...
class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1414, "Join Lines")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.KeyJ
                },
                weight: KeybindingWeight.EditorContrib
            },
            canTriggerInlineEdits: true
...
class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1415, "Transpose Characters around the Cursor")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1416, "Transform to Uppercase")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1417, "Transform to Lowercase")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1418, "Transform to Title Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1419, "Transform to Snake Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1420, "Transform to Camel Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1421, "Transform to Pascal Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1422, "Transform to Kebab Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
