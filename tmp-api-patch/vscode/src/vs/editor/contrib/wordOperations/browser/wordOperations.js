    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.LeftArrow
                },
                weight: KeybindingWeight.EditorContrib
            }
        });
...
class CursorWordAccessibilityLeft extends WordLeftCommand {
    ...
    _move(
        ...
        return super._move(getMapForWordSeparators(
            EditorOptions.wordSeparators.defaultValue,
            wordCharacterClassifier.intlSegmenterLocales
        ), model, position, wordNavigationType, hasMulticursor);
    }
}
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.RightArrow
                },
                weight: KeybindingWeight.EditorContrib
            }
        });
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary: KeyMod$1.Alt | KeyCode.Backspace
                },
                weight: KeybindingWeight.EditorContrib
            }
        });
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary: KeyMod$1.Alt | KeyCode.Delete
                },
                weight: KeybindingWeight.EditorContrib
            }
        });
...
class DeleteInsideWord extends EditorAction {
    constructor() {
        super({
            id: "deleteInsideWord",
            precondition: EditorContextKeys.writable,
            label: ( localize2(1722, "Delete Word")),
            metadata: {
                description: ( localize2(1723, "Delete the word at the cursor")),
                args: [{
                    name: "args",
                    schema: {
                        type: "object",
                        properties: {
                            "onlyWord": {
                                type: "boolean",
                                default: false,
                                description: ( localize(1724, "Delete only the word and leave surrounding whitespace"))
                            }
                        }
                    }
                }]
