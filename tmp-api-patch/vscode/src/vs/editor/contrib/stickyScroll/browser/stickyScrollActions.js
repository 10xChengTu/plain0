...
class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1592, "Toggle Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1593, "&&Toggle Editor Sticky Scroll"))
            },
            metadata: {
            ...
            toggled: {
                ...
                title: ( localize(1595, "Sticky Scroll")),
                mnemonicTitle: ( localize(1596, "&&Sticky Scroll"))
            },
            menu: [{
...
class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1597, "Focus Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1598, "&&Focus Editor Sticky Scroll"))
            },
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1599, "Select the next editor sticky scroll line")),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1600, "Select the previous sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1601, "Go to the focused sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1602, "Select Editor")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
