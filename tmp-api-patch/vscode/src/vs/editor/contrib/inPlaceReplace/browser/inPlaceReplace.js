...
import * as inPlaceReplace from './inPlaceReplace.css';

var InPlaceReplaceController_1;
registerCss(inPlaceReplace);
...
class InPlaceReplaceUp extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1289, "Replace with Previous Value")),
...
class InPlaceReplaceDown extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1290, "Replace with Next Value")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
