...
let SmartSelectController = class SmartSelectController {
    ...
    async run(forward) {
        ...
        const newSelections = ( this._state.map(state => Selection.fromPositions(
...
class GrowSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1545, "Expand Selection")),
            ...
            menuOpts: {
                ...
                group: "1_basic",
                title: ( localize(1546, "&&Expand Selection")),
                order: 2
            }
        });
    }
...
class ShrinkSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1547, "Shrink Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "1_basic",
                title: ( localize(1548, "&&Shrink Selection")),
                order: 3
            }
        });
    }
...
CommandsRegistry.registerCommand("_executeSelectionRangeProvider", async function(accessor, ...args) {
    ...
    try {
        return provideSelectionRanges(registry, reference.object.textEditorModel, ( positions.map(Position.lift)), {
