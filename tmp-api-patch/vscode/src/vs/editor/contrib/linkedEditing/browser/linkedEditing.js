...
import { EditorAction, EditorCommand, registerEditorCommand, registerModelAndPositionCommand, registerEditorContribution, EditorContributionInstantiation, registerEditorAction } from '../../../browser/editorExtensions.js';
...
import * as linkedEditing from './linkedEditing.css';

var LinkedEditingContribution_1;
registerCss(linkedEditing);
...
class LinkedEditingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1423, "Start Linked Editing")),
...
registerColor("editor.linkedEditingBackground", {
    ...
    hcLight: Color.white
}, ( localize(1424, "Background color when the editor auto renames on type.")));
