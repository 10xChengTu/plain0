...
import * as peekViewWidget from './media/peekViewWidget.css';
...
(function(PeekContext) {
    PeekContext.inPeekEditor = ( new RawContextKey("inReferenceSearchEditor", true, ( localize(1464, "Whether the current code editor is embedded inside peek"))));
...
let PeekViewWidget = class PeekViewWidget extends ZoneWidget {
    ...
    _fillHead(container, noCloseAction) {
        ...
        if (!noCloseAction) {
            this._actionbarWidget.push(this._disposables.add(( new Action("peekview.close", ( localize(1465, "Close")), ThemeIcon.asClassName(Codicon.close), true, () => {
                this.dispose();
...
const peekViewTitleBackground = registerColor("peekViewTitle.background", {
    ...
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(1466, "Background color of the peek view title area.")));
const peekViewTitleForeground = registerColor("peekViewTitleLabel.foreground", {
    dark: Color.white,
    light: Color.black,
    hcDark: Color.white,
    hcLight: editorForeground
}, ( localize(1467, "Color of the peek view title.")));
const peekViewTitleInfoForeground = registerColor("peekViewTitleDescription.foreground", {
    dark: "#ccccccb3",
    light: "#616161",
    hcDark: "#FFFFFF99",
    hcLight: "#292929"
}, ( localize(1468, "Color of the peek view title info.")));
const peekViewBorder = registerColor("peekView.border", {
    dark: editorInfoForeground,
    light: editorInfoForeground,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(1469, "Color of the peek view borders and arrow.")));
const peekViewResultsBackground = registerColor("peekViewResult.background", {
    dark: "#252526",
    light: "#F3F3F3",
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(1470, "Background color of the peek view result list.")));
registerColor("peekViewResult.lineForeground", {
    dark: "#bbbbbb",
    light: "#646465",
    hcDark: Color.white,
    hcLight: editorForeground
}, ( localize(1471, "Foreground color for line nodes in the peek view result list.")));
registerColor("peekViewResult.fileForeground", {
    dark: Color.white,
    light: "#1E1E1E",
    hcDark: Color.white,
    hcLight: editorForeground
}, ( localize(1472, "Foreground color for file nodes in the peek view result list.")));
...
registerColor("peekViewResult.selectionForeground", {
    dark: Color.white,
    light: "#6C6C6C",
    hcDark: Color.white,
    hcLight: editorForeground
...
const peekViewEditorBackground = registerColor("peekViewEditor.background", {
    ...
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(1475, "Background color of the peek view editor.")));
registerColor(
    "peekViewEditorGutter.background",
    peekViewEditorBackground,
    ( localize(1476, "Background color of the gutter in the peek view editor."))
);
registerColor(
    "peekViewEditorStickyScroll.background",
    peekViewEditorBackground,
    ( localize(1477, "Background color of sticky scroll in the peek view editor."))
);
registerColor(
...
registerColor("peekViewResult.matchHighlightBackground", {
    dark: "#ea5c004d",
    light: "#ea5c004d",
    hcDark: null,
    hcLight: null
}, ( localize(1479, "Match highlight color in the peek view result list.")));
const peekViewEditorMatchHighlight = registerColor("peekViewEditor.matchHighlightBackground", {
    dark: "#ff8f0099",
    light: "#f5d802de",
    hcDark: null,
    hcLight: null
}, ( localize(1480, "Match highlight color in the peek view editor.")));
registerColor("peekViewEditor.matchHighlightBorder", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(1481, "Match highlight border in the peek view editor.")));
