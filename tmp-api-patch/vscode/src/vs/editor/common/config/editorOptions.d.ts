...
export declare const EditorOptions: {
    ...
    cursorSurroundingLinesStyle: IEditorOption<EditorOption.cursorSurroundingLinesStyle, "all" | "default">;
    ...
    renderWhitespace: IEditorOption<EditorOption.renderWhitespace, "none" | "all" | "selection" | "boundary" | "trailing">;
