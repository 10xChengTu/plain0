    ...
    constructor() {
        super(
            ...
            AccessibilitySupport.Unknown,
            {
                type: "string",
                enum: ["auto", "on", "off"],
                enumDescriptions: [( localize(295, "Use platform APIs to detect when a Screen Reader is attached.")), ( localize(296, "Optimize for usage with a Screen Reader.")), ( localize(297, "Assume a screen reader is not attached."))],
                default: "auto",
                tags: ["accessibility"],
    ...
    constructor() {
        ...
        super(EditorOption.comments, "comments", defaults, {
            "editor.comments.insertSpace": {
                ...
                description: ( localize(299, "Controls whether a space character is inserted when commenting."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.find, "find", defaults, {
            ...
            "editor.find.seedSearchStringFromSelection": {
                ...
                enumDescriptions: [( localize(303, "Never seed search string from the editor selection.")), ( localize(
                    304,
                    "Always seed search string from the editor selection, including word at cursor position."
                )), ( localize(305, "Only seed search string from the editor selection."))],
                description: ( localize(
                    306,
            ...
            "editor.find.autoFindInSelection": {
                ...
                enumDescriptions: [( localize(307, "Never turn on Find in Selection automatically (default).")), ( localize(308, "Always turn on Find in Selection automatically.")), ( localize(
                    309,
            ...
            "editor.find.history": {
                ...
                default: "workspace",
                enumDescriptions: [( localize(315, "Do not store search history from the find widget.")), ( localize(316, "Store search history across the active workspace"))],
                description: ( localize(317, "Controls how the find widget history should be stored"))
            },
            "editor.find.replaceHistory": {
                type: "string",
                enum: ["never", "workspace"],
                default: "workspace",
                enumDescriptions: [( localize(318, "Do not store history from the replace widget.")), ( localize(319, "Store replace history across the active workspace"))],
                description: ( localize(320, "Controls how the replace widget history should be stored"))
            },
            "editor.find.findOnType": {
                type: "boolean",
                default: defaults.findOnType,
                description: ( localize(321, "Controls whether the Find Widget should search as you type."))
            }
        });
    }
    validate(_input) {
        ...
        return {
            ...
            seedSearchStringFromSelection: typeof input.seedSearchStringFromSelection === "boolean" ? (input.seedSearchStringFromSelection ? "always" : "never") : stringSet(
                input.seedSearchStringFromSelection,
                this.defaultValue.seedSearchStringFromSelection,
                ["never", "always", "selection"]
            ),
            autoFindInSelection: typeof input.autoFindInSelection === "boolean" ? (input.autoFindInSelection ? "always" : "never") : stringSet(
            ...
            replaceHistory: stringSet(
                ...
                this.defaultValue.replaceHistory,
                ["never", "workspace"]
            )
        };
    }
...
class EffectiveCursorStyle extends ComputedEditorOption {
    ...
    compute(env, options, _) {
        return env.inputMode === "overtype" ? options.get(EditorOption.overtypeCursorStyle) : options.get(EditorOption.cursorStyle);
    }
}
...
class EditorFontSize extends SimpleEditorOption {
    constructor() {
        super(EditorOption.fontSize, "fontSize", EDITOR_FONT_DEFAULTS.fontSize, {
            ...
            description: ( localize(328, "Controls the font size in pixels."))
        });
    }
    validate(input) {
...
class EditorFontWeight extends BaseEditorOption {
    ...
    validate(input) {
        ...
        return String(EditorIntOption.clampedInt(
            input,
...
class EditorGoToLocation extends BaseEditorOption {
    constructor() {
        ...
        const jsonSubset = {
            ...
            enumDescriptions: [( localize(331, "Show Peek view of the results (default)")), ( localize(332, "Go to the primary result and show a Peek view")), ( localize(333, "Go to the primary result and enable Peek-less navigation to others"))]
        };
    ...
    constructor() {
        ...
        super(EditorOption.hover, "hover", defaults, {
            "editor.hover.enabled": {
                ...
                markdownEnumDescriptions: [( localize(345, "Hover is enabled.")), ( localize(346, "Hover is disabled.")), ( localize(
                    347,
                    "Hover is shown when holding `{0}` or `Alt` (the opposite modifier of `#editor.multiCursorModifier#`)",
                    isMacintosh ? `Command` : `Control`
                ))],
                description: ( localize(348, "Controls whether the hover is shown.")),
            ...
            "editor.hover.delay": {
                ...
                minimum: 0,
                maximum: 10000,
                description: ( localize(349, "Controls the delay in milliseconds after which the hover is shown."))
            },
            "editor.hover.sticky": {
                type: "boolean",
            ...
            "editor.hover.above": {
                ...
                description: ( localize(352, "Prefer showing hovers above the line, if there's space."))
            },
...
class EditorLayoutInfoComputer extends ComputedEditorOption {
    ...
    static _computeMinimapLayout(input, memory) {
            ...
            if (ratio > 1) {
                ...
                if (minimapSize === "fill" || fitBecomesFill) {
                    ...
                    minimapScale = Math.min(
                        maxMinimapScale,
                        Math.max(1, Math.floor(minimapLineHeight / baseCharHeight))
                    );
                    if (minimapScale > configuredMinimapScale) {
                        minimapWidthMultiplier = Math.min(2, minimapScale / configuredMinimapScale);
                    }
                    minimapCharWidth = minimapScale / pixelRatio / minimapWidthMultiplier;
                    minimapCanvasInnerHeight = Math.ceil((Math.max(
                        typicalViewportLineCount,
        ...
        const minimapWidth = Math.min(minimapMaxWidth, Math.max(0, Math.floor(
    ...
    static computeLayout(options, env) {
        ...
        const viewportColumn = Math.max(1, Math.floor(
    ...
    constructor() {
        ...
        super(EditorOption.lightbulb, "lightbulb", defaults, {
            "editor.lightbulb.enabled": {
                ...
                default: defaults.enabled,
                enumDescriptions: [( localize(357, "Disable the code action menu.")), ( localize(358, "Show the code action menu when the cursor is on lines with code.")), ( localize(
                    359,
                    "Show the code action menu when the cursor is on lines with code or on empty lines."
                ))],
                description: ( localize(360, "Enables the Code Action lightbulb in the editor."))
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(EditorOption.stickyScroll, "stickyScroll", defaults, {
            ...
            "editor.stickyScroll.maxLineCount": {
                ...
                minimum: 1,
                maximum: 20,
                description: ( localize(362, "Defines the maximum number of sticky lines to show."))
            },
    ...
    validate(_input) {
        ...
        return {
            ...
            defaultModel: stringSet(
                input.defaultModel,
                this.defaultValue.defaultModel,
    ...
    constructor() {
        ...
        super(EditorOption.inlayHints, "inlayHints", defaults, {
            "editor.inlayHints.enabled": {
                type: "string",
                default: defaults.enabled,
                description: ( localize(365, "Enables the inlay hints in the editor.")),
                enum: ["on", "onUnlessPressed", "offUnlessPressed", "off"],
                markdownEnumDescriptions: [( localize(366, "Inlay hints are enabled")), ( localize(
                    367,
                    ...
                    isMacintosh ? `Ctrl+Option` : `Ctrl+Alt`
                )), ( localize(369, "Inlay hints are disabled"))]
            },
            ...
            "editor.inlayHints.padding": {
                ...
                description: ( localize(372, "Enables the padding around the inlay hints in the editor."))
            },
...
class EditorMinimap extends BaseEditorOption {
    constructor() {
        ...
        super(EditorOption.minimap, "minimap", defaults, {
            "editor.minimap.enabled": {
                type: "boolean",
                default: defaults.enabled,
                description: ( localize(375, "Controls whether the minimap is shown."))
            },
            "editor.minimap.autohide": {
                type: "string",
                enum: ["none", "mouseover", "scroll"],
                enumDescriptions: [( localize(376, "The minimap is always shown.")), ( localize(
                    377,
                    "The minimap is hidden when mouse is not over the minimap and shown when mouse is over the minimap."
                )), ( localize(378, "The minimap is only shown when the editor is scrolled"))],
                default: defaults.autohide,
                description: ( localize(379, "Controls whether the minimap is hidden automatically."))
            },
            "editor.minimap.size": {
                type: "string",
                ...
                description: ( localize(383, "Controls the size of the minimap."))
            },
            "editor.minimap.side": {
                type: "string",
                enum: ["left", "right"],
                default: defaults.side,
                description: ( localize(384, "Controls the side where to render the minimap."))
            },
            "editor.minimap.showSlider": {
                type: "string",
                enum: ["always", "mouseover"],
                default: defaults.showSlider,
                description: ( localize(385, "Controls when the minimap slider is shown."))
            },
            "editor.minimap.scale": {
                ...
                maximum: 3,
                enum: [1, 2, 3],
                description: ( localize(386, "Scale of content drawn in the minimap: 1, 2 or 3."))
            },
            "editor.minimap.renderCharacters": {
                type: "boolean",
                default: defaults.renderCharacters,
                description: ( localize(387, "Render the actual characters on a line as opposed to color blocks."))
            },
            ...
            "editor.minimap.sectionHeaderFontSize": {
                ...
                description: ( localize(392, "Controls the font size of section headers in the minimap."))
            },
    ...
    validate(_input) {
        ...
        return {
            ...
            autohide: stringSet(
                input.autohide,
                this.defaultValue.autohide,
                ["none", "mouseover", "scroll"]
            ),
            ...
            sectionHeaderFontSize: EditorFloatOption.clamp(
                EditorFloatOption.float(input.sectionHeaderFontSize, this.defaultValue.sectionHeaderFontSize),
                4,
                32
            ),
            sectionHeaderLetterSpacing: EditorFloatOption.clamp(EditorFloatOption.float(
...
class EditorPadding extends BaseEditorOption {
    constructor() {
        super(EditorOption.padding, "padding", {
            top: 0,
            bottom: 0
        }, {
            "editor.padding.top": {
...
class EditorQuickSuggestions extends BaseEditorOption {
    constructor() {
        ...
        const types = [{
            ...
            enumDescriptions: [( localize(398, "Quick suggestions show inside the suggest widget")), ( localize(399, "Quick suggestions show as ghost text")), ( localize(400, "Quick suggestions are disabled")), ( localize(401, "Quick suggestions are disabled when inline completions are showing"))]
        }];
        super(EditorOption.quickSuggestions, "quickSuggestions", defaults, {
            anyOf: [{
                ...
                type: "string",
                enum: ["on", "inline", "off", "offWhenInlineCompletions"],
                enumDescriptions: [( localize(402, "Quick suggestions are enabled for all token types")), ( localize(403, "Quick suggestions show as ghost text for all token types")), ( localize(404, "Quick suggestions are disabled for all token types")), ( localize(
                    405,
                ...
                properties: {
                    strings: {
                        ...
                        description: ( localize(406, "Enable quick suggestions inside strings."))
                    },
                    comments: {
                        anyOf: types,
                        default: defaults.comments,
                        description: ( localize(407, "Enable quick suggestions inside comments."))
                    },
                    other: {
                        anyOf: types,
                        default: defaults.other,
                        description: ( localize(408, "Enable quick suggestions outside of strings and comments."))
                    }
                }
            }],
            default: defaults,
...
class EditorRenderLineNumbersOption extends BaseEditorOption {
    constructor() {
        super(EditorOption.lineNumbers, "lineNumbers", {
            renderType: RenderLineNumbersType.On,
            renderFn: null
        }, {
            type: "string",
            enum: ["off", "on", "relative", "interval"],
            enumDescriptions: [( localize(410, "Line numbers are not rendered.")), ( localize(411, "Line numbers are rendered as absolute number.")), ( localize(412, "Line numbers are rendered as distance in lines to cursor position.")), ( localize(413, "Line numbers are rendered every 10 lines."))],
            default: "on",
            description: ( localize(414, "Controls the display of line numbers."))
        });
    }
            ...
            items: {
                anyOf: [columnSchema, {
                    ...
                    properties: {
                        ...
                        color: {
                            type: "string",
                            description: ( localize(416, "Color of this editor ruler.")),
                            format: "color-hex"
                        }
                    }
                }]
    ...
    constructor() {
        ...
        super(EditorOption.scrollbar, "scrollbar", defaults, {
            "editor.scrollbar.vertical": {
                ...
                enumDescriptions: [( localize(418, "The vertical scrollbar will be visible only when necessary.")), ( localize(419, "The vertical scrollbar will always be visible.")), ( localize(420, "The vertical scrollbar will always be hidden."))],
                default: "auto",
                description: ( localize(421, "Controls the visibility of the vertical scrollbar."))
            },
            "editor.scrollbar.horizontal": {
                type: "string",
                enum: ["auto", "visible", "hidden"],
                enumDescriptions: [( localize(422, "The horizontal scrollbar will be visible only when necessary.")), ( localize(423, "The horizontal scrollbar will always be visible.")), ( localize(424, "The horizontal scrollbar will always be hidden."))],
                default: "auto",
                description: ( localize(425, "Controls the visibility of the horizontal scrollbar."))
            },
            "editor.scrollbar.verticalScrollbarSize": {
                type: "number",
                default: defaults.verticalScrollbarSize,
                description: ( localize(426, "The width of the vertical scrollbar."))
            },
            "editor.scrollbar.horizontalScrollbarSize": {
                type: "number",
                default: defaults.horizontalScrollbarSize,
                description: ( localize(427, "The height of the horizontal scrollbar."))
            },
            "editor.scrollbar.scrollByPage": {
                type: "boolean",
                default: defaults.scrollByPage,
                description: ( localize(428, "Controls whether clicks scroll by page or jump to click position."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.unicodeHighlighting, "unicodeHighlight", defaults, {
            ...
            [unicodeHighlightConfigKeys.allowedCharacters]: {
                ...
                description: ( localize(435, "Defines allowed characters that are not being highlighted.")),
    ...
    applyUpdate(value, update) {
        ...
        if (update.allowedLocales && value) {
            if (!equals$1(value.allowedLocales, update.allowedLocales)) {
                value = {
                    ...value,
                    allowedLocales: update.allowedLocales
                };
                didChange = true;
            }
        }
...
class InlineEditorSuggest extends BaseEditorOption {
    constructor() {
        ...
        super(EditorOption.inlineSuggest, "inlineSuggest", defaults, {
            ...
            "editor.inlineSuggest.showToolbar": {
                ...
                )), ( localize(440, "Never show the inline suggestion toolbar."))],
                description: ( localize(441, "Controls when to show the inline suggestion toolbar."))
            },
            ...
            "editor.inlineSuggest.fontFamily": {
                type: "string",
                default: defaults.fontFamily,
                description: ( localize(450, "Controls the font family of the inline suggestions."))
            },
            ...
            "editor.inlineSuggest.edits.showLongDistanceHint": {
                ...
                description: ( localize(452, "Controls whether long distance inline suggestions are shown.")),
                tags: ["nextEditSuggestions", "experimental"]
            },
            "editor.inlineSuggest.edits.renderSideBySide": {
                type: "string",
                default: defaults.edits.renderSideBySide,
                description: ( localize(453, "Controls whether larger suggestions can be shown side by side.")),
                enum: ["auto", "never"],
                enumDescriptions: [( localize(
                    454,
    ...
    validate(_input) {
        ...
        return {
            ...
            triggerCommandOnProviderChange: boolean(
                input.triggerCommandOnProviderChange,
                this.defaultValue.triggerCommandOnProviderChange
            ),
    ...
    _validateEdits(_input) {
        ...
        return {
            ...
            allowCodeShifting: stringSet(
                input.allowCodeShifting,
                this.defaultValue.edits.allowCodeShifting,
            ...
            renderSideBySide: stringSet(
                input.renderSideBySide,
                this.defaultValue.edits.renderSideBySide,
                ["never", "auto"]
            )
        };
    }
    _validateExperimental(_input) {
        ...
        const input = _input;
        return {
            suppressInlineSuggestions: EditorStringOption.string(
                input.suppressInlineSuggestions,
                this.defaultValue.experimental.suppressInlineSuggestions
            ),
            showOnSuggestConflict: stringSet(
                input.showOnSuggestConflict,
                this.defaultValue.experimental.showOnSuggestConflict,
                ["always", "never", "whenSuggestListIsIncomplete"]
            ),
            emptyResponseInformation: boolean(
                input.emptyResponseInformation,
                this.defaultValue.experimental.emptyResponseInformation
            )
        };
    }
}
    ...
    constructor() {
        ...
        super(EditorOption.guides, "guides", defaults, {
            "editor.guides.bracketPairs": {
                ...
                enumDescriptions: [( localize(459, "Enables bracket pair guides.")), ( localize(460, "Enables bracket pair guides only for the active bracket pair.")), ( localize(461, "Disables bracket pair guides."))],
                default: defaults.bracketPairs,
                description: ( localize(462, "Controls whether bracket pair guides are enabled or not."))
            },
            "editor.guides.bracketPairsHorizontal": {
                ...
                )), ( localize(464, "Enables horizontal guides only for the active bracket pair.")), ( localize(465, "Disables horizontal bracket pair guides."))],
                default: defaults.bracketPairsHorizontal,
                description: ( localize(466, "Controls whether horizontal bracket pair guides are enabled or not."))
            },
            ...
            "editor.guides.indentation": {
                ...
                description: ( localize(468, "Controls whether the editor should render indent guides."))
            },
            "editor.guides.highlightActiveIndentation": {
                type: ["boolean", "string"],
                enum: [true, "always", false],
                enumDescriptions: [( localize(469, "Highlights the active indent guide.")), ( localize(
                    470,
                    "Highlights the active indent guide even if bracket guides are highlighted."
                )), ( localize(471, "Do not highlight the active indent guide."))],
    ...
    constructor() {
        ...
        super(EditorOption.suggest, "suggest", defaults, {
            "editor.suggest.insertMode": {
                type: "string",
                enum: ["insert", "replace"],
                enumDescriptions: [( localize(473, "Insert suggestion without overwriting text right of the cursor.")), ( localize(474, "Insert suggestion and overwrite text right of the cursor."))],
            ...
            "editor.suggest.selectionMode": {
                ...
                )), ( localize(482, "Select a suggestion only when triggering IntelliSense as you type."))],
            ...
            "editor.suggest.snippetsPreventQuickSuggestions": {
                ...
                description: ( localize(484, "Controls whether an active snippet prevents quick suggestions."))
            },
            "editor.suggest.showIcons": {
                type: "boolean",
                default: defaults.showIcons,
                description: ( localize(485, "Controls whether to show or hide icons in suggestions."))
            },
            ...
            "editor.suggest.preview": {
                ...
                description: ( localize(487, "Controls whether to preview the suggestion outcome in the editor."))
            },
            ...
            "editor.suggest.maxVisibleSuggestions": {
                type: "number",
                deprecationMessage: ( localize(489, "This setting is deprecated. The suggest widget can now be resized."))
            },
            ...
            "editor.suggest.showMethods": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(491, "When enabled IntelliSense shows `method`-suggestions."))
            },
            "editor.suggest.showFunctions": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(492, "When enabled IntelliSense shows `function`-suggestions."))
            },
            "editor.suggest.showConstructors": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(493, "When enabled IntelliSense shows `constructor`-suggestions."))
            },
            "editor.suggest.showDeprecated": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(494, "When enabled IntelliSense shows `deprecated`-suggestions."))
            },
            ...
            "editor.suggest.showFields": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(496, "When enabled IntelliSense shows `field`-suggestions."))
            },
            "editor.suggest.showVariables": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(497, "When enabled IntelliSense shows `variable`-suggestions."))
            },
            "editor.suggest.showClasses": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(498, "When enabled IntelliSense shows `class`-suggestions."))
            },
            "editor.suggest.showStructs": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(499, "When enabled IntelliSense shows `struct`-suggestions."))
            },
            "editor.suggest.showInterfaces": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(500, "When enabled IntelliSense shows `interface`-suggestions."))
            },
            "editor.suggest.showModules": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(501, "When enabled IntelliSense shows `module`-suggestions."))
            },
            "editor.suggest.showProperties": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(502, "When enabled IntelliSense shows `property`-suggestions."))
            },
            "editor.suggest.showEvents": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(503, "When enabled IntelliSense shows `event`-suggestions."))
            },
            "editor.suggest.showOperators": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(504, "When enabled IntelliSense shows `operator`-suggestions."))
            },
            "editor.suggest.showUnits": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(505, "When enabled IntelliSense shows `unit`-suggestions."))
            },
            "editor.suggest.showValues": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(506, "When enabled IntelliSense shows `value`-suggestions."))
            },
            "editor.suggest.showConstants": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(507, "When enabled IntelliSense shows `constant`-suggestions."))
            },
            "editor.suggest.showEnums": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(508, "When enabled IntelliSense shows `enum`-suggestions."))
            },
            "editor.suggest.showEnumMembers": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(509, "When enabled IntelliSense shows `enumMember`-suggestions."))
            },
            "editor.suggest.showKeywords": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(510, "When enabled IntelliSense shows `keyword`-suggestions."))
            },
            "editor.suggest.showWords": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(511, "When enabled IntelliSense shows `text`-suggestions."))
            },
            "editor.suggest.showColors": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(512, "When enabled IntelliSense shows `color`-suggestions."))
            },
            "editor.suggest.showFiles": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(513, "When enabled IntelliSense shows `file`-suggestions."))
            },
            "editor.suggest.showReferences": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(514, "When enabled IntelliSense shows `reference`-suggestions."))
            },
            "editor.suggest.showCustomcolors": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(515, "When enabled IntelliSense shows `customcolor`-suggestions."))
            },
            "editor.suggest.showFolders": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(516, "When enabled IntelliSense shows `folder`-suggestions."))
            },
            "editor.suggest.showTypeParameters": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(517, "When enabled IntelliSense shows `typeParameter`-suggestions."))
            },
            "editor.suggest.showSnippets": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(518, "When enabled IntelliSense shows `snippet`-suggestions."))
            },
            "editor.suggest.showUsers": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(519, "When enabled IntelliSense shows `user`-suggestions."))
            },
            "editor.suggest.showIssues": {
                type: "boolean",
                default: true,
                markdownDescription: ( localize(520, "When enabled IntelliSense shows `issues`-suggestions."))
            }
        });
    }
    validate(_input) {
        ...
        return {
            ...
            selectionMode: stringSet(
                ...
                ["always", "never", "whenQuickSuggestion", "whenTriggerCharacter"]
            ),
    ...
    constructor() {
        super(EditorOption.smartSelect, "smartSelect", {
            ...
            "editor.smartSelect.selectLeadingAndTrailingWhitespace": {
                description: ( localize(521, "Whether leading and trailing whitespace should always be selected.")),
                default: true,
                type: "boolean"
            },
    ...
    constructor() {
        super(EditorOption.wrappingIndent, "wrappingIndent", WrappingIndent.Same, {
            "editor.wrappingIndent": {
                ...
                enumDescriptions: [( localize(524, "No indentation. Wrapped lines begin at column 1.")), ( localize(525, "Wrapped lines get the same indentation as the parent.")), ( localize(526, "Wrapped lines get +1 indentation toward the parent.")), ( localize(527, "Wrapped lines get +2 indentation toward the parent."))],
                description: ( localize(528, "Controls the indentation of wrapped lines.")),
                default: "same"
            }
        });
    }
    ...
    constructor() {
        ...
        super(EditorOption.pasteAs, "pasteAs", defaults, {
            "editor.pasteAs.enabled": {
                type: "boolean",
                default: defaults.enabled,
                markdownDescription: ( localize(533, "Controls whether you can paste content in different ways."))
            },
...
const EditorOptions = {
    ...
    allowVariableFonts: register(( new EditorBooleanOption(EditorOption.allowVariableFonts, "allowVariableFonts", true, {
        description: ( localize(542, "Controls whether to allow using variable fonts in the editor."))
    }))),
    ...
    ariaLabel: register(( new EditorStringOption(EditorOption.ariaLabel, "ariaLabel", ( localize(544, "Editor content"))))),
    ...
    autoClosingQuotes: register(( new EditorStringEnumOption(
        ...
        ["always", "languageDefined", "beforeWhitespace", "never"],
        {
            enumDescriptions: ["", ( localize(556, "Use language configurations to determine when to autoclose quotes.")), ( localize(557, "Autoclose quotes only when the cursor is to the left of whitespace.")), ""],
            description: ( localize(
                558,
    ...
    autoIndent: register(( new EditorEnumOption(
        ...
        {
            enumDescriptions: [( localize(559, "The editor will not insert indentation automatically.")), ( localize(560, "The editor will keep the current line's indentation.")), ( localize(
                561,
    ...
    autoSurround: register(( new EditorStringEnumOption(
        ...
        ["languageDefined", "quotes", "brackets", "never"],
        {
            ...
            )), ( localize(568, "Surround with quotes but not brackets.")), ( localize(569, "Surround with brackets but not quotes.")), ""],
            description: ( localize(
                570,
    ...
    codeLens: register(( new EditorBooleanOption(EditorOption.codeLens, "codeLens", true, {
        description: ( localize(572, "Controls whether the editor shows CodeLens."))
    }))),
    codeLensFontFamily: register(( new EditorStringOption(EditorOption.codeLensFontFamily, "codeLensFontFamily", "", {
        description: ( localize(573, "Controls the font family for CodeLens."))
    }))),
    ...
    colorDecoratorActivatedOn: register(( new EditorStringEnumOption(
        ...
        ["clickAndHover", "hover", "click"],
        {
            ...
            )), ( localize(577, "Make the color picker appear on hover of the color decorator")), ( localize(578, "Make the color picker appear on click of the color decorator"))],
            description: ( localize(
                579,
    ...
    cursorBlinking: register(( new EditorEnumOption(
        ...
        {
            description: ( localize(583, "Control the cursor animation style."))
        }
    ))),
    cursorSmoothCaretAnimation: register(( new EditorStringEnumOption(
        ...
        ["off", "explicit", "on"],
        {
            enumDescriptions: [( localize(584, "Smooth caret animation is disabled.")), ( localize(
                585,
                "Smooth caret animation is enabled only when the user moves the cursor with an explicit gesture."
            )), ( localize(586, "Smooth caret animation is always enabled."))],
            description: ( localize(587, "Controls whether the smooth caret animation should be enabled."))
        }
    ))),
    cursorStyle: register(( new EditorEnumOption(
        ...
        {
            description: ( localize(588, "Controls the cursor style in insert input mode."))
        }
    ))),
    overtypeCursorStyle: register(( new EditorEnumOption(
        ...
        cursorStyleFromString,
        {
            description: ( localize(589, "Controls the cursor style in overtype input mode."))
        }
    ))),
    ...
    cursorSurroundingLinesStyle: register(( new EditorStringEnumOption(
        ...
        ["default", "all"],
        {
            ...
            )), ( localize(592, "`cursorSurroundingLines` is enforced always."))],
            markdownDescription: ( localize(593, "Controls when `#editor.cursorSurroundingLines#` should be enforced."))
        }
    ))),
    ...
    experimentalGpuAcceleration: register(( new EditorStringEnumOption(
        ...
        {
            tags: ["experimental"],
            enumDescriptions: [( localize(600, "Use regular DOM-based rendering.")), ( localize(601, "Use GPU acceleration."))],
            description: ( localize(
                602,
    ...
    experimentalWhitespaceRendering: register(( new EditorStringEnumOption(
        ...
        ["svg", "font", "off"],
        {
            enumDescriptions: [( localize(603, "Use a new rendering method with svgs.")), ( localize(604, "Use a new rendering method with font characters.")), ( localize(605, "Use the stable rendering method."))],
            description: ( localize(
                606,
    ...
    fastScrollSensitivity: register(( new EditorFloatOption(
        ...
        x => (x <= 0 ? 5 : x),
        {
            markdownDescription: ( localize(607, "Scrolling speed multiplier when pressing `Alt`."))
        }
    ))),
    ...
    folding: register(( new EditorBooleanOption(EditorOption.folding, "folding", true, {
        description: ( localize(608, "Controls whether the editor has code folding enabled."))
    }))),
    foldingStrategy: register(( new EditorStringEnumOption(
        ...
        ["auto", "indentation"],
        {
            ...
            )), ( localize(610, "Use the indentation-based folding strategy."))],
            description: ( localize(611, "Controls the strategy for computing folding ranges."))
        }
    ))),
    foldingHighlight: register(( new EditorBooleanOption(EditorOption.foldingHighlight, "foldingHighlight", true, {
        description: ( localize(612, "Controls whether the editor should highlight folded ranges."))
    }))),
    foldingImportsByDefault: register(( new EditorBooleanOption(EditorOption.foldingImportsByDefault, "foldingImportsByDefault", false, {
        description: ( localize(613, "Controls whether the editor automatically collapses import ranges."))
    }))),
    ...
    fontFamily: register(( new EditorStringOption(EditorOption.fontFamily, "fontFamily", EDITOR_FONT_DEFAULTS.fontFamily, {
        description: ( localize(616, "Controls the font family."))
    }))),
    ...
    hideCursorInOverviewRuler: register(( new EditorBooleanOption(
        ...
        false,
        {
            description: ( localize(620, "Controls whether the cursor should be hidden in the overview ruler."))
        }
    ))),
    ...
    inertialScroll: register(( new EditorBooleanOption(EditorOption.inertialScroll, "inertialScroll", false, {
        description: ( localize(621, "Make scrolling inertial - mostly useful with touchpad on linux."))
    }))),
    letterSpacing: register(( new EditorFloatOption(
        ...
        {
            description: ( localize(622, "Controls the letter spacing in pixels."))
        }
    ))),
    ...
    matchBrackets: register(( new EditorStringEnumOption(
        ...
        ["always", "near", "never"],
        {
            description: ( localize(625, "Highlight matching brackets."))
        }
    ))),
    ...
    multiCursorMergeOverlapping: register(( new EditorBooleanOption(
        ...
        true,
        {
            description: ( localize(629, "Merge multiple cursors when they are overlapping."))
        }
    ))),
    multiCursorModifier: register(( new EditorEnumOption(
        ...
        {
            markdownEnumDescriptions: [( localize(630, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")), ( localize(631, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))],
            markdownDescription: ( localize(
                632,
    ...
    multiCursorPaste: register(( new EditorStringEnumOption(
        ...
        ["spread", "full"],
        {
            markdownEnumDescriptions: [( localize(634, "Each cursor pastes a single line of the text.")), ( localize(635, "Each cursor pastes the full text."))],
            markdownDescription: ( localize(
                636,
    ...
    occurrencesHighlight: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [( localize(638, "Does not highlight occurrences.")), ( localize(639, "Highlights occurrences only in the current file.")), ( localize(640, "Experimental: Highlights occurrences across all valid open files."))],
            markdownDescription: ( localize(
                641,
    ...
    overtypeOnPaste: register(( new EditorBooleanOption(EditorOption.overtypeOnPaste, "overtypeOnPaste", true, {
        description: ( localize(643, "Controls whether pasting should overtype."))
    }))),
    ...
    peekWidgetDefaultFocus: register(( new EditorStringEnumOption(
        ...
        ["tree", "editor"],
        {
            enumDescriptions: [( localize(645, "Focus the tree when opening peek")), ( localize(646, "Focus the editor when opening peek"))],
            description: ( localize(
                647,
    ...
    renameOnType: register(( new EditorBooleanOption(EditorOption.renameOnType, "renameOnType", false, {
        description: ( localize(650, "Controls whether the editor auto renames on type.")),
        markdownDeprecationMessage: ( localize(651, "Deprecated, use `#editor.linkedEditing#` instead."))
    }))),
    renderControlCharacters: register(( new EditorBooleanOption(EditorOption.renderControlCharacters, "renderControlCharacters", true, {
        description: ( localize(652, "Controls whether the editor should render control characters.")),
        restricted: true
    }))),
    renderFinalNewline: register(( new EditorStringEnumOption(
        ...
        ["off", "on", "dimmed"],
        {
            description: ( localize(653, "Render last line number when the file ends with a newline."))
        }
    ))),
    renderLineHighlight: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: ["", "", "", ( localize(654, "Highlights both the gutter and the current line."))],
            description: ( localize(655, "Controls how the editor should render the current line highlight."))
        }
    ))),
    ...
    renderWhitespace: register(( new EditorStringEnumOption(
        ...
        ["none", "boundary", "selection", "trailing", "all"],
        {
            ...
            )), ( localize(658, "Render whitespace characters only on selected text.")), ( localize(659, "Render only trailing whitespace characters.")), ""],
            description: ( localize(660, "Controls how the editor should render whitespace characters."))
        }
    ))),
    ...
    roundedSelection: register(( new EditorBooleanOption(EditorOption.roundedSelection, "roundedSelection", true, {
        description: ( localize(661, "Controls whether selections should have rounded corners."))
    }))),
    ...
    scrollBeyondLastLine: register(( new EditorBooleanOption(EditorOption.scrollBeyondLastLine, "scrollBeyondLastLine", true, {
        description: ( localize(663, "Controls whether the editor will scroll beyond the last line."))
    }))),
    ...
    selectionClipboard: register(( new EditorBooleanOption(EditorOption.selectionClipboard, "selectionClipboard", true, {
        description: ( localize(666, "Controls whether the Linux primary clipboard should be supported.")),
        included: isLinux
    }))),
    ...
    showFoldingControls: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [( localize(670, "Always show the folding controls.")), ( localize(671, "Never show the folding controls and reduce the gutter size.")), ( localize(672, "Only show the folding controls when the mouse is over the gutter."))],
            description: ( localize(673, "Controls when the folding controls on the gutter are shown."))
        }
    ))),
    showUnused: register(( new EditorBooleanOption(EditorOption.showUnused, "showUnused", true, {
        description: ( localize(674, "Controls fading out of unused code."))
    }))),
    showDeprecated: register(( new EditorBooleanOption(EditorOption.showDeprecated, "showDeprecated", true, {
        description: ( localize(675, "Controls strikethrough deprecated variables."))
    }))),
    ...
    snippetSuggestions: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [( localize(676, "Show snippet suggestions on top of other suggestions.")), ( localize(677, "Show snippet suggestions below other suggestions.")), ( localize(678, "Show snippets suggestions with other suggestions.")), ( localize(679, "Do not show snippet suggestions."))],
            description: ( localize(
                680,
    ...
    smoothScrolling: register(( new EditorBooleanOption(EditorOption.smoothScrolling, "smoothScrolling", false, {
        description: ( localize(681, "Controls whether the editor will scroll using an animation."))
    }))),
    ...
    suggestSelection: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [( localize(686, "Always select the first suggestion.")), ( localize(
                687,
    ...
    tabCompletion: register(( new EditorStringEnumOption(
        ...
        ["on", "off", "onlySnippets"],
        {
            ...
            )), ( localize(691, "Disable tab completions.")), ( localize(
                692,
                "Tab complete snippets when their prefix match. Works best when 'quickSuggestions' aren't enabled."
            ))],
            description: ( localize(693, "Enables tab completions."))
        }
    ))),
    ...
    unusualLineTerminators: register(( new EditorStringEnumOption(
        ...
        ["auto", "off", "prompt"],
        {
            enumDescriptions: [( localize(695, "Unusual line terminators are automatically removed.")), ( localize(696, "Unusual line terminators are ignored.")), ( localize(697, "Unusual line terminators prompt to be removed."))],
            description: ( localize(698, "Remove unusual line terminators that might cause problems."))
        }
    ))),
    ...
    wordBreak: register(( new EditorStringEnumOption(EditorOption.wordBreak, "wordBreak", "normal", ["normal", "keepAll"], {
        markdownEnumDescriptions: [( localize(700, "Use the default line break rule.")), ( localize(
            701,
    ...
    wordWrap: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [( localize(704, "Lines will never wrap.")), ( localize(705, "Lines will wrap at the viewport width.")), ( localize(706, "Lines will wrap at `#editor.wordWrapColumn#`.")), ( localize(
                707,
                "Lines will wrap at the minimum of viewport and `#editor.wordWrapColumn#`."
            ))],
            description: ( localize(708, "Controls how lines should wrap."))
        }
    ))),
    ...
    defaultColorDecorators: register(( new EditorStringEnumOption(
        ...
        ["auto", "always", "never"],
        {
            ...
            )), ( localize(712, "Always show default color decorators.")), ( localize(713, "Never show default color decorators."))],
            description: ( localize(
                714,
