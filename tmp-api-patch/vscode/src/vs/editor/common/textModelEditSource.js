...
const EditSources = {
    ...
    rename: (oldName, newName) => createEditSource({
        source: "rename",
        $$$oldName: oldName,
        $$$newName: newName
    }),
    ...
    chatUndoEdits: () => createEditSource({
        source: "Chat.undoEdits"
    }),
    chatReset: () => createEditSource({
        source: "Chat.reset"
    }),
    ...
    reloadFromDisk: () => createEditSource({
    ...
    setValue: () => createEditSource({
        source: "setValue"
    }),
    eolChange: () => createEditSource({
        source: "eolChange"
    }),
    applyEdits: () => createEditSource({
        source: "applyEdits"
    }),
    snippet: () => createEditSource({
        source: "snippet"
    }),
    suggest: data => createEditSource({
        source: "suggest",
        ...toProperties(data.providerId)
    }),
    codeAction: data => createEditSource({
        source: "codeAction",
        $kind: data.kind,
        ...toProperties(data.providerId)
    })
...
export { EditDeltaInfo, EditSources, EditSuggestionId, TextModelEditSource, isAiEdit, isUserEdit };
