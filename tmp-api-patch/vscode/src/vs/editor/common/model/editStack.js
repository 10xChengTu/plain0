...
class SingleModelEditStackData {
    ...
    serialize() {
        let necessarySize =
        (
        4 + 4 + 1 + 1 + SingleModelEditStackData._writeSelectionsSize(this.beforeCursorState) + SingleModelEditStackData._writeSelectionsSize(this.afterCursorState) + 4);
...
class EditStack {
    ...
    _getOrCreateEditStackElement(beforeCursorState, group) {
        ...
        const newElement = ( new SingleModelEditStackElement(( localize(894, "Typing")), "undoredo.textBufferEdit", this._model, beforeCursorState));
