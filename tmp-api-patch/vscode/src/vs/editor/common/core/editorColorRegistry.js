...
const editorLineHighlight = registerColor("editor.lineHighlightBackground", null, ( localize(716, "Background color for the highlight of line at the cursor position.")));
const editorInactiveLineHighlight = registerColor(
...
const editorLineHighlightBorder = registerColor("editor.lineHighlightBorder", {
    dark: "#282828",
    light: "#eeeeee",
    hcDark: "#f38518",
...
const editorRangeHighlight = registerColor("editor.rangeHighlightBackground", {
    dark: "#ffffff0b",
    light: "#fdff0033",
    hcDark: null,
    hcLight: null
...
registerColor("editor.rangeHighlightBorder", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(720, "Background color of the border around highlighted ranges.")));
...
registerColor("editor.symbolHighlightBorder", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(722, "Background color of the border around highlighted symbols.")));
const editorCursorForeground = registerColor("editorCursor.foreground", {
    dark: "#AEAFAD",
    light: Color.black,
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(723, "Color of the editor cursor.")));
...
const editorWhitespaces = registerColor("editorWhitespace.foreground", {
    dark: "#e3e4e229",
    light: "#33333333",
    hcDark: "#e3e4e229",
    hcLight: "#CCCCCC"
}, ( localize(729, "Color of whitespace characters in the editor.")));
const editorLineNumbers = registerColor("editorLineNumber.foreground", {
    dark: "#858585",
    light: "#237893",
    hcDark: Color.white,
    hcLight: "#292929"
}, ( localize(730, "Color of editor line numbers.")));
const deprecatedEditorIndentGuides = registerColor("editorIndentGuide.background", editorWhitespaces, ( localize(731, "Color of the editor indentation guides.")), false, ( localize(
    732,
    "'editorIndentGuide.background' is deprecated. Use 'editorIndentGuide.background1' instead."
)));
const deprecatedEditorActiveIndentGuides = registerColor("editorIndentGuide.activeBackground", editorWhitespaces, ( localize(733, "Color of the active editor indentation guides.")), false, ( localize(
    734,
...
const editorIndentGuide1 = registerColor(
    ...
    ( localize(735, "Color of the editor indentation guides (1)."))
);
const editorIndentGuide2 = registerColor("editorIndentGuide.background2", "#00000000", ( localize(736, "Color of the editor indentation guides (2).")));
const editorIndentGuide3 = registerColor("editorIndentGuide.background3", "#00000000", ( localize(737, "Color of the editor indentation guides (3).")));
const editorIndentGuide4 = registerColor("editorIndentGuide.background4", "#00000000", ( localize(738, "Color of the editor indentation guides (4).")));
const editorIndentGuide5 = registerColor("editorIndentGuide.background5", "#00000000", ( localize(739, "Color of the editor indentation guides (5).")));
const editorIndentGuide6 = registerColor("editorIndentGuide.background6", "#00000000", ( localize(740, "Color of the editor indentation guides (6).")));
const editorActiveIndentGuide1 = registerColor(
    "editorIndentGuide.activeBackground1",
    deprecatedEditorActiveIndentGuides,
    ( localize(741, "Color of the active editor indentation guides (1)."))
);
const editorActiveIndentGuide2 = registerColor("editorIndentGuide.activeBackground2", "#00000000", ( localize(742, "Color of the active editor indentation guides (2).")));
const editorActiveIndentGuide3 = registerColor("editorIndentGuide.activeBackground3", "#00000000", ( localize(743, "Color of the active editor indentation guides (3).")));
const editorActiveIndentGuide4 = registerColor("editorIndentGuide.activeBackground4", "#00000000", ( localize(744, "Color of the active editor indentation guides (4).")));
const editorActiveIndentGuide5 = registerColor("editorIndentGuide.activeBackground5", "#00000000", ( localize(745, "Color of the active editor indentation guides (5).")));
const editorActiveIndentGuide6 = registerColor("editorIndentGuide.activeBackground6", "#00000000", ( localize(746, "Color of the active editor indentation guides (6).")));
const deprecatedEditorActiveLineNumber = registerColor("editorActiveLineNumber.foreground", {
    dark: "#c6c6c6",
    light: "#0B216F",
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(747, "Color of editor active line number")), false, ( localize(748, "Id is deprecated. Use 'editorLineNumber.activeForeground' instead.")));
registerColor(
    "editorLineNumber.activeForeground",
    deprecatedEditorActiveLineNumber,
    ( localize(747, "Color of editor active line number"))
);
const editorDimmedLineNumber = registerColor("editorLineNumber.dimmedForeground", null, ( localize(
    749,
    "Color of the final editor line when editor.renderFinalNewline is set to dimmed."
)));
const editorRuler = registerColor("editorRuler.foreground", {
    dark: "#5A5A5A",
    light: Color.lightgrey,
    hcDark: Color.white,
    hcLight: "#292929"
}, ( localize(750, "Color of the editor rulers.")));
registerColor("editorCodeLens.foreground", {
    dark: "#999999",
    light: "#919191",
    hcDark: "#999999",
    hcLight: "#292929"
}, ( localize(751, "Foreground color of editor CodeLens")));
registerColor("editorBracketMatch.background", {
    dark: "#0064001a",
    light: "#0064001a",
    hcDark: "#0064001a",
    hcLight: "#0000"
}, ( localize(752, "Background color behind matching brackets")));
registerColor("editorBracketMatch.border", {
    dark: "#888",
    light: "#B9B9B9",
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(753, "Color for matching brackets boxes")));
const editorBracketMatchForeground = registerColor("editorBracketMatch.foreground", null, ( localize(754, "Foreground color for matching brackets")));
const editorOverviewRulerBorder = registerColor("editorOverviewRuler.border", {
    dark: "#7f7f7f4d",
    light: "#7f7f7f4d",
    hcDark: "#7f7f7f4d",
    hcLight: "#666666"
}, ( localize(755, "Color of the overview ruler border.")));
const editorOverviewRulerBackground = registerColor("editorOverviewRuler.background", null, ( localize(756, "Background color of the editor overview ruler.")));
registerColor("editorGutter.background", editorBackground, ( localize(
    757,
    "Background color of the editor gutter. The gutter contains the glyph margins and the line numbers."
)));
registerColor("editorUnnecessaryCode.border", {
    dark: null,
    light: null,
    hcDark: ( ( Color.fromHex("#fff")).transparent(0.8)),
    hcLight: contrastBorder
}, ( localize(758, "Border color of unnecessary (unused) source code in the editor.")));
const editorUnnecessaryCodeOpacity = registerColor("editorUnnecessaryCode.opacity", {
...
registerColor("editorGhostText.border", {
    dark: null,
    light: null,
    hcDark: ( ( Color.fromHex("#fff")).transparent(0.8)),
    hcLight: ( ( Color.fromHex("#292929")).transparent(0.8))
}, ( localize(760, "Border color of ghost text in the editor.")));
const ghostTextForeground = registerColor("editorGhostText.foreground", {
    dark: ( Color.fromHex("#ffffff56")),
    light: ( Color.fromHex("#0007")),
    hcDark: null,
    hcLight: null
}, ( localize(761, "Foreground color of the ghost text in the editor.")));
registerColor("editorGhostText.background", null, ( localize(762, "Background color of the ghost text in the editor.")));
...
const overviewRulerError = registerColor("editorOverviewRuler.errorForeground", {
    dark: ( new Color(( new RGBA(255, 18, 18, 0.7)))),
    light: ( new Color(( new RGBA(255, 18, 18, 0.7)))),
    hcDark: ( new Color(( new RGBA(255, 50, 50, 1)))),
    hcLight: "#B5200D"
}, ( localize(764, "Overview ruler marker color for errors.")));
const overviewRulerWarning = registerColor("editorOverviewRuler.warningForeground", {
    dark: editorWarningForeground,
    light: editorWarningForeground,
    hcDark: editorWarningBorder,
    hcLight: editorWarningBorder
}, ( localize(765, "Overview ruler marker color for warnings.")));
const overviewRulerInfo = registerColor("editorOverviewRuler.infoForeground", {
    dark: editorInfoForeground,
    light: editorInfoForeground,
    hcDark: editorInfoBorder,
    hcLight: editorInfoBorder
}, ( localize(766, "Overview ruler marker color for infos.")));
const editorBracketHighlightingForeground1 = registerColor("editorBracketHighlight.foreground1", {
    dark: "#FFD700",
    light: "#0431FAFF",
    hcDark: "#FFD700",
    hcLight: "#0431FAFF"
...
const editorBracketHighlightingForeground2 = registerColor("editorBracketHighlight.foreground2", {
    dark: "#DA70D6",
    light: "#319331FF",
    hcDark: "#DA70D6",
    hcLight: "#319331FF"
...
const editorBracketHighlightingForeground3 = registerColor("editorBracketHighlight.foreground3", {
    dark: "#179FFF",
    light: "#7B3814FF",
    hcDark: "#87CEFA",
    hcLight: "#7B3814FF"
...
const editorBracketHighlightingUnexpectedBracketForeground = registerColor("editorBracketHighlight.unexpectedBracket.foreground", {
    ...
    hcDark: ( new Color(( new RGBA(255, 50, 50, 1)))),
    hcLight: "#B5200D"
}, ( localize(773, "Foreground color of unexpected brackets.")));
...
registerColor("editorUnicodeHighlight.border", editorWarningForeground, ( localize(786, "Border color used to highlight unicode characters.")));
registerColor(
    "editorUnicodeHighlight.background",
    editorWarningBackground,
    ( localize(787, "Background color used to highlight unicode characters."))
);
