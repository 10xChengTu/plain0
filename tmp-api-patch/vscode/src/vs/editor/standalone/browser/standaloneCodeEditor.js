...
let StandaloneCodeEditor = class StandaloneCodeEditor extends CodeEditorWidget {
    constructor(
        ...
        }, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService, userInteractionService, keybindingService);
        ...
        setHoverDelegateFactory(
            (placement, enableInstantHover) => instantiationService.createInstance(WorkbenchHoverDelegate, placement, {
    ...
    addAction(_descriptor) {
        ...
        if (Array.isArray(keybindings)) {
            for (const kb of keybindings) {
                toDispose.add(
                    this._standaloneKeybindingService.addDynamicKeybinding(uniqueId, kb, run, keybindingsWhen)
                );
            }
        }
...
StandaloneCodeEditor = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, ICodeEditorService)), ( __param(4, ICommandService)), ( __param(5, IContextKeyService)), ( __param(6, IHoverService)), ( __param(7, IKeybindingService)), ( __param(8, IThemeService)), ( __param(9, INotificationService)), ( __param(10, IAccessibilityService)), ( __param(11, ILanguageConfigurationService)), ( __param(12, ILanguageFeaturesService)), ( __param(13, IMarkdownRendererService)), ( __param(14, IUserInteractionService))], StandaloneCodeEditor));
...
StandaloneEditor = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, ICodeEditorService)), ( __param(4, ICommandService)), ( __param(5, IContextKeyService)), ( __param(6, IHoverService)), ( __param(7, IKeybindingService)), ( __param(8, IStandaloneThemeService)), ( __param(9, INotificationService)), ( __param(10, IConfigurationService)), ( __param(11, IAccessibilityService)), ( __param(12, IModelService)), ( __param(13, ILanguageService)), ( __param(14, ILanguageConfigurationService)), ( __param(15, ILanguageFeaturesService)), ( __param(16, IMarkdownRendererService)), ( __param(17, IUserInteractionService))], StandaloneEditor));
let StandaloneDiffEditor2 = class StandaloneDiffEditor2 extends DiffEditorWidget {
    constructor(
        ...
        super(domElement, options, {
            isStandaloneEditor: true
        }, contextKeyService, instantiationService, codeEditorService, accessibilitySignalService, editorProgressService, keybindingService);
        this._configurationService = configurationService;
        this._standaloneThemeService = themeService;
        this._register(themeDomRegistration);
    }
