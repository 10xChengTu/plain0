...
import { NullDataChannelService } from '../../../platform/dataChannel/common/dataChannel.js';
...
import { WorkspaceFolder, STANDALONE_EDITOR_WORKSPACE_ID, WorkbenchState } from '../../../platform/workspace/common/workspace.js';
...
import { ITextResourceConfigurationService, ITextResourcePropertiesService } from '../../common/services/textResourceConfiguration.service.js';
import { ITreeSitterLibraryService } from '../../common/services/treeSitter/treeSitterLibraryService.service.js';
...
class StandaloneEnvironmentService {
    constructor() {
        ...
        this.appSharedDataHome = ( URI.from({
            scheme: "monaco",
            authority: "appSharedDataHome"
        }));
        this.localHistoryHome = ( URI.from({
            scheme: "monaco",
            authority: "localHistoryHome"
        }));
        this.cacheHome = ( URI.from({
            scheme: "monaco",
            authority: "cacheHome"
        }));
        this.userDataSyncHome = ( URI.from({
            scheme: "monaco",
        ...
        this.agentSessionsWorkspace = ( URI.from({
            scheme: "monaco",
            authority: "agentSessionsWorkspace"
        }));
...
let StandaloneBulkEditService = class StandaloneBulkEditService {
    ...
    async apply(editsIn, _options) {
        ...
        for (const edit of edits) {
            ...
            array.push(
                EditOperation.replaceMove(Range.lift(edit.textEdit.range), edit.textEdit.text)
            );
        }
        let totalEdits = 0;
        let totalFiles = 0;
