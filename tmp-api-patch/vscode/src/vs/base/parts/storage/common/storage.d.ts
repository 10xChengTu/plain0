...
export declare const MIGRATED_KEY = "__$__migratedStorageMarker";
export declare class MigratingStorage extends Storage {
    private migratedKeys;
    private fallbackStorage;
    private isFallbackStorageReadonly;
    init(): Promise<void>;
    setFallbackStorage(storage: IStorage, isReadonly: boolean): void;
    private static readonly INTERNAL_KEY_PREFIX;
    get(key: string, fallbackValue: string): string;
    get(key: string, fallbackValue?: string): string | undefined;
    private loadMigratedKeys;
    private persistMigratedKeys;
}
