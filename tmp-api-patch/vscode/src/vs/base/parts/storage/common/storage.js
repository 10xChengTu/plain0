...
import { isUndefinedOrNull, isObject, isUndefined } from '../../../common/types.js';
...
class Storage extends Disposable {
    ...
    registerListeners() {
        this._register(
            this.database.onDidChangeItemsExternal(e => this.onDidChangeItemsExternal(e))
        );
    }
    ...
    async flush(delay) {
        if (
        this.state === StorageState.Closed || this.pendingClose) {
            return;
        }
...
class MigratingStorage extends Storage {
    constructor() {
        super(...arguments);
    ...
    static {
        this.INTERNAL_KEY_PREFIX = "__$__";
    }
    get(key, fallbackValue) {
...
export { InMemoryStorageDatabase, MIGRATED_KEY, MigratingStorage, Storage, StorageHint, StorageState, isStorageItemsChangeEvent };
