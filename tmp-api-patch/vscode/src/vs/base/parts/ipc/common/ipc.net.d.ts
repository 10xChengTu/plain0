...
export declare namespace SocketDiagnostics {
    ...
    function traceSocketEvent(nativeObject: unknown, socketDebugLabel: string, type: SocketDiagnosticsEventType, data?: VSBuffer | Uint8Array | ArrayBuffer | ArrayBufferView | any): void;
}
...
export declare enum SocketTimeoutReason {
...
export declare class LoadEstimator {
    private static _HISTORY_LENGTH;
...
export declare class PersistentProtocol implements IMessagePassingProtocol {
     ...
     */
    private _keepAliveTimeoutCheck;
    private _sendAck;
