 ...
 */
export declare const GRANT_TYPE_TOKEN_EXCHANGE = "urn:ietf:params:oauth:grant-type:token-exchange";
/**
 * RFC 8693 token type for an OAuth 2.0 access token used as the `subject_token`
 * during a token exchange.
 */
export declare const TOKEN_TYPE_ACCESS_TOKEN = "urn:ietf:params:oauth:token-type:access_token";
/**
 ...
 */
export declare const TOKEN_TYPE_ID_TOKEN = "urn:ietf:params:oauth:token-type:id_token";
/**
 * Token type for an Identity Assertion Authorization Grant (ID-JAG) used in
 * Cross App Access (XAA) flows.
 */
export declare const TOKEN_TYPE_ID_JAG = "urn:ietf:params:oauth:token-type:id-jag";
/**
 ...
 */
export declare function buildIdJagExchangeBody(clientId: string, clientSecret: string | undefined, idToken: string, audience: string, resource: string | undefined, scopes: readonly string[]): URLSearchParams;
/**
 ...
 */
export declare function buildResourceRedemptionBody(clientId: string, clientSecret: string | undefined, idJag: string, resource: string | undefined, scopes: readonly string[]): URLSearchParams;
/**
