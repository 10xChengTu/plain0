 ...
 */
export declare class ObservableResolvedPromise<T> {
    private readonly _lastResolved;
    readonly lastResolved: IObservable<T>;
    private readonly _isResolving;
    readonly isResolving: IObservable<boolean>;
    private _runningPromise;
    constructor(source: IObservable<ObservablePromise<T>>, initialValue: T, store: DisposableStore);
}
/**
