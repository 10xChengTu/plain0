...
export declare function rejectIfNotCanceled(err: unknown): undefined;
/**
 ...
 */
export declare class ThrottlerByKey<TKey> implements IDisposable {
    private readonly throttlers;
 ...
 */
export declare const MAX_TIMEOUT_DELAY: number;
/**
 ...
 * @param store An optional {@link DisposableStore} that will have the timeout disposable managed automatically.
 */
export declare function disposableLongTimeout(handler: () => void, timeout: number, store?: DisposableStore): IDisposable;
/**
...
export declare class RunOnceScheduler<Runner extends (...args: any[]) => any = () => any> implements IDisposable {
...
export declare class RunOnceWorker<T> extends RunOnceScheduler<(units: T[]) => void> {
    private units;
...
export declare function installFakeRunWhenIdle(fakeImpl: typeof _runWhenIdle): IDisposable;
...
export declare class AsyncIterableProducer<T> implements AsyncIterable<T> {
    ...
    static tee<T>(iterable: AsyncIterable<T>): [
        AsyncIterableProducer<T>,
        AsyncIterableProducer<T>
    ];
...
export declare function createTimeout(ms: number, cb: () => void): IDisposable;
export {};
