...
export declare const codiconsDerived: {
    ...
    readonly chatImport: ThemeIcon;
    readonly chatExport: ThemeIcon;
};
/**
...
export declare const Codicon: {
    ...
    readonly copilotWarning: ThemeIcon;
    readonly python: ThemeIcon;
    readonly copilotLarge: ThemeIcon;
    readonly copilotWarningLarge: ThemeIcon;
    readonly keyboardTab: ThemeIcon;
    readonly copilotBlocked: ThemeIcon;
    readonly copilotNotConnected: ThemeIcon;
    ...
    readonly mcp: ThemeIcon;
    readonly extensionsLarge: ThemeIcon;
    readonly layoutPanelDock: ThemeIcon;
    readonly layoutSidebarLeftDock: ThemeIcon;
    readonly layoutSidebarRightDock: ThemeIcon;
    ...
    readonly copilotSnooze: ThemeIcon;
    readonly sendToRemoteAgent: ThemeIcon;
    ...
    readonly build: ThemeIcon;
    readonly commentDiscussionQuote: ThemeIcon;
    readonly cursor: ThemeIcon;
    readonly eraser: ThemeIcon;
    readonly fileText: ThemeIcon;
    readonly quotes: ThemeIcon;
    readonly rename: ThemeIcon;
    readonly runWithDeps: ThemeIcon;
    readonly debugConnected: ThemeIcon;
    readonly strikethrough: ThemeIcon;
    readonly openInProduct: ThemeIcon;
    readonly indexZero: ThemeIcon;
    readonly agent: ThemeIcon;
    readonly editCode: ThemeIcon;
    readonly repoSelected: ThemeIcon;
    readonly skip: ThemeIcon;
    readonly mergeInto: ThemeIcon;
    readonly gitBranchChanges: ThemeIcon;
    readonly gitBranchStagedChanges: ThemeIcon;
    readonly gitBranchConflicts: ThemeIcon;
    readonly gitBranch: ThemeIcon;
    readonly gitBranchCreate: ThemeIcon;
    readonly gitBranchDelete: ThemeIcon;
    readonly searchLarge: ThemeIcon;
    readonly terminalGitBash: ThemeIcon;
    readonly windowActive: ThemeIcon;
    readonly forward: ThemeIcon;
    readonly download: ThemeIcon;
    readonly clockface: ThemeIcon;
    readonly unarchive: ThemeIcon;
    readonly sessionInProgress: ThemeIcon;
    readonly collectionSmall: ThemeIcon;
    readonly vmSmall: ThemeIcon;
    readonly cloudSmall: ThemeIcon;
    readonly addSmall: ThemeIcon;
    ...
    readonly newSession: ThemeIcon;
    readonly terminalSecure: ThemeIcon;
    readonly shareWindow: ThemeIcon;
    readonly circleSlashCompact: ThemeIcon;
    readonly copilotCompact: ThemeIcon;
    readonly folderOpenedCompact: ThemeIcon;
    readonly folderCompact: ThemeIcon;
    readonly gearCompact: ThemeIcon;
    readonly gitBranchCompact: ThemeIcon;
    readonly libraryCompact: ThemeIcon;
    readonly recordKeysCompact: ThemeIcon;
    readonly remoteCompact: ThemeIcon;
    readonly repoForkedCompact: ThemeIcon;
    readonly repoCompact: ThemeIcon;
    readonly shieldCompact: ThemeIcon;
    readonly sparkleCompact: ThemeIcon;
    readonly symbolColorCompact: ThemeIcon;
    readonly windowCompact: ThemeIcon;
    readonly errorCompact: ThemeIcon;
    readonly warningCompact: ThemeIcon;
    readonly passCompact: ThemeIcon;
    readonly important: ThemeIcon;
    readonly importantCompact: ThemeIcon;
    readonly rocketCompact: ThemeIcon;
    readonly unpin: ThemeIcon;
    readonly addCompact: ThemeIcon;
    readonly attachCompact: ThemeIcon;
    readonly beakerCompact: ThemeIcon;
    readonly checkCompact: ThemeIcon;
    readonly checklistCompact: ThemeIcon;
    readonly chevronDownCompact: ThemeIcon;
    readonly chevronLeftCompact: ThemeIcon;
    readonly chevronRightCompact: ThemeIcon;
    readonly chevronUpCompact: ThemeIcon;
    readonly circleFilledCompact: ThemeIcon;
    readonly circleSmallFilledCompact: ThemeIcon;
    readonly closeCompact: ThemeIcon;
    readonly collapseAllCompact: ThemeIcon;
    readonly commentCompact: ThemeIcon;
    readonly commentUnresolvedCompact: ThemeIcon;
    readonly debugConnectedCompact: ThemeIcon;
    readonly debugDisconnectCompact: ThemeIcon;
    readonly editCompact: ThemeIcon;
    readonly fileMediaCompact: ThemeIcon;
    readonly lightbulbCompact: ThemeIcon;
    readonly loadingCompact: ThemeIcon;
    readonly passFilledCompact: ThemeIcon;
    readonly projectCompact: ThemeIcon;
    readonly refreshCompact: ThemeIcon;
    readonly searchCompact: ThemeIcon;
    readonly sessionInProgressCompact: ThemeIcon;
    readonly syncCompact: ThemeIcon;
    readonly terminalCompact: ThemeIcon;
    readonly vmPending: ThemeIcon;
    readonly worktreeCompact: ThemeIcon;
    readonly developerTools: ThemeIcon;
    readonly cloudCompact: ThemeIcon;
    readonly agentCompact: ThemeIcon;
    readonly askCompact: ThemeIcon;
    readonly settingsCompact: ThemeIcon;
    readonly vmCompact: ThemeIcon;
    readonly runCompact: ThemeIcon;
    readonly gitPullRequestComment: ThemeIcon;
    readonly gitPullRequestError: ThemeIcon;
    readonly rightPanelHide: ThemeIcon;
    readonly rightPanelShow: ThemeIcon;
    readonly vscodeInsidersOutline: ThemeIcon;
    readonly vscodeOutline: ThemeIcon;
    readonly voiceMode: ThemeIcon;
    readonly voiceModeCompact: ThemeIcon;
};
