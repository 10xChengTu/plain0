...
export declare class DisposableResizeObserver extends Disposable {
    ...
    constructor(name: string, callback: ResizeObserverCallback, targetWindow?: CodeWindow, options?: {
 ...
 */
export declare function getRecentDisposableResizeObserverAttributionForLoopError(message: string | undefined | null): string | undefined;
...
export declare function h<TTag extends string, T extends Child[]>(tag: TTag, children: [
    ...T
...
export declare function h<TTag extends string, T extends Child[]>(tag: TTag, attributes: Partial<ElementAttributes<TagToElement<TTag>>>, children: [
    ...T
]): (ArrayToObj<T> & TagToRecord<TTag>) extends infer Y ? {
    [TKey in keyof Y]: Y[TKey];
} : never;
...
/** @deprecated This is a duplication of the h function. Needs cleanup. */
export declare function svgElem<TTag extends string, T extends Child[]>(tag: TTag, children: [
    ...T
]): (ArrayToObj<T> & TagToRecord<TTag>) extends infer Y ? {
    [TKey in keyof Y]: Y[TKey];
} : never;
...
/** @deprecated This is a duplication of the h function. Needs cleanup. */
export declare function svgElem<TTag extends string, T extends Child[]>(tag: TTag, attributes: Partial<ElementAttributes<TagToElement<TTag>>>, children: [
    ...T
]): (ArrayToObj<T> & TagToRecord<TTag>) extends infer Y ? {
    [TKey in keyof Y]: Y[TKey];
} : never;
