...
export declare enum HoverStyle {
    /**
...
export declare function isManagedHoverTooltipMarkdownString(obj: unknown): obj is IManagedHoverTooltipMarkdownString;
export interface IManagedHoverTooltipHTMLElement {
    element: (token: CancellationToken) => HTMLElement | Promise<HTMLElement>;
}
export declare function isManagedHoverTooltipHTMLElement(obj: unknown): obj is IManagedHoverTooltipHTMLElement;
