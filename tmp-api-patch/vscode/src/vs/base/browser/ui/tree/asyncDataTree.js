...
import { FindFilter, TreeFindMode, FindController, ComposedTreeDelegate } from './abstractTree.js';
import { isFilterResult, getVisibleState } from './indexTreeModel.js';
import { ObjectTree, CompressibleObjectTree } from './objectTree.js';
import { TreeVisibility, WeakMapper, ObjectTreeElementCollapseState, TreeError } from './tree.js';
import { ThrottledDelayer, createCancelablePromise, Promises, timeout } from '../../../common/async.js';
import { Codicon } from '../../../common/codicons.js';
import { ThemeIcon } from '../../../common/themables.js';
import { isCancellationError, onUnexpectedError } from '../../../common/errors.js';
import { Event, Emitter } from '../../../common/event.js';
import { Iterable } from '../../../common/iterator.js';
import { toDisposable, DisposableStore, dispose } from '../../../common/lifecycle.js';
import { isIterable } from '../../../common/types.js';
import { CancellationTokenSource } from '../../../common/cancellation.js';
import { FuzzyScore } from '../../../common/filters.js';
import { splice, insertInto } from '../../../common/arrays.js';
...
class AsyncFindController extends FindController {
    ...
    async applyPatternAsync() {
        ...
        const findMetadata = await this.findProvider.find(pattern, {
    ...
    onDidToggleChange(e) {
        ...
        this.placeholder = this.mode === TreeFindMode.Filter ? ( localize(44, "Type to filter")) : ( localize(45, "Type to search"));
...
class AsyncDataTree {
    ...
    constructor(user, container, delegate, renderers, dataSource, options = {}) {
        ...
        if (options.findProvider && (options.findWidgetEnabled ?? true) && options.keyboardNavigationLabelProvider && options.contextViewProvider) {
            ...
            findFilter = ( new AsyncFindFilter(
                options.findProvider,
                options.keyboardNavigationLabelProvider,
                options.filter
            ));
        }
        ...
        if (asyncFindEnabled) {
            ...
            this.findController = this.disposables.add(( new AsyncFindController(
                this.tree,
                options.findProvider,
                findFilter,
                this.tree.options.contextViewProvider,
                findOptions
            )));
    ...
    getDataNode(element) {
        ...
        if (!node) {
            ...
            throw ( new TreeError(
                this.user,
                `Data tree node not found${nodeIdentity ? `: ${nodeIdentity}` : ""}`
            ));
        }
        return node;
    }
