...
import { createElement, DisposableResizeObserver, isHTMLElement } from '../../dom.js';
...
class ToolBar extends Disposable {
    ...
    constructor(
        ...
        this.actionBar = this._register(( new ActionBar(this.element, {
            ...
            actionViewItemProvider: (action, viewItemOptions) => {
                if (action.id === ToggleMenuAction.ID) {
                    this.toggleMenuActionViewItem = ( new DropdownMenuActionViewItem(action, {
        ...
        if (this.options.responsiveBehavior?.enabled) {
            ...
            const observer = this._store.add(( new DisposableResizeObserver("Toolbar.actionsUpdate", () => {
...
class ToggleMenuAction extends Action {
    ...
    constructor(toggleDropdownMenu, title) {
        title = title || ( localize(33, "More Actions..."));
