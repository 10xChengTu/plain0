...
class ActionBar extends Disposable {
        ...
        actions.forEach(action => {
            ...
            if (!this.options.allowContextMenu) {
                this.viewItemDisposables.set(
                    item,
                    addDisposableListener(actionViewItemElement, EventType.CONTEXT_MENU, e => {
    ...
    isFocused(index) {
        return index === undefined ? isAncestor(getActiveElement(), this.domNode) : isAncestor(getActiveElement(), this.actionsList.children[index]);
    }
    focus(arg) {
