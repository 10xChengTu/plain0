...
import { isHTMLElement, getDomNodePagePosition, getDomNodeZoomLevel, $, hide, createElement, addStandardDisposableListener, clearNode, show, getWindow, getActiveWindow, getTotalHeight, getTotalWidth, getActiveElement, isAncestor } from '../../dom.js';
import { Disposable, toDisposable, DisposableStore } from '../../../common/lifecycle.js';
import { layout2d, AnchorPosition, AnchorAlignment } from '../../../common/layout.js';
export { AnchorAxisAlignment } from '../../../common/layout.js';
...
class ContextView extends Disposable {
    ...
    constructor(container, domPosition) {
        ...
        this._register(
            toDisposable(() => this.setContainer(null, ContextViewDOMPosition.ABSOLUTE))
        );
    }
    ...
    doLayout() {
        ...
        const view = {
            width: getTotalWidth(this.view),
            height: getTotalHeight(this.view)
        };
...
export { AnchorAlignment, AnchorPosition, ContextView, ContextViewDOMPosition, getAnchorRect, isAnchor };
