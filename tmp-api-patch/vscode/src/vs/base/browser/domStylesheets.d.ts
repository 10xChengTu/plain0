...
export declare function createStyleSheet(container?: HTMLElement | ShadowRoot, beforeAppend?: (style: HTMLStyleElement) => void, disposableStore?: DisposableStore): HTMLStyleElement;
