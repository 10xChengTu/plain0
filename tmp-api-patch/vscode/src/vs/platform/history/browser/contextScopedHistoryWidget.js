...
const historyNavigationVisible = ( new RawContextKey("suggestWidgetVisible", false, ( localize(2125, "Whether suggestion are visible"))));
...
let ContextScopedFindInput = class ContextScopedFindInput extends FindInput {
    constructor(container, contextViewProvider, options, contextKeyService) {
        ...
        this._register(
            registerAndCreateHistoryNavigationContext(scopedContextKeyService, this.inputBox)
        );
    }
};
