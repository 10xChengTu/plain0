...
import { IUserDataProfilesService } from "./userDataProfile.service.js";
export declare const AGENTS_WINDOW_PROFILE_ID = "agents";
...
export declare class UserDataProfilesService extends Disposable implements IUserDataProfilesService {
    ...
    readonly onDidChangeProfiles: import("../../../base/common/event.js").Event<DidChangeProfilesEvent>;
    protected readonly _onWillCreateProfile: Emitter<WillCreateProfileEvent>;
    readonly onWillCreateProfile: import("../../../base/common/event.js").Event<WillCreateProfileEvent>;
    protected readonly _onWillRemoveProfile: Emitter<WillRemoveProfileEvent>;
    readonly onWillRemoveProfile: import("../../../base/common/event.js").Event<WillRemoveProfileEvent>;
    private readonly _onDidResetWorkspaces;
    readonly onDidResetWorkspaces: import("../../../base/common/event.js").Event<void>;
    ...
    protected createDefaultProfile(): {
        ...
        promptsHome: URI;
        mcpResource: URI;
        languageModelsResource: URI;
        agentPluginsHome: URI;
        cacheHome: URI;
        useDefaultFlags?: UseDefaultProfileFlags;
        isInternal?: boolean;
        isTransient?: boolean;
        isAgentsWindowProfile?: boolean;
