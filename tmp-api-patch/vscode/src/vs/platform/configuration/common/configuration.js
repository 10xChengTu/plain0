...
function isConfigured(configValue) {
    return configValue.applicationValue !== undefined || configValue.userValue !== undefined || configValue.userLocalValue !== undefined || configValue.userRemoteValue !== undefined || configValue.workspaceValue !== undefined || configValue.workspaceFolderValue !== undefined;
}
function isDefaultOverriden(settingName) {
    return ( ( Registry.as(Extensions.Configuration)).getConfigurationDefaultsOverrides().has(settingName));
}
...
export { ConfigurationTarget, ConfigurationTargetToString, addToValueTree, getConfigValueInTarget, getConfigurationValue, getLanguageTagSettingPlainKey, isConfigurationOverrides, isConfigurationUpdateOverrides, isConfigured, isDefaultOverriden, removeFromValueTree, toValuesTree };
