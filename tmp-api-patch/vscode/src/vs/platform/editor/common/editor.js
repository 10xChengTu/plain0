...
function isModalEditorOptionsProvider(obj) {
    return !!obj && typeof obj.getModalEditorOptions === 'function';
}
...
export { EditorActivation, EditorOpenSource, EditorResolution, TextEditorSelectionRevealType, TextEditorSelectionSource, isModalEditorOptionsProvider, isResolvedEditorModel, isTextEditorDiffInformationEqual };
