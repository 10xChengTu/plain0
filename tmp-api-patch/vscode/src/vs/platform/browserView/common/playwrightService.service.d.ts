...
import { IInvokeFunctionResult } from "./playwrightService.js";
...
export interface IPlaywrightService {
    ...
    */
    replyToFileChooser(sessionId: string, pageId: string, files: string[]): Promise<{
        summary: string;
    }>;
    /**
    ...
    * @returns An object with the page summary afterwards.
    */
    replyToDialog(sessionId: string, pageId: string, accept: boolean, promptText?: string): Promise<{
        summary: string;
    }>;
    /**
