...
(function(TerminalSettingId) {
    ...
    TerminalSettingId["AgentHostProfileLinux"] = "terminal.integrated.agentHostProfile.linux";
    TerminalSettingId["AgentHostProfileMacOs"] = "terminal.integrated.agentHostProfile.osx";
    TerminalSettingId["AgentHostProfileWindows"] = "terminal.integrated.agentHostProfile.windows";
    ...
    TerminalSettingId["TabsAllowAgentCliTitle"] = "terminal.integrated.tabs.allowAgentCliTitle";
...
(function(GeneralShellType) {
    GeneralShellType["Claude"] = "claude";
    GeneralShellType["Codex"] = "codex";
    GeneralShellType["Copilot"] = "copilot";
    GeneralShellType["Gemini"] = "gemini";
