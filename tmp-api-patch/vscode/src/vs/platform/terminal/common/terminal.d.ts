...
import { ISerializableEnvironmentVariableCollections } from "@codingame/monaco-vscode-xterm-common/vscode/vs/platform/terminal/common/environmentVariable";
...
export declare enum TerminalLocationConfigValue {
    TerminalView = "view",
    Editor = "editor"
}
