...
export declare abstract class AbstractRequestService extends Disposable implements IRequestService {
    ...
    readonly onDidCompleteRequest: import("../../../base/common/event.js").Event<IRequestCompleteEvent>;
 ...
 */
export declare function readHeader(headers: IHeaders | undefined, name: string): string | undefined;
/**
 ...
 */
export declare function retryAfterFromHeaders(headers: IHeaders | undefined): number | undefined;
