    ...
    proxyConfiguration = [{
        ...
        properties: {
            ...
            "http.proxySupport": {
                ...
                enumDescriptions: [( localize(2238, "Disable proxy support for extensions.")), ( localize(2239, "Enable proxy support for extensions.")), ( localize(
                    2240,
                    "Enable proxy support for extensions, fall back to request options, when no proxy found."
                )), ( localize(2241, "Enable proxy support for extensions, override request options."))],
                default: "override",
                markdownDescription: ( localize(
                    2242,
...
export { AbstractRequestService, NO_FETCH_TELEMETRY, USER_LOCAL_AND_REMOTE_SETTINGS, asJson, asText, asTextOrError, hasNoContent, isClientError, isServerError, isSuccess, readHeader, retryAfterFromHeaders, systemCertificatesNodeDefault };
