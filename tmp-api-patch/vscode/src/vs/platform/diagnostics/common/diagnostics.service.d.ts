...
import { type IMainProcessDiagnostics, type IRemoteDiagnosticInfo, type IRemoteDiagnosticError, type PerformanceInfo, type SystemInfo, type IWorkspaceInformation } from "./diagnostics.js";
...
export interface IDiagnosticsService {
    ...
    getPerformanceInfo(mainProcessInfo: IMainProcessDiagnostics, remoteInfo: (IRemoteDiagnosticInfo | IRemoteDiagnosticError)[], options?: {
        skipCache?: boolean;
        unbounded?: boolean;
