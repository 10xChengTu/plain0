...
export declare class Workspace implements IWorkspace {
    ...
    constructor(_id: string, folders: WorkspaceFolder[], _transient: boolean, _configuration: URI | null, ignorePathCasing: (key: URI) => boolean, _workspaceName?: string | undefined);
