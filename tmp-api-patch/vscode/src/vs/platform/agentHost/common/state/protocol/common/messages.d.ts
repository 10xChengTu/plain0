...
import type { AuthRequiredParams } from "@codingame/monaco-vscode-xterm-common/vscode/vs/platform/agentHost/common/state/protocol/common/notifications";
import type { OtlpExportLogsParams, OtlpExportTracesParams, OtlpExportMetricsParams } from "../channels-otlp/notifications.js";
import type { AhpError } from "@codingame/monaco-vscode-chat-service-override/vscode/vs/platform/agentHost/common/state/protocol/common/errors";
...
export interface CommandMap {
    ...
    "createResourceWatch": {
        ...
        result: CreateResourceWatchResult;
    };
    "listSessions": {
    ...
    "resourceResolve": {
        ...
        result: ResourceResolveResult;
    };
    "resourceMkdir": {
        params: ResourceMkdirParams;
        result: ResourceMkdirResult;
    };
    "resourceRequest": {
