 ...
 */
export declare enum SessionInputRequestKind {
 ...
 * @category Session Input Types
 */
export type SessionInputRequest = SessionChatInputRequest | SessionToolConfirmationRequest | SessionToolClientExecutionRequest;
/**
 ...
 * @category Customization Types
 */
export type ChildCustomizationType = CustomizationType.Agent | CustomizationType.Skill | CustomizationType.Prompt | CustomizationType.Rule | CustomizationType.Hook | CustomizationType.McpServer;
/**
 ...
 * @category Customization Types
 */
export declare enum CustomizationLoadStatus {
    Loading = "loading",
    Loaded = "loaded",
    Degraded = "degraded",
    Error = "error"
 ...
 * @category Customization Types
 */
export type CustomizationLoadState = CustomizationLoadingState | CustomizationLoadedState | CustomizationDegradedState | CustomizationErrorState;
/**
 ...
 * @category Customization Types
 */
export type ChildCustomization = AgentCustomization | SkillCustomization | PromptCustomization | RuleCustomization | HookCustomization | McpServerCustomization;
/**
 ...
 * @category MCP Server State
 */
export declare enum McpAuthRequiredReason {
 ...
 * @category MCP Server State
 */
export type McpServerState = McpServerStartingState | McpServerReadyState | McpServerAuthRequiredState | McpServerErrorState | McpServerStoppedState;
export {};
