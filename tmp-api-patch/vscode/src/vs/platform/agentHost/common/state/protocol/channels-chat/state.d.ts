 ...
 * @category Chat State
 */
export declare enum ChatOriginKind {
 ...
 * @category Chat State
 */
export declare enum ChatInteractivity {
 ...
 */
export declare enum ChatInputResponseKind {
    Accept = "accept",
    Decline = "decline",
    Cancel = "cancel"
}
 ...
 * @category Chat Input Types
 */
export declare enum ChatInputQuestionKind {
    Text = "text",
    Number = "number",
    Integer = "integer",
    Boolean = "boolean",
 ...
 * @category Chat Input Types
 */
export type ChatInputQuestion = ChatInputTextQuestion | ChatInputNumberQuestion | ChatInputBooleanQuestion | ChatInputSingleSelectQuestion | ChatInputMultiSelectQuestion;
/**
 ...
 * @category Chat Input Types
 */
export declare enum ChatInputAnswerValueKind {
    Text = "text",
    Number = "number",
    Boolean = "boolean",
    Selected = "selected",
...
export type ChatInputAnswerValue = ChatInputTextAnswerValue | ChatInputNumberAnswerValue | ChatInputBooleanAnswerValue | ChatInputSelectedAnswerValue | ChatInputSelectedManyAnswerValue;
 ...
 * @category Chat Input Types
 */
export declare enum ChatInputAnswerState {
    Draft = "draft",
    Submitted = "submitted",
    Skipped = "skipped"
}
 ...
 * @category Turn Types
 */
export type MessageAttachment = SimpleMessageAttachment | MessageEmbeddedResourceAttachment | MessageResourceAttachment | MessageAnnotationsAttachment;
/**
...
export declare enum ToolCallContributorKind {
    Client = "client",
    MCP = "mcp"
}
 ...
 * @category Tool Call Types
 */
export type ToolCallConfirmationState = ToolCallPendingConfirmationState | ToolCallPendingResultConfirmationState;
/**
 ...
 * @category Tool Result Content
 */
export type ToolResultContent = ToolResultTextContent | ToolResultEmbeddedResourceContent | ToolResultResourceContent | ToolResultFileEditContent | ToolResultTerminalContent | ToolResultShellExitContent | ToolResultSubagentContent;
export {};
