 ...
 */
export declare const VSCODE_UPGRADE_METHOD: "_vscodeUpgrade";
/**
 ...
 */
export declare function readUnsupportedProtocolVersionErrorMeta(data: unknown): UnsupportedProtocolVersionErrorMeta | undefined;
