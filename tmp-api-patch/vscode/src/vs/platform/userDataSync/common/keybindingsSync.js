...
import { SyncResource, USER_DATA_SYNC_SCHEME, UserDataSyncError, UserDataSyncErrorCode, Change, CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM } from './userDataSync.js';
import { IUserDataSyncStoreService, IUserDataSyncLocalStoreService, IUserDataSyncLogService, IUserDataSyncEnablementService, IUserDataSyncUtilService } from './userDataSync.service.js';
...
let KeybindingsSynchroniser = class KeybindingsSynchroniser extends AbstractJsonFileSynchroniser {
    constructor(
        ...
        super(profile.keybindingsResource, {
            syncResource: SyncResource.Keybindings,
            profile
    ...
    async generateSyncPreview(
        ...
        if (remoteContent) {
            ...
            if (
            !lastSyncContent || lastSyncContent !== localContent || lastSyncContent !== remoteContent) {
...
KeybindingsSynchroniser = ( __decorate([( __param(2, IUserDataSyncStoreService)), ( __param(3, IUserDataSyncLocalStoreService)), ( __param(4, IUserDataSyncLogService)), ( __param(5, IConfigurationService)), ( __param(6, IUserDataSyncEnablementService)), ( __param(7, IFileService)), ( __param(8, IEnvironmentService)), ( __param(9, IStorageService)), ( __param(10, IUserDataSyncUtilService)), ( __param(11, ITelemetryService)), ( __param(12, IUriIdentityService))], KeybindingsSynchroniser));
...
KeybindingsInitializer = ( __decorate([( __param(0, IFileService)), ( __param(1, IUserDataProfilesService)), ( __param(2, IEnvironmentService)), ( __param(3, IUserDataSyncLogService)), ( __param(4, IStorageService)), ( __param(5, IUriIdentityService))], KeybindingsInitializer));
