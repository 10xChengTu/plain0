...
import { IExtensionManagementService } from '../../extensionManagement/common/extensionManagement.service.js';
...
import { AbstractJsonFileSynchroniser, AbstractInitializer } from './abstractSynchronizer.js';
import { merge, updateIgnoredSettings, isEmpty, getIgnoredSettings } from './settingsMerge.js';
import { SyncResource, USER_DATA_SYNC_SCHEME, USER_DATA_SYNC_CONFIGURATION_SCOPE, Change, getIgnoredSettingsForExtension, UserDataSyncError, UserDataSyncErrorCode } from './userDataSync.js';
import { IUserDataSyncStoreService, IUserDataSyncLocalStoreService, IUserDataSyncLogService, IUserDataSyncUtilService, IUserDataSyncEnablementService } from './userDataSync.service.js';
...
let SettingsSynchroniser = class SettingsSynchroniser extends AbstractJsonFileSynchroniser {
    constructor(
        ...
        super(profile.settingsResource, {
            syncResource: SyncResource.Settings,
            profile
        }, collection, fileService, environmentService, storageService, userDataSyncStoreService, userDataSyncLocalStoreService, userDataSyncEnablementService, telemetryService, logService, userDataSyncUtilService, configurationService, uriIdentityService);
    ...
    async getIgnoredSettings(content) {
        ...
        if (!this.userExtensionsIgnoredSettings) {
            ...
            const disposable = this._register(Event.any(Event.filter(
...
SettingsSynchroniser = ( __decorate([( __param(2, IFileService)), ( __param(3, IEnvironmentService)), ( __param(4, IStorageService)), ( __param(5, IUserDataSyncStoreService)), ( __param(6, IUserDataSyncLocalStoreService)), ( __param(7, IUserDataSyncLogService)), ( __param(8, IUserDataSyncUtilService)), ( __param(9, IConfigurationService)), ( __param(10, IUserDataSyncEnablementService)), ( __param(11, ITelemetryService)), ( __param(12, IExtensionManagementService)), ( __param(13, IUriIdentityService))], SettingsSynchroniser));
...
SettingsInitializer = ( __decorate([( __param(0, IFileService)), ( __param(1, IUserDataProfilesService)), ( __param(2, IEnvironmentService)), ( __param(3, IUserDataSyncLogService)), ( __param(4, IStorageService)), ( __param(5, IUriIdentityService))], SettingsInitializer));
