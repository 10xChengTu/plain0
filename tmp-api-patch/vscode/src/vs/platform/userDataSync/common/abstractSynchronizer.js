...
function isRemoteUserData(thing) {
    if (thing && (thing.ref !== undefined && typeof thing.ref === "string" && thing.ref !== "") && (thing.syncData !== undefined && (thing.syncData === null || isSyncData(thing.syncData)))) {
        return true;
    }
    return false;
}
function isSyncData(thing) {
    if (thing && (thing.version !== undefined && typeof thing.version === "number") && (thing.content !== undefined && typeof thing.content === "string")) {
        if (( Object.keys(thing)).length === 2) {
            return true;
        }
        if (( Object.keys(thing)).length === 3 && (thing.machineId !== undefined && typeof thing.machineId === "string")) {
            return true;
        }
    }
    return false;
...
let AbstractSynchroniser = class AbstractSynchroniser extends Disposable {
    ...
    constructor(
        ...
        this.syncFolder = this.extUri.joinPath(environmentService.userDataSyncHome, ...getPathSegments(
            syncResource.profile.isDefault ? undefined : syncResource.profile.id,
    ...
    async sync(
        refOrUserData,
        preview = false,
        userDataSyncConfiguration = this.getUserDataSyncConfiguration(),
        headers = {}
    ) {
        try {
            this.syncHeaders = {
            ...
            try {
                ...
                status = await this.performSync(
                    remoteUserData,
                    lastSyncUserData,
                    preview ? SyncStrategy.Preview : SyncStrategy.Merge,
    ...
    async replace(content) {
        ...
        try {
            ...
            const resourcePreviewResults = await this.generateSyncPreview({
                ...
                syncData
            }, lastSyncUserData, isRemoteDataFromCurrentMachine, this.getUserDataSyncConfiguration(), CancellationToken.None);
    ...
    async doSync(remoteUserData, lastSyncUserData, strategy, userDataSyncConfiguration) {
        try {
            ...
            if (!this.syncPreviewPromise) {
                this.syncPreviewPromise = createCancelablePromise(token => this.doGenerateSyncResourcePreview(
                    remoteUserData,
                    lastSyncUserData,
    ...
    async doGenerateSyncResourcePreview(
        remoteUserData,
        lastSyncUserData,
        isRemoteDataFromCurrentMachine,
        merge,
...
AbstractSynchroniser = ( __decorate([( __param(2, IFileService)), ( __param(3, IEnvironmentService)), ( __param(4, IStorageService)), ( __param(5, IUserDataSyncStoreService)), ( __param(6, IUserDataSyncLocalStoreService)), ( __param(7, IUserDataSyncEnablementService)), ( __param(8, ITelemetryService)), ( __param(9, IUserDataSyncLogService)), ( __param(10, IConfigurationService)), ( __param(11, IUriIdentityService))], AbstractSynchroniser));
...
AbstractFileSynchroniser = ( __decorate([( __param(3, IFileService)), ( __param(4, IEnvironmentService)), ( __param(5, IStorageService)), ( __param(6, IUserDataSyncStoreService)), ( __param(7, IUserDataSyncLocalStoreService)), ( __param(8, IUserDataSyncEnablementService)), ( __param(9, ITelemetryService)), ( __param(10, IUserDataSyncLogService)), ( __param(11, IConfigurationService)), ( __param(12, IUriIdentityService))], AbstractFileSynchroniser));
...
AbstractJsonFileSynchroniser = ( __decorate([( __param(3, IFileService)), ( __param(4, IEnvironmentService)), ( __param(5, IStorageService)), ( __param(6, IUserDataSyncStoreService)), ( __param(7, IUserDataSyncLocalStoreService)), ( __param(8, IUserDataSyncEnablementService)), ( __param(9, ITelemetryService)), ( __param(10, IUserDataSyncLogService)), ( __param(11, IUserDataSyncUtilService)), ( __param(12, IConfigurationService)), ( __param(13, IUriIdentityService))], AbstractJsonFileSynchroniser));
...
AbstractInitializer = ( __decorate([( __param(1, IUserDataProfilesService)), ( __param(2, IEnvironmentService)), ( __param(3, ILogService)), ( __param(4, IFileService)), ( __param(5, IStorageService)), ( __param(6, IUriIdentityService))], AbstractInitializer));
