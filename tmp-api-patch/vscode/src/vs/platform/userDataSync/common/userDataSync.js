...
function registerConfiguration() {
    ...
    configurationRegistry.registerConfiguration({
        id: "settingsSync",
        order: 30,
        title: ( localize(2673, "Settings Sync")),
        type: "object",
        properties: {
            [CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM]: {
                type: "boolean",
                description: ( localize(2674, "Synchronize keybindings for each platform.")),
                default: true,
            ...
            "settingsSync.ignoredExtensions": {
                ...
                items: [{
                    ...
                    errorMessage: ( localize(2676, "Expected format '${publisher}.${name}'. Example: 'vscode.csharp'."))
                }],
                "default": [],
                "scope": ConfigurationScope.APPLICATION,
                uniqueItems: true,
            ...
            "settingsSync.ignoredSettings": {
                "type": "array",
                description: ( localize(2677, "Configure settings to be ignored while synchronizing.")),
                "default": [],
                "scope": ConfigurationScope.APPLICATION,
...
function isUserDataManifest(thing) {
    return thing && isString(thing.session) && isString(thing.ref) && (isObject(thing.latest) || thing.latest === undefined) && (isObject(thing.collections) || thing.collections === undefined);
}
