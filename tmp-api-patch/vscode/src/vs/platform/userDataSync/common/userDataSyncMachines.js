...
import { PlatformToString, Platform, isSafari, isChrome, isEdge, isFirefox, isAndroid, isWeb, platform } from '../../../base/common/platform.js';
...
let UserDataSyncMachinesService = class UserDataSyncMachinesService extends Disposable {
    ...
    async writeMachinesData(machinesData) {
        ...
        const ref = await this.userDataSyncStoreService.writeResource(
            UserDataSyncMachinesService_1.RESOURCE,
            content,
...
UserDataSyncMachinesService = UserDataSyncMachinesService_1 = ( __decorate([( __param(0, IEnvironmentService)), ( __param(1, IFileService)), ( __param(2, IStorageService)), ( __param(3, IUserDataSyncStoreService)), ( __param(4, IUserDataSyncLogService)), ( __param(5, IProductService))], UserDataSyncMachinesService));
