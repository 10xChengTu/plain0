...
function hintDidYouMean(...meant) {
    switch (meant.length) {
    case 1:
        return localize(1977, "Did you mean {0}?", meant[0]);
    case 2:
        return localize(1978, "Did you mean {0} or {1}?", meant[0], meant[1]);
    case 3:
        return localize(1979, "Did you mean {0}, {1} or {2}?", meant[0], meant[1], meant[2]);
    default:
        return undefined;
    }
}
const hintDidYouForgetToOpenOrCloseQuote = ( localize(1980, "Did you forget to open or close the quote?"));
