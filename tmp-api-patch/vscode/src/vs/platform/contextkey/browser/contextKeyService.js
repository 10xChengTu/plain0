...
import { equals, distinct, cloneAndChange } from '../../../base/common/objects.js';
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(1956, "A command that returns information about context keys")),
        args: []
    }
});
