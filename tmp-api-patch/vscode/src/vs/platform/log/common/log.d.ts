 ...
 */
export declare const isDevConsoleLogForwardingEnabled = false;
export declare function registerDevConsoleLogForwarder(logService: ILogService): IDisposable;
export declare function format(args: any, verbose?: boolean): string;
