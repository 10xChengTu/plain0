...
function LogLevelToLocalizedString(logLevel) {
    ...
    case LogLevel.Trace:
        return {
            original: "Trace",
            value: ( localize(2166, "Trace"))
        };
    case LogLevel.Debug:
        return {
            original: "Debug",
            value: ( localize(2167, "Debug"))
        };
    case LogLevel.Info:
        return {
            original: "Info",
            value: ( localize(2168, "Info"))
        };
    case LogLevel.Warning:
        return {
            original: "Warning",
            value: ( localize(2169, "Warning"))
        };
    case LogLevel.Error:
        return {
            original: "Error",
            value: ( localize(2170, "Error"))
        };
    case LogLevel.Off:
        return {
            original: "Off",
            value: ( localize(2171, "Off"))
        };
    }
}
...
export { AbstractLogger, AbstractLoggerService, AbstractMessageLogger, CONTEXT_LOG_LEVEL, ConsoleLogger, DEFAULT_LOG_LEVEL, LogLevel, LogLevelToLocalizedString, LogLevelToString, MultiplexLogger, NullLogService, NullLogger, NullLoggerService, canLog, format, getLogLevel, isDevConsoleLogForwardingEnabled, isLogLevel, log, parseLogLevel };
