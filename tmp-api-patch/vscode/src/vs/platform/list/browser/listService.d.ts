...
import { IContextKey, IScopedContextKeyService, RawContextKey } from "../../contextkey/common/contextkey.js";
...
export declare class WorkbenchObjectTree<T extends NonNullable<any>, TFilterData = void> extends ObjectTree<T, TFilterData> {
    ...
    updateOptions(options?: IWorkbenchObjectTreeOptionsUpdate<T | null>): void;
}
