...
import { isSelectionSingleChangeEvent, isSelectionRangeChangeEvent, List, TypeNavigationMode } from '../../../base/browser/ui/list/listWidget.js';
...
import { DisposableStore, combinedDisposable, toDisposable, Disposable, dispose } from '../../../base/common/lifecycle.js';
...
const WorkbenchListScrollAtTopContextKey = ( ContextKeyExpr.or(( RawWorkbenchListScrollAtBoundaryContextKey.isEqualTo("top")), ( RawWorkbenchListScrollAtBoundaryContextKey.isEqualTo("both"))));
const WorkbenchListScrollAtBottomContextKey = ( ContextKeyExpr.or(( RawWorkbenchListScrollAtBoundaryContextKey.isEqualTo("bottom")), ( RawWorkbenchListScrollAtBoundaryContextKey.isEqualTo("both"))));
...
class ResourceNavigator extends Disposable {
    constructor(widget, options) {
        ...
        this._register(
            Event.filter(this.widget.onDidChangeSelection, e => isKeyboardEvent(e.browserEvent))(e => this.onSelectionFromKeyboard(e))
        );
        this._register(this.widget.onPointer(e => this.onPointer(e.element, e.browserEvent)));
        this._register(
            this.widget.onMouseDblClick(e => this.onMouseDblClick(e.element, e.browserEvent))
        );
...
configurationRegistry.registerConfiguration({
    id: "workbench",
    order: 7,
    title: ( localize(2139, "Workbench")),
    type: "object",
    properties: {
        [multiSelectModifierSettingKey]: {
            type: "string",
            enum: ["ctrlCmd", "alt"],
            markdownEnumDescriptions: [( localize(2140, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")), ( localize(2141, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))],
            default: "ctrlCmd",
        ...
        [scrollByPageKey]: {
            type: "boolean",
            default: false,
            description: ( localize(2145, "Controls whether clicks in the scrollbar scroll page by page."))
        },
        [treeIndentKey]: {
            type: "number",
            default: 8,
            minimum: 4,
            maximum: 40,
            description: ( localize(2146, "Controls tree indentation in pixels."))
        },
        [treeRenderIndentGuidesKey]: {
            type: "string",
            enum: ["none", "onHover", "always"],
            default: "onHover",
            description: ( localize(2147, "Controls whether the tree should render indent guides."))
        },
        [listSmoothScrolling]: {
            type: "boolean",
            default: false,
            description: ( localize(2148, "Controls whether lists and trees have smooth scrolling."))
        },
        ...
        [fastScrollSensitivityKey]: {
            type: "number",
            default: 5,
            markdownDescription: ( localize(2150, "Scrolling speed multiplier when pressing `Alt`."))
        },
        [defaultFindModeSettingKey]: {
            ...
            )), ( localize(2152, "Filter elements when searching."))],
            default: "highlight",
            description: ( localize(
                2153,
        ...
        [defaultFindMatchTypeSettingKey]: {
            ...
            enumDescriptions: [( localize(2159, "Use fuzzy matching when searching.")), ( localize(2160, "Use contiguous matching when searching."))],
            default: "fuzzy",
            description: ( localize(
                2161,
        ...
        [treeStickyScroll]: {
            type: "boolean",
            default: true,
            description: ( localize(2163, "Controls whether sticky scrolling is enabled in trees."))
        },
