...
import { safeStringify, cloneAndChange } from '../../../base/common/objects.js';
import { isObject } from '../../../base/common/types.js';
import { localize } from '../../../nls.js';
import { getRemoteName } from '../../remote/common/remoteHosts.js';
import { verifyMicrosoftInternalDomain } from './commonProperties.js';
import { TelemetryLevel, TELEMETRY_SETTING_ID, TELEMETRY_CRASH_REPORTER_SETTING_ID, TELEMETRY_OLD_SETTING_ID, TelemetryConfiguration } from './telemetry.js';
...
export { NullEndpointTelemetryService, NullTelemetryService, NullTelemetryServiceShape, TelemetryLogGroup, TelemetryTrustedValue, cleanData, cleanRemoteAuthority, getTelemetryLevel, isInternalTelemetry, isLoggingOnly, supportsTelemetry, telemetryLogId, validateTelemetryData };
