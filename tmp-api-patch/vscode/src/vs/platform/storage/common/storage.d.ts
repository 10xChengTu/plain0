...
export declare abstract class AbstractStorageService extends Disposable implements IStorageService {
    ...
    private _applicationSharedKeyTargets;
    private get applicationSharedKeyTargets();
...
export declare class InMemoryStorageService extends AbstractStorageService {
    ...
    private readonly applicationSharedStorage;
...
export declare function logStorage(application: Map<string, string>, applicationShared: Map<string, string>, profile: Map<string, string>, workspace: Map<string, string>, applicationPath: string, applicationSharedPath: string, profilePath: string, workspacePath: string): Promise<void>;
export {};
