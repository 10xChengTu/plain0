...
import { createElement, addDisposableGenericMouseDownListener, addDisposableListener, EventType, trackFocus, getActiveElement, $ } from '../../../base/browser/dom.js';
...
registerColor("actionBar.toggledBackground", inputActiveOptionBackground, ( localize(1804, "Background color for toggled action items in action bar.")));
const ActionWidgetContextKeys = {
    Visible: ( new RawContextKey("codeActionMenuVisible", false, ( localize(1805, "Whether the action widget list is visible")))),
    FilterFocused: ( new RawContextKey("codeActionMenuFilterFocused", false, ( localize(1806, "Whether the action widget filter input is focused"))))
};
    ...
    _renderWidget(element, list, actionBarActions) {
        ...
        if (headerContainer) {
            renderDisposables.add(
                addDisposableGenericMouseDownListener(headerContainer, e => e.preventDefault())
            );
        }
        ...
        renderDisposables.add(
            addDisposableListener(pointerBlock, EventType.POINTER_MOVE, () => pointerBlock.remove())
        );
        renderDisposables.add(
            addDisposableGenericMouseDownListener(pointerBlock, () => pointerBlock.remove())
        );
        ...
        renderDisposables.add({
            dispose: () => filterFocusedContext.reset()
        });
        if (this._list.value?.filterInput) {
            const filterInput = this._list.value.filterInput;
            renderDisposables.add(
                addDisposableListener(filterInput, "focus", () => filterFocusedContext.set(true))
            );
            renderDisposables.add(
                addDisposableListener(filterInput, "blur", () => filterFocusedContext.set(false))
            );
        }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1807, "Hide action widget")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1808, "Clear action widget filter")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1809, "Select previous action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
                ...
                mac: {
                    primary: KeyCode.UpArrow,
                    secondary: [KeyMod$1.CtrlCmd | KeyCode.UpArrow, KeyMod$1.WinCtrl | KeyCode.KeyP]
                }
            }
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1810, "Select next action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
                ...
                mac: {
                    primary: KeyCode.DownArrow,
                    secondary: [KeyMod$1.CtrlCmd | KeyCode.DownArrow, KeyMod$1.WinCtrl | KeyCode.KeyN]
                }
            }
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1811, "Collapse section")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1812, "Expand section")),
            precondition: ( ContextKeyExpr.and(ActionWidgetContextKeys.Visible, ( ActionWidgetContextKeys.FilterFocused.negate()))),
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1813, "Toggle section")),
            precondition: ( ContextKeyExpr.and(ActionWidgetContextKeys.Visible, ( ActionWidgetContextKeys.FilterFocused.negate()))),
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1814, "Accept selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1815, "Preview selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
