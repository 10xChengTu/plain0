...
const editorBackground = registerColor("editor.background", {
    light: "#ffffff",
    dark: "#1E1E1E",
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(2334, "Editor background color.")));
const editorForeground = registerColor("editor.foreground", {
    light: "#333333",
    dark: "#BBBBBB",
    hcDark: Color.white,
    hcLight: foreground
}, ( localize(2335, "Editor default foreground color.")));
registerColor("editorStickyScroll.background", editorBackground, ( localize(2336, "Background color of sticky scroll in the editor")));
registerColor("editorStickyScrollGutter.background", editorBackground, ( localize(2337, "Background color of the gutter part of sticky scroll in the editor")));
registerColor("editorStickyScrollHover.background", {
    dark: "#2A2D2E",
    light: "#F0F0F0",
    hcDark: null,
    hcLight: ( ( Color.fromHex("#0F4A85")).transparent(0.1))
}, ( localize(2338, "Background color of sticky scroll on hover in the editor")));
registerColor("editorStickyScroll.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2339, "Border color of sticky scroll in the editor")));
registerColor("editorStickyScroll.shadow", scrollbarShadow, ( localize(2340, " Shadow color of sticky scroll in the editor")));
const editorWidgetBackground = registerColor("editorWidget.background", {
    dark: "#252526",
    light: "#F3F3F3",
    hcDark: "#0C141F",
    hcLight: Color.white
}, ( localize(2341, "Background color of editor widgets, such as find/replace.")));
const editorWidgetForeground = registerColor("editorWidget.foreground", foreground, ( localize(2342, "Foreground color of editor widgets, such as find/replace.")));
...
const editorErrorForeground = registerColor("editorError.foreground", {
    ...
    hcDark: "#F48771",
    hcLight: "#B5200D"
}, ( localize(2346, "Foreground color of error squigglies in the editor.")));
const editorErrorBorder = registerColor("editorError.border", {
    dark: null,
    light: null,
    hcDark: ( ( Color.fromHex("#E47777")).transparent(0.8)),
    hcLight: "#B5200D"
}, ( localize(2347, "If set, color of double underlines for errors in the editor.")));
...
const editorWarningForeground = registerColor("editorWarning.foreground", {
    ...
    hcDark: "#FFD370",
    hcLight: "#895503"
}, ( localize(2349, "Foreground color of warning squigglies in the editor.")));
...
}, ( localize(2350, "If set, color of double underlines for warnings in the editor.")));
...
}, ( localize(2361, "Border color for regions with the same content as the selection.")));
registerColor("editor.compositionBorder", {
    light: "#000000",
    dark: "#ffffff",
    hcLight: "#000000",
    hcDark: "#ffffff"
}, ( localize(2362, "The border color for an IME composition.")));
const editorFindMatch = registerColor("editor.findMatchBackground", {
    light: "#A8AC94",
    dark: "#515C6A",
    hcDark: null,
    hcLight: null
}, ( localize(2363, "Color of the current search match.")));
const editorFindMatchForeground = registerColor("editor.findMatchForeground", null, ( localize(2364, "Text color of the current search match.")));
...
const editorFindMatchHighlightForeground = registerColor("editor.findMatchHighlightForeground", null, ( localize(2366, "Foreground color of the other search matches.")), true);
...
registerColor("editor.findMatchBorder", {
    ...
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2368, "Border color of the current search match.")));
const editorFindMatchHighlightBorder = registerColor("editor.findMatchHighlightBorder", {
    light: null,
    dark: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2369, "Border color of the other search matches.")));
...
const editorHoverBackground = registerColor("editorHoverWidget.background", editorWidgetBackground, ( localize(2372, "Background color of the editor hover.")));
const editorHoverForeground = registerColor("editorHoverWidget.foreground", editorWidgetForeground, ( localize(2373, "Foreground color of the editor hover.")));
const editorHoverBorder = registerColor("editorHoverWidget.border", editorWidgetBorder, ( localize(2374, "Border color of the editor hover.")));
...
}, ( localize(2375, "Background color of the editor hover status bar.")));
const editorInlayHintForeground = registerColor("editorInlayHint.foreground", {
    dark: "#969696",
    light: "#969696",
    hcDark: Color.white,
    hcLight: Color.black
}, ( localize(2376, "Foreground color of inline hints")));
...
const editorLightBulbForeground = registerColor("editorLightBulb.foreground", {
    ...
    hcDark: "#FFCC00",
    hcLight: "#007ACC"
}, ( localize(2382, "The color used for the lightbulb actions icon.")));
registerColor("editorLightBulbAutoFix.foreground", {
    dark: "#75BEFF",
    light: "#007ACC",
    hcDark: "#75BEFF",
    hcLight: "#007ACC"
}, ( localize(2383, "The color used for the lightbulb auto fix actions icon.")));
registerColor("editorLightBulbAi.foreground", editorLightBulbForeground, ( localize(2384, "The color used for the lightbulb AI icon.")));
...
}, ( localize(2385, "Highlight background color of a snippet tabstop.")));
registerColor("editor.snippetTabstopHighlightBorder", null, ( localize(2386, "Highlight border color of a snippet tabstop.")));
registerColor("editor.snippetFinalTabstopHighlightBackground", null, ( localize(2387, "Highlight background color of the final tabstop of a snippet.")));
registerColor("editor.snippetFinalTabstopHighlightBorder", {
    dark: "#525252",
    light: ( new Color(( new RGBA(10, 50, 100, 0.5)))),
    hcDark: "#525252",
    hcLight: "#292929"
}, ( localize(2388, "Highlight border color of the final tabstop of a snippet.")));
...
registerColor("diffEditorGutter.insertedLineBackground", null, ( localize(2393, "Background color for the margin where lines got inserted.")));
registerColor("diffEditorGutter.removedLineBackground", null, ( localize(2394, "Background color for the margin where lines got removed.")));
const diffOverviewRulerInserted = registerColor("diffEditorOverview.insertedForeground", null, ( localize(2395, "Diff overview ruler foreground for inserted content.")));
const diffOverviewRulerRemoved = registerColor("diffEditorOverview.removedForeground", null, ( localize(2396, "Diff overview ruler foreground for removed content.")));
registerColor("diffEditor.insertedTextBorder", {
    dark: null,
    light: null,
    hcDark: "#33ff2eff",
    hcLight: "#374E06"
}, ( localize(2397, "Outline color for the text that got inserted.")));
registerColor("diffEditor.removedTextBorder", {
    dark: null,
    light: null,
    hcDark: "#FF008F",
    hcLight: "#AD0707"
}, ( localize(2398, "Outline color for text that got removed.")));
registerColor("diffEditor.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2399, "Border color between the two text editors.")));
...
registerColor(
    ...
    "sideBar.background",
    ( localize(2401, "The background color of unchanged blocks in the diff editor."))
);
registerColor("diffEditor.unchangedRegionForeground", "foreground", ( localize(2402, "The foreground color of unchanged blocks in the diff editor.")));
registerColor("diffEditor.unchangedCodeBackground", {
    dark: "#74747429",
    light: "#b8b8b829",
    hcDark: null,
    hcLight: null
}, ( localize(2403, "The background color of unchanged code in the diff editor.")));
const widgetShadow = registerColor("widget.shadow", {
    dark: ( transparent(Color.black, .36)),
    light: ( transparent(Color.black, .16)),
    hcDark: null,
    hcLight: null
}, ( localize(2404, "Shadow color of widgets such as find/replace inside the editor.")));
const widgetBorder = registerColor("widget.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2405, "Border color of widgets such as find/replace inside the editor.")));
const toolbarHoverBackground = registerColor("toolbar.hoverBackground", {
    dark: "#5a5d5e50",
    light: "#b8b8b850",
    hcDark: null,
    hcLight: null
}, ( localize(2406, "Toolbar background when hovering over actions using the mouse")));
registerColor("toolbar.hoverOutline", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2407, "Toolbar outline when hovering over actions using the mouse")));
registerColor("toolbar.activeBackground", {
    dark: ( lighten(toolbarHoverBackground, 0.1)),
    light: ( darken(toolbarHoverBackground, 0.1)),
    hcDark: null,
    hcLight: null
}, ( localize(2408, "Toolbar background when holding the mouse over actions")));
const breadcrumbsForeground = registerColor("breadcrumb.foreground", ( transparent(foreground, 0.8)), ( localize(2409, "Color of focused breadcrumb items.")));
const breadcrumbsBackground = registerColor("breadcrumb.background", editorBackground, ( localize(2410, "Background color of breadcrumb items.")));
...
}, ( localize(2409, "Color of focused breadcrumb items.")));
const breadcrumbsActiveSelectionForeground = registerColor("breadcrumb.activeSelectionForeground", {
    light: ( darken(foreground, 0.2)),
    dark: ( lighten(foreground, 0.1)),
    hcDark: ( lighten(foreground, 0.1)),
    hcLight: ( lighten(foreground, 0.1))
}, ( localize(2411, "Color of selected breadcrumb items.")));
const breadcrumbsPickerBackground = registerColor("breadcrumbPicker.background", editorWidgetBackground, ( localize(2412, "Background color of breadcrumb item picker.")));
...
const mergeCurrentHeaderBackground = registerColor("merge.currentHeaderBackground", {
...
registerColor("editorOverviewRuler.currentContentForeground", {
    ...
    hcDark: mergeBorder,
    hcLight: mergeBorder
}, ( localize(2420, "Current overview ruler foreground for inline merge-conflicts.")));
registerColor("editorOverviewRuler.incomingContentForeground", {
    ...
    hcDark: mergeBorder,
    hcLight: mergeBorder
}, ( localize(2421, "Incoming overview ruler foreground for inline merge-conflicts.")));
...
const problemsErrorIconForeground = registerColor("problemsErrorIcon.foreground", editorErrorForeground, ( localize(2425, "The color used for the problems error icon.")));
const problemsWarningIconForeground = registerColor("problemsWarningIcon.foreground", editorWarningForeground, ( localize(2426, "The color used for the problems warning icon.")));
const problemsInfoIconForeground = registerColor("problemsInfoIcon.foreground", editorInfoForeground, ( localize(2427, "The color used for the problems info icon.")));
