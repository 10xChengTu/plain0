...
registerColor("sash.hoverBorder", focusBorder, ( localize(2530, "Border color of active sashes.")));
const badgeBackground = registerColor("badge.background", {
    dark: "#4D4D4D",
    light: "#C4C4C4",
    hcDark: Color.black,
    hcLight: "#0F4A85"
...
const badgeForeground = registerColor("badge.foreground", {
    dark: Color.white,
    light: "#333",
    hcDark: Color.white,
    hcLight: Color.white
...
const activityWarningBadgeForeground = registerColor("activityWarningBadge.foreground", {
    ...
    hcDark: Color.white,
    hcLight: Color.white
}, ( localize(2533, "Foreground color of the warning activity badge")));
const activityWarningBadgeBackground = registerColor("activityWarningBadge.background", {
    dark: "#B27C00",
    light: "#B27C00",
    hcDark: null,
    hcLight: "#B27C00"
}, ( localize(2534, "Background color of the warning activity badge")));
...
}, ( localize(2535, "Foreground color of the error activity badge")));
const activityErrorBadgeBackground = registerColor("activityErrorBadge.background", {
    dark: "#F14C4C",
    light: "#E51400",
    hcDark: null,
    hcLight: "#F14C4C"
}, ( localize(2536, "Background color of the error activity badge")));
const scrollbarShadow = registerColor("scrollbar.shadow", {
    dark: "#000000",
    light: "#DDDDDD",
    hcDark: null,
    hcLight: null
}, ( localize(2537, "Scrollbar shadow to indicate that the view is scrolled.")));
const scrollbarSliderBackground = registerColor("scrollbarSlider.background", {
...
}, ( localize(2538, "Scrollbar slider background color.")));
const scrollbarSliderHoverBackground = registerColor("scrollbarSlider.hoverBackground", {
...
}, ( localize(2539, "Scrollbar slider background color when hovering.")));
const scrollbarSliderActiveBackground = registerColor("scrollbarSlider.activeBackground", {
    dark: ( ( Color.fromHex("#BFBFBF")).transparent(0.4)),
    light: ( ( Color.fromHex("#000000")).transparent(0.6)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2540, "Scrollbar slider background color when clicked on.")));
registerColor("scrollbar.background", null, ( localize(2541, "Scrollbar track background color.")));
const progressBarBackground = registerColor("progressBar.background", {
...
const chartLine = registerColor("chart.line", {
    dark: "#236B8E",
    light: "#236B8E",
    hcDark: "#236B8E",
    hcLight: "#236B8E"
}, ( localize(2543, "Line color for the chart.")));
const chartAxis = registerColor("chart.axis", {
    dark: ( ( Color.fromHex("#BFBFBF")).transparent(0.4)),
    light: ( ( Color.fromHex("#000000")).transparent(0.6)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2544, "Axis color for the chart.")));
const chartGuide = registerColor("chart.guide", {
    dark: ( ( Color.fromHex("#BFBFBF")).transparent(0.2)),
    light: ( ( Color.fromHex("#000000")).transparent(0.2)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2545, "Guide line for the chart.")));
