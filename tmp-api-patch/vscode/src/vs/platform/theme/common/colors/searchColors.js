...
registerColor("search.resultsInfoForeground", {
    light: foreground,
    dark: ( transparent(foreground, 0.65)),
    hcDark: foreground,
    hcLight: foreground
}, ( localize(2556, "Color of the text in the search viewlet's completion message.")));
registerColor("searchEditor.findMatchBackground", {
...
}, ( localize(2557, "Color of the Search Editor query matches.")));
registerColor("searchEditor.findMatchBorder", {
...
}, ( localize(2558, "Border color of the Search Editor query matches.")));
