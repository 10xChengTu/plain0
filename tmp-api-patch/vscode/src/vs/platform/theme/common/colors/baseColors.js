...
const foreground = registerColor("foreground", {
    dark: "#CCCCCC",
    light: "#616161",
    hcDark: "#FFFFFF",
    hcLight: "#292929"
...
const iconForeground = registerColor("icon.foreground", {
    ...
    hcDark: "#FFFFFF",
    hcLight: "#292929"
}, ( localize(2312, "The default color for icons in the workbench.")));
...
const textLinkForeground = registerColor("textLink.foreground", {
    ...
    hcDark: "#21A6FF",
    hcLight: "#0F4A85"
}, ( localize(2317, "Foreground color for links in text.")));
...
registerColor("textSeparator.foreground", {
    ...
    hcDark: Color.black,
    hcLight: "#292929"
}, ( localize(2319, "Color for text separators.")));
registerColor("textPreformat.foreground", {
    light: "#A31515",
    dark: "#D7BA7D",
    hcDark: "#FFFFFF",
    hcLight: "#FFFFFF"
}, ( localize(2320, "Foreground color for preformatted text segments.")));
registerColor("textPreformat.background", {
    light: "#0000001A",
    dark: "#FFFFFF1A",
    hcDark: null,
    hcLight: "#09345f"
}, ( localize(2321, "Background color for preformatted text segments.")));
registerColor("textPreformat.border", {
    light: null,
    dark: null,
    hcDark: contrastBorder,
    hcLight: null
}, ( localize(2322, "Border color for preformatted text segments.")));
registerColor("textBlockQuote.background", {
    light: "#f2f2f2",
    dark: "#222222",
    hcDark: null,
    hcLight: "#F2F2F2"
}, ( localize(2323, "Background color for block quotes in text.")));
registerColor("textBlockQuote.border", {
    light: "#007acc80",
    dark: "#007acc80",
    hcDark: Color.white,
    hcLight: "#292929"
}, ( localize(2324, "Border color for block quotes in text.")));
registerColor("textCodeBlock.background", {
    light: "#dcdcdc66",
    dark: "#0a0a0a66",
    hcDark: Color.black,
    hcLight: "#F2F2F2"
}, ( localize(2325, "Background color for code blocks in text.")));
