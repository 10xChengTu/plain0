...
const listFocusOutline = registerColor("list.focusOutline", {
    dark: focusBorder,
    light: focusBorder,
...
const listActiveSelectionBackground = registerColor("list.activeSelectionBackground", {
    dark: "#04395E",
    light: "#0060C0",
    hcDark: null,
...
const listActiveSelectionForeground = registerColor("list.activeSelectionForeground", {
    dark: Color.white,
    light: Color.white,
    hcDark: null,
    hcLight: null
...
const listInactiveSelectionBackground = registerColor("list.inactiveSelectionBackground", {
    dark: "#37373D",
    light: "#E4E6F1",
    hcDark: null,
    hcLight: ( ( Color.fromHex("#0F4A85")).transparent(0.1))
...
const listHoverBackground = registerColor("list.hoverBackground", {
    dark: "#2A2D2E",
    light: "#F0F0F0",
    hcDark: ( Color.white.transparent(0.1)),
    hcLight: ( ( Color.fromHex("#0F4A85")).transparent(0.1))
}, ( localize(2488, "List/Tree background when hovering over items using the mouse.")));
const listHoverForeground = registerColor("list.hoverForeground", null, ( localize(2489, "List/Tree foreground when hovering over items using the mouse.")));
const listDropOverBackground = registerColor("list.dropBackground", {
    dark: "#062F4A",
    light: "#D6EBFF",
    hcDark: null,
    hcLight: null
...
const listDropBetweenBackground = registerColor("list.dropBetweenBackground", {
    dark: iconForeground,
...
const listHighlightForeground = registerColor("list.highlightForeground", {
    dark: "#2AAAFF",
    light: "#0066BF",
    hcDark: focusBorder,
    hcLight: focusBorder
...
const listFocusHighlightForeground = registerColor("list.focusHighlightForeground", {
...
const listInvalidItemForeground = registerColor("list.invalidItemForeground", {
    dark: "#B89500",
    light: "#B89500",
    hcDark: "#B89500",
    hcLight: "#B5200D"
...
const listErrorForeground = registerColor("list.errorForeground", {
    dark: "#F88070",
    light: "#B01011",
    hcDark: null,
    hcLight: null
}, ( localize(2495, "Foreground color of list items containing errors.")));
const listWarningForeground = registerColor("list.warningForeground", {
    dark: "#CCA700",
    light: "#855F00",
    hcDark: null,
    hcLight: null
}, ( localize(2496, "Foreground color of list items containing warnings.")));
const listFilterWidgetBackground = registerColor("listFilterWidget.background", {
    light: ( darken(editorWidgetBackground, 0)),
    dark: ( lighten(editorWidgetBackground, 0)),
    hcDark: editorWidgetBackground,
    hcLight: editorWidgetBackground
}, ( localize(2497, "Background color of the type filter widget in lists and trees.")));
const listFilterWidgetOutline = registerColor("listFilterWidget.outline", {
    dark: Color.transparent,
    light: Color.transparent,
    hcDark: "#f38518",
    hcLight: "#007ACC"
}, ( localize(2498, "Outline color of the type filter widget in lists and trees.")));
const listFilterWidgetNoMatchesOutline = registerColor("listFilterWidget.noMatchesOutline", {
    dark: "#BE1100",
    light: "#BE1100",
...
const listFilterWidgetShadow = registerColor("listFilterWidget.shadow", widgetShadow, ( localize(2500, "Shadow color of the type filter widget in lists and trees.")));
const listFilterMatchHighlight = registerColor("list.filterMatchBackground", {
    dark: editorFindMatchHighlight,
    light: editorFindMatchHighlight,
    hcDark: null,
    hcLight: null
}, ( localize(2501, "Background color of the filtered match.")));
const listFilterMatchHighlightBorder = registerColor("list.filterMatchBorder", {
    dark: editorFindMatchHighlightBorder,
    light: editorFindMatchHighlightBorder,
    hcDark: contrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2502, "Border color of the filtered match.")));
const listDeemphasizedForeground = registerColor("list.deemphasizedForeground", {
    dark: "#8C8C8C",
    light: "#8E8E90",
    hcDark: "#A7A8A9",
    hcLight: "#666666"
}, ( localize(2503, "List/Tree foreground color for items that are deemphasized.")));
const treeIndentGuidesStroke = registerColor("tree.indentGuidesStroke", {
    dark: "#585858",
    light: "#a9a9a9",
    hcDark: "#a9a9a9",
    hcLight: "#a5a5a5"
}, ( localize(2504, "Tree stroke color for the indentation guides.")));
const treeInactiveIndentGuidesStroke = registerColor("tree.inactiveIndentGuidesStroke", ( transparent(treeIndentGuidesStroke, 0.4)), ( localize(2505, "Tree stroke color for the indentation guides that are not active.")));
const tableColumnsBorder = registerColor("tree.tableColumnsBorder", {
    dark: "#CCCCCC20",
    light: "#61616120",
    hcDark: null,
    hcLight: null
}, ( localize(2506, "Table border color between columns.")));
const tableOddRowsBackgroundColor = registerColor("tree.tableOddRowsBackground", {
    dark: ( transparent(foreground, 0.04)),
    light: ( transparent(foreground, 0.04)),
    hcDark: null,
    hcLight: null
}, ( localize(2507, "Background color for odd table rows.")));
registerColor("editorActionList.background", editorWidgetBackground, ( localize(2508, "Action List background color.")));
const editorActionListForeground = registerColor("editorActionList.foreground", editorWidgetForeground, ( localize(2509, "Action List foreground color.")));
registerColor(
    "editorActionList.focusForeground",
    listActiveSelectionForeground,
    ( localize(2510, "Action List foreground color for the focused item."))
);
registerColor(
    "editorActionList.focusBackground",
    listActiveSelectionBackground,
    ( localize(2511, "Action List background color for the focused item."))
);
