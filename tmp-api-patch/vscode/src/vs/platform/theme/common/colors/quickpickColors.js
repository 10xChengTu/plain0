...
import { listActiveSelectionForeground, listActiveSelectionIconForeground, listActiveSelectionBackground, listFocusHighlightForeground } from './listColors.js';
...
const quickInputTitleBackground = registerColor("quickInputTitle.background", {
...
const pickerGroupForeground = registerColor("pickerGroup.foreground", {
    dark: "#3794FF",
    light: "#0066BF",
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(2549, "Quick picker color for grouping labels.")));
const pickerGroupBorder = registerColor("pickerGroup.border", {
    dark: "#3F3F46",
    light: "#CCCEDB",
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(2550, "Quick picker color for grouping borders.")));
const _deprecatedQuickInputListFocusBackground = registerColor("quickInput.list.focusBackground", null, "", undefined, ( localize(2551, "Please use quickInputList.focusBackground instead")));
const quickInputListFocusForeground = registerColor(
    "quickInputList.focusForeground",
    listActiveSelectionForeground,
    ( localize(2552, "Quick picker foreground color for the focused item."))
);
const quickInputListFocusIconForeground = registerColor(
    "quickInputList.focusIconForeground",
    listActiveSelectionIconForeground,
    ( localize(2553, "Quick picker icon foreground color for the focused item."))
);
const quickInputListFocusBackground = registerColor("quickInputList.focusBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(2554, "Quick picker background color for the focused item.")));
registerColor(
