            ...
            definitions: {
                icons: {
                    ...
                    properties: {
                        ...
                        fontCharacter: {
                            type: "string",
                            description: ( localize(2561, "The font character associated with the icon definition."))
                        }
                    },
...
const widgetClose = registerIcon("widget-close", Codicon.close, ( localize(2562, "Icon for the close action in widgets.")));
registerIcon("goto-previous-location", Codicon.arrowUp, ( localize(2563, "Icon for goto previous editor location.")));
registerIcon("goto-next-location", Codicon.arrowDown, ( localize(2564, "Icon for goto next editor location.")));
const syncing = ThemeIcon.modify(Codicon.sync, "spin");
const spinningLoading = ThemeIcon.modify(Codicon.loading, "spin");

export { Extensions, IconContribution, IconFontDefinition, fontColorRegex, fontFormatRegex, fontIdErrorMessage, fontIdRegex, fontSizeRegex, fontStyleRegex, fontWeightRegex, getIconRegistry, iconsSchemaId, registerIcon, spinningLoading, syncing, widgetClose };
