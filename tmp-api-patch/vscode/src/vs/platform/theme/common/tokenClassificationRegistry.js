...
(function(TokenStyle) {
    ...
    function equals(s1, s2) {
        ...
        return s1 !== undefined && s2 !== undefined && (s1.foreground instanceof Color ? s1.foreground.equals(s2.foreground) : s2.foreground === undefined) && s1.bold === s2.bold && s1.underline === s2.underline && s1.strikethrough === s2.strikethrough && s1.italic === s2.italic;
    }
    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: "object",
                    description: ( localize(2591, "Colors and styles for the token.")),
                    properties: {
                        foreground: {
                            type: "string",
                            description: ( localize(2592, "Foreground color for the token.")),
                            format: "color-hex",
                            default: "#ff0000"
                        },
                        background: {
                            type: "string",
                            deprecationMessage: ( localize(2593, "Token background colors are currently not supported."))
                        },
                        fontStyle: {
                            type: "string",
                            ...
                            defaultSnippets: [{
                                label: ( localize(2596, "None (clear inherited style)")),
                                bodyText: "\"\""
                            }, {
                                body: "italic"
                            }, {
...
function createDefaultTokenClassificationRegistry() {
    ...
    registerTokenType("comment", ( localize(2601, "Style for comments.")), [["comment"]]);
    registerTokenType("string", ( localize(2602, "Style for strings.")), [["string"]]);
    registerTokenType("keyword", ( localize(2603, "Style for keywords.")), [["keyword.control"]]);
    registerTokenType("number", ( localize(2604, "Style for numbers.")), [["constant.numeric"]]);
    registerTokenType("regexp", ( localize(2605, "Style for expressions.")), [["constant.regexp"]]);
    registerTokenType("operator", ( localize(2606, "Style for operators.")), [["keyword.operator"]]);
    registerTokenType("namespace", ( localize(2607, "Style for namespaces.")), [["entity.name.namespace"]]);
    registerTokenType("type", ( localize(2608, "Style for types.")), [["entity.name.type"], ["support.type"]]);
    registerTokenType("struct", ( localize(2609, "Style for structs.")), [["entity.name.type.struct"]]);
    registerTokenType("class", ( localize(2610, "Style for classes.")), [["entity.name.type.class"], ["support.class"]]);
    registerTokenType("interface", ( localize(2611, "Style for interfaces.")), [["entity.name.type.interface"]]);
    registerTokenType("enum", ( localize(2612, "Style for enums.")), [["entity.name.type.enum"]]);
    registerTokenType("typeParameter", ( localize(2613, "Style for type parameters.")), [["entity.name.type.parameter"]]);
    registerTokenType("function", ( localize(2614, "Style for functions")), [["entity.name.function"], ["support.function"]]);
    registerTokenType("member", ( localize(2615, "Style for member functions")), [], "method", "Deprecated use `method` instead");
    registerTokenType("method", ( localize(2616, "Style for method (member functions)")), [["entity.name.function.member"], ["support.function"]]);
    registerTokenType("macro", ( localize(2617, "Style for macros.")), [["entity.name.function.preprocessor"]]);
    registerTokenType("variable", ( localize(2618, "Style for variables.")), [["variable.other.readwrite"], ["entity.name.variable"]]);
    registerTokenType("parameter", ( localize(2619, "Style for parameters.")), [["variable.parameter"]]);
    registerTokenType("property", ( localize(2620, "Style for properties.")), [["variable.other.property"]]);
    registerTokenType("enumMember", ( localize(2621, "Style for enum members.")), [["variable.other.enummember"]]);
    registerTokenType("event", ( localize(2622, "Style for events.")), [["variable.other.event"]]);
    registerTokenType("decorator", ( localize(2623, "Style for decorators & annotations.")), [["entity.name.decorator"], ["entity.name.function"]]);
    registerTokenType("label", ( localize(2624, "Style for labels. ")), undefined);
    registry.registerTokenModifier("declaration", ( localize(2625, "Style for all symbol declarations.")), undefined);
    registry.registerTokenModifier("documentation", ( localize(2626, "Style to use for references in documentation.")), undefined);
    registry.registerTokenModifier("static", ( localize(2627, "Style to use for symbols that are static.")), undefined);
    registry.registerTokenModifier("abstract", ( localize(2628, "Style to use for symbols that are abstract.")), undefined);
    registry.registerTokenModifier("deprecated", ( localize(2629, "Style to use for symbols that are deprecated.")), undefined);
    registry.registerTokenModifier("modification", ( localize(2630, "Style to use for write accesses.")), undefined);
    registry.registerTokenModifier("async", ( localize(2631, "Style to use for symbols that are async.")), undefined);
    registry.registerTokenModifier("readonly", ( localize(2632, "Style to use for symbols that are read-only.")), undefined);
