...
export declare const State: {
    ...
    Idle: (updateType: UpdateType, error?: string, notAvailable?: boolean) => Idle;
    CheckingForUpdates: (explicit: boolean) => CheckingForUpdates;
    AvailableForDownload: (update: IUpdate, canInstall?: boolean) => AvailableForDownload;
    ...
    Updating: (update: IUpdate, explicit: boolean, currentProgress?: number, maxProgress?: number) => Updating;
    Ready: (update: IUpdate, explicit: boolean, overwrite: boolean) => Ready;
    Overwriting: (update: IUpdate, explicit: boolean) => Overwriting;
    Cancelling: Cancelling;
    Restarting: (update: IUpdate) => Restarting;
};
