...
const ExtensionsLocalizedLabel = ( localize2(2007, "Extensions"));
const PreferencesLocalizedLabel = ( localize2(2008, "Preferences"));
...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    id: "extensions",
    order: 30,
    title: ( localize(2009, "Extensions")),
    type: "object",
    properties: {
        [AllowedExtensionsConfigKey]: {
            ...
            defaultSnippets: [{
                body: {},
                description: ( localize(2011, "No extensions are allowed."))
            }, {
                body: {
                    "*": true
                },
                description: ( localize(2012, "All extensions are allowed."))
            }],
            ...
            patternProperties: {
                "([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$": {
                    anyOf: [{
                        ...
                        description: ( localize(2014, "Allow or disallow the extension.")),
                        enumDescriptions: [( localize(2015, "Extension is allowed.")), ( localize(2016, "Extension is not allowed.")), ( localize(2017, "Allow only stable versions of the extension."))]
                    }, {
                        type: "array",
                        items: {
                            type: "string"
                ...
                "([a-z0-9A-Z][a-z0-9-A-Z]*)$": {
                    type: ["boolean", "string"],
                    enum: [true, false, "stable"],
                    description: ( localize(2019, "Allow or disallow all extensions from the publisher.")),
                    enumDescriptions: [( localize(2020, "All extensions from the publisher are allowed.")), ( localize(2021, "All extensions from the publisher are not allowed.")), ( localize(2022, "Allow only stable versions of the extensions from the publisher."))]
                },
                "\\*": {
                    type: "boolean",
                    enum: [true, false],
                    description: ( localize(2023, "Allow or disallow all extensions.")),
                    enumDescriptions: [( localize(2024, "Allow all extensions.")), ( localize(2025, "Disallow all extensions."))]
                }
            }
        }
    }
...
export { AllowedExtensionsConfigKey, DISABLED_EXTENSIONS_STORAGE_PATH, ENABLED_EXTENSIONS_STORAGE_PATH, EXTENSION_IDENTIFIER_PATTERN, EXTENSION_IDENTIFIER_REGEX, EXTENSION_INSTALL_DEP_PACK_CONTEXT, EXTENSION_INSTALL_SKIP_PUBLISHER_TRUST_CONTEXT, EXTENSION_INSTALL_SKIP_WALKTHROUGH_CONTEXT, EXTENSION_INSTALL_SOURCE_CONTEXT, ExtensionGalleryError, ExtensionGalleryErrorCode, ExtensionInstallSource, ExtensionManagementError, ExtensionManagementErrorCode, ExtensionRequestsTimeoutConfigKey, ExtensionSignatureVerificationCode, ExtensionsLocalizedLabel, FilterType, InstallOperation, LANGUAGE_MODEL_CHAT_PROVIDER_EXTENSION_TAG, PreferencesLocalizedLabel, SortBy, SortOrder, StatisticType, TargetPlatformToString, VerifyExtensionSignatureConfigKey, WEB_EXTENSION_TAG, computeSize, getTargetPlatform, isIExtensionIdentifier, isNotWebExtensionInWebTargetPlatform, isTargetPlatformCompatible, shouldRequireRepositorySignatureFor, toTargetPlatform };
