...
import { $ as $$1, append, addStandardDisposableListener, EventType, prepend, isAncestorOfActiveElement, addDisposableListener, isHTMLAnchorElement, isAncestor } from '../../../base/browser/dom.js';
import { ToolBar } from '../../../base/browser/ui/toolbar/toolbar.js';
import { HoverPosition } from '../../../base/browser/ui/hover/hoverWidget.js';
import { IconLabel } from '../../../base/browser/ui/iconLabel/iconLabel.js';
import { KeybindingLabel } from '../../../base/browser/ui/keybindingLabel/keybindingLabel.js';
import { createToggleActionViewItemProvider, Checkbox } from '../../../base/browser/ui/toggle/toggle.js';
import { RenderIndentGuides } from '../../../base/browser/ui/tree/abstractTree.js';
import { TreeVisibility } from '../../../base/browser/ui/tree/tree.js';
import { equals } from '../../../base/common/arrays.js';
import { ThrottledDelayer, disposableTimeout } from '../../../base/common/async.js';
...
class QuickInputAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(2223, "Quick Input");
    }
...
class BaseQuickInputListRenderer extends Disposable {
    ...
    disposeElement(_element, _index, data) {
        if (isAncestorOfActiveElement(data.entry)) {
...
let QuickPickItemElementRenderer = class QuickPickItemElementRenderer extends BaseQuickInputListRenderer {
    ...
    renderElement(node, index, data) {
        ...
        data.entry.classList.toggle(
            ...
            !!element.separator && element.childIndex !== 0
        );
        ...
        if (buttons && buttons.length) {
            const {
                primary,
                secondary
            } = quickInputButtonsToActionArrays(buttons, "quick-input-item", button => element.fireButtonTriggered({
                button,
                item: element.item
            }));
...
QuickPickItemElementRenderer = QuickPickItemElementRenderer_1 = ( __decorate([( __param(2, IContextMenuService)), ( __param(3, IThemeService))], QuickPickItemElementRenderer));
    ...
    renderElement(node, index, data) {
        ...
        if (buttons && buttons.length) {
            const {
                ...
                button => element.fireSeparatorButtonTriggered({
                    button,
...
QuickPickSeparatorElementRenderer = QuickPickSeparatorElementRenderer_1 = ( __decorate([( __param(2, IContextMenuService))], QuickPickSeparatorElementRenderer));
let QuickInputList = class QuickInputList extends Disposable {
    constructor(
        ...
        this._tree = this._register(
            instantiationService.createInstance(WorkbenchObjectTree, "QuickInput", this._container, ( new QuickInputItemDelegate()), [this._itemRenderer, this._separatorRenderer], {
                filter: {
                    filter(element) {
        ...
        this._register(
            this._separatorRenderer.onDidDisposeFocusedElement(() => this._tree.domFocus())
        );
    ...
    _registerOnElementChecked() {
        this._register(
            this._elementCheckedEventBufferer.wrapEvent(this._elementChecked.event, (_, e) => e)(_ => this._updateCheckedObservables())
        );
    }
    ...
    _registerHoverListeners() {
        const delayer = this._register(( new ThrottledDelayer(
    ...
    _registerSeparatorActionShowingListeners() {
        this._register(this._tree.onDidChangeFocus(e => {
            ...
            this._tree.getParentElement(e.elements[0]) : null;
...
Math.floor(maxHeight / 44) * 44 + 6}px` : "";
    ...
    filter(query) {
        ...
        this._setElementsToTree(
            ...
            this._itemElements : this._elementTree
        );
        this._tree.layout();
        return true;
    }
...
QuickInputList.__decorator = ( __decorate([memoize], QuickInputList.prototype, "onDidChangeFocus", null));
QuickInputList.__decorator = ( __decorate([memoize], QuickInputList.prototype, "onDidChangeSelection", null));
QuickInputList = ( __decorate([( __param(5, IInstantiationService)), ( __param(6, IAccessibilityService))], QuickInputList));
