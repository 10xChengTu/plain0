...
class QuickTree extends QuickInput {
    static {
        this.DEFAULT_ARIA_LABEL = ( localize(2229, "Type to narrow down results."));
    }
    constructor(ui) {
        super(ui);
        ...
        this._register(
            ui.tree.onDidChangeCheckedLeafItems(e => this._onDidChangeCheckedLeafItems.fire(e))
        );
        this._register(
            ui.tree.onDidChangeCheckboxState(e => this._onDidChangeCheckboxState.fire(e.item))
        );
    ...
    _registerAutoruns() {
        ...
        this.registerVisibleAutorun(reader => {
            ...
            this.ui.tree.updateFilterOptions({
                matchOnLabel,
                matchOnDescription
            });
        });
