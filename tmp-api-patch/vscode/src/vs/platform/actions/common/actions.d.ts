...
export declare class MenuId {
    ...
    static readonly EditorTitleLayout: MenuId;
    static readonly ModalEditorTitle: MenuId;
    static readonly ModalEditorTitleContext: MenuId;
    ...
    static readonly EditorGroupWatermarkToolbar: MenuId;
     ...
     */
    static readonly EditorTabsBarAddTab: MenuId;
    ...
    static readonly EditorRenderWhitespaceSubmenu: MenuId;
    ...
    static readonly TitleBarAdjacentCenter: MenuId;
    ...
    static readonly ChatSubagentContent: MenuId;
    ...
    static readonly ChatInputStatus: MenuId;
    static readonly ChatInputSide: MenuId;
    static readonly AutomationsDialogInput: MenuId;
    ...
    static readonly ChatEditingSessionTitleToolbar: MenuId;
    static readonly ChatEditingSessionChangesVersionsSubmenu: MenuId;
    static readonly ChatEditingSessionChangesFileHeaderToolbar: MenuId;
    static readonly ChatEditingSessionChangesFileHeaderRightToolbar: MenuId;
    ...
    static readonly BrowserChatActionsMenu: MenuId;
    static readonly BrowserEmulationToolbar: MenuId;
    ...
    static readonly SessionItemContextMenu: MenuId;
    static readonly SessionHeaderContext: MenuId;
    static readonly AgentsTitleBarControlMenu: MenuId;
    static readonly AgentsChangesToolbar: MenuId;
    static readonly AgentsChangesPrimaryActionSubMenu: MenuId;
    static readonly AgentsChangeInlineToolbar: MenuId;
    ...
    static readonly MarkerHoverStatusBar: MenuId;
    /**
