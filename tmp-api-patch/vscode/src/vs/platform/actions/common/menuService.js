...
let MenuService = class MenuService extends Disposable {
...
let PersistedMenuHideState = class PersistedMenuHideState {
    ...
    constructor(_storageService) {
        ...
        this._disposables.add(
            _storageService.onDidChangeValue(StorageScope.PROFILE, PersistedMenuHideState_1._key, this._disposables)(() => {
...
function createMenuHide(menu, command, states) {
    ...
    const hide = toAction({
        id: `hide/${menu.id}/${id}`,
        label: ( localize(1823, "Hide '{0}'", title)),
        run() {
...
function createConfigureKeybindingAction(
    commandService,
    keybindingService,
    commandId,
    when = undefined,
    ...
    return toAction({
        ...
        label: ( localize(1824, "Configure Keybinding")),
        enabled,
        run() {
