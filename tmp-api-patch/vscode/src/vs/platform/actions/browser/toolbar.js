...
let WorkbenchToolBar = class WorkbenchToolBar extends ToolBar {
    constructor(
        ...
        if (telemetrySource) {
            this._store.add(
                this.actionBar.onDidRun(e => telemetryService.publicLog2("workbenchActionExecuted", {
                    id: e.action.id,
    ...
    setActions(_primary, _secondary = [], menuIds) {
        ...
        super.setActions(
            Separator.clean(primary),
            Separator.join(Separator.clean(extraSecondary), secondary)
        );
        if (toggleActions.length > 0 || primary.length > 0) {
            this._sessionDisposables.add(addDisposableListener(this.getElement(), "contextmenu", e => {
                ...
                if (action instanceof MenuItemAction && action.menuKeybinding) {
                    ...
                    primaryActions.push(createConfigureKeybindingAction(
                ...
                if (someAreHidden && menuIds) {
                    ...
                    actions.push(toAction({
                        id: "resetThisMenu",
                        label: ( localize(1821, "Reset Menu")),
...
let MenuWorkbenchToolBar = class MenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    constructor(
        ...
        this._menu = this._store.add(menuService.createMenu(menuId, contextKeyService, {
...
MenuWorkbenchToolBar = ( __decorate([( __param(3, IMenuService)), ( __param(4, IContextKeyService)), ( __param(5, IContextMenuService)), ( __param(6, IKeybindingService)), ( __param(7, ICommandService)), ( __param(8, ITelemetryService)), ( __param(9, IActionViewItemService)), ( __param(10, IInstantiationService))], MenuWorkbenchToolBar));
