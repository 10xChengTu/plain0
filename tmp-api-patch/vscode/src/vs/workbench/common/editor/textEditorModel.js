...
let BaseTextEditorModel = class BaseTextEditorModel extends EditorModel {
    ...
    async doAutoDetectLanguage() {
        if (
        this.hasLanguageSetExplicitly || !this.textEditorModelHandle || !this.languageDetectionService.isEnabledForLanguage(this.getLanguageId() ?? PLAINTEXT_LANGUAGE_ID)) {
            return;
        }
...
BaseTextEditorModel = BaseTextEditorModel_1 = ( __decorate([( __param(0, IModelService)), ( __param(1, ILanguageService)), ( __param(2, ILanguageDetectionService)), ( __param(3, IAccessibilityService))], BaseTextEditorModel));
