...
import { contrastBorder, activeContrastBorder, focusBorder, errorForeground, textLinkForeground } from '../../platform/theme/common/colors/baseColors.js';
import '../../platform/theme/common/colors/chartsColors.js';
import { editorBackground, editorWidgetForeground, editorWidgetBackground, editorInfoForeground, editorForeground, editorWarningForeground, toolbarHoverBackground, widgetBorder, editorErrorForeground } from '../../platform/theme/common/colors/editorColors.js';
...
const OUTPUT_VIEW_BACKGROUND = registerColor("outputView.background", null, ( localize(4423, "Output view background color.")));
registerColor(
    "outputViewStickyScroll.background",
    OUTPUT_VIEW_BACKGROUND,
    ( localize(4424, "Output view sticky scroll background color."))
);
...
registerColor("activityBarTop.background", null, ( localize(4467, "Background color of the activity bar when set to top / bottom.")));
...
const PANEL_TITLE_BADGE_FOREGROUND = registerColor(
...
registerColor("panelInput.border", {
    ...
    hcDark: inputBorder,
    hcLight: inputBorder
}, ( localize(4476, "Input box border for inputs in the panel.")));
...
const PANEL_STICKY_SCROLL_BACKGROUND = registerColor("panelStickyScroll.background", PANEL_BACKGROUND, ( localize(4483, "Background color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_BORDER = registerColor("panelStickyScroll.border", null, ( localize(4484, "Border color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_SHADOW = registerColor("panelStickyScroll.shadow", scrollbarShadow, ( localize(4485, "Shadow color of sticky scroll in the panel.")));
registerColor("browser.border", TAB_BORDER, ( localize(4486, "Border color for integrated browser pages.")));
...
const STATUS_BAR_REMOTE_ITEM_BACKGROUND = registerColor(
    ...
    ACTIVITY_BAR_BADGE_BACKGROUND,
    ( localize(4489, "Background color for the remote indicator on the status bar."))
);
const STATUS_BAR_REMOTE_ITEM_FOREGROUND = registerColor(
    "statusBarItem.remoteForeground",
    ACTIVITY_BAR_BADGE_FOREGROUND,
    ( localize(4490, "Foreground color for the remote indicator on the status bar."))
);
registerColor(
...
registerColor("statusBarItem.offlineBackground", "#6c1717", ( localize(4493, "Status bar item background color when the workbench is offline.")));
registerColor(
    "statusBarItem.offlineForeground",
    STATUS_BAR_REMOTE_ITEM_FOREGROUND,
    ( localize(4494, "Status bar item foreground color when the workbench is offline."))
);
registerColor(
...
const EXTENSION_BADGE_BACKGROUND = registerColor(
    ...
    ACTIVITY_BAR_BADGE_BACKGROUND,
    ( localize(4497, "Background color for the remote badge in the extensions view."))
);
const EXTENSION_BADGE_FOREGROUND = registerColor(
    "extensionBadge.remoteForeground",
    ACTIVITY_BAR_BADGE_FOREGROUND,
    ( localize(4498, "Foreground color for the remote badge in the extensions view."))
);
...
const SIDE_BAR_STICKY_SCROLL_BACKGROUND = registerColor("sideBarStickyScroll.background", SIDE_BAR_BACKGROUND, ( localize(4510, "Background color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_BORDER = registerColor("sideBarStickyScroll.border", null, ( localize(4511, "Border color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_SHADOW = registerColor("sideBarStickyScroll.shadow", scrollbarShadow, ( localize(4512, "Shadow color of sticky scroll in the side bar.")));
const TITLE_BAR_ACTIVE_FOREGROUND = registerColor("titleBar.activeForeground", {
    dark: "#CCCCCC",
    light: "#333333",
    hcDark: "#FFFFFF",
    hcLight: "#292929"
}, ( localize(4513, "Title bar foreground when the window is active.")));
const TITLE_BAR_INACTIVE_FOREGROUND = registerColor("titleBar.inactiveForeground", {
    dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    hcDark: null,
    hcLight: "#292929"
}, ( localize(4514, "Title bar foreground when the window is inactive.")));
const TITLE_BAR_ACTIVE_BACKGROUND = registerColor("titleBar.activeBackground", {
    dark: "#3C3C3C",
    light: "#DDDDDD",
    hcDark: "#000000",
    hcLight: "#FFFFFF"
}, ( localize(4515, "Title bar background when the window is active.")));
const TITLE_BAR_INACTIVE_BACKGROUND = registerColor("titleBar.inactiveBackground", {
    dark: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    hcDark: null,
    hcLight: null
}, ( localize(4516, "Title bar background when the window is inactive.")));
const TITLE_BAR_BORDER = registerColor("titleBar.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(4517, "Title bar border color.")));
const MENUBAR_SELECTION_FOREGROUND = registerColor("menubar.selectionForeground", TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4518, "Foreground color of the selected menu item in the menubar.")));
const MENUBAR_SELECTION_BACKGROUND = registerColor("menubar.selectionBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(4519, "Background color of the selected menu item in the menubar.")));
registerColor("menubar.selectionBorder", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(4520, "Border color of the selected menu item in the menubar.")));
registerColor("commandCenter.foreground", TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4521, "Foreground color of the command center")), false);
registerColor(
    "commandCenter.activeForeground",
    MENUBAR_SELECTION_FOREGROUND,
    ( localize(4522, "Active foreground color of the command center")),
    false
);
registerColor(
    "commandCenter.inactiveForeground",
    TITLE_BAR_INACTIVE_FOREGROUND,
    ( localize(4523, "Foreground color of the command center when the window is inactive")),
    false
);
const COMMAND_CENTER_BACKGROUND = registerColor("commandCenter.background", {
    ...
    hcLight: null
}, ( localize(4524, "Background color of the command center")), false);
...
}, ( localize(4525, "Active background color of the command center")), false);
registerColor("commandCenter.border", {
    ...
    hcLight: contrastBorder
}, ( localize(4526, "Border color of the command center")), false);
...
}, ( localize(4527, "Active border color of the command center")), false);
registerColor("commandCenter.inactiveBorder", ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), ( localize(4528, "Border color of the command center when the window is inactive")), false);
