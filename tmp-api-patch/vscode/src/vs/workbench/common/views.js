...
const VIEWS_LOG_NAME = ( localize(4542, "Views"));
const defaultViewIcon = registerIcon("default-view-icon", Codicon.window, ( localize(4543, "Default view icon.")));
var Extensions;
(function(Extensions) {
...
var WindowEnablement;
(function(WindowEnablement) {
    WindowEnablement[WindowEnablement["Editor"] = 1] = "Editor";
    WindowEnablement[WindowEnablement["Sessions"] = 2] = "Sessions";
    WindowEnablement[WindowEnablement["Both"] = 3] = "Both";
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw ( new Error(( localize(4544, "A view with id '{0}' is already registered", viewDescriptor.id))));
            }
...
class NoTreeViewError extends Error {
    constructor(treeViewId) {
        super(( localize(4545, "No tree view with id '{0}' registered.", treeViewId)));
...
export { Extensions, NoTreeViewError, ResolvableTreeItem, TreeItemCollapsibleState, VIEWS_LOG_ID, VIEWS_LOG_NAME, ViewContainerLocation, ViewContainerLocationToString, ViewContentGroups, ViewVisibilityState, WindowEnablement, defaultViewIcon };
