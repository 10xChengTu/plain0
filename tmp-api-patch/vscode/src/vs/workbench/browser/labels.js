...
import { extractCellOutputDetails } from '../services/notebook/common/notebookDocumentService.js';
...
let ResourceLabels = class ResourceLabels extends Disposable {
    ...
    registerListeners(container) {
        ...
        this._register(
            this.languageService.onDidChange(() => this.widgets.forEach(widget => widget.notifyExtensionsRegistered()))
        );
        ...
        this._register(
            this.themeService.onDidColorThemeChange(() => this.widgets.forEach(widget => widget.notifyThemeChange()))
        );
...
ResourceLabels = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IConfigurationService)), ( __param(3, IModelService)), ( __param(4, IWorkspaceContextService)), ( __param(5, ILanguageService)), ( __param(6, IDecorationsService)), ( __param(7, IThemeService)), ( __param(8, ILabelService)), ( __param(9, ITextFileService))], ResourceLabels));
...
ResourceLabel = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, IConfigurationService)), ( __param(4, IModelService)), ( __param(5, IWorkspaceContextService)), ( __param(6, ILanguageService)), ( __param(7, IDecorationsService)), ( __param(8, IThemeService)), ( __param(9, ILabelService)), ( __param(10, ITextFileService))], ResourceLabel));
var Redraw;
(function(Redraw) {
    ...
    setResource(label, options = Object.create(null)) {
        ...
        if (!options.forceLabel && !isSideBySideEditor && resource?.scheme === Schemas.vscodeNotebookCell) {
            ...
            if (notebookDocument && cellIndex !== undefined && typeof label.name === "string") {
                options.title = ( localize(3233, "{0} • Cell {1}", label.name, `${cellIndex + 1}`));
            }
            if (typeof label.name === "string" && notebookDocument && cellIndex !== undefined && typeof label.name === "string") {
                label.name = ( localize(3233, "{0} • Cell {1}", label.name, `${cellIndex + 1}`));
            }
        }
        if (!options.forceLabel && !isSideBySideEditor && resource?.scheme === Schemas.vscodeNotebookCellOutput) {
            ...
            if (outputUriData?.cellFragment) {
                ...
                if (cellIndex !== undefined && outputIndex !== undefined && typeof label.name === "string") {
                    ...
                    label.name = ( localize(3235, "{0} • Cell {1} • Output", label.name, `${cellIndex + 1}`));
                }
            }
        }
        ...
        if (options.nameSuffix) {
            if (typeof label.name === "string") {
                ...
                label.name = [
                    ...label.name.slice(0, label.name.length - 1),
                    label.name[label.name.length - 1] + options.nameSuffix
                ];
            }
        }
...
ResourceLabelWidget = ( __decorate([( __param(2, ILanguageService)), ( __param(3, IModelService)), ( __param(4, IDecorationsService)), ( __param(5, ILabelService)), ( __param(6, ITextFileService)), ( __param(7, IWorkspaceContextService)), ( __param(8, INotebookDocumentService))], ResourceLabelWidget));
