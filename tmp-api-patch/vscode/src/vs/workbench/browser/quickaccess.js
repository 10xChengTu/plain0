...
const InQuickPickContextKey = ( new RawContextKey(inQuickPickContextKeyValue, false, ( localize(4001, "Whether keyboard focus is inside the quick open control"))));
...
PickerEditorState = ( __decorate([( __param(0, IEditorService)), ( __param(1, IEditorGroupsService))], PickerEditorState));
