...
import * as part from './media/part.css';
import * as floatingPanels from './media/floatingPanels.css';
import { Component } from '../common/component.js';
import { prepend, Dimension, size, getActiveDocument } from '../../base/browser/dom.js';
import { Emitter } from '../../base/common/event.js';
import { assertReturnsDefined } from '../../base/common/types.js';
import { toDisposable } from '../../base/common/lifecycle.js';

registerCss(part);
registerCss(floatingPanels);
...
class PartLayout {
    ...
    static {
        this.TITLE_HEIGHT_STYLE_OVERRIDE = 32;
    }
    static {
