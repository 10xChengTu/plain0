...
let SidebarPart = class SidebarPart extends AbstractPaneCompositePart {
    ...
    constructor(
        ...
        }, SidebarPart_1.activeViewletSettingsKey, ActiveViewletContext.bindTo(contextKeyService), SidebarFocusContext.bindTo(contextKeyService), "sideBar", "viewlet", SIDE_BAR_TITLE_FOREGROUND, SIDE_BAR_TITLE_BORDER, ViewContainerLocation.Sidebar, Extensions.Viewlets, MenuId.SidebarTitle, notificationService, storageService, contextMenuService, layoutService, keybindingService, hoverService, instantiationService, themeService, viewDescriptorService, contextKeyService, extensionService, menuService, configurationService);
        this.minimumWidth = 170;
        this.maximumWidth = Number.POSITIVE_INFINITY;
        this.minimumHeight = 0;
        this.maximumHeight = Number.POSITIVE_INFINITY;
        this.priority = LayoutPriority.Low;
        this.activityBarPart = this._register(
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(3921, "Toggle Activity Bar Visibility"))
                });
            }
            run() {
...
SidebarPart = SidebarPart_1 = ( __decorate([( __param(0, INotificationService)), ( __param(1, IStorageService)), ( __param(2, IContextMenuService)), ( __param(3, IWorkbenchLayoutService)), ( __param(4, IKeybindingService)), ( __param(5, IHoverService)), ( __param(6, IInstantiationService)), ( __param(7, IThemeService)), ( __param(8, IViewDescriptorService)), ( __param(9, IContextKeyService)), ( __param(10, IExtensionService)), ( __param(11, IConfigurationService)), ( __param(12, IMenuService))], SidebarPart));
