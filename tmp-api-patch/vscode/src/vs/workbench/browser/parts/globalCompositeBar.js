...
import { ACTIVITY_BAR_BADGE_FOREGROUND, ACTIVITY_BAR_BADGE_BACKGROUND } from '../../common/theme.js';
import { ICommandService } from '../../../platform/commands/common/commands.service.js';
import { AnchorAxisAlignment, AnchorAlignment } from '../../../base/common/layout.js';
...
let GlobalCompositeBar = class GlobalCompositeBar extends Disposable {
    ...
    static {
        this.ACCOUNTS_ICON = registerIcon("accounts-view-bar-icon", Codicon.account, ( localize(3786, "Accounts icon in the view bar.")));
    }
    constructor(
        ...
        this.globalActivityActionBar = this._register(( new ActionBar(this.element, {
            actionViewItemProvider: (action, options) => {
                ...
                if (action.id === ACCOUNTS_ACTIVITY_ID) {
                    return this.instantiationService.createInstance(AccountsActivityActionViewItem, this.contextMenuActionsProvider, {
                        ...
                        actions.unshift(...[toAction({
                            id: "hideAccounts",
                            label: ( localize(3787, "Hide Accounts")),
            ...
            ariaLabel: ( localize(3788, "Manage")),
    ...
    registerListeners() {
        // Plain intentionally has no accounts surface.
    }
    create(parent) {
...
GlobalCompositeBar = GlobalCompositeBar_1 = ( __decorate([( __param(3, IConfigurationService)), ( __param(4, IInstantiationService)), ( __param(5, IStorageService)), ( __param(6, IExtensionService))], GlobalCompositeBar));
let AbstractGlobalActivityActionViewItem = class AbstractGlobalActivityActionViewItem extends CompositeBarActionViewItem {
    constructor(
        ...
        super(action, {
            ...
            hasPopup: true,
            ...options
        }, () => true, themeService, hoverService, configurationService, keybindingService);
        this.menuId = menuId;
        this.contextMenuActionsProvider = contextMenuActionsProvider;
    ...
    async resolveMainMenuActions(menu, _disposable) {
        return getActionBarActions(menu.getActions({
            renderShortTitle: true
        })).secondary;
    }
};
AbstractGlobalActivityActionViewItem = ( __decorate([( __param(5, IThemeService)), ( __param(6, IHoverService)), ( __param(7, IMenuService)), ( __param(8, IContextMenuService)), ( __param(9, IContextKeyService)), ( __param(10, IConfigurationService)), ( __param(11, IKeybindingService)), ( __param(12, IActivityService))], AbstractGlobalActivityActionViewItem));
let AccountsActivityActionViewItem = class AccountsActivityActionViewItem extends AbstractGlobalActivityActionViewItem {
    ...
    registerListeners() {
        this._register(
            this.authenticationService.onDidRegisterAuthenticationProvider(async e => {
    ...
    async resolveMainMenuActions(accountsMenu, disposables) {
        ...
        if (!this.initialized) {
            const noAccountsAvailableAction = disposables.add(( new Action("noAccountsAvailable", ( localize(3790, "Loading...")), undefined, false)));
            ...
            for (const providerId of registeredProviders) {
                ...
                if (!accounts) {
                    if (( this.problematicProviders.has(providerId))) {
                        const providerUnavailableAction = disposables.add(( new Action("providerUnavailable", ( localize(3791, "{0} is currently unavailable", provider.label)), undefined, false)));
                ...
                for (const account of accounts) {
                    const manageExtensionsAction = toAction({
                        ...
                        label: ( localize(3792, "Manage Trusted Extensions")),
                        enabled: true,
                    ...
                    if (canUseMcp) {
                        const manageMCPAction = toAction({
                            id: `configureSessions${account.label}`,
                            label: ( localize(3793, "Manage Trusted MCP Servers")),
                            enabled: true,
                            run: () => this.commandService.executeCommand("_manageTrustedMCPServersForAccount", {
                                providerId,
                                accountLabel: account.label
                            })
                        });
            ...
            for (const providerId of dynamicProviders) {
                ...
                const manageDynamicAuthProvidersAction = toAction({
                    ...
                    label: ( localize(3795, "Manage Dynamic Authentication Providers...")),
                    enabled: true,
    ...
    async addOrUpdateAccount(providerId, account) {
        ...
        let canSignOut = true;
        if (
        sessionFromEmbedder && !sessionFromEmbedder.canSignOut && (
        (await this.authenticationService.getSessions(providerId)).some(s => s.id === sessionFromEmbedder.id && s.account.id === account.id))) {
            canSignOut = false;
        }
...
AccountsActivityActionViewItem = ( __decorate([( __param(4, IThemeService)), ( __param(5, ILifecycleService)), ( __param(6, IHoverService)), ( __param(7, IContextMenuService)), ( __param(8, IMenuService)), ( __param(9, IContextKeyService)), ( __param(10, IAuthenticationService)), ( __param(11, IWorkbenchEnvironmentService)), ( __param(12, IProductService)), ( __param(13, IConfigurationService)), ( __param(14, IKeybindingService)), ( __param(15, ISecretStorageService)), ( __param(16, ILogService)), ( __param(17, IActivityService)), ( __param(18, IInstantiationService)), ( __param(19, ICommandService))], AccountsActivityActionViewItem));
let GlobalActivityActionViewItem = class GlobalActivityActionViewItem extends AbstractGlobalActivityActionViewItem {
    constructor(
        ...
        const action = instantiationService.createInstance(CompositeBarAction, {
            ...
            name: ( localize(3788, "Manage")),
            classNames: ThemeIcon.asClassNameArray(
                userDataProfileService.currentProfile.icon ? ThemeIcon.fromId(userDataProfileService.currentProfile.icon) : DEFAULT_ICON
            )
        });
        super(
...
GlobalActivityActionViewItem = ( __decorate([( __param(3, IUserDataProfileService)), ( __param(4, IThemeService)), ( __param(5, IHoverService)), ( __param(6, IMenuService)), ( __param(7, IContextMenuService)), ( __param(8, IContextKeyService)), ( __param(9, IConfigurationService)), ( __param(10, IWorkbenchEnvironmentService)), ( __param(11, IKeybindingService)), ( __param(12, IInstantiationService)), ( __param(13, IActivityService))], GlobalActivityActionViewItem));
...
SimpleAccountActivityActionViewItem = ( __decorate([( __param(2, IThemeService)), ( __param(3, ILifecycleService)), ( __param(4, IHoverService)), ( __param(5, IContextMenuService)), ( __param(6, IMenuService)), ( __param(7, IContextKeyService)), ( __param(8, IAuthenticationService)), ( __param(9, IWorkbenchEnvironmentService)), ( __param(10, IProductService)), ( __param(11, IConfigurationService)), ( __param(12, IKeybindingService)), ( __param(13, ISecretStorageService)), ( __param(14, IStorageService)), ( __param(15, ILogService)), ( __param(16, IActivityService)), ( __param(17, IInstantiationService)), ( __param(18, ICommandService))], SimpleAccountActivityActionViewItem));
...
SimpleGlobalActivityActionViewItem = ( __decorate([( __param(2, IUserDataProfileService)), ( __param(3, IThemeService)), ( __param(4, IHoverService)), ( __param(5, IMenuService)), ( __param(6, IContextMenuService)), ( __param(7, IContextKeyService)), ( __param(8, IConfigurationService)), ( __param(9, IWorkbenchEnvironmentService)), ( __param(10, IKeybindingService)), ( __param(11, IInstantiationService)), ( __param(12, IActivityService)), ( __param(13, IStorageService))], SimpleGlobalActivityActionViewItem));
function simpleActivityContextMenuActions(storageService, isAccount) {
    return [toAction({
        id: "toggle.hideManage",
        label: ( localize(3788, "Manage")),
        checked: true,
        enabled: false,
        run: () => {
