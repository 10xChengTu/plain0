...
import * as paneCompositePart from './media/paneCompositePart.css';
import { Event } from '../../../base/common/event.js';
import { IInstantiationService } from '../../../platform/instantiation/common/instantiation.js';
import { IViewDescriptorService } from '../../common/views.service.js';
import { DisposableStore, MutableDisposable } from '../../../base/common/lifecycle.js';
import { getFloatingOuterGutterEdges, getFloatingSidebarSiblingToEditorStatus, Parts, Position, FLOATING_PANEL_MARGIN } from '../../services/layout/browser/layoutService.js';
...
import { trackFocus, $, EventHelper, addDisposableListener, EventType, getWindow, prepend, Dimension } from '../../../base/browser/dom.js';
...
let AbstractPaneCompositePart = class AbstractPaneCompositePart extends CompositePart {
    ...
    createEmptyPaneMessage(parent) {
        ...
        messageElement.textContent = ( localize(3875, "Drag a view here to display."));
    ...
    createTitleArea(parent) {
        ...
        this.globalToolBar = this._register(this.instantiationService.createInstance(
            ...
            this.globalActionsMenuId,
            {
                ...
                toggleMenuTitle: ( localize(3876, "More Actions...")),
    ...
    isSidebarSiblingToEditor() {
        const {
            sideBar,
            auxBar
        } = getFloatingSidebarSiblingToEditorStatus(this.layoutService);
        return this.partId === Parts.SIDEBAR_PART ? sideBar : auxBar;
    }
    getFloatingPartTopMargin(panelVisible, margin) {
        if (this.partId === Parts.PANEL_PART && this.layoutService.getPanelPosition() === Position.BOTTOM) {
            return margin;
        }
        if (panelVisible && this.layoutService.getPanelPosition() === Position.TOP && (this.partId === Parts.SIDEBAR_PART || this.partId === Parts.AUXILIARYBAR_PART) && this.isSidebarSiblingToEditor()) {
            return margin;
        }
        return 0;
    }
    isFloatingPartAtWindowBottomEdge(panelVisible) {
        ...
        if (panelAtBottom && (this.partId === Parts.SIDEBAR_PART || this.partId === Parts.AUXILIARYBAR_PART) && this.isSidebarSiblingToEditor()) {
            return false;
        }
        return true;
    }
    getFloatingInset() {
        ...
        const bottomMargin = !this.layoutService.isVisible(Parts.STATUSBAR_PART, getWindow(this.element)) && isAtWindowBottom ? margin * 2 : margin;
        const outerGutter = this.getFloatingOuterGutterEdges();
    ...
    getViewsSubmenuAction() {
        ...
        if (viewPaneContainer) {
            ...
            disposables.dispose();
            return viewsActions.length > 1 && ( viewsActions.some(a => a.enabled)) ? ( new SubmenuAction("views", ( localize(3877, "Views")), viewsActions)) : undefined;
        }
        return undefined;
    }
};
AbstractPaneCompositePart = AbstractPaneCompositePart_1 = ( __decorate([( __param(12, INotificationService)), ( __param(13, IStorageService)), ( __param(14, IContextMenuService)), ( __param(15, IWorkbenchLayoutService)), ( __param(16, IKeybindingService)), ( __param(17, IHoverService)), ( __param(18, IInstantiationService)), ( __param(19, IThemeService)), ( __param(20, IViewDescriptorService)), ( __param(21, IContextKeyService)), ( __param(22, IExtensionService)), ( __param(23, IMenuService)), ( __param(24, IConfigurationService))], AbstractPaneCompositePart));
