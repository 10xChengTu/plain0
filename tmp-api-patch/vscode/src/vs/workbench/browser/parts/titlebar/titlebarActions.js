...
import { IsCompactTitleBarContext, TitleBarStyleContext, IsMainWindowFullscreenContext, TitleBarVisibleContext } from '../../../common/contextkeys.js';
import { TitlebarStyle, TitleBarSetting, CustomTitleBarVisibility } from '../../../../platform/window/common/window.js';
...
registerAction2(class ToggleCommandCenter extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.COMMAND_CENTER, ( localize(3951, "Command Center")), ( localize(3952, "Toggle visibility of the Command Center in title bar")), 1, ( IsCompactTitleBarContext.toNegated()));
    }
});
registerAction2(class ToggleNavigationControl extends ToggleTitleBarConfigAction {
    constructor() {
        super("workbench.navigationControl.enabled", ( localize(3953, "Navigation Controls")), ( localize(3954, "Toggle visibility of the Navigation Controls in title bar")), 2, ( ContextKeyExpr.and(( IsCompactTitleBarContext.toNegated()), ( ContextKeyExpr.has(`config.${LayoutSettings.COMMAND_CENTER}`)))));
    }
});
registerAction2(class ToggleLayoutControl extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.LAYOUT_ACTIONS, ( localize(3955, "Layout Controls")), ( localize(3956, "Toggle visibility of the Layout Controls in title bar")), 4);
    }
});
registerAction2(class ToggleNotificationsButton extends ToggleTitleBarConfigAction {
    constructor() {
        super(NotificationsSettings.NOTIFICATIONS_BUTTON, ( localize(3957, "Notifications")), ( localize(3958, "Toggle visibility of the Notifications button in title bar")), 5, ( ContextKeyExpr.equals(
            `config.${NotificationsSettings.NOTIFICATIONS_POSITION}`,
...
registerAction2(class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3959, "Hide Custom Title Bar")),
            menu: [{
                id: MenuId.TitleBarContext,
                order: 0,
...
registerAction2(class ToggleCustomTitleBarWindowed extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3960, "Hide Custom Title Bar In Full Screen")),
            menu: [{
                id: MenuId.TitleBarContext,
                order: 1,
...
class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3961, "Custom Title Bar")),
...
registerAction2(class ShowCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3962, "Show Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3963, "Hide Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3964, "Hide Custom Title Bar In Full Screen")),
...
registerAction2(class ToggleEditorActions extends Action2 {
    ...
    constructor() {
        ...
        super({
            ...
            title: ( localize(3965, "Editor Actions")),
...
const ACCOUNTS_ACTIVITY_TILE_ACTION = {
    ...
    label: ( localize(3966, "Accounts")),
    tooltip: ( localize(3966, "Accounts")),
    class: undefined,
    enabled: true,
    run: function() {}
};
const GLOBAL_ACTIVITY_TITLE_ACTION = {
    ...
    label: ( localize(3967, "Manage")),
    tooltip: ( localize(3967, "Manage")),
    class: undefined,
    enabled: true,
    run: function() {}
};

export { ACCOUNTS_ACTIVITY_TILE_ACTION, GLOBAL_ACTIVITY_TITLE_ACTION, TitleBarLeadingActionsGroup, ToggleTitleBarConfigAction };
