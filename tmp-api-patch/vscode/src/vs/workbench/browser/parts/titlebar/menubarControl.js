...
import * as menubarControl from './media/menubarControl.css';
import { localize, localize2 } from '../../../../nls.js';
import { MenuId, SubmenuItemAction, registerAction2, Action2, MenuItemAction } from '../../../../platform/actions/common/actions.js';
import { IMenuService } from '../../../../platform/actions/common/actions.service.js';
import { MenuSettings, getMenuBarVisibility, hasNativeMenu } from '../../../../platform/window/common/window.js';
import { IContextKeyService } from '../../../../platform/contextkey/common/contextkey.service.js';
import { Separator, toAction, ActionRunner, SubmenuAction, Action } from '../../../../base/common/actions.js';
...
class MenubarControl extends Disposable {
    ...
    constructor(
        ...
        this.mainMenu = this._register(
            this.menuService.createMenu(MenuId.MenubarMainMenu, this.contextKeyService)
        );
        ...
        for (const mainMenuAction of mainMenuActions) {
            if (mainMenuAction instanceof SubmenuItemAction && typeof mainMenuAction.item.title !== "string") {
                this.menus[mainMenuAction.item.title.original] = this.mainMenuDisposables.add(
                    this.menuService.createMenu(mainMenuAction.item.submenu, this.contextKeyService, {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        this.notificationService.prompt(Severity$1.Info, message, [{
            label: ( localize(3941, "Open Settings")),
            run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(3942, "Focus Application Menu")),
                    keybinding: {
...
let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
    constructor(
        ...
        this.visible = true;
        this.webNavigationMenu = this._register(
    ...
    getUpdateAction() {
        ...
        case StateType.Idle:
            return toAction({
                id: "update.check",
                label: ( localize(3943, "Check for &&Updates...")),
                enabled: true,
        ...
        case StateType.CheckingForUpdates:
            return toAction({
                id: "update.checking",
                label: ( localize(3944, "Checking for Updates...")),
                enabled: false,
                run: () => {}
            });
        case StateType.AvailableForDownload:
            return toAction({
                ...
                label: ( localize(3945, "D&&ownload Update")),
                enabled: true,
        ...
        case StateType.Overwriting:
            return toAction({
                ...
                label: ( localize(3946, "Downloading Update...")),
                enabled: false,
                run: () => {}
            });
        case StateType.Downloaded:
            return isMacintosh ? null : toAction({
                id: "update.install",
                label: ( localize(3947, "Install &&Update...")),
                enabled: true,
        ...
        case StateType.Updating:
            return toAction({
                id: "update.updating",
                label: ( localize(3948, "Installing Update...")),
                enabled: false,
                run: () => {}
            });
        case StateType.Cancelling:
            return toAction({
                ...
                label: ( localize(3949, "Cancelling Update...")),
                enabled: false,
                run: () => {}
            });
        case StateType.Ready:
            return toAction({
                id: "update.restart",
                label: ( localize(3950, "Restart to &&Update")),
                enabled: true,
    ...
    toActionsArray(menu) {
        return getFlatContextMenuActions(menu.getActions({
...
CustomMenubarControl = ( __decorate([( __param(0, IMenuService)), ( __param(1, IWorkspacesService)), ( __param(2, IContextKeyService)), ( __param(3, IKeybindingService)), ( __param(4, IConfigurationService)), ( __param(5, ILabelService)), ( __param(6, IUpdateService)), ( __param(7, IStorageService)), ( __param(8, INotificationService)), ( __param(9, IPreferencesService)), ( __param(10, IWorkbenchEnvironmentService)), ( __param(11, IAccessibilityService)), ( __param(12, ITelemetryService)), ( __param(13, IHostService)), ( __param(14, ICommandService))], CustomMenubarControl));
