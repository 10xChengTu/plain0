...
export declare abstract class AbstractPaneCompositePart extends CompositePart<PaneComposite> implements IPaneCompositePart {
    ...
    private floatingLayoutDimension;
     ...
     */
    private getFloatingOuterGutterEdges;
     ...
     */
    private isSidebarSiblingToEditor;
    /**
     ...
     */
    private getFloatingPartTopMargin;
    /**
     ...
     */
    private isFloatingPartAtWindowBottomEdge;
    /**
