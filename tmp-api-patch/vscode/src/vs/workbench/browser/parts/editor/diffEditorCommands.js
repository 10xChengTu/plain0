...
import { TextCompareEditorVisibleContext, ActiveCustomEditorDiffCanToggleLayoutContext, TextCompareEditorActiveContext, ActiveCompareEditorCanSwapContext } from '../../../common/contextkeys.js';
import { DiffEditorInput } from '../../../common/editor/diffEditorInput.js';
import { IEditorService } from '../../../services/editor/common/editorService.service.js';
import { EditorResourceAccessor, SideBySideEditor, isDiffEditorInput } from '../../../common/editor.js';
...
function registerDiffEditorCommands() {
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: DIFF_OPEN_SIDE,
            title: ( localize2(3367, "Open Active Diff Side"))
        }
    });
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        id: GOTO_NEXT_CHANGE,
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_NEXT_CHANGE,
            title: ( localize2(3368, "Go to Next Change"))
        }
    });
    KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_PREVIOUS_CHANGE,
            title: ( localize2(3369, "Go to Previous Change"))
        }
    });
    ...
    function getActiveDiffModifiedResource(accessor, args) {
        ...
        if (ActiveCustomEditorDiffCanToggleLayoutContext.getValue(contextKeyService)) {
            const activeCustomDiffModifiedResource = EditorResourceAccessor.getOriginalUri(editorService.activeEditor, {
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: TOGGLE_DIFF_SIDE_BY_SIDE,
            title: ( localize2(3370, "Toggle Inline View")),
            category: ( localize(3371, "Compare"))
        },
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: DIFF_SWAP_SIDES,
            title: ( localize2(3372, "Swap Left and Right Editor Side")),
            category: ( localize(3371, "Compare"))
        },
