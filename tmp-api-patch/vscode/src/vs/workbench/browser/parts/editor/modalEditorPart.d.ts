...
declare class ModalEditorPartImpl extends EditorPart implements IModalEditorPart {
    ...
    private readonly modalContextKeyService;
    ...
    readonly onDidRequestLayout: Event<void>;
    ...
    set size(value: IDimension | undefined);
    private _position;
    get position(): IPosition | undefined;
    set position(value: IPosition | undefined);
    private _sidebarWidth;
    get sidebarWidth(): number | undefined;
    set sidebarWidth(value: number | undefined);
    private _sidebarHidden;
    get sidebarHidden(): boolean;
    set sidebarHidden(value: boolean);
    private _hasSidebar;
    get hasSidebar(): boolean;
    set hasSidebar(value: boolean);
    private readonly _onDidToggleSidebar;
    readonly onDidToggleSidebar: Event<void>;
    private savedSize;
