...
import * as sidebysideeditor from './media/sidebysideeditor.css';
...
let SideBySideEditor = class SideBySideEditor extends AbstractEditorWithViewState {
    static {
        SideBySideEditor_1 = this;
    }
    static {
        this.ID = SIDE_BY_SIDE_EDITOR_ID;
    }
    static {
    ...
    constructor(
        ...
        super(
            SideBySideEditor_1.ID,
            group,
            SideBySideEditor_1.VIEW_STATE_PREFERENCE_KEY,
            telemetryService,
            instantiationService,
            storageService,
            textResourceConfigurationService,
    ...
    createSplitView(parent, ratio) {
        this.splitview = this.splitviewDisposables.add(( new SplitView(parent, {
    ...
    getTitle() {
        ...
        return localize(3780, "Side by Side Editor");
    }
    async setInput(input, options, context, token) {
        ...
        const {
            ...
            secondary,
            viewState
        } = this.loadViewState(input, options, context);
    ...
    createEditors(newInput) {
        ...
        this.editorDisposables.add(
            this.primaryEditorPane.onDidFocus(() => this.onDidFocusChange(SideBySideEditor$1.PRIMARY))
        );
        this.editorDisposables.add(
            this.secondaryEditorPane.onDidFocus(() => this.onDidFocusChange(SideBySideEditor$1.SECONDARY))
        );
    }
...
SideBySideEditor = SideBySideEditor_1 = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IInstantiationService)), ( __param(3, IThemeService)), ( __param(4, IStorageService)), ( __param(5, IConfigurationService)), ( __param(6, ITextResourceConfigurationService)), ( __param(7, IEditorService)), ( __param(8, IEditorGroupsService))], SideBySideEditor));
