...
import { GroupsOrder, GroupActivationReason, GroupDirection } from '../../../services/editor/common/editorGroupsService.js';
import { IEditorService } from '../../../services/editor/common/editorService.service.js';
import { IHostService } from '../../../services/host/browser/host.service.js';
import { shouldShowCustomTitleBar, Parts } from '../../../services/layout/browser/layoutService.js';
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3304, "Toggle Window Compact Mode")),
    ...
    async run() {
        compactWindowEmitter.fire({
            windowId: getActiveWindow().vscodeWindowId,
            compact: "toggle"
        });
    }
});
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3305, "Turn On Compact Mode")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3306, "Turn Off Compact Mode")),
...
let AuxiliaryEditorPart = class AuxiliaryEditorPart {
    ...
    async create(label, options) {
        ...
        function updateCompact(newCompact) {
            ...
            titlebarPart?.updateOptions({
                compact
            });
            editorPart.updateOptions({
                compact
            });
        ...
        const editorPartContainer = $(".part.editor", {
            role: "main"
        });
        ...
        if (useCustomTitle) {
            titlebarPart = disposables.add(this.titleService.createAuxiliaryTitlebarPart(
                auxiliaryWindow.container,
                editorPart,
                scopedEditorPartInstantiationService
            ));
            titlebarPart.updateOptions({
                compact
            });
            ...
            disposables.add(
                this.layoutService.onDidChangePartVisibility(() => handleTitleBarVisibilityEvent())
            );
            ...
            disposables.add(
                scopedEditorPartInstantiationService.createInstance(WindowTitle, auxiliaryWindow.window)
            );
        }
        const statusbarPart = disposables.add(
            this.statusbarService.createAuxiliaryStatusbarPart(auxiliaryWindow.container, scopedEditorPartInstantiationService)
        );
        ...
        disposables.add(
            Event.once(this.lifecycleService.onDidShutdown)(() => disposables.dispose())
        );
...
AuxiliaryEditorPart = AuxiliaryEditorPart_1 = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IAuxiliaryWindowService)), ( __param(3, ILifecycleService)), ( __param(4, IConfigurationService)), ( __param(5, IStatusbarService)), ( __param(6, ITitleService)), ( __param(7, IEditorService)), ( __param(8, IWorkbenchLayoutService))], AuxiliaryEditorPart));
...
AuxiliaryEditorPartImpl = AuxiliaryEditorPartImpl_1 = ( __decorate([( __param(4, IInstantiationService)), ( __param(5, IThemeService)), ( __param(6, IConfigurationService)), ( __param(7, IStorageService)), ( __param(8, IWorkbenchLayoutService)), ( __param(9, IHostService)), ( __param(10, IContextKeyService))], AuxiliaryEditorPartImpl));
