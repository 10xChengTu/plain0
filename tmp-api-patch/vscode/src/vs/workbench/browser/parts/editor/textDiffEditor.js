...
import { assertReturnsDefined, isObject } from '../../../../base/common/types.js';
...
let TextDiffEditor = class TextDiffEditor extends AbstractTextEditor {
    static {
        TextDiffEditor_1 = this;
    }
    static {
        this.ID = TEXT_DIFF_EDITOR_ID;
    }
    ...
    getTitle() {
        ...
        return localize(3782, "Text Diff Editor");
    }
    createEditorControl(parent, configuration) {
        this.diffEditorControl = this._register(
            this.instantiationService.createInstance(DiffEditorWidget, parent, configuration, {})
        );
    }
...
TextDiffEditor = TextDiffEditor_1 = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IInstantiationService)), ( __param(3, IStorageService)), ( __param(4, ITextResourceConfigurationService)), ( __param(5, IEditorService)), ( __param(6, IThemeService)), ( __param(7, IEditorGroupsService)), ( __param(8, IFileService)), ( __param(9, IPreferencesService))], TextDiffEditor));
