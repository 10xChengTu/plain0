...
import { CloseDirection, EditorsOrder, EditorInputCapabilities, SaveReason, EditorResourceAccessor } from '../../../common/editor.js';
...
import { splitEditor, SPLIT_EDITOR, SPLIT_EDITOR_LEFT, SPLIT_EDITOR_RIGHT, SPLIT_EDITOR_UP, SPLIT_EDITOR_DOWN, CLOSE_EDITOR_COMMAND_ID, UNPIN_EDITOR_COMMAND_ID, TOGGLE_MAXIMIZE_EDITOR_GROUP, MOVE_ACTIVE_EDITOR_COMMAND_ID, MOVE_EDITOR_INTO_ABOVE_GROUP, MOVE_EDITOR_INTO_BELOW_GROUP, MOVE_EDITOR_INTO_LEFT_GROUP, MOVE_EDITOR_INTO_RIGHT_GROUP, COPY_ACTIVE_EDITOR_COMMAND_ID, LAYOUT_EDITOR_GROUPS_COMMAND_ID, REOPEN_ACTIVE_EDITOR_WITH_COMMAND_ID, MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, NEW_EMPTY_EDITOR_WINDOW_COMMAND_ID } from './editorCommands.js';
import { preferredSideBySideGroupDirection, GroupDirection, GroupLocation, GroupsOrder, GroupsArrangement, GroupOrientation, MergeGroupMode } from '../../../services/editor/common/editorGroupsService.js';
...
import { MultipleEditorGroupsContext, SideBarVisibleContext, AuxiliaryBarVisibleContext, EditorPartMaximizedEditorGroupContext, EditorPartMultipleEditorGroupsContext, ActiveEditorGroupEmptyContext, InAutomationContext, ActiveEditorAvailableEditorIdsContext, ActiveEditorContext, IsAuxiliaryWindowFocusedContext } from '../../../common/contextkeys.js';
...
class SplitEditorAction extends AbstractSplitEditorAction {
    static {
        this.ID = SPLIT_EDITOR;
    }
    constructor() {
        super({
            id: SplitEditorAction.ID,
            title: ( localize2(3509, "Split Editor")),
            f1: true,
            keybinding: {
...
class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3510, "Split Editor Orthogonal")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3511, "Split Editor Left")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3512, "Split Editor Right")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorUpAction extends ExecuteCommandAction {
    static {
        this.LABEL = ( localize(3513, "Split Editor Up"));
    }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: ( localize2(3513, "Split Editor Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorDownAction extends ExecuteCommandAction {
    static {
        this.LABEL = ( localize(3514, "Split Editor Down"));
    }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: ( localize2(3514, "Split Editor Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3515, "Join Editor Group with Next Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3516, "Join All Editor Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3517, "Navigate Between Editor Groups")),
            f1: true,
            category: Categories.View
        });
    }
    async run(accessor) {
        ...
        }, editorGroupService.activeGroup, true);
        nextGroup?.focus();
    }
}
class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3518, "Focus Active Editor Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3519, "Focus First Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3520, "Focus Last Editor Group")),
            f1: true,
            category: Categories.View
        }, {
...
class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3521, "Focus Next Editor Group")),
            f1: true,
            category: Categories.View
        }, {
            location: GroupLocation.NEXT
...
class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3522, "Focus Previous Editor Group")),
            f1: true,
            category: Categories.View
        }, {
...
class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3523, "Focus Left Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3524, "Focus Right Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3525, "Focus Editor Group Above")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3526, "Focus Editor Group Below")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static {
        this.LABEL = ( localize(3527, "Close Editor"));
    }
...
CloseEditorAction = ( __decorate([( __param(2, ICommandService))], CloseEditorAction));
let UnpinEditorAction = class UnpinEditorAction extends Action {
    static {
        this.ID = "workbench.action.unpinActiveEditor";
    }
    static {
        this.LABEL = ( localize(3528, "Unpin Editor"));
    }
    constructor(id, label, commandService) {
...
UnpinEditorAction = ( __decorate([( __param(2, ICommandService))], UnpinEditorAction));
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static {
        this.ID = "workbench.action.closeActiveEditor";
    }
    static {
        this.LABEL = ( localize(3529, "Close"));
    }
...
CloseEditorTabAction = ( __decorate([( __param(2, IEditorGroupsService))], CloseEditorTabAction));
class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            id: "workbench.action.revertAndCloseActiveEditor",
            title: ( localize2(3530, "Revert and Close Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3531, "Close Editors to the Left in Group")),
            f1: true,
            category: Categories.View
        });
    }
    async run(accessor, context) {
        ...
        const {
            group,
            editor
        } = this.getTarget(editorGroupService, context);
        if (group && editor) {
...
class AbstractCloseAllAction extends Action2 {
    ...
    async run(accessor) {
        ...
        for (const {
            editor,
            groupId
        } of editorService.getEditors(EditorsOrder.SEQUENTIAL, {
            ...
            if (typeof editor.closeHandler?.confirm === "function") {
                ...
                dirtyAutoSaveOnFocusChangeEditors.add({
                    editor,
                    groupId
                });
            }
                ...
                dirtyAutoSaveOnWindowChangeEditors.add({
                    editor,
                    groupId
                });
            }
            else {
                dirtyEditorsWithDefaultConfirm.add({
                    editor,
                    groupId
                });
            }
        ...
        if (dirtyEditorsWithDefaultConfirm.size > 0) {
            ...
            const confirmation = await fileDialogService.showSaveConfirm(( editors.map((
                {
                    editor
                }
            ) => {
    ...
    revertEditors(editorService, logService, progressService, editors) {
        return progressService.withProgress({
            ...
            delay: 800,
            title: ( localize(3532, "Reverting Editors..."))
    ...
    async doCloseAll(editorGroupService) {
        await Promise.all(( this.groupsToClose(editorGroupService).map(group => group.closeAllEditors({
            excludeSticky: this.excludeSticky
        }))));
    }
}
class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static {
        this.LABEL = ( localize2(3533, "Close All Editors"));
    }
    constructor() {
        super({
...
class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: ( localize2(3534, "Close All Editor Groups")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(
                    KeyMod$1.CtrlCmd | KeyCode.KeyK,
                    KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyW
                )
            },
            category: Categories.View
        });
...
class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3535, "Close Editors in Other Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3536, "Close Editor in All Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3537, "Move Editor Group Left")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3538, "Move Editor Group Right")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3539, "Move Editor Group Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3540, "Move Editor Group Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3541, "Duplicate Editor Group Left")),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3542, "Duplicate Editor Group Right")),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3543, "Duplicate Editor Group Up")),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3544, "Duplicate Editor Group Down")),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3545, "Expand Editor Group")),
            f1: true,
            category: Categories.View,
...
class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3546, "Expand Editor Group and Hide Side Bars")),
            f1: true,
            category: Categories.View,
...
class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3547, "Reset Editor Group Sizes")),
            f1: true,
            category: Categories.View
        });
    }
...
class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3548, "Toggle Editor Group Sizes")),
            f1: true,
            category: Categories.View
        });
    }
...
class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3549, "Maximize Editor Group and Hide Side Bars")),
            f1: true,
            category: Categories.View,
...
class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3550, "Toggle Maximize Editor Group")),
            f1: true,
            category: Categories.View,
            precondition: ( ContextKeyExpr.or(
            ...
            toggled: {
                ...
                title: ( localize(3551, "Unmaximize Group"))
            }
        });
    }
    async run(accessor, ...args) {
...
class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3552, "Open Next Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3553, "Open Previous Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3554, "Open Next Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                ...
                mac: {
                    primary: KeyChord(
                        KeyMod$1.CtrlCmd | KeyCode.KeyK,
                        KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow
                    )
                }
            },
            category: Categories.View
...
class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3555, "Open Previous Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                ...
                mac: {
                    primary: KeyChord(
                        KeyMod$1.CtrlCmd | KeyCode.KeyK,
                        KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow
                    )
                }
            },
            category: Categories.View
...
class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3556, "Open First Editor in Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3557, "Open Last Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3558, "Go Forward"));
    }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...( localize2(3558, "Go Forward")),
                mnemonicTitle: ( localize(3559, "&&Forward"))
            },
            f1: true,
            ...
            keybinding: {
                ...
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyMod$1.Shift | KeyCode.Minus,
                    secondary: [KeyCode.BrowserForward]
                },
                linux: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Minus,
                    secondary: [KeyCode.BrowserForward]
                }
            },
            menu: [{
...
class NavigateBackwardsAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3560, "Go Back"));
    }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...( localize2(3560, "Go Back")),
                mnemonicTitle: ( localize(3561, "&&Back"))
            },
            f1: true,
            ...
            keybinding: {
                ...
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.Minus,
                    secondary: [KeyCode.BrowserBack]
                },
                linux: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Minus,
                    secondary: [KeyCode.BrowserBack]
                }
            },
            menu: [{
...
class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3562, "Go Previous")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3563, "Go Forward in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3564, "Go Back in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3565, "Go Previous in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3566, "Go to Last Edit Location")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3567, "Go Forward in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3568, "Go Back in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3569, "Go Previous in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3570, "Go to Last Navigation Location")),
            f1: true
        });
    }
    async run(accessor) {
...
class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3571, "Reopen Closed Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3572, "Clear Recently Opened...")),
            f1: true,
    ...
    async run(accessor) {
        ...
        const {
            ...
            type: "warning",
            message: ( localize(3573, "Do you want to clear all recently opened files and workspaces?")),
            detail: ( localize(3574, "This action is irreversible!")),
            primaryButton: ( localize(3575, "&&Clear"))
        });
        if (!confirmed) {
            return;
        }
...
class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3576, "Show Editors in Active Group By Most Recently Used")),
            f1: true,
            category: Categories.View
        });
    }
...
class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3577, "Show All Editors By Appearance")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3578, "Show All Editors By Most Recently Used")),
            f1: true,
            category: Categories.View
        });
    }
...
class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3579, "Quick Open Previous Recently Used Editor")),
            f1: true,
            category: Categories.View
...
class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3580, "Quick Open Least Recently Used Editor")),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3581, "Quick Open Previous Recently Used Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3582, "Quick Open Least Recently Used Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3583, "Quick Open Previous Editor from History")),
            f1: true
        });
    }
    async run(accessor) {
...
class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3584, "Open Next Recently Used Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3585, "Open Previous Recently Used Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3586, "Open Next Recently Used Editor In Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3587, "Open Previous Recently Used Editor In Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class ClearEditorHistoryWithoutConfirmAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3588, "Clear Editor History without Confirmation")),
            f1: true,
...
class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3589, "Clear Editor History")),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const {
            ...
            type: "warning",
            message: ( localize(3590, "Do you want to clear the history of recently opened editors?")),
            detail: ( localize(3574, "This action is irreversible!")),
            primaryButton: ( localize(3575, "&&Clear"))
        });
        if (!confirmed) {
...
class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3591, "Move Editor Left")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                ...
                mac: {
                    primary: KeyChord(
                        KeyMod$1.CtrlCmd | KeyCode.KeyK,
                        KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.LeftArrow
                    )
                }
            },
            f1: true,
...
class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3592, "Move Editor Right")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                ...
                mac: {
                    primary: KeyChord(
                        KeyMod$1.CtrlCmd | KeyCode.KeyK,
                        KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.RightArrow
                    )
                }
            },
            f1: true,
...
class MoveEditorToStartAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3593, "Move Editor to Start")),
            f1: true,
            category: Categories.View
        }, MOVE_ACTIVE_EDITOR_COMMAND_ID, {
            to: "first"
...
class MoveEditorToEndAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3594, "Move Editor to End")),
            f1: true,
            category: Categories.View
        }, MOVE_ACTIVE_EDITOR_COMMAND_ID, {
            to: "last"
...
class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3595, "Move Editor into Previous Group")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow,
                mac: {
...
class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3596, "Move Editor into Next Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow,
...
class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3597, "Move Editor into Group Above")),
            f1: true,
            category: Categories.View
...
class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3598, "Move Editor into Group Below")),
            f1: true,
            category: Categories.View
...
class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3599, "Move Editor into Left Group")),
            f1: true,
            category: Categories.View
...
class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3600, "Move Editor into Right Group")),
            f1: true,
            category: Categories.View
...
class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3601, "Move Editor into First Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3602, "Move Editor into Last Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3603, "Split Editor into Previous Group")),
            f1: true,
            category: Categories.View
...
class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3604, "Split Editor into Next Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "next",
...
class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3605, "Split Editor into Group Above")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "up",
...
class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3606, "Split Editor into Group Below")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "down",
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static {
        this.LABEL = ( localize(3607, "Split Editor into Left Group"));
    }
    constructor() {
        super({
            id: "workbench.action.splitEditorToLeftGroup",
            title: ( localize2(3607, "Split Editor into Left Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "left",
...
class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3608, "Split Editor into Right Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "right",
...
class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3609, "Split Editor into First Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "first",
...
class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3610, "Split Editor into Last Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "last",
...
class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3611, "Single Column Editor Layout")),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3612, "Two Columns Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}],
...
class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3613, "Three Columns Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}, {}],
...
class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3614, "Two Rows Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}],
...
class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3615, "Three Rows Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}, {}],
...
class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3616, "Grid Editor Layout (2x2)")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{
...
class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3617, "Two Columns Bottom Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {
...
class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3618, "Two Rows Right Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {
...
class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3619, "New Editor Group to the Left")),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3620, "New Editor Group to the Right")),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3621, "New Editor Group Above")),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3622, "New Editor Group Below")),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3623, "Toggle Editor Type")),
            f1: true,
            category: Categories.View,
...
class ReOpenInTextEditorAction extends ExecuteCommandAction {
    static {
        this.ID = "workbench.action.reopenTextEditor";
    }
    static {
        this.TITLE = ( localize2(3624, "Reopen Editor with Text Editor"));
    }
    constructor() {
        super({
...
class BaseMoveCopyEditorToNewWindowAction extends Action2 {
    ...
    async run(accessor, ...args) {
        ...
        const {
            group,
            editors
        } = resolvedContext.groupedEditors[0];
...
class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3625, "Move Editor into New Window")),
            mnemonicTitle: ( localize(3626, "&&Move Editor into New Window"))
        }, undefined, true);
    }
}
class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3627, "Copy Editor into New Window")),
            mnemonicTitle: ( localize(3628, "&&Copy Editor into New Window"))
        }, {
            primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyO),
            weight: KeybindingWeight.WorkbenchContrib
        }, false);
    }
}
...
class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3629, "Move Editor Group into New Window")),
            mnemonicTitle: ( localize(3630, "&&Move Editor Group into New Window"))
        }, true);
    }
}
class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3631, "Copy Editor Group into New Window")),
            mnemonicTitle: ( localize(3632, "&&Copy Editor Group into New Window"))
        }, false);
    }
}
class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3633, "Restore Editors into Main Window")),
                mnemonicTitle: ( localize(3634, "&&Restore Editors into Main Window"))
            },
            f1: true,
...
class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3635, "New Empty Editor Window")),
                mnemonicTitle: ( localize(3636, "&&New Empty Editor Window"))
            },
            f1: true,
            category: Categories.View
        });
