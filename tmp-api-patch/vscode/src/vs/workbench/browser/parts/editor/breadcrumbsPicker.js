...
import { FileKind, FileSystemProviderCapabilities } from '../../../../platform/files/common/files.js';
...
import { breadcrumbsPickerBackground, widgetBorder } from '../../../../platform/theme/common/colors/editorColors.js';
...
import { isWorkspace, isWorkspaceFolder } from '../../../../platform/workspace/common/workspace.js';
...
class FileAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(3366, "Breadcrumbs");
    }
...
FileFilter = ( __decorate([( __param(0, IWorkspaceContextService)), ( __param(1, IConfigurationService)), ( __param(2, IFileService))], FileFilter));
class FileSorter {
    compare(a, b) {
