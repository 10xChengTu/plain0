...
import * as editorquickaccess from './media/editorquickaccess.css';
...
import { EditorResourceAccessor, SideBySideEditor, EditorsOrder } from '../../../common/editor.js';
...
let BaseEditorQuickAccessProvider = class BaseEditorQuickAccessProvider extends PickerQuickAccessProvider {
    constructor(prefix, editorGroupService, editorService, modelService, languageService) {
        super(prefix, {
            ...
            noResultsPick: {
                label: ( localize(3705, "No matching editors")),
                groupId: -1
            }
        });
        ...
        return (this.doGetEditors().map((
            ...
            return {
                ...
                ariaLabel: (() => {
                    ...
                    return isDirty ? ( localize(3708, "{0}, unsaved changes", nameAndDescription)) : nameAndDescription;
                })(),
                description,
                ...
                buttons: (() => {
                    return [{
                        ...
                        tooltip: ( localize(3709, "Close Editor")),
...
let ActiveGroupEditorsByMostRecentlyUsedQuickAccess = class ActiveGroupEditorsByMostRecentlyUsedQuickAccess extends BaseEditorQuickAccessProvider {
    ...
    constructor(editorGroupService, editorService, modelService, languageService) {
        super(
            ActiveGroupEditorsByMostRecentlyUsedQuickAccess_1.PREFIX,
            editorGroupService,
            editorService,
            modelService,
            languageService
    ...
    doGetEditors() {
        ...
        return ( group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE).map(editor => ({
            editor,
            groupId: group.id
        })));
    }
...
let AllEditorsByAppearanceQuickAccess = class AllEditorsByAppearanceQuickAccess extends BaseEditorQuickAccessProvider {
    ...
    constructor(editorGroupService, editorService, modelService, languageService) {
        super(
            AllEditorsByAppearanceQuickAccess_1.PREFIX,
            editorGroupService,
            editorService,
            modelService,
            languageService
...
let AllEditorsByMostRecentlyUsedQuickAccess = class AllEditorsByMostRecentlyUsedQuickAccess extends BaseEditorQuickAccessProvider {
    ...
    constructor(editorGroupService, editorService, modelService, languageService) {
        super(
            AllEditorsByMostRecentlyUsedQuickAccess_1.PREFIX,
            editorGroupService,
            editorService,
            modelService,
            languageService
