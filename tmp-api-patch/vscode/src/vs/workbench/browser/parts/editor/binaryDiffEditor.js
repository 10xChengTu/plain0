...
let BinaryResourceDiffEditor = class BinaryResourceDiffEditor extends SideBySideEditor {
    ...
    getMetadata() {
        ...
        if (primary instanceof BaseBinaryResourceEditor && secondary instanceof BaseBinaryResourceEditor) {
            return localize(3307, "{0} ↔ {1}", secondary.getMetadata(), primary.getMetadata());
        }
        return undefined;
    }
};
BinaryResourceDiffEditor = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IInstantiationService)), ( __param(3, IThemeService)), ( __param(4, IStorageService)), ( __param(5, IConfigurationService)), ( __param(6, ITextResourceConfigurationService)), ( __param(7, IEditorService)), ( __param(8, IEditorGroupsService))], BinaryResourceDiffEditor));
