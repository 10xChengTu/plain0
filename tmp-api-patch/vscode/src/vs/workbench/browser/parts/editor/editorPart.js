...
import { $, getWindow, getActiveElement, isAncestorOfActiveElement, isHTMLElement, addDisposableGenericMouseDownListener, EventHelper, Dimension } from '../../../../base/browser/dom.js';
import { Relay, Event, Emitter, PauseableEmitter } from '../../../../base/common/event.js';
...
import { GroupOrientation, GroupsOrder, GroupLocation, GroupsArrangement, GroupActivationReason, GroupDirection, MergeGroupMode } from '../../../services/editor/common/editorGroupsService.js';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.js';
import { Direction, isGridBranchNode, createSerializedGrid, Sizing, SerializableGrid } from '../../../../base/browser/ui/grid/grid.js';
...
import { Parts, Position, getFloatingOuterEdgeOwners, FLOATING_PANEL_MARGIN } from '../../../services/layout/browser/layoutService.js';
...
import { EditorAreaFocusContext, EditorPartMultipleEditorGroupsContext, EditorPartMaximizedEditorGroupContext, EditorTabsVisibleContext, IsTopRightEditorGroupContext } from '../../../common/contextkeys.js';
...
let EditorPart = class EditorPart extends Part {
    ...
    constructor(
        ...
        this.sideGroup = {
            openEditor: async (editor, options) => {
                const findGroupResult = this.scopedInstantiationService.invokeFunction(accessor => findGroup(accessor, {
                    editor,
                    options
                }, SIDE_GROUP));
                let group;
    ...
    registerListeners() {
        ...
        this._register(
            this.themeService.onDidFileIconThemeChange(() => this.handleChangedPartOptions())
        );
        this._register(
    ...
    applyLayout(layout) {
        ...
        const gridDescriptor = createSerializedGrid({
            orientation: this.toGridViewOrientation(
                ...
                this.gridWidget.orientation : orthogonal(this.gridWidget.orientation)
            ),
    ...
    createContentArea(parent, options) {
        ...
        this._register(this.onDidChangeEditorPartOptions(
            e => this.centeredLayoutWidget.setFixedWidth(e.newPartOptions.centeredLayoutFixedWidth ?? false)
        ));
    ...
    setupDragAndDropSupport(parent, container) {
        ...
        this._register(
            addDisposableGenericMouseDownListener(overlay, () => overlay.classList.remove("visible"))
        );
    ...
    layout(width, height, top, left) {
        ...
        if (this.windowId === mainWindow.vscodeWindowId && this.layoutService.isFloatingPanelsEnabled()) {
            ...
            const {
                topMargin,
                bottomMargin
            } = this.getFloatingPanelHeightInsets();
    ...
    getFloatingPanelHeightInsets() {
        ...
        const bottomMargin = !this.layoutService.isVisible(Parts.STATUSBAR_PART, mainWindow) && !panelAtBottom ? FLOATING_PANEL_MARGIN * 2 : FLOATING_PANEL_MARGIN;
        return {
            topMargin: panelAtTop ? FLOATING_PANEL_MARGIN : 0,
            bottomMargin
        };
    }
    ...
    async doApplyState(state, options) {
        ...
        await this.activeGroup.openEditors(( groups.flatMap(group => group.editors).filter(
            editor => this.editorPartsView.groups.every(groupView => !groupView.contains(editor))
        ).map(editor => ({
            editor,
            options: {
                pinned: true,
...
EditorPart = EditorPart_1 = ( __decorate([( __param(4, IInstantiationService)), ( __param(5, IThemeService)), ( __param(6, IConfigurationService)), ( __param(7, IStorageService)), ( __param(8, IWorkbenchLayoutService)), ( __param(9, IHostService)), ( __param(10, IContextKeyService))], EditorPart));
...
MainEditorPart = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IThemeService)), ( __param(3, IConfigurationService)), ( __param(4, IStorageService)), ( __param(5, IWorkbenchLayoutService)), ( __param(6, IHostService)), ( __param(7, IContextKeyService))], MainEditorPart));
