...
import { RawWorkbenchListFocusContextKey, WorkbenchTreeFindOpen, WorkbenchTreeStickyScrollFocused } from '../../../../platform/list/browser/listService.js';
...
import { ActiveEditorGroupEmptyContext, MultipleEditorGroupsContext, ActiveEditorCanSplitInGroupContext, SideBySideEditorActiveContext, TextCompareEditorActiveContext, ActiveEditorGroupLockedContext, ActiveEditorStickyContext, IsSessionsWindowContext, EditorPartModalContext, EditorPartModalSidebarContext, EditorPartModalMaximizedContext, EditorPartModalNavigationContext } from '../../../common/contextkeys.js';
import { EditorInputCapabilities, EditorsOrder, CloseDirection, isDiffEditorInput, isEditorInputWithOptionsAndGroup } from '../../../common/editor.js';
...
import { DIFF_FOCUS_SECONDARY_SIDE, DIFF_FOCUS_PRIMARY_SIDE, DIFF_FOCUS_OTHER_SIDE, registerDiffEditorCommands } from './diffEditorCommands.js';
...
function registerEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3637, "Move the active editor by tabs or groups")),
            args: [{
                name: ( localize(3638, "Active editor move argument")),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3640, "Copy the active editor by groups")),
            args: [{
                name: ( localize(3641, "Active editor copy argument")),
                description: ( localize(
                    3642,
    ...
    [{
        ...
        CommandsRegistry.registerCommand(id, function(accessor, ...args) {
            ...
            if (resolvedContext.groupedEditors.length) {
                moveCopyEditorsToGroup(true, {
                    to}, resolvedContext.groupedEditors[0].group, resolvedContext.groupedEditors[0].editors, accessor);
            }
        });
    });
                ...
                schema: {
                    ...
                    "properties": {
                        "orientation": {
                            ...
                            "enum": [0, 1],
                            "enumDescriptions": [( localize(3643, "Horizontal")), ( localize(3644, "Vertical"))]
                        },
                        "groups": {
...
function registerOpenEditorAPICommands() {
    ...
    CommandsRegistry.registerCommand(
        ...
        async function(accessor, resourceArg, columnAndOptions, label, context) {
    ...
    CommandsRegistry.registerCommand(API_OPEN_DIFF_EDITOR_COMMAND_ID, async function(
        accessor,
        originalResource,
        modifiedResource,
        ...
        await editorService.openEditor({
            original: {
                resource: ( URI.from(originalResource, true))
            },
            modified: {
                resource: ( URI.from(modifiedResource, true))
            },
            label,
            description,
            options
    ...
    CommandsRegistry.registerCommand("_workbench.changes", async (accessor, title, resources) => {
        ...
        for (const [label, original, modified] of resources) {
            editor.push({
                ...
                original: {
                    resource: URI.revive(original)
                },
                modified: {
                    resource: URI.revive(modified)
                }
            });
        }
        await editorService.openEditor({
    ...
    CommandsRegistry.registerCommand("_workbench.openMultiDiffEditor", async (accessor, options) => {
        ...
        const resources = options.resources?.map(r => ({
            original: {
                resource: URI.revive(r.originalUri)
            },
            modified: {
                resource: URI.revive(r.modifiedUri)
            }
        }));
...
function registerOpenEditorAtIndexCommands() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        KeybindingsRegistry.registerCommandAndKeybindingRule({
            ...
            mac: {
                primary: KeyMod$1.WinCtrl | toKeyCode(visibleIndex)
            },
...
function splitEditor(editorGroupsService, direction, resolvedContext) {
    ...
    for (const editorToCopy of editors) {
        if (editorToCopy && !editorToCopy.hasCapability(EditorInputCapabilities.Singleton)) {
            group.copyEditor(editorToCopy, newGroup, {
                preserveFocus
            });
        }
    }
...
function registerCloseEditorCommands() {
    function closeEditorHandler(accessor, forceCloseStickyEditors, ...args) {
        ...
        if (keepStickyEditors) {
            ...
            if (activeEditor && activeGroup.isSticky(activeEditor)) {
                const nextNonStickyEditorInGroup = activeGroup.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE, {
                    excludeSticky: true
                })[0];
                if (nextNonStickyEditorInGroup) {
                    return activeGroup.openEditor(nextNonStickyEditorInGroup);
                }
                const nextNonStickyEditorInAllGroups = editorService.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE, {
                    excludeSticky: true
                })[0];
        ...
        const preserveFocus = resolvedContext.preserveFocus;
        return Promise.all(( resolvedContext.groupedEditors.map(async (
            {
                group,
                editors
            }
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        primary: undefined,
        mac: {
            primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyT
        },
        handler: (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(
                args,
    ...
    async function reopenEditorWith(accessor, editorOverride, ...args) {
        ...
        for (const {
            group,
            editors
        } of resolvedContext.groupedEditors) {
            for (const editor of editors) {
...
function registerFocusEditorGroupWihoutWrapCommands() {
    ...
    for (const command of commands) {
        CommandsRegistry.registerCommand(command.id, async accessor => {
            ...
            }, editorGroupsService.activeGroup, false) ?? editorGroupsService.activeGroup;
            group.focus();
        });
    }
}
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3645, "Split Editor in Group")),
                ...
                keybinding: {
                    ...
                    primary: KeyChord(
                        ...
                        KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Backslash
                    )
                }
            });
        }
        run(accessor, ...args) {
            return splitEditorInGroup(accessor, resolveCommandsContext(
                args,
                accessor.get(IEditorService),
                accessor.get(IEditorGroupsService),
                accessor.get(IListService)
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3646, "Join Editor in Group")),
                category: Categories.View,
        ...
        run(accessor, ...args) {
            return joinEditorInGroup(resolveCommandsContext(
                args,
                accessor.get(IEditorService),
                accessor.get(IEditorGroupsService),
                accessor.get(IListService)
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3647, "Toggle Split Editor in Group")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3648, "Toggle Layout of Split Editor in Group")),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3649, "Focus First Side in Active Editor")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3650, "Focus Second Side in Active Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3651, "Focus Other Side in Active Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3652, "Toggle Editor Group Lock")),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3653, "Lock Editor Group")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3654, "Unlock Editor Group")),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3655, "Open Modal Editor in Main Window")),
                category: Categories.View,
                f1: true,
        ...
        async run(accessor) {
            ...
            for (const part of editorGroupsService.parts) {
                if (isModalEditorPart(part)) {
                    await part.close({
                        mergeAllEditorsToMainPart: true
                    });
                    break;
                }
            }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3656, "Open Modal Editor in New Window")),
                category: Categories.View,
                f1: true,
            ...
            for (const part of editorGroupsService.parts) {
                if (isModalEditorPart(part)) {
                    ...
                    for (const group of part.getGroups(GroupsOrder.MOST_RECENTLY_ACTIVE)) {
                        group.moveEditors(( group.editors.map(editor => ({
                            editor,
                            options: {
                                preserveFocus: true
                            }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3657, "Toggle Modal Editor Sidebar")),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3658, "Maximize Modal Editor")),
                category: Categories.View,
                f1: true,
                precondition: EditorPartModalContext,
                ...
                toggled: {
                    ...
                    title: ( localize(3659, "Restore Modal Editor"))
                },
                menu: {
                    id: MenuId.ModalEditorTitle,
                    group: "navigation",
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3660, "Close Modal Editor")),
                category: Categories.View,
                f1: true,
                icon: Codicon.close,
                precondition: EditorPartModalContext,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3661, "Navigate to Previous Item in Modal Editor")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3662, "Navigate to Next Item in Modal Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.and(EditorPartModalContext, EditorPartModalNavigationContext)),
                keybinding: {
...
export { API_OPEN_DIFF_EDITOR_COMMAND_ID, API_OPEN_EDITOR_COMMAND_ID, API_OPEN_WITH_EDITOR_COMMAND_ID, CLOSE_EDITORS_AND_GROUP_COMMAND_ID, CLOSE_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, CLOSE_EDITOR_COMMAND_ID, CLOSE_EDITOR_GROUP_COMMAND_ID, CLOSE_MODAL_EDITOR_COMMAND_ID, CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_PINNED_EDITOR_COMMAND_ID, CLOSE_SAVED_EDITORS_COMMAND_ID, COPY_ACTIVE_EDITOR_COMMAND_ID, COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, EDITOR_CORE_NAVIGATION_COMMANDS, FOCUS_ABOVE_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_BELOW_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_FIRST_SIDE_EDITOR, FOCUS_LEFT_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_OTHER_SIDE_EDITOR, FOCUS_RIGHT_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_SECOND_SIDE_EDITOR, JOIN_EDITOR_IN_GROUP, KEEP_EDITOR_COMMAND_ID, LAYOUT_EDITOR_GROUPS_COMMAND_ID, LOCK_GROUP_COMMAND_ID, MOVE_ACTIVE_EDITOR_COMMAND_ID, MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_INTO_ABOVE_GROUP, MOVE_EDITOR_INTO_BELOW_GROUP, MOVE_EDITOR_INTO_LEFT_GROUP, MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_INTO_RIGHT_GROUP, MOVE_MODAL_EDITOR_TO_MAIN_COMMAND_ID, MOVE_MODAL_EDITOR_TO_WINDOW_COMMAND_ID, NAVIGATE_MODAL_EDITOR_NEXT_COMMAND_ID, NAVIGATE_MODAL_EDITOR_PREVIOUS_COMMAND_ID, NEW_EMPTY_EDITOR_WINDOW_COMMAND_ID, OPEN_EDITOR_AT_INDEX_COMMAND_ID, PIN_EDITOR_COMMAND_ID, REOPEN_ACTIVE_EDITOR_WITH_COMMAND_ID, REOPEN_WITH_COMMAND_ID, SHOW_EDITORS_IN_GROUP, SPLIT_EDITOR, SPLIT_EDITOR_DOWN, SPLIT_EDITOR_IN_GROUP, SPLIT_EDITOR_LEFT, SPLIT_EDITOR_RIGHT, SPLIT_EDITOR_UP, TOGGLE_KEEP_EDITORS_COMMAND_ID, TOGGLE_LOCK_GROUP_COMMAND_ID, TOGGLE_MAXIMIZE_EDITOR_GROUP, TOGGLE_MODAL_EDITOR_MAXIMIZED_COMMAND_ID, TOGGLE_MODAL_EDITOR_SIDEBAR_COMMAND_ID, TOGGLE_SPLIT_EDITOR_IN_GROUP, TOGGLE_SPLIT_EDITOR_IN_GROUP_LAYOUT, UNLOCK_GROUP_COMMAND_ID, UNPIN_EDITOR_COMMAND_ID, setup, splitEditor };
