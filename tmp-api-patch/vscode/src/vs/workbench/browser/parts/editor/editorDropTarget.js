...
import * as editordroptarget from './media/editordroptarget.css';
import { DataTransfers } from '../../../../base/browser/dnd.js';
import { $, DragAndDropObserver, EventHelper, addDisposableListener, EventType, getWindow, isAncestor } from '../../../../base/browser/dom.js';
...
import { LocalSelectionTransfer, Extensions, containsDragType, CodeDataTransfers } from '../../../../platform/dnd/browser/dnd.js';
...
import { MergeGroupMode, GroupDirection } from '../../../services/editor/common/editorGroupsService.js';
...
let DropOverlay = class DropOverlay extends Themable {
    ...
    create() {
        ...
        if (this.enableDropIntoEditor) {
            this.dropIntoPromptElement = renderFormattedText(( localize(3672, "Hold __{0}__ to drop into editor", isMacintosh ? "⇧" : "Shift")), {});
    ...
    async handleDrop(event, splitDirection) {
        ...
        if (this.groupTransfer.hasData(DraggedEditorGroupIdentifier.prototype)) {
            ...
            if (Array.isArray(data) && data.length > 0) {
                ...
                if (editors.length) {
                    this.editorService.openEditors(editors, ensureTargetGroup(), {
                        validateTrust: true
                    });
                }
            }
...
DropOverlay = DropOverlay_1 = ( __decorate([( __param(1, IThemeService)), ( __param(2, IConfigurationService)), ( __param(3, IInstantiationService)), ( __param(4, IEditorService)), ( __param(5, IEditorGroupsService)), ( __param(6, ITreeViewsDnDService)), ( __param(7, IWorkspaceContextService))], DropOverlay));
let EditorDropTarget = class EditorDropTarget extends Themable {
    ...
    registerListeners() {
        this._register(
            addDisposableListener(this.container, EventType.DRAG_ENTER, e => this.onDragEnter(e))
        );
        this._register(
            addDisposableListener(this.container, EventType.DRAG_LEAVE, () => this.onDragLeave())
        );
...
EditorDropTarget = ( __decorate([( __param(3, IEditorGroupsService)), ( __param(4, IThemeService)), ( __param(5, IConfigurationService)), ( __param(6, IInstantiationService))], EditorDropTarget));
