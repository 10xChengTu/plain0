...
const openChat = {
    text: ( localize(3680, "Open Chat")),
    id: "workbench.action.chat.open",
    when: {
        native: showChatContextKey,
        web: showChatContextKey
    }
};
const showCommands = {
    text: ( localize(3681, "Show All Commands")),
    id: "workbench.action.showCommands"
};
const gotoFile = {
    text: ( localize(3682, "Go to File")),
    id: "workbench.action.quickOpen"
};
const openFile = {
    text: ( localize(3683, "Open File")),
    id: "workbench.action.files.openFile"
};
const openFolder = {
    text: ( localize(3684, "Open Folder")),
    id: "workbench.action.files.openFolder"
};
const openFileOrFolder = {
    text: ( localize(3685, "Open File or Folder")),
    id: "workbench.action.files.openFileFolder"
};
const openRecent = {
    text: ( localize(3686, "Open Recent")),
    id: "workbench.action.openRecent"
};
const newUntitledFile = {
    text: ( localize(3687, "New Untitled Text File")),
    id: "workbench.action.files.newUntitledFile"
};
const findInFiles = {
    text: ( localize(3688, "Find in Files")),
    id: "workbench.action.findInFiles"
};
const toggleTerminal = {
    text: ( localize(3689, "Toggle Terminal")),
    id: "workbench.action.terminal.toggleTerminal",
    when: {
        web: ( ContextKeyExpr.equals("terminalProcessSupported", true))
    }
};
const startDebugging = {
    text: ( localize(3690, "Start Debugging")),
...
const openSettings = {
    text: ( localize(3691, "Open Settings")),
    id: "workbench.action.openSettings"
};
const baseEntries = [openChat, showCommands];
...
const workspaceEntries = [...baseEntries];
const otherEntries = [gotoFile, findInFiles, startDebugging, toggleTerminal, openSettings];
let EditorGroupWatermark = class EditorGroupWatermark extends Disposable {
    ...
    constructor(
        ...
        this.enabled = false;
        this.cachedWhen = this.storageService.getObject(
        ...
        const elements = h(
            ".editor-group-watermark-wrapper",
            [h(".editor-group-watermark-toolbar-container@toolbarContainer"), h(
                ".editor-group-watermark",
                [h(".watermark-container", [h(".letterpress"), h(".shortcuts@shortcuts")])]
            )]
        );
        ...
        this._register(this.instantiationService.createInstance(
            ...
            MenuId.EditorGroupWatermarkToolbar,
            {
    ...
    render() {
        ...
        if (entries.length < EditorGroupWatermark_1.MINIMUM_ENTRIES) {
            ...
            entries.push(
                ...additionalEntries.slice(0, EditorGroupWatermark_1.MINIMUM_ENTRIES - entries.length)
            );
        }
        ...
        const update = () => {
            ...
            for (const entry of entries) {
                ...
                const label = this.keybindingLabels.add(( new KeybindingLabel(dd, OS, {
...
EditorGroupWatermark = EditorGroupWatermark_1 = ( __decorate([( __param(1, IKeybindingService)), ( __param(2, IWorkspaceContextService)), ( __param(3, IContextKeyService)), ( __param(4, IConfigurationService)), ( __param(5, IStorageService)), ( __param(6, IInstantiationService))], EditorGroupWatermark));
