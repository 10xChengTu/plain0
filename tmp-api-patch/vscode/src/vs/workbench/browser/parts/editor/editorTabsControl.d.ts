...
export declare abstract class EditorTabsControl extends Themable implements IEditorTabsControl {
    ...
    private editorLayoutActionsSeparator;
    protected editorLayoutActionsToolbarContainer: HTMLElement | undefined;
    private editorLayoutActionsToolbar;
    private readonly editorLayoutActionsToolbarDisposables;
    private readonly editorLayoutActionsDisposables;
    ...
    private handleEditorLayoutActionsToolBarVisibility;
    private doCreateEditorActionsToolBar;
    private doCreateEditorLayoutActionsToolBar;
    private actionViewItemProvider;
    protected updateEditorActionsToolbar(): void;
    private updateEditorLayoutActionsToolbar;
    ...
    protected get tabHeight(): 32 | 35 | 22 | 28;
