...
export declare class ActivitybarPart extends Part {
     ...
     */
    static readonly FLOATING_MARGIN = 4;
    ...
    private get floatingGutter();
    private readonly compositeBar;
    private content;
    private _isCompact;
    constructor(location: ViewContainerLocation, paneCompositePart: IPaneCompositePart, instantiationService: IInstantiationService, layoutService: IWorkbenchLayoutService, themeService: IThemeService, storageService: IStorageService, configurationService: IConfigurationService);
    private updateCompactStyle;
    private recreateCompositeBar;
...
export declare class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    constructor(location: ViewContainerLocation, options: IPaneCompositeBarOptions, part: Parts, paneCompositePart: IPaneCompositePart, showGlobalActivities: boolean, instantiationService: IInstantiationService, storageService: IStorageService, extensionService: IExtensionService, viewDescriptorService: IViewDescriptorService, viewService: IViewsService, contextKeyService: IContextKeyService, environmentService: IWorkbenchEnvironmentService, configurationService: IConfigurationService, menuService: IMenuService, layoutService: IWorkbenchLayoutService);
