...
import * as activitybarpart from './media/activitybarpart.css';
import * as activityaction from './media/activityaction.css';
import { localize, localize2 } from '../../../../nls.js';
import { ActionsOrientation } from '../../../../base/browser/ui/actionbar/actionbar.js';
import { Part } from '../../part.js';
import { FLOATING_PANEL_MARGIN, Parts, LayoutSettings, Position, ActivityBarPosition } from '../../../services/layout/browser/layoutService.js';
...
import { contrastBorder, activeContrastBorder, focusBorder } from '../../../../platform/theme/common/colors/baseColors.js';
...
import { clearNode, append, $, isAncestor, addDisposableListener, EventType } from '../../../../base/browser/dom.js';
...
registerCss(activitybarpart);
registerCss(activityaction);
let ActivitybarPart = class ActivitybarPart extends Part {
    ...
    get baseWidth() {
        return this._isCompact ? ActivitybarPart_1.COMPACT_ACTIVITYBAR_WIDTH : ActivitybarPart_1.ACTIVITYBAR_WIDTH;
    }
    get floatingGutter() {
        return this.layoutService.isFloatingPanelsEnabled() ? ActivitybarPart_1.FLOATING_MARGIN : 0;
    }
    constructor(
        location,
        paneCompositePart,
        ...
        super(Parts.ACTIVITYBAR_PART, {
            hasTitle: false
        }, themeService, storageService, layoutService);
    ...
    updateCompactStyle() {
        if (this.element) {
            ...
            this.element.style.setProperty(
                ...
                `${this._isCompact ? ActivitybarPart_1.COMPACT_ACTION_HEIGHT : ActivitybarPart_1.ACTION_HEIGHT}px`
            );
            this.element.style.setProperty(
                "--activity-bar-icon-size",
                `${this._isCompact ? ActivitybarPart_1.COMPACT_ICON_SIZE : ActivitybarPart_1.ICON_SIZE}px`
            );
        }
    }
...
ActivitybarPart = ActivitybarPart_1 = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, IWorkbenchLayoutService)), ( __param(4, IThemeService)), ( __param(5, IStorageService)), ( __param(6, IConfigurationService))], ActivitybarPart));
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    constructor(
        ...
        if (showGlobalActivities) {
            this.globalCompositeBar = this._register(instantiationService.createInstance(
                ...
                theme => this.options.colors(theme),
    ...
    fillContextMenuActions(actions, e) {
        ...
        if (menuBarVisibility === "compact" && this.menuBarContainer && e?.target) {
            if (isAncestor(e.target, this.menuBarContainer)) {
                actions.unshift(...[toAction({
                    id: "hideCompactMenu",
                    label: ( localize(3237, "Hide Menu")),
                    run: () => this.configurationService.updateValue(MenuSettings.MenuBarVisibility, "toggle")
                }), ( new Separator())]);
            }
        }
    ...
    registerKeyboardNavigationListeners() {
        ...
        if (this.compositeBarContainer) {
            this.keyboardNavigationDisposables.add(
                addDisposableListener(this.compositeBarContainer, EventType.KEY_DOWN, e => {
                    const kbEvent = ( new StandardKeyboardEvent(e));
                    if (kbEvent.equals(KeyCode.DownArrow) || kbEvent.equals(KeyCode.RightArrow)) {
        ...
        if (this.globalCompositeBar) {
            this.keyboardNavigationDisposables.add(
                addDisposableListener(this.globalCompositeBar.element, EventType.KEY_DOWN, e => {
                    const kbEvent = ( new StandardKeyboardEvent(e));
    ...
    getActivityBarContextMenuActions() {
        const activityBarPositionMenu = this.menuService.getMenuActions(MenuId.ActivityBarPositionMenu, this.contextKeyService, {
            shouldForwardArgs: true,
            renderShortTitle: true
        });
        const positionActions = getContextMenuActions(activityBarPositionMenu).secondary;
        const actions = [( new SubmenuAction("workbench.action.activityBar.position", ( localize(3238, "Activity Bar Position")), positionActions))];
        ...
        if (activityBarPosition === ActivityBarPosition.DEFAULT) {
            ...
            const sizeActions = [toAction({
                id: "workbench.action.activityBar.size.default",
                label: ( localize(3239, "Default")),
                checked: !isCompact,
                run: () => this.configurationService.updateValue(LayoutSettings.ACTIVITY_BAR_COMPACT, false)
            }), toAction({
                id: "workbench.action.activityBar.size.compact",
                label: ( localize(3240, "Compact")),
                checked: isCompact,
                run: () => this.configurationService.updateValue(LayoutSettings.ACTIVITY_BAR_COMPACT, true)
            })];
            actions.push(( new SubmenuAction("workbench.action.activityBar.size", ( localize(3241, "Activity Bar Size")), sizeActions)));
        }
...
ActivityBarCompositeBar = ( __decorate([( __param(5, IInstantiationService)), ( __param(6, IStorageService)), ( __param(7, IExtensionService)), ( __param(8, IViewDescriptorService)), ( __param(9, IViewsService)), ( __param(10, IContextKeyService)), ( __param(11, IWorkbenchEnvironmentService)), ( __param(12, IConfigurationService)), ( __param(13, IMenuService)), ( __param(14, IWorkbenchLayoutService))], ActivityBarCompositeBar));
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: "workbench.action.activityBarLocation.default",
            title: {
                ...( localize2(3242, "Move Activity Bar to Side")),
                mnemonicTitle: ( localize(3243, "&&Default"))
            },
            shortTitle: ( localize(3244, "Default")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3245, "Move Activity Bar to Top")),
                mnemonicTitle: ( localize(3246, "&&Top"))
            },
            shortTitle: ( localize(3247, "Top")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3248, "Move Activity Bar to Bottom")),
                mnemonicTitle: ( localize(3249, "&&Bottom"))
            },
            shortTitle: ( localize(3250, "Bottom")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3251, "Hide Activity Bar")),
                mnemonicTitle: ( localize(3252, "&&Hidden"))
            },
            shortTitle: ( localize(3253, "Hidden")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(3254, "Activity Bar Position")),
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3255, "Previous Primary Side Bar View")),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3256, "Next Primary Side Bar View")),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Sidebar, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3257, "Focus Activity Bar")),
            category: Categories.View,
            f1: true
        });
    }
