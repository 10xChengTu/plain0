...
let ViewMenuActions = class ViewMenuActions extends Disposable {
    ...
    getActions() {
        if (!this.actions) {
            this.actions = getActionBarActions(
                this.menu.getActions(this.options),
                group => this.isPrimaryActionGroup(group),
                undefined,
                true
            );
        }
...
ViewMenuActions = ( __decorate([( __param(4, IContextKeyService)), ( __param(5, IMenuService))], ViewMenuActions));
let ViewContainerMenuActions = class ViewContainerMenuActions extends ViewMenuActions {
    constructor(
        ...
        super(MenuId.ViewContainerTitle, MenuId.ViewContainerTitleContext, {
            shouldForwardArgs: true,
            renderShortTitle: true
        }, menuActionsOptions, scopedContextKeyService, menuService);
...
ViewContainerMenuActions = ( __decorate([( __param(3, IViewDescriptorService)), ( __param(4, IContextKeyService)), ( __param(5, IMenuService))], ViewContainerMenuActions));
