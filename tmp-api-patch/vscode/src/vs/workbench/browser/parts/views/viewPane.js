...
import * as paneviewlet from './media/paneviewlet.css';
...
import { append, $, trackFocus, addDisposableListener, EventType, after, isActiveElement, isAncestorOfActiveElement, Dimension, reset } from '../../../../base/browser/dom.js';
import { createCSSRule } from '../../../../base/browser/domStylesheets.js';
import { asCssValueWithDefault, asCSSUrl } from '../../../../base/browser/cssValue.js';
import { DisposableStore, toDisposable, DisposableMap } from '../../../../base/common/lifecycle.js';
...
import { Extensions, ViewContainerLocation, ViewContainerLocationToString, defaultViewIcon } from '../../../common/views.js';
...
const viewPaneContainerExpandedIcon = registerIcon("view-pane-container-expanded", Codicon.chevronDown, ( localize(3990, "Icon for an expanded view pane container.")));
const viewPaneContainerCollapsedIcon = registerIcon("view-pane-container-collapsed", Codicon.chevronRight, ( localize(3991, "Icon for a collapsed view pane container.")));
...
let ViewWelcomeController = class ViewWelcomeController {
    ...
    constructor(
        ...
        this.disposables.add(Event.runAndSubscribe(
    ...
    onDidChangeViewWelcomeState() {
        ...
        this.element = $(".welcome-view-content", {
            tabIndex: 0,
            role: "region",
            "aria-label": ( localize(3992, "Welcome"))
        });
        if (this._wide) {
...
ViewWelcomeController = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, IOpenerService)), ( __param(4, IContextKeyService)), ( __param(5, ILifecycleService))], ViewWelcomeController));
let ViewPane = class ViewPane extends Pane {
    ...
    constructor(
        ...
        super({
            ...options,
            ...{
                orientation: viewDescriptorService.getViewLocationById(options.id) === ViewContainerLocation.Panel ? Orientation.HORIZONTAL : Orientation.VERTICAL
            }
        });
        ...
        const viewLocationKey = this.scopedContextKeyService.createKey(
            "viewLocation",
            ViewContainerLocationToString(viewDescriptorService.getViewLocationById(this.id))
        );
        this._register(
            Event.filter(viewDescriptorService.onDidChangeLocation, e => ( e.views.some(view => view.id === this.id)))(() => viewLocationKey.set(
                ViewContainerLocationToString(viewDescriptorService.getViewLocationById(this.id))
            ))
        );
        ...
        this.menuActions = this._register(childInstantiationService.createInstance(
            ViewMenuActions,
            ...
            {
                primaryActionGroups: this.primaryActionGroups
            }
        ));
    ...
    renderHeader(container) {
        ...
        this.twistiesContainer = append(container, $(
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: ( localize(3993, "{0} actions", this.title)),
        ...
        const onDidRelevantConfigurationChange = Event.filter(
            ...
            e => e.affectsConfiguration(ViewPane_1.AlwaysShowActionsConfig)
        );
    ...
    renderHeaderTitle(container, title) {
        ...
        this.titleContainerHover = this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), this.titleContainer, calculatedTitle)
        );
        if (this._titleDescription) {
            this.setTitleDescription(this._titleDescription);
        }
        this.iconContainerHover = this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), this.iconContainer, calculatedTitle)
        );
    ...
    _getAriaLabel(title, description) {
        ...
        return localize(3994, "Use Alt+F1 for accessibility help {0}", title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
    ...
    setTitleDescription(description) {
        if (this.titleDescriptionContainer) {
            ...
            this.titleDescriptionContainerHover = this._register(this.hoverService.setupManagedHover(
    ...
    renderBody(container) {
        this.viewWelcomeController = this._register(
            this.instantiationService.createInstance(ViewWelcomeController, container, this)
        );
    }
    ...
    getProgressIndicator() {
        ...
        if (this.progressIndicator === undefined) {
            ...
            this.progressIndicator = this._register(( new ScopedProgressIndicator(
                ...
                this._register(new (class extends AbstractProgressScope {
                    constructor() {
                        super(that.id, that.isBodyVisible());
                        this._register(that.onDidChangeBodyVisibility(
...
ViewPane = ViewPane_1 = ( __decorate([( __param(1, IKeybindingService)), ( __param(2, IContextMenuService)), ( __param(3, IConfigurationService)), ( __param(4, IContextKeyService)), ( __param(5, IViewDescriptorService)), ( __param(6, IInstantiationService)), ( __param(7, IOpenerService)), ( __param(8, IThemeService)), ( __param(9, IHoverService))], ViewPane));
let FilterViewPane = class FilterViewPane extends ViewPane {
    constructor(
        ...
        this.filterWidget = this._register(
            childInstantiationService.createInstance(FilterWidget, options.filterOptions)
        );
...
FilterViewPane = ( __decorate([( __param(1, IKeybindingService)), ( __param(2, IContextMenuService)), ( __param(3, IConfigurationService)), ( __param(4, IContextKeyService)), ( __param(5, IViewDescriptorService)), ( __param(6, IInstantiationService)), ( __param(7, IOpenerService)), ( __param(8, IThemeService)), ( __param(9, IHoverService))], FilterViewPane));
