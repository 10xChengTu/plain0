...
import { LayoutSettings, isHorizontal, FLOATING_PANEL_MARGIN } from '../../../services/layout/browser/layoutService.js';
...
class ViewPaneDropOverlay extends Themable {
    static {
        this.OVERLAY_ID = "monaco-pane-drop-overlay";
    }
    ...
    create() {
        this.container = $("div", {
            id: ViewPaneDropOverlay.OVERLAY_ID
        });
...
let ViewPaneContainer = class ViewPaneContainer extends Component {
    ...
    create(parent) {
        ...
        this._register(this.paneview.onDidDrop((
            {
                from,
                to
            }
        ) => this.movePane(from, to)));
        ...
        this._register(
            addDisposableListener(parent, EventType.CONTEXT_MENU, e => this.showContextMenu(( new StandardMouseEvent(getWindow(parent), e))))
        );
        this._register(Gesture.addTarget(parent));
        this._register(addDisposableListener(
            parent,
            EventType$1.Contextmenu,
            e => this.showContextMenu(( new StandardMouseEvent(getWindow(parent), e)))
        ));
        this._menuActions = this._register(this.instantiationService.createInstance(
    ...
    addPanes(panes) {
        ...
        this._onDidAddViews.fire(( panes.map((
            {
                pane
            }
        ) => pane)));
    ...
    addPane(pane, size, disposable, index = this.paneItems.length - 1) {
        ...
        if (this.viewDescriptorService.canMoveViews()) {
            if (pane.draggableElement) {
                store.add(
                    CompositeDragAndDropObserver.INSTANCE.registerDraggable(pane.draggableElement, () => {
                        return {
                            type: "view",
                            id: pane.id
                        };
                ...
                CompositeDragAndDropObserver.INSTANCE.registerTarget(pane.dropTargetElement, {
                    ...
                    onDrop: e => {
                        if (overlay) {
                            ...
                            if (anchorView) {
                                if (overlay.currentDropOperation === DropDirection.DOWN || overlay.currentDropOperation === DropDirection.RIGHT) {
                                ...
                                if (overlay.currentDropOperation === DropDirection.UP || overlay.currentDropOperation === DropDirection.LEFT) {
                                    const fromIndex = this.panes.findIndex(p => p.id === anchorView.id);
                                    let toIndex = this.panes.findIndex(p => p.id === pane.id);
                                    if (fromIndex >= 0 && toIndex >= 0) {
                                        if (fromIndex < toIndex) {
...
ViewPaneContainer = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, IConfigurationService)), ( __param(4, IWorkbenchLayoutService)), ( __param(5, IContextMenuService)), ( __param(6, ITelemetryService)), ( __param(7, IExtensionService)), ( __param(8, IThemeService)), ( __param(9, IStorageService)), ( __param(10, IWorkspaceContextService)), ( __param(11, IViewDescriptorService)), ( __param(12, ILogService))], ViewPaneContainer));
...
registerAction2(class MoveViewUp extends MoveViewPosition {
    constructor() {
        super({
            id: "views.moveViewUp",
            title: ( localize(3996, "Move View Up")),
            keybinding: {
...
registerAction2(class MoveViewLeft extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3997, "Move View Left")),
            keybinding: {
...
registerAction2(class MoveViewDown extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3998, "Move View Down")),
            keybinding: {
...
registerAction2(class MoveViewRight extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3999, "Move View Right")),
            keybinding: {
...
registerAction2(class MoveViews extends Action2 {
    constructor() {
        super({
            id: "vscode.moveViews",
            title: ( localize(4000, "Move Views"))
        });
    }
