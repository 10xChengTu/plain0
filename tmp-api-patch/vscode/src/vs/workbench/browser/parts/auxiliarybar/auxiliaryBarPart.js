...
let AuxiliaryBarPart = class AuxiliaryBarPart extends AbstractPaneCompositePart {
    ...
    constructor(
        ...
        this.visibleViewContainersTracker = this._register(
            instantiationService.createInstance(VisibleViewContainersTracker, ViewContainerLocation.AuxiliaryBar)
        );
        this._register(
            this.visibleViewContainersTracker.onDidChange(e => this.onDidChangeAutoHideViewContainers(e))
        );
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: this.configuration.showLabels ? ( localize(3280, "Show Icons")) : ( localize(3281, "Show Labels")),
        ...
        actions.push(...[( new Separator()), ( new SubmenuAction("workbench.action.panel.position", ( localize(3282, "Activity Bar Position")), positionActions)), toAction({
            id: ToggleSidebarPositionAction.ID,
            label: currentPositionRight ? ( localize(3283, "Move Secondary Side Bar Left")) : ( localize(3284, "Move Secondary Side Bar Right")),
            run: () => this.commandService.executeCommand(ToggleSidebarPositionAction.ID)
        }), toggleShowLabelsAction, toAction({
            id: ToggleAuxiliaryBarAction.ID,
            label: ( localize(3285, "Hide Secondary Side Bar")),
