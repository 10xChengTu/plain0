...
import { isNotificationViewItem, NotificationsSettings, NotificationsPosition } from '../../../common/notifications.js';
...
function registerNotificationCommands(center, toasts, model) {
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        primary: KeyChord(
            ...
            KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyN
        ),
        handler: () => {
            toasts.hide();
            center.show();
    ...
    CommandsRegistry.registerCommand(TOGGLE_DO_NOT_DISTURB_MODE_BY_SOURCE, accessor => {
        ...
        picker.placeholder = ( localize(3831, "Select sources to enable all notifications from"));
    ...
    const category = ( localize2(3832, "Notifications"));
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: SHOW_NOTIFICATIONS_CENTER,
            title: ( localize2(3833, "Show Notifications")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: HIDE_NOTIFICATIONS_CENTER,
            title: ( localize2(3834, "Hide Notifications")),
            category
        },
        when: NotificationsCenterVisibleContext
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3835, "Clear All Notifications")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: ACCEPT_PRIMARY_ACTION_NOTIFICATION,
            title: ( localize2(3836, "Accept Notification Primary Action")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3837, "Toggle Do Not Disturb Mode")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3838, "Toggle Do Not Disturb Mode By Source...")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3839, "Focus Notification Toast")),
            category
        },
        when: NotificationsToastsVisibleContext
    });
    MenuRegistry.appendMenuItem(MenuId.TitleBar, {
        command: {
            ...
            title: ( localize(3840, "Toggle Notifications")),
            icon: Codicon.bell
        },
        group: "navigation",
        order: 10000,
...
registerAction2(class SetNotificationsPositionBottomRight extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3841, "Bottom Right")),
...
registerAction2(class SetNotificationsPositionBottomLeft extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3842, "Bottom Left")),
            toggled: ( ContextKeyExpr.equals(
                `config.${NotificationsSettings.NOTIFICATIONS_POSITION}`,
...
registerAction2(class SetNotificationsPositionTopRight extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3843, "Top Right")),
            toggled: ( ContextKeyExpr.equals(
                `config.${NotificationsSettings.NOTIFICATIONS_POSITION}`,
                NotificationsPosition.TOP_RIGHT
            )),
...
NotificationActionRunner = ( __decorate([( __param(0, ITelemetryService)), ( __param(1, INotificationService))], NotificationActionRunner));
