...
import { PANEL_TITLE_BORDER, PANEL_BACKGROUND, PANEL_BORDER, PANEL_DRAG_AND_DROP_BORDER, PANEL_TITLE_BADGE_FOREGROUND, PANEL_TITLE_BADGE_BACKGROUND, PANEL_INACTIVE_TITLE_FOREGROUND, PANEL_ACTIVE_TITLE_FOREGROUND, PANEL_ACTIVE_TITLE_BORDER } from '../../../common/theme.js';
...
let PanelPart = class PanelPart extends AbstractPaneCompositePart {
    ...
    constructor(
        ...
        }, PanelPart_1.activePanelSettingsKey, ActivePanelContext.bindTo(contextKeyService), PanelFocusContext.bindTo(contextKeyService), "panel", "panel", undefined, PANEL_TITLE_BORDER, ViewContainerLocation.Panel, Extensions.Panels, MenuId.PanelTitle, notificationService, storageService, contextMenuService, layoutService, keybindingService, hoverService, instantiationService, themeService, viewDescriptorService, contextKeyService, extensionService, menuService, configurationService);
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const panelPositionMenu = this.menuService.getMenuActions(MenuId.PanelPositionMenu, this.contextKeyService, {
            shouldForwardArgs: true
        });
        const panelAlignMenu = this.menuService.getMenuActions(MenuId.PanelAlignmentMenu, this.contextKeyService, {
            shouldForwardArgs: true
        });
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: panelShowLabels ? ( localize(3914, "Show Icons")) : ( localize(3915, "Show Labels")),
            run: () => this.configurationService.updateValue("workbench.panel.showLabels", !panelShowLabels)
        });
        actions.push(...[( new Separator()), ( new SubmenuAction("workbench.action.panel.position", ( localize(3916, "Panel Position")), positionActions)), ( new SubmenuAction("workbench.action.panel.align", ( localize(3917, "Align Panel")), alignActions)), toggleShowLabelsAction, toAction({
            id: TogglePanelAction.ID,
            label: ( localize(3918, "Hide Panel")),
...
PanelPart = PanelPart_1 = ( __decorate([( __param(0, INotificationService)), ( __param(1, IStorageService)), ( __param(2, IContextMenuService)), ( __param(3, IWorkbenchLayoutService)), ( __param(4, IKeybindingService)), ( __param(5, IHoverService)), ( __param(6, IInstantiationService)), ( __param(7, IThemeService)), ( __param(8, IViewDescriptorService)), ( __param(9, IContextKeyService)), ( __param(10, IExtensionService)), ( __param(11, ICommandService)), ( __param(12, IMenuService)), ( __param(13, IConfigurationService))], PanelPart));
