...
import { defaultDialogStyles, defaultInputBoxStyles, defaultCheckboxStyles, defaultButtonStyles } from '../../../../platform/theme/browser/defaultStyles.js';
...
function createWorkbenchDialogOptions(
    options,
    keybindingService,
    layoutService,
    hostService,
...
export { createBrowserAboutDialogDetails, createWorkbenchDialogOptions };
