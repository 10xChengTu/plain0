...
let PaneComposite = class PaneComposite extends Composite {
    ...
    getSecondaryActions() {
        ...
        if (viewsSubmenuActionIndex !== -1) {
            ...
            if (( viewsSubmenuAction.actions.some((
                {
                    enabled
                }
            ) => enabled))) {
...
PaneComposite = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IStorageService)), ( __param(3, IInstantiationService)), ( __param(4, IThemeService)), ( __param(5, IContextMenuService)), ( __param(6, IExtensionService)), ( __param(7, IWorkspaceContextService))], PaneComposite));
