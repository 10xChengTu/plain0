...
const menubarIcon = registerIcon("menuBar", Codicon.layoutMenubar, ( localize(3027, "Represents the menu bar")));
const activityBarLeftIcon = registerIcon("activity-bar-left", Codicon.layoutActivitybarLeft, ( localize(3028, "Represents the activity bar in the left position")));
const activityBarRightIcon = registerIcon("activity-bar-right", Codicon.layoutActivitybarRight, ( localize(3029, "Represents the activity bar in the right position")));
const panelLeftIcon = registerIcon("panel-left", Codicon.layoutSidebarLeft, ( localize(3030, "Represents a side bar in the left position")));
const panelLeftOffIcon = registerIcon("panel-left-off", Codicon.layoutSidebarLeftOff, ( localize(3031, "Represents a side bar in the left position toggled off")));
const panelRightIcon = registerIcon("panel-right", Codicon.layoutSidebarRight, ( localize(3032, "Represents side bar in the right position")));
const panelRightOffIcon = registerIcon("panel-right-off", Codicon.layoutSidebarRightOff, ( localize(3033, "Represents side bar in the right position toggled off")));
const panelIcon = registerIcon("panel-bottom", Codicon.layoutPanel, ( localize(3034, "Represents the bottom panel")));
const statusBarIcon = registerIcon("statusBar", Codicon.layoutStatusbar, ( localize(3035, "Represents the status bar")));
const panelAlignmentLeftIcon = registerIcon("panel-align-left", Codicon.layoutPanelLeft, ( localize(3036, "Represents the bottom panel alignment set to the left")));
const panelAlignmentRightIcon = registerIcon("panel-align-right", Codicon.layoutPanelRight, ( localize(3037, "Represents the bottom panel alignment set to the right")));
const panelAlignmentCenterIcon = registerIcon("panel-align-center", Codicon.layoutPanelCenter, ( localize(3038, "Represents the bottom panel alignment set to the center")));
const panelAlignmentJustifyIcon = registerIcon("panel-align-justify", Codicon.layoutPanelJustify, ( localize(3039, "Represents the bottom panel alignment set to justified")));
const quickInputAlignmentTopIcon = registerIcon("quickInputAlignmentTop", Codicon.arrowUp, ( localize(3040, "Represents quick input alignment set to the top")));
const quickInputAlignmentCenterIcon = registerIcon("quickInputAlignmentCenter", Codicon.circle, ( localize(3041, "Represents quick input alignment set to the center")));
const fullscreenIcon = registerIcon("fullscreen", Codicon.screenFull, ( localize(3042, "Represents full screen")));
const centerLayoutIcon = registerIcon("centerLayoutIcon", Codicon.layoutCentered, ( localize(3043, "Represents centered layout mode")));
const zenModeIcon = registerIcon("zenMode", Codicon.target, ( localize(3044, "Represents zen mode")));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3045, "Toggle Centered Layout")),
                mnemonicTitle: ( localize(3046, "&&Centered Layout"))
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2(3047, "Move Primary Side Bar Right")), Position.RIGHT);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2(3048, "Move Primary Side Bar Left")), Position.LEFT);
    }
}
...
class ToggleSidebarPositionAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3049, "Toggle Primary Side Bar Position"));
    }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === Position.LEFT ? ( localize(3047, "Move Primary Side Bar Right")) : ( localize(3048, "Move Primary Side Bar Left"));
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: ( localize2(3049, "Toggle Primary Side Bar Position")),
            category: Categories.View,
            f1: true,
...
const configureLayoutIcon = registerIcon("configure-layout-icon", Codicon.layout, ( localize(3050, "Icon represents workbench layout configuration.")));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: ( localize(3051, "Configure Layout")),
...
MenuRegistry.appendMenuItems([{
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(3052, "Move Primary Side Bar Right"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(3053, "Move Primary Side Bar Left"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(3054, "Move Secondary Side Bar Left"))
        },
        when: ( ContextKeyExpr.and(( ContextKeyExpr.notEquals("config.workbench.sideBar.location", "right")), ( ContextKeyExpr.equals(
            "viewContainerLocation",
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(3055, "Move Secondary Side Bar Right"))
        },
        when: ( ContextKeyExpr.and(( ContextKeyExpr.equals("config.workbench.sideBar.location", "right")), ( ContextKeyExpr.equals(
            "viewContainerLocation",
            ViewContainerLocationToString(ViewContainerLocation.AuxiliaryBar)
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(3056, "&&Move Primary Side Bar Right"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(3057, "&&Move Primary Side Bar Left"))
    },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3058, "Toggle Editor Area Visibility")),
                mnemonicTitle: ( localize(3059, "Show &&Editor Area"))
            },
            category: Categories.View,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: "2_appearance",
    title: ( localize(3060, "&&Appearance")),
...
class ToggleSidebarVisibilityAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3061, "Hide Primary Side Bar"));
    }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize2(3062, "Toggle Primary Side Bar Visibility")),
            toggled: {
                condition: SideBarVisibleContext,
                title: ( localize(3063, "Primary Side Bar")),
                mnemonicTitle: ( localize(3064, "&&Primary Side Bar"))
            },
            metadata: {
                description: ( localize(3065, "Open/Show and Close/Hide Sidebar"))
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItems([{
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize(3061, "Hide Primary Side Bar"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize(3068, "Toggle Primary Side Bar")),
...
class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3069, "Toggle Status Bar Visibility")),
                mnemonicTitle: ( localize(3070, "S&&tatus Bar"))
            },
            category: Categories.View,
            f1: true,
            precondition: ( IsSessionsWindowContext.negate()),
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3071, "Hide Editor Tabs"));
        super(
...
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3073, "Hide Editor Tabs in Zen Mode"));
        super(
            ...
            precondition,
            ( localize2(3074, "Hide Tab Bar in Zen Mode"))
        );
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3075, "Show Multiple Editor Tabs"));
        super(
            LayoutSettings.EDITOR_TABS_MODE,
            ...
            precondition,
            ( localize2(3076, "Show Tab Bar with multiple tabs"))
        );
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3077, "Show Multiple Editor Tabs in Zen Mode"));
        super(
            ZenModeSettings.SHOW_TABS,
            EditorTabsMode.MULTIPLE,
            title,
            ...
            precondition,
            ( localize2(3078, "Show Tab Bar in Zen Mode"))
        );
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3079, "Show Single Editor Tab"));
        super(
            LayoutSettings.EDITOR_TABS_MODE,
            ...
            precondition,
            ( localize2(3080, "Show Tab Bar with one Tab"))
        );
    }
}
...
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(3081, "Show Single Editor Tab in Zen Mode"));
        super(
            ZenModeSettings.SHOW_TABS,
            EditorTabsMode.SINGLE,
            title,
            ...
            precondition,
            ( localize2(3082, "Show Tab Bar in Zen Mode with one Tab"))
        );
    }
}
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    submenu: MenuId.EditorTabsBarShowTabsSubmenu,
    title: ( localize(3083, "Tab Bar")),
    group: "3_workbench_layout_move",
    order: 10,
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3084, "Move Editor Actions to Title Bar")),
            category: Categories.View,
            ...
            )).negate()), ( IsSessionsWindowContext.negate()))),
            metadata: {
                description: ( localize2(3085, "Move Editor Actions from the tab bar to the title bar"))
            },
            f1: true
        });
    }
...
class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3086, "Move Editor Actions to Tab Bar")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.DEFAULT
            )).negate()), ( ( ContextKeyExpr.equals(`config.${LayoutSettings.EDITOR_TABS_MODE}`, EditorTabsMode.NONE)).negate()), ( IsSessionsWindowContext.negate()))),
            metadata: {
                description: ( localize2(3087, "Move Editor Actions from the title bar to the tab bar"))
            },
            f1: true
        });
    }
...
class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3088, "Hide Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
            ...
            metadata: {
                description: ( localize2(3089, "Hide Editor Actions in the tab and title bar"))
            },
            f1: true
        });
    }
...
class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3090, "Show Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            ...
            metadata: {
                description: ( localize2(3091, "Make Editor Actions visible."))
            },
            f1: true
        });
    }
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(3092, "Editor Actions Position")),
    group: "3_workbench_layout_move",
    order: 11,
    when: ( IsSessionsWindowContext.negate())
});
class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3093, "Configure Tabs")),
            category: Categories.View
        });
    }
    run(accessor) {
...
class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3094, "Configure Editors")),
            category: Categories.View
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3095, "Separate Pinned Editor Tabs")),
            category: Categories.View,
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...( localize2(3097, "Toggle Menu Bar")),
                    mnemonicTitle: ( localize(3098, "Menu &&Bar"))
                },
                category: Categories.View,
                f1: true,
                precondition: ( IsSessionsWindowContext.negate()),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3100, "Reset View Locations")),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3101, "Move View")),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(3102, "Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(3103, "Panel / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(3104, "Secondary Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = ( localize(3105, "Select a View to Move"));
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3106, "Move Focused View")),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === "") {
            dialogService.error(( localize(3107, "There is no view currently focused.")));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor?.canMoveView) {
            dialogService.error(( localize(3108, "The currently focused view is not movable.")));
            return;
        }
        const disposables = ( new DisposableStore());
        const quickPick = disposables.add(quickInputService.createQuickPick({
        ...
        quickPick.placeholder = ( localize(3109, "Select a Destination for the View"));
        quickPick.title = ( localize(3110, "View: Move {0}", viewDescriptor.name.value));
        const items = [];
        ...
        items.push({
            type: "separator",
            label: ( localize(3116, "Secondary Side Bar"))
        });
        ...
        disposables.add(quickPick.onDidAccept(() => {
            ...
            if (destination.id === "_.panel.newcontainer") {
                ...
                viewDescriptorService.moveViewsToContainer(
                    [viewDescriptor],
                    viewDescriptorService.getViewContainerById(destination.id),
                    undefined,
                    this.desc.id
                );
                viewsService.openView(focusedViewId, true);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3117, "Reset Focused View Location")),
            category: Categories.View,
            f1: true,
            precondition: ( FocusedViewContext.notEqualsTo(""))
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(( localize(3118, "There is no view currently focused.")));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3119, "Increase Current View Size")),
            f1: true,
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3120, "Increase Editor Width")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3121, "Increase Editor Height")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3122, "Decrease Current View Size")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3123, "Decrease Editor Width")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3124, "Decrease Editor Height")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3125, "Align Quick Input Top")),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3126, "Align Quick Input Center")),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(3127, "Select to Hide")),
        inactiveAriaLabel: ( localize(3128, "Select to Show")),
        useButtons: true
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(3129, "Active")),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(
        CreateToggleLayoutItem("workbench.action.toggleMenuBar", MenuBarToggledContext, ( localize(3130, "Menu Bar")), menubarIcon)
    );
}
ToggleVisibilityActions.push(
    ...[CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.notEquals("config.workbench.activityBar.location", "hidden")), ( localize(3131, "Activity Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: activityBarLeftIcon,
        iconB: activityBarRightIcon
    }), CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, ( localize(3132, "Primary Side Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: panelLeftIcon,
        iconB: panelRightIcon
    }), CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, ( localize(3116, "Secondary Side Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: panelRightIcon,
        iconB: panelLeftIcon
    }), CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, ( localize(3115, "Panel")), panelIcon), CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ( ContextKeyExpr.equals("config.workbench.statusBar.visible", true)), ( localize(3133, "Status Bar")), statusBarIcon)]
);
const MoveSideBarActions = [CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")), ( localize(3134, "Left")), panelLeftIcon), CreateOptionLayoutItem(MoveSidebarRightAction.ID, ( ContextKeyExpr.equals("config.workbench.sideBar.location", "right")), ( localize(3135, "Right")), panelRightIcon)];
const AlignPanelActions = [CreateOptionLayoutItem("workbench.action.alignPanelLeft", ( PanelAlignmentContext.isEqualTo("left")), ( localize(3136, "Left")), panelAlignmentLeftIcon), CreateOptionLayoutItem("workbench.action.alignPanelRight", ( PanelAlignmentContext.isEqualTo("right")), ( localize(3137, "Right")), panelAlignmentRightIcon), CreateOptionLayoutItem("workbench.action.alignPanelCenter", ( PanelAlignmentContext.isEqualTo("center")), ( localize(3138, "Center")), panelAlignmentCenterIcon), CreateOptionLayoutItem("workbench.action.alignPanelJustify", ( PanelAlignmentContext.isEqualTo("justify")), ( localize(3139, "Justify")), panelAlignmentJustifyIcon)];
const QuickInputActions = [
    CreateOptionLayoutItem("workbench.action.alignQuickInputTop", ( QuickInputAlignmentContextKey.isEqualTo("top")), ( localize(3140, "Top")), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem("workbench.action.alignQuickInputCenter", ( QuickInputAlignmentContextKey.isEqualTo("center")), ( localize(3141, "Center")), quickInputAlignmentCenterIcon)
];
const MiscLayoutOptions = [CreateOptionLayoutItem(
    "workbench.action.toggleFullScreen",
    IsMainWindowFullscreenContext,
    ( localize(3142, "Full Screen")),
    fullscreenIcon
), CreateOptionLayoutItem("workbench.action.toggleZenMode", InEditorZenModeContext, ( localize(3143, "Zen Mode")), zenModeIcon), CreateOptionLayoutItem(
    "workbench.action.toggleCenteredLayout",
    IsMainEditorCenteredLayoutContext,
    ( localize(3144, "Centered Layout")),
    centerLayoutIcon
)];
...
const EditorActionsInTitleBar = ( ContextKeyExpr.or(( ContextKeyExpr.equals(
    `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
    EditorActionsLocation.TITLEBAR
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3145, "Customize Layout...")),
            f1: true,
            icon: configureLayoutIcon,
            menu: [{
                id: MenuId.LayoutControlMenuSubmenu,
                ...
                id: MenuId.LayoutControlMenu,
                when: ( ContextKeyExpr.and(( IsAuxiliaryWindowContext.toNegated()), ( ContextKeyExpr.equals("config.workbench.layoutControl.type", "both")), ( EditorActionsInTitleBar.negate()))),
                group: "navigation"
            }, {
                id: MenuId.LayoutControlMenu,
                when: ( ContextKeyExpr.and(( IsAuxiliaryWindowContext.toNegated()), ( ContextKeyExpr.equals("config.workbench.layoutControl.type", "both")), EditorActionsInTitleBar)),
                group: "1_layout"
            }]
        });
    }
    getItems(contextKeyService, keybindingService) {
        ...
        return [{
            type: "separator",
            label: ( localize(3146, "Visibility"))
        }, ...( ToggleVisibilityActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(3147, "Primary Side Bar Position"))
        }, ...( MoveSideBarActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(3148, "Panel Alignment"))
        }, ...( AlignPanelActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(3149, "Quick Input Position"))
        }, ...( QuickInputActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(3150, "Modes"))
    ...
    run(accessor) {
        ...
        quickPick.title = ( localize(3151, "Customize Layout"));
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: ( localize(3152, "Close"))
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: ( localize(3153, "Restore Defaults"))
        };
