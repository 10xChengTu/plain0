...
import { OpenFolderWorkspaceSupportContext, WorkbenchStateContext, EnterMultiRootWorkspaceSupportContext, EmptyWorkspaceSupportContext, IsSessionsWindowContext, WorkspaceFolderCountContext } from '../../common/contextkeys.js';
...
const workspacesCategory = ( localize2(3208, "Workspaces"));
class OpenFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3209, "Open File...")),
...
class OpenFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3210, "Open Folder...")),
            category: Categories.File,
            f1: true,
...
class OpenFileFolderAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize2(3211, "Open..."));
    }
    constructor() {
        super({
...
class OpenWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3212, "Open Workspace from File...")),
            category: Categories.File,
            f1: true,
...
class CloseWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3213, "Close Workspace")),
...
class OpenWorkspaceConfigFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3214, "Open Workspace Configuration File")),
            category: workspacesCategory,
            f1: true,
...
class RemoveRootFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3215, "Remove Folder from Workspace...")),
            category: workspacesCategory,
            f1: true,
...
class SaveWorkspaceAsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3216, "Save Workspace As...")),
            category: workspacesCategory,
            f1: true,
    ...
    async run(accessor) {
        ...
        if (configPathUri && hasWorkspaceFileExtension(configPathUri)) {
            ...
            case WorkbenchState.FOLDER:
                {
                    const folders = ( contextService.getWorkspace().folders.map(folder => ({
                        uri: folder.uri
                    })));
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3217, "Duplicate As Workspace in New Window")),
            category: workspacesCategory,
            f1: true,
            precondition: ( ContextKeyExpr.and(EnterMultiRootWorkspaceSupportContext, ( IsSessionsWindowContext.negate())))
        });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenFolderAction.ID,
        title: ( localize(3219, "Open &&Folder..."))
    },
    order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenWorkspaceAction.ID,
        title: ( localize(3221, "Open Wor&&kspace from File..."))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(3222, "A&&dd Folder to Workspace..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: SaveWorkspaceAsAction.ID,
        title: ( localize(3223, "Save Workspace As..."))
    },
    order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: DuplicateWorkspaceInNewWindowAction.ID,
        title: ( localize(3224, "Duplicate Workspace"))
    },
    order: 3,
    when: ( ContextKeyExpr.and(EnterMultiRootWorkspaceSupportContext, ( IsSessionsWindowContext.negate())))
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(3225, "Close &&Folder"))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(3226, "Close &&Workspace"))
    },
    order: 3,
