...
import { ExtHostChatAgentsShape2, IChatAgentCompletionItem, IChatAgentHistoryEntryDto, IChatAgentInvokeResult, IChatAgentProgressShape, IChatSessionCustomizationItemDto, IChatSessionCustomizationSourceFolderDto, IChatSessionContextDto, IMainContext } from "./extHost.protocol.js";
...
export declare class ExtHostChatAgents2 extends Disposable implements ExtHostChatAgentsShape2 {
    ...
    private readonly _chatSessions;
    ...
    readonly onDidChangeSlashCommands: import("../../../base/common/event.js").Event<void>;
    private readonly _onDidChangeHooks;
    readonly onDidChangeHooks: import("../../../base/common/event.js").Event<void>;
    private readonly _onDidChangePlugins;
    readonly onDidChangePlugins: import("../../../base/common/event.js").Event<void>;
    ...
    constructor(mainContext: IMainContext, _logService: ILogService, _commands: ExtHostCommands, _documents: ExtHostDocuments, _editorsAndDocuments: ExtHostDocumentsAndEditors, _languageModels: ExtHostLanguageModels, _diagnostics: ExtHostDiagnostics, _tools: ExtHostLanguageModelTools, _chatSessions: ExtHostChatSessions);
    ...
    $provideChatSessionCustomizations(handle: number, sessionResource: UriComponents | undefined, token: CancellationToken): Promise<IChatSessionCustomizationItemDto[] | undefined>;
