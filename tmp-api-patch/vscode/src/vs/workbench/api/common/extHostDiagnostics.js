...
let ExtHostDiagnostics = class ExtHostDiagnostics {
    ...
    static {
        this._maxDiagnosticsPerFile = 1000;
    }
    static {
    ...
    static _mapper(last) {
        ...
        return {
            uris: ( Object.freeze(Array.from(( map.values()))))
        };
    }
    constructor(
        mainContext,
        ...
        const result = new (class extends DiagnosticCollection {
            constructor() {
                super(
                    name,
                    owner,
                    ExtHostDiagnostics_1._maxDiagnosticsTotal,
                    ExtHostDiagnostics_1._maxDiagnosticsPerFile,
...
ExtHostDiagnostics = ExtHostDiagnostics_1 = ( __decorate([( __param(1, ILogService)), ( __param(2, IExtHostFileSystemInfo))], ExtHostDiagnostics));
