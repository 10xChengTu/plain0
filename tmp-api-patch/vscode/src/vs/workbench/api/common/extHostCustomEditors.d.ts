...
export declare class ExtHostCustomEditors implements extHostProtocol.ExtHostCustomEditorsShape {
    ...
    $resolveCustomEditorInlineDiff(originalResource: UriComponents, modifiedResource: UriComponents, handle: extHostProtocol.WebviewHandle, viewType: string, initData: extHostProtocol.CustomEditorDiffInitData, position: EditorGroupColumn, cancellation: CancellationToken): Promise<void>;
    $resolveCustomEditorSideBySideDiff(originalResource: UriComponents, modifiedResource: UriComponents, webviewHandles: extHostProtocol.CustomEditorSideBySideDiffWebviewHandles, viewType: string, initData: extHostProtocol.CustomEditorSideBySideDiffInitData, position: EditorGroupColumn, cancellation: CancellationToken): Promise<void>;
