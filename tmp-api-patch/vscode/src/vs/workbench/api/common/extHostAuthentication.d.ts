...
export declare class ExtHostAuthentication implements ExtHostAuthenticationShape {
    ...
    protected readonly _xaaAuthProviderCtor: typeof DynamicAuthProvider;
    private _proxy;
    ...
    $registerXaaAuthProvider(issuerComponents: UriComponents, serverMetadata: IAuthorizationServerMetadata, clientId: string | undefined, clientSecret: string | undefined, initialTokens: IAuthorizationToken[] | undefined): Promise<string>;
...
export declare class TokenStore implements Disposable {
    private readonly _persistence;
    private readonly _logger;
    private readonly _tokensObservable;
    private readonly _sessionsObservable;
    ...
    }, initialTokens: IAuthorizationToken[], _logger: ILogger);
    ...
    private _registerChangeEventAutorun;
