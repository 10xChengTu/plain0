...
ExtHostConfiguration = ( __decorate([( __param(0, IExtHostRpcService)), ( __param(1, IExtHostWorkspace)), ( __param(2, ILogService))], ExtHostConfiguration));
class ExtHostConfigProvider {
    ...
    getConfiguration(section, scope, extensionDescription) {
        ...
        function parseConfigurationTarget(arg) {
            ...
            switch (arg) {
            case ConfigurationTarget$1.Global:
                return ConfigurationTarget.USER;
            case ConfigurationTarget$1.Workspace:
                return ConfigurationTarget.WORKSPACE;
            case ConfigurationTarget$1.WorkspaceFolder:
