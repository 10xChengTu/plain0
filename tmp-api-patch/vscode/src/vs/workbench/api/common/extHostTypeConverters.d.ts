...
export declare namespace Color {
    ...
    function from(color: types.Color): [
        number,
        number,
        number,
        number
...
export declare namespace DataTransfer {
    ...
    function fromList(dataTransfer: Iterable<readonly [
        string,
        IDataTransferItem
...
export declare namespace ChatResponseHookPart {
    function from(part: vscode.ChatResponseHookPart): Dto<IChatHookPart>;
    function to(part: Dto<IChatHookPart>): vscode.ChatResponseHookPart;
}
export declare namespace ChatResponseAutoModeResolutionPart {
    function from(part: vscode.ChatResponseAutoModeResolutionPart): Dto<IChatAutoModeResolutionPart>;
    function to(part: Dto<IChatAutoModeResolutionPart>): vscode.ChatResponseAutoModeResolutionPart;
}
...
export declare namespace ChatResponsePullRequestPart {
    function from(part: Omit<vscode.ChatResponsePullRequestPart, "command"> & {
        command?: vscode.Command;
    }, commandsConverter: CommandsConverter, commandDisposables: DisposableStore): Dto<IChatPullRequestContent>;
}
...
export declare namespace ChatToolInvocationPart {
    function from(part: vscode.ChatToolInvocationPart): IChatToolInvocationSerialized | IChatExternalToolInvocationUpdate;
...
export declare namespace ChatAgentRequest {
    function to(request: IChatAgentRequest, location2: vscode.ChatRequestEditorData | vscode.ChatRequestNotebookData | undefined, model: vscode.LanguageModelChat, modelConfiguration: IStringDictionary<unknown> | undefined, diagnostics: readonly [
        vscode.Uri,
        readonly vscode.Diagnostic[]
    ][], tools: Map<vscode.LanguageModelToolInformation, boolean>, extension: IRelaxedExtensionDescription, logService: ILogService): vscode.ChatRequest;
}
...
export declare namespace ChatSessionCustomizationType {
    ...
    function to(id: string): types.ChatSessionCustomizationType;
}
...
export declare namespace ChatRequestHooksConverter {
    function to(hooks: ChatRequestHooks): vscode.ChatRequestHooks;
}
export declare namespace ChatHookCommand {
    function to(hook: IParsedHookCommand): vscode.ChatHookCommand | undefined;
}
export declare namespace ChatSessionItem {
    function from(sessionContent: vscode.ChatSessionItem): Dto<IChatSessionItem>;
}
