...
import { IChatMessage, IChatResponsePart, ILanguageModelChatInfoOptions, ILanguageModelChatMetadataAndIdentifier, ILanguageModelChatRequestOptions } from "../../contrib/chat/common/languageModels.js";
...
export declare class ExtHostLanguageModels implements ExtHostLanguageModelsShape {
    ...
    private readonly _pendingCancelCTS;
    ...
    private _createLanguageModelChatApi;
