...
export declare class ExtHostLanguages implements ExtHostLanguagesShape {
    ...
    private readonly _onDidChangeSyntaxHighlighting;
    readonly onDidChangeSyntaxHighlighting: import("../../../base/common/event.js").Event<void>;
    ...
    computeFullSyntaxHighlighting(source: string, languageId: string): Promise<vscode.SyntaxHighlightingResult>;
