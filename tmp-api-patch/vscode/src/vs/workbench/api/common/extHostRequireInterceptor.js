...
let RequireInterceptor = class RequireInterceptor {
    ...
    async install() {
        ...
        if (this._initData.remote.isRemote) {
            this.register(this._instaService.createInstance(
...
RequireInterceptor = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, IExtHostConfiguration)), ( __param(4, IExtHostExtensionService)), ( __param(5, IExtHostInitDataService)), ( __param(6, ILogService))], RequireInterceptor));
...
NodeModuleAliasingModuleFactory = NodeModuleAliasingModuleFactory_1 = ( __decorate([( __param(0, IExtHostInitDataService))], NodeModuleAliasingModuleFactory));
...
let OpenNodeModuleFactory = class OpenNodeModuleFactory {
    ...
    sendShimmingTelemetry() {
        ...
        this._mainThreadTelemetry.$publicLog2("shimming.open", {
    ...
    sendNoForwardTelemetry() {
        ...
        this._mainThreadTelemetry.$publicLog2("shimming.open.call.noForward", {
            extension: this._extensionId
        });
    }
};
OpenNodeModuleFactory = ( __decorate([( __param(2, IExtHostRpcService))], OpenNodeModuleFactory));
