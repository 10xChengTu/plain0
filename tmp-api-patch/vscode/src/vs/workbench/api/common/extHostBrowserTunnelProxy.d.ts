...
export declare const IExtHostBrowserTunnelProxy: import("../../../platform/instantiation/common/instantiation.js").ServiceIdentifier<IExtHostBrowserTunnelProxy>;
/**
...
export declare class ExtHostBrowserTunnelProxy implements IExtHostBrowserTunnelProxy {
    readonly _serviceBrand: undefined;
