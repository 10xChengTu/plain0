    ...
    return function(extension, extensionInfo, configProvider) {
        ...
        const authentication = {
            ...
            get onDidChangeSessions() {
                return _asExtensionEvent(
                    extHostAuthentication.getExtensionScopedSessionsEvent(extension.identifier.value)
                );
            },
        ...
        const window = {
            ...
            withScmProgress(task) {
                ...
                return extHostProgress.withProgress(extension, {
            ...
            createTerminal(nameOrOptions, shellPath, shellArgs) {
                if (typeof nameOrOptions === "object") {
                    ...
                    if (!isProposedApiEnabled(extension) && "titleTemplate" in nameOrOptions && nameOrOptions.titleTemplate !== undefined) {
                        console.error(
        ...
        const workspace = {
            ...
            onWillSaveNotebookDocument(listener, thisArg, disposables) {
                return _asExtensionEvent(
                    extHostNotebookDocumentSaveParticipant.getOnWillSaveNotebookDocumentEvent(extension)
            ...
            registerNotebookSerializer(viewType, serializer, options, registration) {
                return extHostNotebook.registerNotebookSerializer(
                    ...
                    serializer,
                    options,
                    isProposedApiEnabled(extension) ? registration : undefined
                );
            },
        ...
        const notebooks = {
            createNotebookController(id, notebookType, label, handler, rendererScripts) {
                return extHostNotebookKernels.createNotebookController(
                    ...
                    label,
                    handler,
                    isProposedApiEnabled(extension) ? rendererScripts : undefined
                );
            },
        ...
        const chat = {
            ...
            registerChatSessionItemProvider: (chatSessionType, provider) => {
                ...
                extHostApiDeprecation.report(
                    ...
                    extension,
                    `Please migrate to the new chat session controller API`,
                    {
            ...
            registerChatContextProvider(selector, id, provider) {
                checkProposedApiEnabled(extension, "chatContextProvider");
                return extHostChatContext.registerChatContextProvider(
                    selector ? checkSelector(selector) : undefined,
                    `${extension.id}-${id}`,
                    provider
                );
            },
        ...
        return {
            ...
            ChatSubagentToolInvocationData: ChatSubagentToolInvocationData,
            ...
            ChatDebugToolCallEvent: ChatDebugToolCallEvent,
            ChatDebugModelTurnEvent: ChatDebugModelTurnEvent,
            ChatDebugGenericEvent: ChatDebugGenericEvent,
            ChatDebugSubagentInvocationEvent: ChatDebugSubagentInvocationEvent,
            ChatDebugUserMessageEvent: ChatDebugUserMessageEvent,
            ChatDebugAgentResponseEvent: ChatDebugAgentResponseEvent,
            ChatDebugMessageSection: ChatDebugMessageSection,
            ChatDebugEventTextContent: ChatDebugEventTextContent,
            ChatDebugMessageContentType: ChatDebugMessageContentType,
            ChatDebugEventMessageContent: ChatDebugEventMessageContent,
            ChatDebugEventToolCallContent: ChatDebugEventToolCallContent,
            ChatDebugEventModelTurnContent: ChatDebugEventModelTurnContent,
            ChatDebugEventHookContent: ChatDebugEventHookContent,
            ...
            McpToolInvocationContentData: McpToolInvocationContentData,
