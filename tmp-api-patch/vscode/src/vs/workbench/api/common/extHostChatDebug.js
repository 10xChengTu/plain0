...
import { ChatDebugSubagentStatus, ChatDebugToolCallResult, ChatDebugHookResult, ChatDebugMessageContentType, ChatDebugAgentResponseEvent, ChatDebugMessageSection, ChatDebugUserMessageEvent, ChatDebugSubagentInvocationEvent, ChatDebugGenericEvent, ChatDebugModelTurnEvent, ChatDebugToolCallEvent } from './extHostTypes.js';
        ...
        case "toolCall":
            {
                ...
                return {
                    ...
                    input: e.input,
                    output: e.output,
                    result: e.result === ChatDebugToolCallResult.Success ? "success" : e.result === ChatDebugToolCallResult.Error ? "error" : undefined,
        ...
        case "subagentInvocation":
            {
                ...
                return {
                    ...
                    status: e.status === ChatDebugSubagentStatus.Running ? "running" : e.status === ChatDebugSubagentStatus.Completed ? "completed" : e.status === ChatDebugSubagentStatus.Failed ? "failed" : undefined,
                    durationInMillis: e.durationInMillis,
        ...
        case "toolCallContent":
            {
                ...
                return {
                    ...
                    result: tc.result === ChatDebugToolCallResult.Success ? "success" : tc.result === ChatDebugToolCallResult.Error ? "error" : undefined,
        ...
        case "hookContent":
            {
                ...
                return {
                    ...
                    command: hk.command,
                    result: hk.result === ChatDebugHookResult.Success ? "success" : hk.result === ChatDebugHookResult.Error ? "error" : hk.result === ChatDebugHookResult.NonBlockingError ? "nonBlockingError" : undefined,
        ...
        case "toolCall":
            {
                ...
                evt.result = dto.result === "success" ? ChatDebugToolCallResult.Success : dto.result === "error" ? ChatDebugToolCallResult.Error : undefined;
        ...
        case "subagentInvocation":
            {
                ...
                evt.status = dto.status === "running" ? ChatDebugSubagentStatus.Running : dto.status === "completed" ? ChatDebugSubagentStatus.Completed : dto.status === "failed" ? ChatDebugSubagentStatus.Failed : undefined;
                evt.durationInMillis = dto.durationInMillis;
...
ExtHostChatDebug = ( __decorate([( __param(0, IExtHostRpcService))], ExtHostChatDebug));
