...
export declare enum SyntaxHighlightingTokenFontStyle {
    None = 0,
    Italic = 1,
    Bold = 2,
    Underline = 4,
...
export declare class ChatResponseAutoModeResolutionPart {
...
export declare enum ChatDebugHookResult {
    Success = 0,
    Error = 1,
    NonBlockingError = 2
}
...
export declare class ChatDebugEventHookContent {
