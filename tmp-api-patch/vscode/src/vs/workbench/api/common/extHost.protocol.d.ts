...
import { IRemoteConsoleLog } from "@codingame/monaco-vscode-extensions-service-override/vscode/vs/base/common/console";
...
export interface MainThreadDocumentsShape extends IDisposable, IExtHostDocumentSaveDelegate {
    ...
    $tryOpenDocument(uri: UriComponents, options?: {
        encoding?: string;
    }): Promise<UriComponents>;
...
export interface ExtHostChatDebugShape {
    ...
    $importChatDebugLog(handle: number, data: VSBuffer, token: CancellationToken): Promise<{
        uri: UriComponents;
        sessionTitle?: string;
    } | undefined>;
...
export type IChatContentProgressDto = Dto<Exclude<IChatProgressHistoryResponseContent, IChatTask | IChatMultiDiffData>> | IChatMultiDiffDataSerialized | IChatTaskDto;
...
export type IChatProgressDto = Dto<Exclude<IChatProgress, IChatTask | IChatNotebookEdit>> | IChatTaskDto | IChatNotebookEditDto | IChatExternalEditsDto | IChatResponseClearToPreviousToolInvocationDto | IChatBeginToolInvocationDto | IChatUpdateToolInvocationDto | IChatUsageDto;
...
export interface ExtHostAuthenticationShape {
    ...
    $registerXaaAuthProvider(issuer: UriComponents, serverMetadata: IAuthorizationServerMetadata, clientId?: string, clientSecret?: string, initialTokens?: (IAuthorizationTokenResponse & {
        created_at: number;
    })[]): Promise<string>;
 ...
 * in the editor.
 */
export declare class TerminalCompletionListDto<T extends ITerminalCompletionItemDto = ITerminalCompletionItemDto> {
    /**
...
export interface ExtHostMcpShape {
    ...
    $onDidChangeGatewayServers(gatewayId: string, servers: {
        label: string;
...
export declare enum IAuthServerMetadataSource {
...
export declare const MainContext: {
    ...
    MainThreadAgentEditorComments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadAgentEditorCommentsShape>;
    ...
    MainThreadBrowserTunnelProxy: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadBrowserTunnelProxyShape>;
    ...
    MainThreadChatQuota: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadChatQuotaShape>;
    ...
    MainThreadBrowsers: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadBrowsersShape>;
};
export declare const ExtHostContext: {
    ...
    ExtHostAgentEditorComments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostAgentEditorCommentsShape>;
    ...
    ExtHostBrowserTunnelProxy: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostBrowserTunnelProxyShape>;
    ...
    ExtHostChatQuota: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostChatQuotaShape>;
    ExtHostGitExtension: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostGitExtensionShape>;
    ExtHostBrowsers: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostBrowsersShape>;
};
export {};
