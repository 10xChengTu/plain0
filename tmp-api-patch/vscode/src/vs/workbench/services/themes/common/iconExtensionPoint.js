...
const iconConfigurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(18075, "Contributes extension defined themable icons")),
        type: "object",
        propertyNames: {
            pattern: iconIdPattern,
            description: ( localize(18076, "The identifier of the themable icon")),
        ...
        additionalProperties: {
            ...
            properties: {
                description: {
                    type: "string",
                    description: ( localize(18078, "The description of the themable icon"))
                },
                default: {
                    anyOf: [iconReferenceSchema, {
                        type: "object",
                        properties: {
                            fontPath: {
                                description: ( localize(18079, "The path of the icon font that defines the icon.")),
                                type: "string"
                            },
                            fontCharacter: {
                                description: ( localize(18080, "The character for the icon in the icon font.")),
                                type: "string"
                            }
                        },
...
let ColorExtensionPointWorkbenchContribution = class ColorExtensionPointWorkbenchContribution {
    static {
        this.ID = "workbench.contrib.iconExtensionPoint";
    }
