...
const languagesExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(17805, "Contributes language declarations.")),
        type: "array",
        items: {
            type: "object",
            defaultSnippets: [{
            ...
            properties: {
                id: {
                    description: ( localize(17806, "ID of the language.")),
                    type: "string"
                },
                aliases: {
                    description: ( localize(17807, "Name aliases for the language.")),
                    type: "array",
                    items: {
                        type: "string"
                    }
                ...
                extensions: {
                    description: ( localize(17808, "File extensions associated to the language.")),
                    default: [".foo"],
                    type: "array",
                    items: {
                        type: "string"
                ...
                filenames: {
                    description: ( localize(17809, "File names associated to the language.")),
                    type: "array",
                    items: {
                        type: "string"
                    }
                ...
                filenamePatterns: {
                    description: ( localize(17810, "File name glob patterns associated to the language.")),
                    type: "array",
                    items: {
                        type: "string"
                    }
                ...
                mimetypes: {
                    description: ( localize(17811, "Mime types associated to the language.")),
                    type: "array",
                    items: {
                        type: "string"
                    }
                ...
                icon: {
                    ...
                    properties: {
                        light: {
                            description: ( localize(17815, "Icon path when a light theme is used")),
                            type: "string"
                        },
                        dark: {
                            description: ( localize(17816, "Icon path when a dark theme is used")),
                            type: "string"
                        }
                    }
                }
...
class LanguageTableRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [( localize(17817, "ID")), ( localize(17818, "Name")), ( localize(17819, "File Extensions")), ( localize(17820, "Grammar")), ( localize(17821, "Snippets"))];
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: "languages",
    label: ( localize(17822, "Programming Languages")),
    access: {
        canToggle: false
    },
...
WorkbenchLanguageService = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IConfigurationService)), ( __param(2, IEnvironmentService)), ( __param(3, ILogService))], WorkbenchLanguageService));
...
function isValidLanguageExtensionPoint(value, collector) {
    if (!value) {
        collector?.error(( localize(17824, "Empty value for `contributes.{0}`", languagesExtPoint.name)));
        return false;
    }
    if (typeof value.id !== "string") {
        collector?.error(( localize(17825, "property `{0}` is mandatory and must be of type `string`", "id")));
        return false;
    }
