...
export declare const EXTENSIONS_SUPPORT_AGENTS_WINDOW = "extensions.supportAgentsWindow";
export declare class ExtensionManifestPropertiesService extends Disposable implements IExtensionManifestPropertiesService {
    ...
    private _configuredSessionsWindowSupportMap;
    ...
    private getConfiguredSessionsWindowSupport;
