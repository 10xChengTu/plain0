...
const SESSIONS_WINDOW_ALLOWED_CONTRIBUTION_POINTS = ( new Set([
    "themes",
    "iconThemes",
    "productIconThemes",
    "colors",
    ...
    getSupportedExtensionKindsForExtensionPoint(extensionPoint) {
        if (this._extensionPointExtensionKindsMap === null) {
            ...
            ExtensionsRegistry.getExtensionPoints().forEach(
                e => extensionPointExtensionKindsMap.set(e.name, e.defaultExtensionKind || [] )
            );
...
ExtensionManifestPropertiesService = ( __decorate([( __param(0, IProductService)), ( __param(1, IConfigurationService)), ( __param(2, IWorkspaceTrustEnablementService)), ( __param(3, ILogService))], ExtensionManifestPropertiesService));

export { EXTENSIONS_SUPPORT_AGENTS_WINDOW, ExtensionManifestPropertiesService };
