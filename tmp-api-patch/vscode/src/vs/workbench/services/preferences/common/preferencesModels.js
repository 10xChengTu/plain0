...
import { Extensions, OVERRIDE_PROPERTY_REGEX, ConfigurationScope } from '../../../../platform/configuration/common/configurationRegistry.js';
...
Settings2EditorModel = ( __decorate([( __param(1, IConfigurationService))], Settings2EditorModel));
...
class DefaultSettings extends Disposable {
    ...
    getMostCommonlyUsedSettings() {
        ...
        return {
            id: "mostCommonlyUsed",
            range: nullRange,
            title: ( localize(17858, "Commonly Used")),
            titleRange: nullRange,
            sections: [{
                settings
            }]
    ...
    writeResultGroups(groups, startLine) {
        ...
        if (groups.length) {
            ...
            groups.forEach(resultGroup => {
                ...
                matches.push(
                    ...this.writeSettingsGroupToBuilder(builder, settingsGroup, resultGroup.result.filterMatches)
                );
            });
        }
...
DefaultKeybindingsEditorModel = ( __decorate([( __param(1, IKeybindingService))], DefaultKeybindingsEditorModel));

export { DefaultKeybindingsEditorModel, DefaultRawSettingsEditorModel, DefaultSettings, DefaultSettingsEditorModel, Settings2EditorModel, SettingsEditorModel, WorkspaceConfigurationEditorModel, defaultKeybindingsContents, fixSettingLinks, nullRange };
