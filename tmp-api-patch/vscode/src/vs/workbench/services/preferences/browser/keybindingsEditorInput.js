...
const KeybindingsEditorIcon = registerIcon("keybindings-editor-label-icon", Codicon.keyboard, ( localize(17842, "Icon of the keybindings editor label.")));
let KeybindingsEditorInput = class KeybindingsEditorInput extends EditorInput {
    ...
    getName() {
        return localize(17843, "Keyboard Shortcuts");
    }
    getIcon() {
