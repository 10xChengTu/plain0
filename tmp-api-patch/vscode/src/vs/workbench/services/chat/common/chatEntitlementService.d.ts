...
export declare namespace ChatEntitlementContextKeys {
    ...
    const clientByokEnabled: RawContextKey<boolean>;
    const hasByokModels: RawContextKey<boolean>;
}
 ...
 */
export declare function chatRequiresSetup(context: IChatSetupRequirement): boolean;
/**
...
export declare class ChatEntitlementService extends Disposable implements IChatEntitlementService {
    ...
    private readonly _onDidChangeUsageBasedBilling;
...
export declare function parseQuotas(entitlementsData: IEntitlementsData): IQuotas;
...
export declare class ChatEntitlementContext extends Disposable {
    ...
    private static readonly CHAT_ENTITLEMENT_CONTEXT_MIGRATED_STORAGE_KEY;
    ...
    private readonly completedContext;
    private readonly hiddenContext;
    private readonly disabledInWorkspaceContext;
