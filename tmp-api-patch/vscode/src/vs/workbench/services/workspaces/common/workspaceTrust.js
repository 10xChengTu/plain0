...
WorkspaceTrustEnablementService = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IWorkbenchEnvironmentService))], WorkspaceTrustEnablementService));
let WorkspaceTrustManagementService = class WorkspaceTrustManagementService extends Disposable {
    ...
    registerListeners() {
        this._register(
            this.workspaceService.onDidChangeWorkspaceFolders(async () => await this.updateWorkspaceTrust())
        );
        this._register(
            this.storageService.onDidChangeValue(StorageScope.APPLICATION_SHARED, this.storageKey, this._store)(async () => {
    ...
    async resolveCanonicalUris() {
        ...
        if (filesToOpen.length) {
            ...
            this._canonicalStartupFiles.push(...canonicalFilesToOpen.filter(
                uri => this._canonicalStartupFiles.every(u => !this.uriIdentityService.extUri.isEqual(uri, u))
            ));
        }
...
WorkspaceTrustManagementService = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IRemoteAuthorityResolverService)), ( __param(2, IStorageService)), ( __param(3, IUriIdentityService)), ( __param(4, IWorkbenchEnvironmentService)), ( __param(5, IWorkspaceContextService)), ( __param(6, IWorkspaceTrustEnablementService)), ( __param(7, IFileService))], WorkspaceTrustManagementService));
...
WorkspaceTrustRequestService = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IWorkspaceTrustManagementService))], WorkspaceTrustRequestService));
