...
export declare enum SemanticSearchBehavior {
    Auto = "auto",
    Manual = "manual",
...
export declare function isFilePatternMatch(candidate: IRawFileMatch, filePatternToUse: string, fuzzy?: boolean, ignoreCase?: boolean): boolean;
