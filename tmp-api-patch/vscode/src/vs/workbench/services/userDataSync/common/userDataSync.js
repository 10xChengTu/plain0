...
function getSyncAreaLabel(source) {
    ...
    case SyncResource.Settings:
        return localize(18259, "Settings");
    case SyncResource.Keybindings:
        return localize(18260, "Keyboard Shortcuts");
    case SyncResource.Snippets:
        return localize(18261, "Snippets");
    case SyncResource.Prompts:
        return localize(18262, "Prompts and Instructions");
    case SyncResource.Tasks:
        return localize(18263, "Tasks");
    case SyncResource.Mcp:
        return localize(18264, "MCP Servers");
    case SyncResource.Extensions:
        return localize(18265, "Extensions");
    case SyncResource.GlobalState:
        return localize(18266, "UI State");
    case SyncResource.Profiles:
        return localize(18267, "Profiles");
    case SyncResource.WorkspaceState:
        return localize(18268, "Workspace State");
    }
}
var AccountStatus;
...
const SYNC_TITLE = ( localize2(18269, "Settings Sync"));
const SYNC_VIEW_ICON = registerIcon("settings-sync-view-icon", Codicon.sync, ( localize(18270, "View icon of the Settings Sync view.")));
...
const DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR = {
    ...
    title: ( localize2(18271, "Download Settings Sync Activity")),
