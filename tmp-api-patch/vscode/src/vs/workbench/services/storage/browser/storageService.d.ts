...
export declare class BrowserStorageService extends AbstractStorageService {
    ...
    private applicationSharedStorage;
    private applicationSharedStorageDatabase;
    ...
    private createApplicationSharedStorage;
...
export declare class IndexedDBStorageDatabase extends Disposable implements IIndexedDBStorageDatabase {
    ...
    static createApplicationSharedStorage(logService: ILogService): Promise<IIndexedDBStorageDatabase>;
