...
const extensionVerifiedPublisherIconColor = registerColor("extensionIcon.verifiedForeground", textLinkForeground, ( localize(17628, "The icon color for extension verified publisher.")), false);
