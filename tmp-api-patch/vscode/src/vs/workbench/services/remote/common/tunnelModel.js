...
import { isLocalhost, LOCALHOST_ADDRESSES, isAllInterfaces, ALL_INTERFACES_ADDRESSES, ProvidedOnAutoForward, TunnelProtocol, TunnelPrivacyId } from '../../../../platform/tunnel/common/tunnel.js';
...
const forwardedPortsFeaturesEnabled = ( new RawContextKey("forwardedPortsViewEnabled", false, ( localize(17907, "Whether the Ports view is enabled."))));
const forwardedPortsViewEnabled = ( new RawContextKey("forwardedPortsViewOnlyEnabled", false, ( localize(17907, "Whether the Ports view is enabled."))));
...
const UserTunnelSource = {
    ...
    description: ( localize(17908, "User Forwarded"))
};
const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: ( localize(17909, "Auto Forwarded"))
};
...
class PortsAttributes extends Disposable {
    ...
    getAttributes(port, host, commandLine) {
        ...
        if (attributes.onAutoForward !== undefined || attributes.elevateIfNeeded !== undefined || attributes.label !== undefined || attributes.requireLocalPort !== undefined || attributes.protocol !== undefined) {
            return attributes;
        }
    ...
    hasHostAndPort(value) {
        return (value.host !== undefined) && (value.port !== undefined) && isString(value.host) && isNumber(value.port);
    }
...
let TunnelModel = class TunnelModel extends Disposable {
    constructor(
        ...
        this._register(
            this.configPortsAttributes.onDidChangeAttributes(this.updateAttributes, this)
        );
    ...
    async restoreForwarded() {
        ...
        if (!this.restoreListener) {
            ...
            this.restoreListener.add(
                this.storageService.onDidChangeValue(StorageScope.PROFILE, undefined, this.restoreListener)(async e => {
                    if (e.key === key) {
    ...
    async doForward(tunnelProperties, attributes) {
        ...
        attributes = attributes ?? ((attributes !== null) ? (await this.getAttributes([tunnelProperties.remote]))?.get(tunnelProperties.remote.port) : undefined);
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: ( localize(17911, "Statically Forwarded"))
                    }
                });
...
TunnelModel.__decorator = ( __decorate([debounce(1000)], TunnelModel.prototype, "storeForwarded", null));
TunnelModel = ( __decorate([( __param(0, ITunnelService)), ( __param(1, IStorageService)), ( __param(2, IConfigurationService)), ( __param(3, IWorkbenchEnvironmentService)), ( __param(4, IRemoteAuthorityResolverService)), ( __param(5, IWorkspaceContextService)), ( __param(6, ILogService)), ( __param(7, IDialogService)), ( __param(8, IExtensionService)), ( __param(9, IContextKeyService))], TunnelModel));

export { ACTIVATION_EVENT, AutoTunnelSource, OnPortForward, PortsAttributes, TunnelCloseReason, TunnelModel, TunnelSource, UserTunnelSource, forwardedPortsFeaturesEnabled, forwardedPortsViewEnabled, isCandidatePort, makeAddress, mapHasAddress, mapHasAddressLocalhostOrAllInterfaces, parseAddress };
