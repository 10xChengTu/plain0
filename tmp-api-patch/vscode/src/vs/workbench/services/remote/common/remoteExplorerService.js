...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(17899, "The ID of a Get Started walkthrough to open.")),
            type: "string"
        }
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(17900, "Contributes help information for Remote")),
        type: "object",
        properties: {
            "getStarted": {
            ...
            "feedback": {
                ...
                type: "string",
                markdownDeprecationMessage: ( localize(17904, "Use {0} instead", "`reportIssue`"))
            },
            "reportIssue": {
                description: ( localize(
                    17905,
...
let RemoteExplorerService = class RemoteExplorerService {
    ...
    getEditableData(tunnelItem, editId) {
        return (this._editable && ((!tunnelItem && (tunnelItem === this._editable.tunnelItem)) || (tunnelItem && (this._editable.tunnelItem?.remotePort === tunnelItem.remotePort) && (this._editable.tunnelItem.remoteHost === tunnelItem.remoteHost) && (this._editable.editId === editId)))) ? this._editable.data : undefined;
    }
...
RemoteExplorerService = ( __decorate([( __param(0, IStorageService)), ( __param(1, ITunnelService)), ( __param(2, IInstantiationService))], RemoteExplorerService));

export { PORT_AUTO_FALLBACK_SETTING, PORT_AUTO_FORWARD_SETTING, PORT_AUTO_SOURCE_SETTING, PORT_AUTO_SOURCE_SETTING_HYBRID, PORT_AUTO_SOURCE_SETTING_OUTPUT, PORT_AUTO_SOURCE_SETTING_PROCESS, PortsEnablement, REMOTE_EXPLORER_TYPE_KEY, RemoteExplorerService, TUNNEL_VIEW_CONTAINER_ID, TUNNEL_VIEW_ID, TunnelEditId, TunnelType };
