...
const defaultUserDataProfileIcon = registerIcon("defaultProfile-icon", Codicon.settings, ( localize(18226, "Icon for Default Profile.")));
const PROFILES_TITLE = ( localize2(18227, "Profiles"));
const PROFILES_CATEGORY = {
    ...PROFILES_TITLE
};
const PROFILE_EXTENSION = "code-profile";
const PROFILE_FILTER = [{
    name: ( localize(18228, "Profile")),
    extensions: [PROFILE_EXTENSION]
}];
...
export { CURRENT_PROFILE_CONTEXT, HAS_PROFILES_CONTEXT, PROFILES_CATEGORY, PROFILES_TITLE, PROFILE_EXTENSION, PROFILE_FILTER, PROFILE_URL_AUTHORITY, PROFILE_URL_AUTHORITY_PREFIX, defaultUserDataProfileIcon, isProfileURL, toUserDataProfileUri };
