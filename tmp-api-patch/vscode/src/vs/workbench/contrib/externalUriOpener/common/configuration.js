...
const externalUriOpenersConfigurationNode = {
    ...
    properties: {
        [externalUriOpenersSettingId]: {
            type: "object",
            markdownDescription: ( localize(10870, "Configure the opener to use for external URIs (http, https).")),
            defaultSnippets: [{
                body: {
                    "example.com": "$1"
                }
            ...
            additionalProperties: {
                anyOf: [{
                    ...
                    enumDescriptions: [( localize(10872, "Open using VS Code's standard opener."))]
