...
const manageTrustedDomainSettingsCommand = {
    ...
    description: {
        description: ( localize2(16403, "Manage Trusted Domains")),
        args: []
    },
...
async function configureOpenerTrustedDomainsHandler(
    ...
    options.push({
        type: "item",
        label: ( localize(16404, "Trust {0}", domainToConfigure)),
        id: "trust",
    ...
    if (isIP) {
        if (parsedDomainToConfigure.authority.includes(":")) {
            ...
            options.push({
                type: "item",
                label: ( localize(16405, "Trust {0} on all ports", base)),
                toTrust: base + ":*",
                id: "trust"
            });
        }
        ...
        options.push({
            type: "item",
            label: ( localize(16406, "Trust {0} and all its subdomains", domainEnd)),
    ...
    options.push({
        type: "item",
        label: ( localize(16407, "Trust all domains (disables link protection)")),
        toTrust: "*",
        id: "trust"
    });
    options.push({
        type: "item",
        label: ( localize(16408, "Manage Trusted Domains")),
        id: "manage"
    });
