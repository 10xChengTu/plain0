...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    constructor(_extensionService, _configurationService) {
        ...
        this._store.add(
            FoldingController.setFoldingRangeProviderSelector(this._selectFoldingRangeProvider.bind(this))
        );
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(11261, "All")));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(11262, "All active folding range providers")));
