...
const TASK_RUNNING_STATE = ( new RawContextKey("taskRunning", false, ( localize(14735, "Whether a task is currently running."))));
const TASK_TERMINAL_ACTIVE = ( new RawContextKey("taskTerminalActive", false, ( localize(14736, "Whether the active terminal is a task terminal."))));
const TASKS_CATEGORY = ( localize2(14737, "Tasks"));
var ShellQuoting;
...
(function(RunOptions) {
    RunOptions.defaults = {
        ...
        instanceLimit: 1,
        instancePolicy: InstancePolicy.prompt
    };
