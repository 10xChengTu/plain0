...
import { ChatSessionStatus, IChatNewSessionRequest, IChatSession, IChatSessionCommitEvent, IChatSessionContentProvider, IChatSessionCustomizationItemGroup, IChatSessionCustomizationsProvider, IChatSessionItem, IChatSessionItemController, IChatSessionItemsDelta, IChatSessionOptionsChangeEvent, IChatSessionProviderOptionGroup, IChatSessionProviderOptionItem, IChatSessionRequestHistoryItem, IChatSessionsExtensionPoint, IChatInputCompletionsParams, IChatInputCompletionsResult, ReadonlyChatSessionOptionsMap, ResolvedChatSessionsExtensionPoint } from "../../common/chatSessionsService.js";
...
export declare class ChatSessionsService extends Disposable implements IChatSessionsService {
    ...
    private readonly _asyncActivationRegistry;
    ...
    private readonly _onDidCommitSession;
    ...
    private readonly _realResources;
    private readonly _customizationsProviders;
    ...
    constructor(_logService: ILogService, _chatAgentService: IChatAgentService, _extensionService: IExtensionService, _contextKeyService: IContextKeyService, _menuService: IMenuService, _themeService: IThemeService, _labelService: ILabelService, _instantiationService: IInstantiationService);
     ...
     */
    private _isContributionAvailableForType;
    /**
     ...
     */
    private _resolveCreateSubMenuCommandId;
    ...
    private waitForContentProvider;
...
export declare function openChatSession(accessor: ServicesAccessor, openOptions: NewChatSessionOpenOptions, chatSendOptions?: NewChatSessionSendOptions): Promise<void>;
export declare function getResourceForNewChatSession(options: NewChatSessionOpenOptions): URI;
export declare function getSessionStatusForModel(model: IChatModel): ChatSessionStatus | undefined;
export declare function chatResponseStateToSessionStatus(state: ResponseModelState): ChatSessionStatus;
export {};
