    ...
    for (let i = responseParts.length - 1; i >= 0; i--) {
        ...
        if (part.kind === "confirmation" && typeof part.message === "string") {
            ...
            if (state.type === IChatToolInvocation.StateKind.WaitingForConfirmation) {
                ...
                description = titleMessage ?? ( localize(7177, "Waiting for confirmation: {0}", descriptionValue));
            }
            ...
            description = ( localize(7178, "Thinking..."));
        }
    }
...
export { getInProgressSessionDescription };
