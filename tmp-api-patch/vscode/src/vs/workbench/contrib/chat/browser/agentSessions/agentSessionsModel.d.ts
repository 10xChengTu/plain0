...
export interface IAgentSessionsModel {
    readonly onWillResolve: Event<string>;
    readonly onDidResolve: Event<string>;
...
export declare function isAgentHostAgentSessionItem(session: IAgentSession): boolean;
...
export declare function countUnreadSessions(sessions: IAgentSession[]): number;
...
export declare function isAgentSessionShowMore(obj: unknown): obj is IAgentSessionShowMore;
/**
...
export declare function isAgentSessionShowLess(obj: unknown): obj is IAgentSessionShowLess;
