...
const ctxIsGlobalEditingSession = ( new RawContextKey("chatEdits.isGlobalEditingSession", undefined, ( localize(6990, "The current editor is part of the global edit session"))));
const ctxHasEditorModification = ( new RawContextKey("chatEdits.hasEditorModifications", undefined, ( localize(6991, "The current editor contains chat modifications"))));
const ctxIsCurrentlyBeingModified = ( new RawContextKey("chatEdits.isCurrentlyBeingModified", undefined, ( localize(6992, "The current editor is currently being modified"))));
const ctxReviewModeEnabled = ( new RawContextKey("chatEdits.isReviewModeEnabled", true, ( localize(6993, "Review mode for chat changes is enabled"))));
...
const ctxRequestCount = ( new RawContextKey("chatEdits.requestCount", 0, ( localize(6995, "The number of turns the editing session in this editor has"))));
const ctxCursorInChangeRange = ( new RawContextKey("chatEdits.cursorInChangeRange", false, ( localize(6996, "The cursor is inside a change range made by chat editing."))));
...
ChatEditingEditorContextKeys = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IEditorGroupsService))], ChatEditingEditorContextKeys));
...
ContextKeyGroup = ( __decorate([( __param(1, IInlineChatSessionService)), ( __param(2, IChatEditingService)), ( __param(3, IChatService))], ContextKeyGroup));
...
ObservableEditorSession = ( __decorate([( __param(1, IChatEditingService)), ( __param(2, IInlineChatSessionService))], ObservableEditorSession));
