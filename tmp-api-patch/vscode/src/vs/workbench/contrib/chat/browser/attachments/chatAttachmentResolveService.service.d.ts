...
import { IChatRequestVariableEntry, IBrowserViewVariableEntry, IDiagnosticVariableEntry, ISymbolVariableEntry, ISCMHistoryItemVariableEntry } from "../../common/attachments/chatVariableEntries.js";
import { ImageTransferData } from "@codingame/monaco-vscode-chat-service-override/vscode/vs/workbench/contrib/chat/browser/attachments/chatAttachmentResolveService";
