...
import { IChatVariablesService } from "../../common/attachments/chatVariables.service.js";
...
export declare function getSelectedToolAndToolSetsForWidget(widget: IChatWidget): ToolAndToolSetEnablementMap;
