...
export declare class ChatEditorInput extends EditorInput implements IEditorCloseHandler {
    ...
    constructor(resource: URI, options: IChatEditorOptions, chatService: IChatService, dialogService: IDialogService, configurationService: IConfigurationService, chatSessionsService: IChatSessionsService, instantiationService: IInstantiationService);
    closeHandler: this;
    showConfirm(): boolean;
    ...
    private shouldReplaceEmptyLocalSession;
    /**
