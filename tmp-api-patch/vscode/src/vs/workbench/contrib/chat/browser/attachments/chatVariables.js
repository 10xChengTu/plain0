...
ChatVariablesService = ( __decorate([( __param(0, IChatWidgetService))], ChatVariablesService));

export { ChatVariablesService, getDynamicVariablesForWidget, getSelectedToolAndToolSetsForWidget };
