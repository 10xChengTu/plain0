...
export declare const AICustomizationManagementCommands: {
    ...
    readonly OpenMarketplace: "aiCustomization.openMarketplace";
    ...
    readonly GenerateDebugReport: "aiCustomization.generateDebugReport";
};
/**
 ...
 */
export declare const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_HARNESS: RawContextKey<string>;
/**
 ...
 */
export declare const AICustomizationManagementCreateMenuId: MenuId;
/**
 * Context key for the item prompt type (e.g. 'prompt', 'agent') used in when-clause filtering.
 */
export declare const AI_CUSTOMIZATION_ITEM_TYPE_KEY = "aiCustomizationManagementItemType";
/**
 * Context key for the item storage type (e.g. 'local', 'user', 'extension') used in when-clause filtering.
 */
export declare const AI_CUSTOMIZATION_ITEM_STORAGE_KEY = "aiCustomizationManagementItemStorage";
/**
 * Context key for the item URI used in when-clause filtering.
 */
export declare const AI_CUSTOMIZATION_ITEM_URI_KEY = "aiCustomizationManagementItemUri";
/**
 * Context key for the parent plugin URI, set when the item is provided by a plugin.
 */
export declare const AI_CUSTOMIZATION_ITEM_PLUGIN_URI_KEY = "aiCustomizationManagementItemPluginUri";
/**
 * Context key indicating whether the item is disabled.
 */
export declare const AI_CUSTOMIZATION_ITEM_DISABLED_KEY = "aiCustomizationManagementItemDisabled";
/**
