...
const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_EDITOR = ( new RawContextKey("aiCustomizationManagementEditorFocused", false, ( localize(5855, "Whether the Agent Customizations editor is focused"))));
const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_SECTION = ( new RawContextKey(
    "chatCustomizationSection",
    AICustomizationManagementSection.Agents,
    ( localize(5856, "The currently selected section in the Agent Customizations editor"))
));
const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_HARNESS = ( new RawContextKey("chatCustomizationSessionType", "", ( localize(
    5857,
