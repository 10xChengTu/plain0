...
import { IToolData, IToolSet, ToolAndToolSetEnablementMap } from "../../common/tools/languageModelToolsService.js";
 ...
 * in the sidebar.
 */
export declare function clearChatSessionPreservingType(widget: IChatWidget, viewsService: IViewsService, sessionType: string | undefined, configurationService: IConfigurationService, chatSessionsService: IChatSessionsService): Promise<void>;
export {};
