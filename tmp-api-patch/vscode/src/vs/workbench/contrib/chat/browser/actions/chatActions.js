...
import { GitHubPaths } from '../../../../../platform/defaultAccount/common/defaultAccount.js';
...
import { ACTIVE_GROUP, SIDE_GROUP, AUX_WINDOW_GROUP } from '../../../../services/editor/common/editorService.js';
...
import { IChatToolInvocation, ElicitationState } from '../../common/chatService/chatService.js';
import { IChatService } from '../../common/chatService/chatService.service.js';
import { isRequestVM } from '../../common/model/chatViewModel.js';
import { IChatWidgetHistoryService } from '../../common/widget/chatWidgetHistoryService.service.js';
import { ChatConfiguration, ChatAgentLocation, getDefaultNewChatSessionResource, ChatModeKind, getDefaultNewChatSessionType } from '../../common/constants.js';
...
import { ILanguageModelToolsConfirmationService } from '../../common/tools/languageModelToolsConfirmationService.service.js';
import { isToolSet, ToolAndToolSetEnablementMap } from '../../common/tools/languageModelToolsService.js';
import { ILanguageModelToolsService } from '../../common/tools/languageModelToolsService.service.js';
import { ChatViewId, isIChatViewViewContext } from '../chat.js';
...
const CHAT_CATEGORY = ( localize2(5132, "Chat"));
...
const defaultChat = {
    provider: product.defaultChatAgent?.provider ?? {
        enterprise: {
            id: ""
        }
    },
...
class OpenChatGlobalAction extends Action2 {
    ...
    async run(accessor, opts) {
        ...
        if (opts?.toolsInclude || opts?.toolsExclude) {
            ...
            for (const identifier of result.unknownIdentifiers) {
                logService.warn(
                    `Tool filtering: Unknown identifier '${identifier}' - no matching tool or toolset found.`
                );
            }
        ...
        if (opts?.previousRequests?.length && chatWidget.viewModel) {
            for (const {
                request,
                response
            } of opts.previousRequests) {
                chatService.addCompleteRequest(chatWidget.viewModel.sessionResource, request, undefined, 0, {
                    message: response
                });
            }
        }
    ...
    async handleSwitchToMode(switchToMode, chatWidget, instaService, commandService) {
        ...
        if (switchToMode) {
            ...
            const chatModeCheck = model ? await instaService.invokeFunction(
                handleModeSwitch,
                currentMode,
                switchToMode.kind,
...
async function waitForDefaultAgent(chatAgentService, mode) {
    ...
    await Promise.race([Event.toPromise(Event.filter(chatAgentService.onDidChangeAgents, () => {
        const defaultAgent = chatAgentService.getDefaultAgent(ChatAgentLocation.Chat, mode);
...
class PrimaryOpenChatGlobalAction extends OpenChatGlobalAction {
    constructor() {
        super({
            ...
            title: ( localize2(5133, "Open Chat")),
            keybinding: {
...
class ModeOpenChatGlobalAction extends OpenChatGlobalAction {
    constructor(mode, keybinding) {
        super({
            ...
            title: ( localize2(5134, "Open Chat ({0})", mode.label.get())),
            keybinding
        }, mode);
    }
}
function registerChatActions() {
    ...
    registerAction2(class ToggleChatAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5135, "Toggle Chat")),
                category: CHAT_CATEGORY
            });
        }
        async run(accessor) {
    ...
    registerAction2(class NewChatEditorAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5136, "New Chat Editor")),
                icon: Codicon.plus,
                f1: true,
                category: CHAT_CATEGORY,
        ...
        async run(accessor) {
            const widgetService = accessor.get(IChatWidgetService);
            await widgetService.openSession(getNewChatEditorSessionUri(accessor), ACTIVE_GROUP, {
                pinned: true
            });
        }
    });
    ...
    registerAction2(class NewChatEditorToSideAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5137, "New Chat Editor to the Side")),
                f1: true,
                category: CHAT_CATEGORY,
                precondition: ChatContextKeys.enabled
            });
        ...
        async run(accessor) {
            const widgetService = accessor.get(IChatWidgetService);
            await widgetService.openSession(getNewChatEditorSessionUri(accessor), SIDE_GROUP, {
                pinned: true
            });
        }
    });
    registerAction2(class NewChatWindowAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5138, "New Chat Window")),
                f1: true,
                category: CHAT_CATEGORY,
                precondition: ChatContextKeys.enabled,
                menu: [{
        ...
        async run(accessor) {
            const widgetService = accessor.get(IChatWidgetService);
            await widgetService.openSession(getNewChatEditorSessionUri(accessor), AUX_WINDOW_GROUP, {
                pinned: true,
                auxiliary: {
                    compact: true,
                    bounds: {
    ...
    registerAction2(class ClearChatInputHistoryAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5139, "Clear Input History")),
                precondition: ChatContextKeys.enabled,
                category: CHAT_CATEGORY,
                f1: true
            });
    ...
    registerAction2(class FocusChatAction extends EditorAction2 {
        constructor() {
            super({
                ...
                title: ( localize2(5140, "Focus Chat List")),
    ...
    registerAction2(class FocusMostRecentlyFocusedChatAction extends EditorAction2 {
        constructor() {
            super({
                ...
                title: ( localize2(5141, "Focus Last Focused Chat List Item")),
                precondition: ( ContextKeyExpr.and(ChatContextKeys.inChatInput)),
                category: CHAT_CATEGORY,
                keybinding: [
                    {
    ...
    registerAction2(class FocusChatInputAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5142, "Focus Chat Input")),
                f1: false,
                keybinding: [{
                    primary: KeyMod$1.CtrlCmd | KeyCode.DownArrow,
                    weight: KeybindingWeight.WorkbenchContrib,
    ...
    registerAction2(class FocusTodosViewAction extends Action2 {
        ...
        constructor() {
            super({
                ...
                title: ( localize2(5143, "Toggle Focus Between TODOs and Input")),
                category: CHAT_CATEGORY,
                f1: true,
        ...
        run(accessor) {
            ...
            if (!widget || !widget.toggleTodosViewFocus()) {
                alert(( localize(5144, "No agent todos to focus right now.")));
            }
        }
    });
    registerAction2(class FocusQuestionCarouselAction extends Action2 {
        ...
        constructor() {
            super({
                ...
                title: ( localize2(5145, "Chat: Toggle Focus Between Question and Input")),
                category: CHAT_CATEGORY,
                f1: true,
        ...
        run(accessor) {
            ...
            if (!widget || !widget.toggleQuestionCarouselFocus()) {
                alert(( localize(5146, "No chat question to focus right now.")));
            }
        }
    });
    registerAction2(class PreviousQuestionCarouselQuestionAction extends Action2 {
        ...
        constructor() {
            super({
                ...
                title: ( localize2(5147, "Chat: Previous Question")),
                category: CHAT_CATEGORY,
                f1: true,
                ...
                keybinding: [{
                    ...
                    when: ( ContextKeyExpr.and(
                        ChatContextKeys.inChatQuestionCarousel,
    ...
    registerAction2(class NextQuestionCarouselQuestionAction extends Action2 {
        ...
        constructor() {
            super({
                ...
                title: ( localize2(5148, "Chat: Next Question")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ( ContextKeyExpr.and(ChatContextKeys.inChatSession, ChatContextKeys.Editing.hasQuestionCarousel)),
                keybinding: [{
                    weight: KeybindingWeight.WorkbenchContrib,
                    primary: KeyMod$1.Alt | KeyCode.KeyN,
                    when: ( ContextKeyExpr.and(
                        ChatContextKeys.inChatQuestionCarousel,
                        ChatContextKeys.Editing.hasQuestionCarousel
                    ))
    ...
    registerAction2(class FocusQuestionCarouselTerminalAction extends Action2 {
        static {
            this.ID = "workbench.action.chat.focusQuestionCarouselTerminal";
        }
        constructor() {
            super({
                id: FocusQuestionCarouselTerminalAction.ID,
                title: ( localize2(5149, "Chat: Focus Terminal from Question Carousel")),
                category: CHAT_CATEGORY,
                f1: true,
                ...
                keybinding: [{
                    weight: KeybindingWeight.WorkbenchContrib,
                    primary: KeyMod$1.Alt | KeyCode.KeyT,
                    when: ( ContextKeyExpr.and(
                        ChatContextKeys.inChatQuestionCarousel,
                        ChatContextKeys.Editing.hasQuestionCarousel,
                        ChatContextKeys.chatQuestionCarouselHasTerminal
    ...
    registerAction2(class FocusTipAction extends Action2 {
        ...
        constructor() {
            super({
                ...
                title: ( localize2(5150, "Chat: Toggle Focus Between Tip and Input")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ChatContextKeys.inChatSession,
                keybinding: [{
                    weight: KeybindingWeight.WorkbenchContrib,
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Slash,
        ...
        run(accessor) {
            ...
            if (!widget || !widget.toggleTipFocus()) {
                alert(( localize(5151, "No chat tip.")));
            }
        }
    });
    registerAction2(class ShowContextUsageAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5152, "Show Context Window Usage")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ChatContextKeys.enabled
            });
    ...
    registerAction2(class CompactAgentHostConversationAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5153, "Compact Conversation")),
                category: CHAT_CATEGORY,
                precondition: ChatContextKeys.enabled,
                menu: {
                    id: MenuId.ChatContextUsageActions,
                    group: "navigation",
                    when: ( ContextKeyExpr.and(ChatContextKeys.chatIsAgentHostSession, ( ChatContextKeys.chatAgentHostProviderId.isEqualTo(COPILOT_CLI_AGENT_HOST_PROVIDER_ID))))
                }
            });
        }
    ...
    registerAction2(class ToggleShowContextUsageAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5154, "Show Context Usage")),
                category: CHAT_CATEGORY,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5155, "Manage Copilot Settings")),
                category: CHAT_CATEGORY,
                f1: true,
    ...
    registerAction2(class ShowExtensionsUsingCopilot extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5156, "Show Extensions using Copilot")),
                f1: true,
    ...
    registerAction2(class ConfigureCopilotCompletions extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5157, "Configure Inline Suggestions...")),
    ...
    registerAction2(class ShowQuotaExceededDialogAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize(5158, "Upgrade GitHub Copilot Plan"))
            });
        }
        async run(accessor) {
            ...
            if (chatEntitlementService.quotas.resetDate) {
                const dateFormatter = chatEntitlementService.quotas.resetDateHasTime ? safeIntl.DateTimeFormat(language, {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                    hour: "numeric",
                    minute: "numeric"
                }) : safeIntl.DateTimeFormat(language, {
                    year: "numeric",
                    month: "long",
                    day: "numeric"
                });
            ...
            const upgradeToPro = free ? ( localize(
                5163,
                "Upgrade to GitHub Copilot Pro for:\n- Unlimited inline suggestions\n- Unlimited chat messages\n- Access to premium models"
            )) : undefined;
            await dialogService.prompt({
                type: "none",
                message: ( localize(5164, "GitHub Copilot Quota Reached")),
                cancelButton: {
                    label: ( localize(5165, "Dismiss")),
                    run: () => {}
                },
                buttons: [{
                    label: free ? ( localize(5166, "Upgrade to GitHub Copilot Pro")) : ( localize(5167, "Upgrade GitHub Copilot Plan")),
                    run: () => {
    ...
    registerAction2(class ResetTrustedToolsAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5168, "Reset Tool Confirmations")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ChatContextKeys.enabled
            });
        ...
        run(accessor) {
            ...
            accessor.get(INotificationService).info(( localize(5169, "Tool confirmation preferences have been reset.")));
        }
    });
    registerAction2(class GenerateInstructionsAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5170, "Generate Agent Instructions")),
                category: CHAT_CATEGORY,
    ...
    registerAction2(class GenerateInstructionAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5171, "Generate On-Demand Instructions")),
                category: CHAT_CATEGORY,
                icon: Codicon.sparkle,
                f1: true,
                precondition: ChatContextKeys.enabled
    ...
    registerAction2(class GeneratePromptAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5172, "Generate Prompt File")),
                shortTitle: ( localize2(5173, "Generate Prompt")),
                category: CHAT_CATEGORY,
                icon: Codicon.sparkle,
                f1: true,
                precondition: ChatContextKeys.enabled
    ...
    registerAction2(class GenerateSkillAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5174, "Generate Skill")),
                shortTitle: ( localize2(5175, "Generate Skill")),
                category: CHAT_CATEGORY,
                icon: Codicon.sparkle,
                f1: true,
                precondition: ChatContextKeys.enabled
    ...
    registerAction2(class GenerateAgentAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5176, "Generate Custom Agent")),
                shortTitle: ( localize2(5177, "Generate Agent")),
                category: CHAT_CATEGORY,
                icon: Codicon.sparkle,
                f1: true,
                precondition: ChatContextKeys.enabled
    ...
    registerAction2(class GenerateHookAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5178, "Generate Hook")),
                shortTitle: ( localize2(5179, "Generate Hook")),
                category: CHAT_CATEGORY,
                icon: Codicon.sparkle,
                f1: true,
                precondition: ChatContextKeys.enabled
    ...
    registerAction2(class InsertForkConversationSlashCommandAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5180, "Insert Fork Command")),
                shortTitle: ( localize2(5181, "Insert /fork")),
                category: CHAT_CATEGORY,
    ...
    registerAction2(class InsertTroubleshootSlashCommandAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5182, "Insert Troubleshoot Command")),
                shortTitle: ( localize2(5183, "Insert /troubleshoot")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ChatContextKeys.enabled
            });
    ...
    registerAction2(class OpenChatFeatureSettingsAction extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5184, "Chat Settings")),
                shortTitle: ( localize(5185, "Chat Settings")),
                category: CHAT_CATEGORY,
                f1: true,
                precondition: ChatContextKeys.enabled,
                menu: [{
    ...
    MenuRegistry.appendMenuItem(MenuId.ViewTitle, {
        command: {
            ...
            title: ( localize2(5186, "Open Customizations")),
            category: CHAT_CATEGORY,
            icon: Codicon.gear
        },
        group: "navigation",
...
function computeToolEnablementMap(options) {
    ...
    if (enabledToolCount === 0) {
        throw ( new Error(
            "Tool filtering resulted in zero enabled tools. At least one tool must be enabled."
        ));
    }
    for (const toolSet of allToolSets) {
    ...
    return {
        enablementMap: ToolAndToolSetEnablementMap.fromMap(enablementMap),
        unknownIdentifiers
    };
}
async function handleCurrentEditingSession(model, phrase, dialogService) {
    return showClearEditingSessionConfirmation(model, dialogService, {
...
async function handleModeSwitch(accessor, fromMode, toMode, requestCount, model) {
    ...
    if (needToClearEdits) {
        const phrase = ( localize(5187, "Switching agents will end your current edit session."));
...
async function clearChatSessionPreservingType(
    widget,
    viewsService,
    sessionType,
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    ...
    group: "1_chat",
    order: 5,
    title: ( localize(5191, "Generate Code")),
...
registerAction2(class ToggleDefaultVisibilityAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5192, "Show View by Default")),
    ...
    async run(accessor) {
        ...
        configurationService.updateValue(
            ...
            currentValue !== "hidden" ? "hidden" : "visible"
        );
    }
});
registerAction2(class EditToolApproval extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5193, "Manage Tool Approval")),
            metadata: {
    ...
    async run(accessor, scope) {
        ...
        const toolsService = accessor.get(ILanguageModelToolsService);
        confirmationService.manageConfirmationPreferences([...toolsService.getAllToolsIncludingDisabled()], scope ? {
            defaultScope: scope
        } : undefined);
    }
});

export { ACTION_ID_NEW_CHAT, ACTION_ID_NEW_EDIT_SESSION, ACTION_ID_OPEN_CHAT, CHAT_CATEGORY, CHAT_CONFIG_MENU_ID, CHAT_OPEN_ACTION_ID, CHAT_SETUP_ACTION_ID, CHAT_SETUP_SUPPORT_ANONYMOUS_ACTION_ID, GENERATE_AGENT_COMMAND_ID, GENERATE_AGENT_INSTRUCTIONS_COMMAND_ID, GENERATE_HOOK_COMMAND_ID, GENERATE_ON_DEMAND_INSTRUCTIONS_COMMAND_ID, GENERATE_PROMPT_COMMAND_ID, GENERATE_SKILL_COMMAND_ID, INSERT_FORK_CONVERSATION_COMMAND_ID, INSERT_TROUBLESHOOT_COMMAND_ID, ModeOpenChatGlobalAction, clearChatSessionPreservingType, computeToolEnablementMap, getOpenChatActionIdForMode, handleCurrentEditingSession, handleModeSwitch, registerChatActions, stringifyItem };
