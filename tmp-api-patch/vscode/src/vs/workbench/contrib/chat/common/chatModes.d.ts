...
import { IAgentSource, ICustomAgent, ICustomAgentVisibility, PromptsStorage } from "./promptSyntax/service/promptsService.js";
...
export declare class ChatModeService extends Disposable implements IChatModeService {
    ...
    private localMode;
    constructor(instantiationService: IInstantiationService, contextKeyService: IContextKeyService, configurationService: IConfigurationService);
...
export declare namespace IChatModeInstructions {
    function isEquals(a: IChatModeInstructions | undefined, b: IChatModeInstructions | undefined): boolean;
}
...
type IChatModeSourceData = {
    ...
    type?: PromptFileSource.ExtensionContribution | PromptFileSource.ExtensionAPI;
} | {
 ...
 * ```
 */
export declare function getHandoffId(handoff: IHandOff): string;
/**
 ...
 */
export declare function buildCustomAgentHandoffsInfo(modes: readonly IChatMode[]): ICustomAgentInfo[];
export {};
