    ...
    function executionConfirmedOrDenied(invocation, reader) {
        if (invocation.kind === "toolInvocationSerialized") {
            if (invocation.isConfirmed === undefined || typeof invocation.isConfirmed === "boolean") {
                return {
                    type: invocation.isConfirmed ? ToolConfirmKind.UserAction : ToolConfirmKind.Denied
                };
            }
...
var AgentFeedbackReviewCommandId;
(function(AgentFeedbackReviewCommandId) {
    AgentFeedbackReviewCommandId["GetComments"] = "_agentFeedbackReview.getComments";
    AgentFeedbackReviewCommandId["Reveal"] = "_agentFeedbackReview.reveal";
    AgentFeedbackReviewCommandId["RevealAt"] = "_agentFeedbackReview.revealAt";
    AgentFeedbackReviewCommandId["Delete"] = "_agentFeedbackReview.delete";
    AgentFeedbackReviewCommandId["Accept"] = "_agentFeedbackReview.accept";
})(AgentFeedbackReviewCommandId || (AgentFeedbackReviewCommandId = {}));
class ChatMcpServersStarting {
    ...
    toJSON() {
        return {
            ...
            didStartServerIds: this.didStartServerIds
        };
    }
}
...
export { AgentFeedbackReviewCommandId, ChatAgentVoteDirection, ChatCopyKind, ChatErrorLevel, ChatMcpServersStarting, ChatPendingRequestChangeEventName, ChatRequestQueueKind, ChatResponseClearToPreviousToolInvocationReason, ChatResponseReferencePartStatusKind, ChatSendResult, ChatStopCancellationNoopEventName, ElicitationState, IChatToolInvocation, ResponseModelState, ToolConfirmKind, convertLegacyChatSessionTiming, formatCopilotCredits, isChatFollowup, isIDocumentContext, isIUsedContext, isLegacyChatTerminalToolInvocationData };
