...
LanguageModelStatsService = ( __decorate([( __param(0, IExtensionFeaturesManagementService)), ( __param(1, IStorageService))], LanguageModelStatsService));
const CopilotUsageExtensionFeatureId = "copilot";
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: CopilotUsageExtensionFeatureId,
    label: ( localize(8544, "Copilot")),
    description: ( localize(8545, "Language models usage statistics of this extension.")),
    icon: Codicon.copilot,
    access: {
        canToggle: false
    },
    accessDataLabel: ( localize(8546, "chat"))
});
