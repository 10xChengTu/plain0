 ...
 */
export declare function isSkillFilename(filename: string): boolean;
/**
 * Regex for valid skill names: lowercase alphanumeric and hyphens only.
 */
export declare const VALID_SKILL_NAME_REGEX: RegExp;
/**
 * AGENT file name
 */
 ...
 */
export declare const COPILOT_CONFIG_FOLDER = ".copilot";
/**
 ...
 */
export declare const GITHUB_CONFIG_FOLDER = ".github";
/**
 ...
 */
export declare const COPILOT_USER_AGENTS_SOURCE_FOLDER = "~/.copilot/agents";
/**
 * Claude rules folder.
 */
 ...
 */
export declare function isInCopilotAgentsFolder(fileUri: URI): boolean;
/**
...
export declare function getSkillFolderName(fileUri: URI): string;
/**
