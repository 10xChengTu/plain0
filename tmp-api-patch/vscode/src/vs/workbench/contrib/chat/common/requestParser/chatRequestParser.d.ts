...
import { IChatAgentAttachmentCapabilities, IChatAgentData } from "../participants/chatAgents.js";
...
export declare const agentReg: RegExp;
export declare const variableReg: RegExp;
export declare const slashReg: RegExp;
...
export declare class ChatRequestParser {
    ...
    parseChatRequestWithReferences(references: ReadonlyArray<IDynamicVariable>, selectedToolAndToolSets: ToolAndToolSetEnablementMap, message: string, location?: ChatAgentLocation, context?: IChatParserContext): IParsedChatRequest;
