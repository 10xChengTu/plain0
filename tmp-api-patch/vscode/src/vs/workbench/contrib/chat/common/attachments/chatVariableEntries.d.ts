...
export declare const ChatPasteAttachmentMetadata: {
    readonly Kind: "vscode.chat.attachment.kind";
    readonly Language: "vscode.chat.attachment.language";
    readonly FileName: "vscode.chat.attachment.fileName";
    readonly PastedLines: "vscode.chat.attachment.pastedLines";
};
...
export declare enum AgentHostCompletionReferenceKind {
    Skill = "skill",
    Command = "command"
}
...
export declare function toAgentHostCompletionVariableEntry(kind: AgentHostCompletionReferenceKind, name: string, reference: URI | string | undefined, _meta: Record<string, unknown> | undefined): IGenericChatRequestVariableEntry & {
    value: IAgentHostCompletionVariableValue;
};
export declare function toAgentHostCompletionVariableEntryFromMetadata(kind: AgentHostCompletionReferenceKind, name: string, _meta: Record<string, unknown> | undefined): IGenericChatRequestVariableEntry & {
    value: IAgentHostCompletionVariableValue;
};
export declare function getAgentHostCompletionReferenceKind(entry: IChatRequestVariableEntry): AgentHostCompletionReferenceKind | undefined;
export declare function isAgentHostCompletionVariableEntry(entry: IChatRequestVariableEntry): entry is IGenericChatRequestVariableEntry & {
    value: IAgentHostCompletionVariableValue;
};
 ...
 */
export declare function getImageAttachmentLimit(model: Pick<ILanguageModelChatMetadata, "family"> | undefined): number | undefined;
...
export declare function toPasteVariableEntry(name: string, code: string, options?: {
    readonly id?: string;
    readonly icon?: ThemeIcon;
    readonly language?: string;
    readonly fileName?: string;
...
export declare function restorePasteVariableEntryFromAttachment(attachment: IRestorablePasteAttachment): IChatRequestPasteVariableEntry | undefined;
...
export declare function isExplicitFileOrImageVariableEntry(obj: IChatRequestVariableEntry): obj is IChatRequestFileEntry | IChatRequestDirectoryEntry | IImageVariableEntry;
export declare function getExplicitFileOrImageAttachmentSummary(entries: readonly IChatRequestVariableEntry[]): string | undefined;
