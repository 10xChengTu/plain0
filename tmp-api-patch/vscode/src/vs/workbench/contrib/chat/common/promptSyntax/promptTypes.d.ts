 ...
 */
export declare const AGENT_DEBUG_LOG_ENABLED_SETTING = "github.copilot.chat.agentDebugLog.enabled";
/**
 * Configuration key for enabling file logging for the agent debug log.
 */
export declare const AGENT_DEBUG_LOG_FILE_LOGGING_ENABLED_SETTING = "github.copilot.chat.agentDebugLog.fileLogging.enabled";
/**
 * The name of the troubleshoot slash command / skill.
 */
export declare const TROUBLESHOOT_COMMAND_NAME = "troubleshoot";
/**
 * URI scheme used by the Copilot extension for built-in skills.
 */
export declare const COPILOT_SKILL_URI_SCHEME = "copilot-skill";
/**
 * Path fragment that identifies the troubleshoot skill in a URI.
 */
export declare const TROUBLESHOOT_SKILL_PATH = "troubleshoot/SKILL.md";
/**
 ...
 */
export declare function getSourceDescription(source: PromptFileSource): string | undefined;
