...
export declare enum ContributionEnablementState {
    DisabledProfile = 0,
    DisabledWorkspace = 1,
    EnabledProfile = 2,
    EnabledWorkspace = 3
...
export declare class CollisionEnablementModel implements IEnablementModel {
    private readonly _base;
    private readonly _collisionGroups;
    constructor(_base: IEnablementModel, _collisionGroups: IObservable<ReadonlyMap<string, readonly string[]>>);
    readEnabled(key: string, reader?: IReader): ContributionEnablementState;
    setEnabled(key: string, state: ContributionEnablementState, tx?: ITransaction): void;
    remove(key: string): void;
}
