...
import { IChatAgentCommand, IChatAgentData } from "../participants/chatAgents.js";
import { IChatAgentService } from "../participants/chatAgents.service.js";
import { IChatSlashData } from "@codingame/monaco-vscode-chat-service-override/vscode/vs/workbench/contrib/chat/common/participants/chatSlashCommands";
...
export declare class ChatRequestSlashPromptPart implements IParsedChatRequestPart {
    ...
    constructor(range: OffsetRange, editorRange: IRange, name: string, displayText?: string);
    get text(): string;
    get promptText(): string;
}
/**
...
export declare class ChatRequestDynamicVariablePart implements IParsedChatRequestPart {
    ...
    constructor(range: OffsetRange, editorRange: IRange, text: string, id: string, modelDescription: string | undefined, data: IChatRequestVariableValue, fullName?: string | undefined, icon?: ThemeIcon | undefined, isFile?: boolean | undefined, isDirectory?: boolean | undefined, _meta?: Record<string, unknown> | undefined);
