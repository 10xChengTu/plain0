...
import { ToolConfirmKind, IChatToolInvocation } from '../../chatService/chatService.js';
...
class ChatToolInvocation {
    ...
    constructor(
        ...
        if (startOptions.startInStreaming) {
            ...
            defaultMessage = startOptions.cancelReasonMessage ?? ( localize(8581, "Tool \"{0}\" was denied", toolData.displayName));
        }
        ...
        if (startOptions.startInCancelled) {
            ...
            this._state = observableValue(this, {
                ...
                confirmed: {
                    ...
                    reason: this.confirmationMessages?.confirmationNotNeededReason
                },
    ...
    toJSON() {
        ...
        return {
            ...
            resultDetails: isToolResultOutputDetails(details) ? {
                output: {
                    type: "data",
                    mimeType: details.output.mimeType,
                    base64Data: encodeBase64(details.output.value)
                }
            } : details,
