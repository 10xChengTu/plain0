...
const chatEditingWidgetFileStateContextKey = ( new RawContextKey("chatEditingWidgetFileState", undefined, ( localize(8542, "The current state of the file in the chat editing widget"))));
...
function isChatEditingActionContext(thing) {
    return typeof thing === "object" && !!thing && hasKey(thing, {
