...
export declare function newInstructionsCollectionDebugInfo(): InstructionsCollectionDebugInfo;
/**
...
export declare const INSTRUCTIONS_PROVIDER_ACTIVATION_EVENT = "onInstructionsProvider";
export declare const PROMPT_FILE_PROVIDER_ACTIVATION_EVENT = "onPromptFileProvider";
export declare const SKILL_PROVIDER_ACTIVATION_EVENT = "onSkillProvider";
/**
 ...
 */
export declare function matchesSessionType(sessionTypes: readonly string[] | undefined, currentSessionType: string | undefined): boolean;
/**
...
export declare function isExtensionPromptPath(obj: IPromptPath): obj is IExtensionPromptPath;
...
export declare namespace IAgentSource {
    function fromPromptPath(promptPath: IPromptPath): IAgentSource;
    function isEquals(a: IAgentSource | undefined, b: IAgentSource | undefined): boolean;
}
/**
 ...
 */
export declare enum AgentInstructionFileType {
    agentsMd = "agentsMd",
    claudeMd = "claudeMd",
 ...
 */
export type PromptFileSkipReason = "missing-name" | "missing-description" | "name-mismatch" | "duplicate-name" | "parse-error" | "disabled" | "all-hooks-disabled" | "claude-hooks-disabled" | "workspace-untrusted";
/**
