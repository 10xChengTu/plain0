...
const SetArtifactRulesToolData = {
    ...
    displayName: ( localize(8973, "Set Artifact Rules")),
...
let SetArtifactRulesTool = class SetArtifactRulesTool {
    ...
    async prepareToolInvocation(_context, _token) {
        return {
            pastTenseMessage: ( new MarkdownString(( localize(8974, "Updated artifact rules")))),
    ...
    async invoke(invocation, _countTokens, _progress, _token) {
        ...
        return {
            content: [{
                kind: "text",
                value: ( localize(8975, "Updated artifact rules"))
            }]
        };
    }
};
SetArtifactRulesTool = ( __decorate([( __param(0, IChatArtifactsService))], SetArtifactRulesTool));

export { SetArtifactRulesTool, SetArtifactRulesToolData, SetArtifactRulesToolId };
