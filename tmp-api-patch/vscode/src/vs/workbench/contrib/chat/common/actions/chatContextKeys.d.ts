...
export declare namespace ChatContextKeys {
    ...
    const hasActiveRequest: RawContextKey<boolean>;
    ...
    const inputHasSendableContent: RawContextKey<boolean>;
    ...
    const chatQuestionCarouselHasTerminal: RawContextKey<boolean>;
    ...
    const accountPolicyGateActive: RawContextKey<boolean>;
    /**
     ...
     */
    const chatIsAgentHostSession: RawContextKey<boolean>;
    /**
     * Widget-scoped: logical Agent Host provider ID for this chat widget, e.g. `copilotcli`, `claude`, or `codex`.
     */
    const chatAgentHostProviderId: RawContextKey<string>;
    /**
    ...
    const nonCopilotLanguageModelsAreUserSelectable: RawContextKey<boolean>;
    ...
    const inAutomationsDialog: RawContextKey<boolean>;
    ...
    const chatSessionSupportsDelegation: RawContextKey<boolean>;
    const hasPendingDelegationTarget: RawContextKey<boolean>;
    const chatSessionSupportsFork: RawContextKey<boolean>;
    const agentSessionSection: RawContextKey<string>;
    const isArchivedAgentSession: RawContextKey<boolean>;
    const isPinnedAgentSession: RawContextKey<boolean>;
...
export declare namespace ChatContextKeyExprs {
     ...
     */
    const isAgentHostSession: import("../../../../../platform/contextkey/common/contextkey.js").ContextKeyExpression;
    /**
     ...
     */
    const isAgentHostSessionItem: import("../../../../../platform/contextkey/common/contextkey.js").ContextKeyExpression | undefined;
}
