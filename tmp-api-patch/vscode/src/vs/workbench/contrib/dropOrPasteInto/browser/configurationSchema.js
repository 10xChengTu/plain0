...
const dropAsPreferenceSchema = {
    ...
    default: [],
    items: {
        description: ( localize(10132, "The kind identifier of the drop edit.")),
        anyOf: [{
            type: "string"
        }, {
            enum: dropEnumValues
...
const pasteAsPreferenceSchema = {
    ...
    default: [],
    items: {
        description: ( localize(10134, "The kind identifier of the paste edit.")),
        anyOf: [{
            type: "string"
        }, {
...
let DropOrPasteSchemaContribution = class DropOrPasteSchemaContribution extends Disposable {
    ...
    constructor(keybindingService, languageFeatures) {
        ...
        this._register(Event.runAndSubscribe(Event.debounce(Event.any(
...
DropOrPasteSchemaContribution = ( __decorate([( __param(0, IKeybindingService)), ( __param(1, ILanguageFeaturesService))], DropOrPasteSchemaContribution));
