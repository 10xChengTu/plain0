...
import { $, createElement, trackFocus, addDisposableListener, getTotalWidth } from '../../../../../../base/browser/dom.js';
import * as notebookFindReplaceWidget from './notebookFindReplaceWidget.css';
...
import { Separator, Action, ActionRunner } from '../../../../../../base/common/actions.js';
...
import { registerAndCreateHistoryNavigationContext, ContextScopedReplaceInput } from '../../../../../../platform/history/browser/contextScopedHistoryWidget.js';
import { IHoverService } from '../../../../../../platform/hover/browser/hover.service.js';
import { IInstantiationService } from '../../../../../../platform/instantiation/common/instantiation.js';
import { defaultProgressBarStyles, defaultToggleStyles, defaultInputBoxStyles } from '../../../../../../platform/theme/browser/defaultStyles.js';
...
const NLS_FIND_INPUT_LABEL = ( localize(12409, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(12410, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(12411, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(12412, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(12413, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(12414, "Close"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(12415, "Toggle Replace"));
const NLS_REPLACE_INPUT_LABEL = ( localize(12416, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(12417, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(12418, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(12419, "Replace All"));
registerIcon("find-filter", Codicon.filter, ( localize(12420, "Icon for Find Filter in find widget.")));
const NOTEBOOK_FIND_FILTERS = ( localize(12421, "Find Filters"));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localize(12422, "Markdown Source"));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localize(12423, "Rendered Markdown"));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localize(12424, "Code Cell Source"));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localize(12425, "Code Cell Output"));
...
NotebookFindFilterActionViewItem = ( __decorate([( __param(4, IContextMenuService))], NotebookFindFilterActionViewItem));
class NotebookFindInputFilterButton extends Disposable {
    constructor(
        ...
        this._filtersAction = this._register(( new Action(
            ...
            actionViewItemProvider: (action, options) => {
                if (action.id === this._filtersAction.id) {
                    return this.instantiationService.createInstance(
                        ...
                        action,
                        options,
                        this._register(( new ActionRunner()))
                    );
                }
                return undefined;
            }
        })));
        this._actionbar.push(this._filtersAction, {
            icon: true,
            label: false
        });
    }
...
class NotebookFindInput extends FindInput {
    constructor(
        ...
        this._register(
            registerAndCreateHistoryNavigationContext(contextKeyService, this.inputBox)
        );
...
let SimpleFindReplaceWidget = class SimpleFindReplaceWidget extends Widget {
    constructor(
        ...
        this._filters = this._register(( new NotebookFindFilters(
        ...
        this._innerFindDomNode = createElement("div");
        ...
        this._register(
            this._findInputFocusTracker.onDidFocus(this.onFindInputFocusTrackerFocus.bind(this))
        );
        this._register(
            this._findInputFocusTracker.onDidBlur(this.onFindInputFocusTrackerBlur.bind(this))
        );
        this._register(addDisposableListener(this._innerFindDomNode, "click", event => {
            event.stopPropagation();
        }));
        this._innerReplaceDomNode = createElement("div");
        ...
        this._register(
            this._replaceInputFocusTracker.onDidFocus(this.onReplaceInputFocusTrackerFocus.bind(this))
        );
        this._register(
            this._replaceInputFocusTracker.onDidBlur(this.onReplaceInputFocusTrackerBlur.bind(this))
        );
        ...
        this._resizeSash = this._register(( new Sash(this._domNode, {
...
SimpleFindReplaceWidget = ( __decorate([( __param(0, IContextViewService)), ( __param(1, IContextKeyService)), ( __param(2, IConfigurationService)), ( __param(3, IContextMenuService)), ( __param(4, IInstantiationService)), ( __param(5, IHoverService))], SimpleFindReplaceWidget));
