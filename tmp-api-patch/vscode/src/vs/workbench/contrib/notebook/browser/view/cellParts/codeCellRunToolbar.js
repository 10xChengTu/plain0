...
let RunToolbar = class RunToolbar extends CellContentPart {
    ...
    didRenderCell(element) {
        this.cellDisposables.add(
            registerCellToolbarStickyScroll(this.notebookEditor, element, this.runButtonContainer)
        );
    ...
    createRunCellToolbar(container, cellContainer, contextKeyService) {
        ...
        const dropdownAction = this._register(( new Action("notebook.moreRunActions", ( localize(12852, "More...")), "codicon-chevron-down", true)));
...
RunToolbar = ( __decorate([( __param(6, IMenuService)), ( __param(7, IKeybindingService)), ( __param(8, IContextMenuService)), ( __param(9, IInstantiationService))], RunToolbar));
