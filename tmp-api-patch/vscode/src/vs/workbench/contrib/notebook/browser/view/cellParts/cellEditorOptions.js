...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    "properties": {
        "notebook.lineNumbers": {
            ...
            enum: ["off", "on"],
            default: "off",
            markdownDescription: ( localize(12833, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12834, "Toggle Notebook Line Numbers")),
            shortTitle: ( localize2(12835, "Line Numbers")),
            ...
            toggled: {
                ...
                title: ( localize(12836, "Line Numbers"))
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(12837, "Show Cell Line Numbers")),
