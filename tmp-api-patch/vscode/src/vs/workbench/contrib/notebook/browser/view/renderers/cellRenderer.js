...
let MarkupCellRenderer = class MarkupCellRenderer extends AbstractCellRenderer {
    ...
    renderTemplate(rootContainer) {
        ...
        const focusIndicatorLeft = ( new FastDomNode(append(container, $$1(
        ...
        const focusIndicatorRight = ( new FastDomNode(append(container, $$1(
        ...
        const cellParts = ( new CellPartsCollection(getWindow(rootContainer), [templateDisposables.add(
            scopedInstaService.createInstance(CellChatPart, this.notebookEditor, cellChatPart)
        ), templateDisposables.add(
            scopedInstaService.createInstance(CellEditorStatusBar, this.notebookEditor, container, editorPart, undefined)
        ...
        ))), templateDisposables.add(( new CellDecorations(this.notebookEditor, rootContainer, decorationContainer))), templateDisposables.add(
            scopedInstaService.createInstance(CellComments, this.notebookEditor, cellCommentPartContainer)
        ), templateDisposables.add(( new CollapsedCellInput(this.notebookEditor, cellInputCollapsedContainer))), templateDisposables.add(( new CellFocusPart(container, undefined, this.notebookEditor))), templateDisposables.add(( new CellDragAndDropPart(container))), templateDisposables.add(scopedInstaService.createInstance(CellContextKeyPart, this.notebookEditor))], [titleToolbar, templateDisposables.add(scopedInstaService.createInstance(
            BetweenCellToolbar,
            this.notebookEditor,
            titleToolbarContainer,
            bottomCellContainer
    ...
    renderElement(element, index, templateData, details) {
        ...
        templateData.elementDisposables.add(templateData.instantiationService.createInstance(
            MarkupCell,
            this.notebookEditor,
            element,
            templateData,
...
let CodeCellRenderer = class CodeCellRenderer extends AbstractCellRenderer {
    ...
    renderTemplate(rootContainer) {
        ...
        executionOrderLabel.title = ( localize(12864, "Execution Order"));
        ...
        const contentParts = [focusIndicatorPart, templateDisposables.add(
            scopedInstaService.createInstance(CellChatPart, this.notebookEditor, cellChatPart)
        ), templateDisposables.add(
            scopedInstaService.createInstance(CellEditorStatusBar, this.notebookEditor, container, editorPart, editor)
        ), templateDisposables.add(
            scopedInstaService.createInstance(CellProgressBar, editorPart, cellInputCollapsedContainer)
        ), templateDisposables.add(( new CellDecorations(this.notebookEditor, rootContainer, decorationContainer))), templateDisposables.add(
            scopedInstaService.createInstance(CellComments, this.notebookEditor, cellCommentPartContainer)
        ), templateDisposables.add(
            scopedInstaService.createInstance(CellExecutionPart, this.notebookEditor, executionOrderLabel)
        ), templateDisposables.add(
            scopedInstaService.createInstance(CollapsedCellOutput, this.notebookEditor, cellOutputCollapsedContainer)
        ...
        if (cellExecutePrimary && cellExecuteToolbar) {
            contentParts.push(templateDisposables.add(scopedInstaService.createInstance(
                RunToolbar,
                this.notebookEditor,
                contextKeyService,
                container,
        ...
        const cellParts = ( new CellPartsCollection(
            getWindow(rootContainer),
            contentParts,
            [titleToolbar, templateDisposables.add(scopedInstaService.createInstance(
                BetweenCellToolbar,
                this.notebookEditor,
                titleToolbarContainer,
    ...
    renderElement(element, index, templateData, details) {
        ...
        templateData.elementDisposables.add(
            templateData.instantiationService.createInstance(CodeCell, this.notebookEditor, element, templateData, this.editorPool)
        );
...
CodeCellRenderer = CodeCellRenderer_1 = ( __decorate([( __param(5, IConfigurationService)), ( __param(6, IContextMenuService)), ( __param(7, IMenuService)), ( __param(8, IInstantiationService)), ( __param(9, IKeybindingService)), ( __param(10, INotificationService))], CodeCellRenderer));
