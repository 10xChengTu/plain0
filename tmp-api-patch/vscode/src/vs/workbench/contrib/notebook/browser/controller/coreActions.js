...
import { NOTEBOOK_IS_ACTIVE_EDITOR, INTERACTIVE_WINDOW_IS_ACTIVE_EDITOR, REPL_NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_KERNEL_COUNT, NOTEBOOK_KERNEL_SOURCE_COUNT, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED } from '../../common/notebookContextKeys.js';
...
const NOTEBOOK_ACTIONS_CATEGORY = ( localize2(12506, "Notebook"));
...
MenuRegistry.appendMenuItem(MenuId.NotebookCellTitle, {
    ...
    title: ( localize(12507, "Insert Cell")),
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    ...
    title: ( localize(12508, "Notebook Cell")),
    group: CellOverflowToolbarGroups.Insert,
    when: NOTEBOOK_EDITOR_FOCUSED
});
MenuRegistry.appendMenuItem(MenuId.NotebookCellTitle, {
    title: ( localize(12509, "Share")),
