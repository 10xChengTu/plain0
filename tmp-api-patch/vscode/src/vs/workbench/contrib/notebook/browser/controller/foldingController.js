...
import { NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_EDITOR_FOCUSED } from '../../common/notebookContextKeys.js';
...
class FoldingController extends Disposable {
    ...
    setFoldingStateDown(index, state, levels) {
        ...
        regions.forEach(
            r => this._foldingModel.setCollapsed(r.regionIndex, state === CellFoldingState.Collapsed)
        );
        this._updateEditorFoldingRanges();
    }
...
const NOTEBOOK_FOLD_COMMAND_LABEL = ( localize(12549, "Fold Cell"));
const NOTEBOOK_UNFOLD_COMMAND_LABEL = ( localize2(12550, "Unfold Cell"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: "notebook.fold",
            title: ( localize2(12549, "Fold Cell")),
