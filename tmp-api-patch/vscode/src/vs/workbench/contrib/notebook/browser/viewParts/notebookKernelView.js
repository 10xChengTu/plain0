...
function shouldSkip(selected, controllerId, extensionId, context) {
    return !!(selected && (
    (context && "skipIfAlreadySelected" in context && context.skipIfAlreadySelected) || (controllerId && selected.id === controllerId && ExtensionIdentifier.equals(selected.extension, extensionId))));
}
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12880, "Select Notebook Kernel")),
            ...
            metadata: {
                description: ( localize(12881, "Notebook Kernel Args")),
                args: [{
                    name: "kernelInfo",
