...
import { NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_HAS_HIDDEN_OUTPUTS, NOTEBOOK_CELL_OUTPUT_MIMETYPE } from '../../common/notebookContextKeys.js';
import { copyIcon, saveIcon } from '../notebookIcons.js';
...
import { INotebookEditorModelResolverService } from '../../common/notebookEditorModelResolverService.service.js';
...
registerAction2(class ShowAllOutputsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12486, "Show Empty Outputs")),
            menu: {
...
registerAction2(class CopyCellOutputAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12487, "Copy Cell Output")),
            menu: {
                id: MenuId.NotebookOutputToolbar,
...
registerAction2(class OpenCellOutputInEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12488, "Open Cell Output in Text Editor")),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            icon: copyIcon
        });
    ...
    async run(accessor, outputContext) {
        ...
        if (outputViewModel?.model.outputId && notebookEditor.textModel?.uri) {
            ...
            await openerService.open(
                CellUri.generateCellOutputUriWithId(notebookEditor.textModel.uri, outputViewModel.model.outputId)
            );
            ref.dispose();
        }
    }
...
registerAction2(class SaveCellOutputImageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12489, "Save Image")),
            menu: {
                id: MenuId.NotebookOutputToolbar,
    ...
    async run(accessor, outputContext) {
        ...
        const defaultUri = notebookEditor.textModel?.uri ? URI.joinPath(URI.file(notebookEditor.textModel.uri.fsPath), "..", defaultFileName) : undefined;
        const uri = await fileDialogService.showSaveDialog({
            defaultUri,
            filters: [{
                name: ( localize(12490, "Image Files")),
...
registerAction2(class OpenCellOutputInNotebookOutputEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12491, "Open in Output Preview")),
            menu: {
                id: MenuId.NotebookOutputToolbar,
    ...
    async run(accessor, outputContext) {
        ...
        openerService.open(outputURI, {
            openToSide: true
        });
    }
});

export { COPY_OUTPUT_COMMAND_ID, OPEN_OUTPUT_COMMAND_ID, OPEN_OUTPUT_IN_OUTPUT_PREVIEW_COMMAND_ID, SAVE_OUTPUT_IMAGE_COMMAND_ID, getOutputViewModelFromId };
