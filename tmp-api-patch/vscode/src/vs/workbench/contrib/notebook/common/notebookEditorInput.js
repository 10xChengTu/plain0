...
import { toLocalResource, isEqual } from '../../../../base/common/resources.js';
...
let NotebookEditorInput = class NotebookEditorInput extends AbstractResourceEditorInput {
    ...
    async resolve(_options, perf) {
        ...
        if (!this.editorModelReference) {
            ...
            this._register(
                this.editorModelReference.object.onDidChangeDirty(() => this._onDidChangeDirty.fire())
            );
            this._register(
                this.editorModelReference.object.onDidChangeReadonly(() => this._onDidChangeCapabilities.fire())
            );
...
NotebookEditorInput = NotebookEditorInput_1 = ( __decorate([( __param(4, INotebookService)), ( __param(5, INotebookEditorModelResolverService)), ( __param(6, IFileDialogService)), ( __param(7, ILabelService)), ( __param(8, IFileService)), ( __param(9, IFilesConfigurationService)), ( __param(10, IExtensionService)), ( __param(11, IEditorService)), ( __param(12, ITextResourceConfigurationService)), ( __param(13, ICustomEditorLabelService)), ( __param(14, IWorkbenchEnvironmentService)), ( __param(15, IPathService))], NotebookEditorInput));
