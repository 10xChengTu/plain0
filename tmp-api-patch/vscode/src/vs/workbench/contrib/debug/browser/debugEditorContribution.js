...
registerColor("editor.inlineValuesForeground", {
    ...
    hcDark: "#ffffff80",
    hcLight: "#00000080"
}, ( localize(9727, "Color for the debug inline value text.")));
registerColor("editor.inlineValuesBackground", "#ffc80033", ( localize(9728, "Color for the debug inline value background.")));
class InlineSegment {
...
function createInlineValueDecoration(
    ...
    viewportMaxCol = MAX_INLINE_DECORATOR_LENGTH
) {
...
let DebugEditorContribution = class DebugEditorContribution {
    constructor(
        ...
        this.debounceInfo = featureDebounceService.for(languageFeaturesService.inlineValuesProvider, "InlineValues", {
    ...
    registerListeners() {
        this.toDispose.push(
            this.debugService.getViewModel().onDidFocusStackFrame(e => this.onFocusStackFrame(e.stackFrame))
        );
        ...
        this.toDispose.push(
            this.debugService.getViewModel().onWillUpdateViews(() => this.updateInlineValuesScheduler.schedule())
        );
        this.toDispose.push(
            this.debugService.getViewModel().onDidEvaluateLazyExpression(() => this.updateInlineValuesScheduler.schedule())
        );
    ...
    preventDefaultEditorHover() {
        ...
        this.defaultHoverLockout.value = {
            dispose: () => {
                this.editor.updateOptions({
                    hover: {
                        enabled: this.editorHoverOptions?.enabled ?? "on"
                    }
                });
            }
        };
    ...
    async addLaunchConfiguration() {
        ...
        if (!configurationsArrayPosition) {
            ...
            const edit = (basename(model.uri.fsPath) === "launch.json") ? setProperty(model.getValue(), ["configurations"], [], {
                ...
                insertSpaces,
                eol
            })[0] : setProperty(model.getValue(), ["launch"], {
                "configurations": []
            }, {
                tabSize,
                insertSpaces,
        ...
        if (( this.languageFeaturesService.inlineValuesProvider.has(model))) {
            ...
            lineDecorations.forEach((segments, line) => {
                if (segments.length > 0) {
                    ...
                    allDecorations.push(
                        ...createInlineValueDecoration(line, text, "debug", undefined, viewportMaxCol)
                    );
                }
            });
        } else {
...
DebugEditorContribution.__decorator = ( __decorate([memoize], DebugEditorContribution.prototype, "showHoverScheduler", null));
DebugEditorContribution.__decorator = ( __decorate(
    [memoize],
    DebugEditorContribution.prototype,
    "removeInlineValuesScheduler",
    null
));
DebugEditorContribution.__decorator = ( __decorate(
    [memoize],
...
DebugEditorContribution = ( __decorate([( __param(1, IDebugService)), ( __param(2, IInstantiationService)), ( __param(3, ICommandService)), ( __param(4, IConfigurationService)), ( __param(5, IHostService)), ( __param(6, IUriIdentityService)), ( __param(7, IContextKeyService)), ( __param(8, ILanguageFeaturesService)), ( __param(9, ILanguageFeatureDebounceService)), ( __param(10, IEditorService))], DebugEditorContribution));
