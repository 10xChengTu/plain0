...
export declare class StartDebugActionViewItem extends BaseActionViewItem {
    ...
    private selected;
    private providers;
    constructor(context: unknown, action: IAction, options: IBaseActionViewItemOptions, debugService: IDebugService, configurationService: IConfigurationService, commandService: ICommandService, contextService: IWorkspaceContextService, _contextViewService: IContextViewService, keybindingService: IKeybindingService, hoverService: IHoverService, contextKeyService: IContextKeyService, actionWidgetService: IActionWidgetService, telemetryService: ITelemetryService);
