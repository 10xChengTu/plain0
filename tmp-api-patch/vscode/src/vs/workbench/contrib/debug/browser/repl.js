...
let Repl = class Repl extends FilterViewPane {
    ...
    constructor(
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(9887, "Filter (e.g. text, !exclude, \\escape)")),
                text: filterText,
                history: JSON.parse(
                    storageService.get(FILTER_HISTORY_STORAGE_KEY, StorageScope.WORKSPACE, "[]")
                )
            }
        ...
        this.replOptions = this._register(
            this.instantiationService.createInstance(ReplOptions, this.id, () => this.getLocationBasedColors().background)
        );
    ...
    get refreshScheduler() {
        ...
        return (new RunOnceScheduler(async () => {
            ...
            this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(9888, "Showing {0} of {1}", filtered, total)));
    ...
    createReplTree() {
        ...
        this.selectSession();
        this.styleElement = createStyleSheet(this.container, undefined, this._store);
        this.onDidStyleChange();
    }
    createReplInput(container) {
        this.replInputContainer = append(container, $(".repl-input-wrapper"));
        append(this.replInputContainer, $(
        ...
        const {
            ...
            registerAndCreateHistoryNavigationContext(this.scopedContextKeyService, this)
        );
    ...
    getAriaLabel() {
        let ariaLabel = ( localize(9889, "Debug Console"));
        ...
        if (keybinding) {
            ariaLabel = ( localize(9890, "{0}, use ({1}) for accessibility help", ariaLabel, keybinding));
        } else {
            ariaLabel = ( localize(
                9891,
    ...
    updateInputDecoration() {
        ...
        if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
            ...
            decorations.push({
                ...
                renderOptions: {
                    after: {
                        contentText: ( localize(9892, "Please start a debug session to evaluate expressions")),
...
Repl.__decorator = ( __decorate([memoize], Repl.prototype, "refreshScheduler", null));
Repl = Repl_1 = ( __decorate([( __param(1, IDebugService)), ( __param(2, IInstantiationService)), ( __param(3, IStorageService)), ( __param(4, IThemeService)), ( __param(5, IModelService)), ( __param(6, IContextKeyService)), ( __param(7, ICodeEditorService)), ( __param(8, IViewDescriptorService)), ( __param(9, IContextMenuService)), ( __param(10, IConfigurationService)), ( __param(11, ITextResourcePropertiesService)), ( __param(12, IEditorService)), ( __param(13, IKeybindingService)), ( __param(14, IOpenerService)), ( __param(15, IHoverService)), ( __param(16, IMenuService)), ( __param(17, ILanguageFeaturesService)), ( __param(18, ILogService))], Repl));
...
ReplOptions = ReplOptions_1 = ( __decorate([( __param(2, IConfigurationService)), ( __param(3, IThemeService)), ( __param(4, IViewDescriptorService))], ReplOptions));
class AcceptReplInputAction extends EditorAction {
    constructor() {
        super({
            id: "repl.action.acceptInput",
            label: ( localize2(9893, "Debug Console: Accept Input")),
...
class FilterReplAction extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9894, "Debug Console: Focus Filter")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class FindReplAction extends ViewAction {
    constructor() {
        super({
            viewId: REPL_VIEW_ID,
            id: "repl.action.find",
            title: ( localize(9895, "Debug Console: Focus Find")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class ReplCopyAllAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(9896, "Debug: Console Copy All")),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize(9897, "Select Debug Console")),
            f1: false,
            menu: {
                id: MenuId.ViewTitle,
                group: "navigation",
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize2(9898, "Clear Console")),
            metadata: {
                description: ( localize2(9899, "Clears all program output from your debug REPL"))
            },
            f1: true,
            ...
            keybinding: [{
                primary: 0,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyCode.KeyK
                },
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9900, "Collapse All")),
            viewId: REPL_VIEW_ID,
            menu: {
                id: MenuId.DebugConsoleContext,
                group: "z_commands",
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9904, "Focus on Debug Console View"))
        });
    }
    async run(accessor) {
