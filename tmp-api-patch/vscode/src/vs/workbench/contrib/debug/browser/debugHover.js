...
import { $ as $$1, append, addStandardDisposableListener, SafeTriangle, isAncestorOfActiveElement } from '../../../../base/browser/dom.js';
...
import { editorHoverBackground, editorHoverBorder, editorHoverForeground } from '../../../../platform/theme/common/colors/editorColors.js';
...
import { Variable, Expression, VisualizedExpression } from '../common/debugModel.js';
...
class DebugHoverAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(9730, "Debug Hover");
    }
    getAriaLabel(element) {
        return localize(9731, "{0}, value {1}, variables, debug", element.name, element.value);
    }
}
...
DebugHoverComputer = ( __decorate([( __param(1, IDebugService)), ( __param(2, ILanguageFeaturesService)), ( __param(3, ILogService))], DebugHoverComputer));
