...
import { TrackedRangeStickiness, OverviewRulerLane, GlyphMarginLane } from '../../../../editor/common/model.js';
...
import * as callStackEditorContribution from './media/callStackEditorContribution.css';

registerCss(callStackEditorContribution);
const topStackFrameColor = registerColor("editor.stackFrameHighlightBackground", {
    dark: "#ffff0033",
    light: "#ffff6673",
    hcDark: "#ffff0033",
    hcLight: "#ffff6673"
...
const focusedStackFrameColor = registerColor("editor.focusedStackFrameHighlightBackground", {
    dark: "#7abd7a4d",
    light: "#cee7ce73",
    hcDark: "#7abd7a4d",
    hcLight: "#cee7ce73"
                ...
                if (t.stopped) {
                    ...
                    stackFrames.forEach(candidateStackFrame => {
                        if (candidateStackFrame && this.uriIdentityService.extUri.isEqual(candidateStackFrame.source.uri, editor.getModel()?.uri)) {
                            ...
                            decorations.push(
                                ...createDecorationsForStackFrame(candidateStackFrame, isSessionFocused, noCharactersBefore)
                            );
                        }
                    });
                }
...
CallStackEditorContribution = ( __decorate([( __param(1, IDebugService)), ( __param(2, IUriIdentityService)), ( __param(3, ILogService))], CallStackEditorContribution));
