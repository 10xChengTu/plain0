...
const DisassemblyEditorIcon = registerIcon("disassembly-editor-label-icon", Codicon.debug, ( localize(10125, "Icon of the disassembly editor label.")));
class DisassemblyViewInput extends EditorInput {
    ...
    getName() {
        return localize(10126, "Disassembly");
    }
    getIcon() {
