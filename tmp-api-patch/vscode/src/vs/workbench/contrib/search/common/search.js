...
function getOutOfWorkspaceEditorResources(accessor) {
    ...
    const resources = ( editorService.editors.map(editor => EditorResourceAccessor.getOriginalUri(editor, {
...
const searchConfigurationNode = {
    id: "search",
    order: 13,
    title: ( localize(14147, "Search")),
    type: "object",
    properties: {}
};

export { SearchStateKey, SearchUIState, WorkspaceSymbolItem, WorkspaceSymbolProviderRegistry, extractRangeFromFilter, getOutOfWorkspaceEditorResources, getWorkspaceSymbols, searchConfigurationNode };
