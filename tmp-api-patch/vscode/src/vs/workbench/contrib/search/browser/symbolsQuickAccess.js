...
import { SymbolKind, SymbolTag, SymbolKinds } from '../../../../editor/common/languages.js';
...
let SymbolsQuickAccessProvider = class SymbolsQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    static {
        this.TREAT_AS_GLOBAL_SYMBOL_TYPES = ( new Set([
            SymbolKind.Class,
            SymbolKind.Enum,
            SymbolKind.File,
    ...
    constructor(
        ...
        super(SymbolsQuickAccessProvider_1.PREFIX, {
            ...
            noResultsPick: {
                label: ( localize(14144, "No matching workspace symbols"))
            }
        });
        ...
        for (const {
            ...
            symbolPicks.push({
                ...
                buttons: [{
                    ...
                    tooltip: openSideBySideDirection === "right" ? ( localize(14145, "Open to the Side")) : ( localize(14146, "Open to the Bottom"))
                }],
...
SymbolsQuickAccessProvider = SymbolsQuickAccessProvider_1 = ( __decorate([( __param(0, ILabelService)), ( __param(1, IOpenerService)), ( __param(2, IEditorService)), ( __param(3, IConfigurationService)), ( __param(4, ICodeEditorService)), ( __param(5, IChatWidgetService))], SymbolsQuickAccessProvider));
