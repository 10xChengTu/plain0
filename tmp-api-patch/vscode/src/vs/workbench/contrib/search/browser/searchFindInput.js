...
class SearchFindInput extends ContextScopedFindInput {
    constructor(
        ...
        this._findFilter = this._register(( new NotebookFindInputFilterButton(filters, contextMenuService, instantiationService, options, ( localize(14036, "Notebook Find Filters")))));
        this._updatePadding();
