...
import { DisposableStore, MutableDisposable, DisposableMap, Disposable } from '../../../../base/common/lifecycle.js';
...
const SEARCH_CANCELLED_MESSAGE = ( localize(14078, "Search was canceled before any results could be found - "));
...
let SearchView = class SearchView extends ViewPane {
    ...
    static {
        this.ACTIONS_RIGHT_CLASS_NAME = "actions-right";
    }
    constructor(
        options,
        fileService,
        ...
        this.refreshTreeController = this._register(
            this.instantiationService.createInstance(RefreshTreeController, this, () => this.searchConfig)
        );
        ...
        this._register(
            this.textFileService.untitled.onWillDispose(model => this.onUntitledDidDispose(model.resource))
        );
        this._register(
            this.contextService.onDidChangeWorkbenchState(() => this.onDidChangeWorkbenchState())
        );
        ...
        const updateChangedFilesToggleEnabled = () => {
            const hasChanges = ( [...this.scmService.repositories].some(repo => ( repo.provider.groups.some(group => group.resources.length > 0))));
    ...
    async replaceSearchModel(searchModel, asyncResults) {
        ...
        this._onSearchResultChangedDisposable = this._register(
            searchModel.onSearchResultChanged(async event => this.onSearchResultsChanged(event))
        );
    ...
    renderBody(parent) {
        ...
        const toggleQueryDetailsLabel = ( localize(14079, "Toggle Search Details"));
        ...
        this._register(
            addDisposableListener(this.toggleQueryDetailsButton, EventType.CLICK, e => {
                EventHelper.stop(e);
                this.toggleQueryDetails(!this.accessibilityService.isScreenReaderOptimized());
            })
        );
        this._register(
            addDisposableListener(this.toggleQueryDetailsButton, EventType.KEY_UP, e => {
        ...
        this._register(
            addDisposableListener(this.toggleQueryDetailsButton, EventType.KEY_DOWN, e => {
                const event = ( new StandardKeyboardEvent(e));
        ...
        const filesToIncludeTitle = ( localize(14080, "files to include"));
        append(folderIncludesList, $("h4", undefined, filesToIncludeTitle));
        this.inputPatternIncludes = this._register(
            this.instantiationService.createInstance(IncludePatternInputWidget, folderIncludesList, this.contextViewService, {
                ariaLabel: filesToIncludeTitle,
                placeholder: ( localize(14081, "e.g. *.ts, src/**/include")),
        ...
        this.inputPatternIncludes.setOnlySearchInChangedFilesEnabled(( [...this.scmService.repositories].some(repo => ( repo.provider.groups.some(group => group.resources.length > 0)))));
        ...
        this._register(
            this.inputPatternIncludes.onChangeSearchInChangedFilesBox(() => this.triggerQueryChange())
        );
        this.trackInputBox(
        ...
        const excludesTitle = ( localize(14082, "files to exclude"));
        append(excludesList, $("h4", undefined, excludesTitle));
        this.inputPatternExcludes = this._register(
            this.instantiationService.createInstance(ExcludePatternInputWidget, excludesList, this.contextViewService, {
                ariaLabel: excludesTitle,
                placeholder: ( localize(14083, "e.g. *.ts, src/**/exclude")),
                showPlaceholderOnFocus: true,
        ...
        this._onSearchResultChangedDisposable = this._register(
            this.viewModel.onSearchResultChanged(async event => await this.onSearchResultsChanged(event))
        );
        ...
        this._register(
            this.onDidChangeBodyVisibility(visible => this.onVisibilityChanged(visible))
        );
        this.updateIndentStyles(this.themeService.getFileIconTheme());
    ...
    createSearchWidget(container) {
        ...
        this._register(this.searchWidget.onSearchCancel((
            {
                focus
            }
        ...
        this._register(
            this.searchWidget.replaceInput.inputBox.onDidChange(() => updateHasReplacePatternKey())
        );
    ...
    replaceAll() {
        ...
        const confirmation = {
            title: ( localize(14084, "Replace All")),
            message: this.buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue),
            primaryButton: ( localize(14085, "&&Replace"))
        };
    ...
    buildAfterReplaceAllMessage(occurrences, fileCount, replaceValue) {
        if (occurrences === 1) {
            if (fileCount === 1) {
                ...
                return localize(14087, "Replaced {0} occurrence across {1} file.", occurrences, fileCount);
            }
            if (replaceValue) {
                return localize(
                    14088,
            ...
            return localize(14089, "Replaced {0} occurrence across {1} files.", occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (replaceValue) {
                return localize(
            ...
            return localize(14091, "Replaced {0} occurrences across {1} file.", occurrences, fileCount);
        }
        if (replaceValue) {
            return localize(
                14092,
    ...
    buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue) {
        ...
        if (occurrences === 1) {
            if (fileCount === 1) {
                ...
                return localize(14095, "Replace {0} occurrence across {1} file?", occurrences, fileCount);
            }
            if (displayReplaceValue) {
                return localize(
                    14096,
            ...
            return localize(14097, "Replace {0} occurrence across {1} files?", occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (displayReplaceValue) {
                return localize(
            ...
            return localize(14099, "Replace {0} occurrences across {1} file?", occurrences, fileCount);
        }
        if (displayReplaceValue) {
            return localize(
                14100,
        ...
        return localize(14101, "Replace {0} occurrences across {1} files?", occurrences, fileCount);
    }
    clearMessage() {
    ...
    createSearchResultsView(container) {
        ...
        this.tree = this._register(this.instantiationService.createInstance(
            ...
            [this._register(
                this.instantiationService.createInstance(FolderMatchRenderer, this, this.treeLabels)
            ), this._register(
                this.instantiationService.createInstance(FileMatchRenderer, this, this.treeLabels)
            ), this._register(
                this.instantiationService.createInstance(TextSearchResultRenderer, this.treeLabels)
        ...
        this._register(
            Event.debounce(this.tree.onDidOpen, (last, event) => event, DEBOUNCE_DELAY, true)(options => {
        ...
        this._register(
            Event.debounce(this.tree.onDidChangeFocus, (last, event) => event, DEBOUNCE_DELAY, true)(() => {
    ...
    focus() {
        ...
        if (this.lastFocusState === "input" || !this.hasSearchResults()) {
            const updatedText = this.searchConfig.seedOnFocus ? this.updateTextFromSelection({
                allowSearchOnType: false
            }) : false;
    ...
    clearSearchResults(clearInput = true) {
        ...
        this.tree.ariaLabel = ( localize(14102, "Empty Search"));
    ...
    validateQuery(query) {
        ...
        return Promise.all(folderQueriesExistP).then(existResults => {
            ...
            if (!query.folderQueries.length || existingFolderQueries.length) {
                ...
                const searchPathNotFoundError = ( localize(14103, "Search path not found: {0}", nonExistantPath));
    ...
    onQueryTriggered(
        ...
        this.currentSearchQ = this.currentSearchQ.then(() => this.doSearch(
            query,
            excludePatternText,
            includePatternText,
            triggeredOnType,
    ...
    appendSearchWithAIButton(messageEl) {
        const searchWithAIButtonTooltip = this.keybindingService.appendKeybinding(( localize(14104, "Search with AI.")), SearchCommandIds.SearchWithAIActionId);
        const searchWithAIButtonText = ( localize(14105, "Search with AI"));
        ...
        if (!allResults) {
            ...
            if (!completed) {
                ...
                if (hasIncludes && hasExcludes) {
                    ...
                    message = ( localize(14111, "No results found in '{0}' - ", includePatternText));
                } else if (hasExcludes) {
                    message = ( localize(14112, "No results found excluding '{0}' - ", excludePatternText));
                } else {
                    message = ( localize(
                        14113,
            ...
            if (!completed) {
                const searchAgainButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14114, "Search again")), () => this.triggerQueryChange({
                    preserveFocus: false
                }), this.hoverService)));
                append(messageEl, searchAgainButton.element);
            } else if (hasIncludes || hasExcludes) {
                const searchAgainButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14115, "Search again in all files")), this.onSearchAgain.bind(this), this.hoverService)));
                append(messageEl, searchAgainButton.element);
            } else {
                const openSettingsButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14116, "Open Settings")), this.onOpenSettings.bind(this), this.hoverService)));
    ...
    async requestAIResults() {
        this.logService.info(
            `SearchView: Requesting semantic results from keybinding. Cached: ${!!this.cachedResults}`
        );
    ...
    doSearch(
        ...
        if (this.model.searchResult.aiTextSearchResult.hidden && shouldUpdateAISearch) {
            this.logService.info(
                `SearchView: Semantic search visible. Keep semantic results: ${shouldKeepAIResults}. Update semantic search: ${shouldUpdateAISearch}`
            );
            this.model.searchResult.aiTextSearchResult.hidden = false;
        }
        const slowTimer = setTimeout(() => {
    ...
    updateSearchResultCount(disregardExcludesAndIgnores, onlyOpenEditors, clear = false) {
        ...
        if (fileCount > 0) {
            if (disregardExcludesAndIgnores) {
                const excludesDisabledMessage = " - " + ( localize(14120, "exclude settings and ignore files are disabled")) + " ";
                const enableExcludesButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14121, "enable")), this.onEnableExcludes.bind(this), this.hoverService, ( localize(14122, "Use Exclude Settings and Ignore Files")))));
                append(messageEl, $(
                    "span",
                    undefined,
            ...
            if (onlyOpenEditors) {
                const searchingInOpenMessage = " - " + ( localize(14123, "searching only in open files")) + " ";
                const disableOpenEditorsButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14124, "disable")), this.onDisableSearchInOpenEditors.bind(this), this.hoverService, ( localize(14125, "Search in entire workspace")))));
                append(messageEl, $(
                    "span",
                    undefined,
            ...
            append(messageEl, " - ");
            const openInEditorTooltip = this.keybindingService.appendKeybinding(( localize(14126, "Copy current search results to an editor")), SearchCommandIds.OpenInEditorCommandId);
            const openInEditorButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14127, "Open in editor")), () => this.instantiationService.invokeFunction(
                createEditorFromSearchResult,
                this.searchResult,
                this.searchIncludePattern.getValue(),
                this.searchExcludePattern.getValue(),
                this.searchIncludePattern.onlySearchInOpenEditors()
            ), this.hoverService, openInEditorTooltip)));
    ...
    updateKeywordSuggestionUI(keyword) {
        ...
        if (this._cachedKeywords.length > 0) {
            ...
            const resultMsg = ( localize(14128, "Search instead for: "));
            append(messageEl, resultMsg);
            const button = this.messageDisposables.add(( new SearchLinkButton(
                keyword.keyword,
    ...
    addMessage(message) {
        ...
        append(messageBox, renderSearchMessage(
            message,
    ...
    buildResultCountMessage(resultCount, fileCount) {
        if (resultCount === 1 && fileCount === 1) {
            return localize(14129, "{0} result in {1} file", resultCount, fileCount);
        } else if (resultCount === 1) {
            return localize(14130, "{0} result in {1} files", resultCount, fileCount);
        } else if (fileCount === 1) {
            return localize(14131, "{0} results in {1} file", resultCount, fileCount);
        } else {
            return localize(14132, "{0} results in {1} files", resultCount, fileCount);
        }
    }
    showSearchWithoutFolderMessage() {
        ...
        const openFolderButton = this.messageDisposables.add(( new SearchLinkButton(( localize(14134, "Open Folder")), () => {
...
SearchView = SearchView_1 = ( __decorate([( __param(1, IFileService)), ( __param(2, IEditorService)), ( __param(3, ICodeEditorService)), ( __param(4, IProgressService)), ( __param(5, INotificationService)), ( __param(6, IDialogService)), ( __param(7, ICommandService)), ( __param(8, IContextViewService)), ( __param(9, IInstantiationService)), ( __param(10, IViewDescriptorService)), ( __param(11, IConfigurationService)), ( __param(12, IWorkspaceContextService)), ( __param(13, ISearchViewModelWorkbenchService)), ( __param(14, IContextKeyService)), ( __param(15, IReplaceService)), ( __param(16, ITextFileService)), ( __param(17, IPreferencesService)), ( __param(18, IThemeService)), ( __param(19, ISearchHistoryService)), ( __param(20, IContextMenuService)), ( __param(21, IAccessibilityService)), ( __param(22, IKeybindingService)), ( __param(23, IStorageService)), ( __param(24, IOpenerService)), ( __param(25, IHoverService)), ( __param(26, INotebookService)), ( __param(27, ILogService)), ( __param(28, IAccessibilitySignalService)), ( __param(29, ITelemetryService)), ( __param(30, ISCMService))], SearchView));
class SearchLinkButton extends Disposable {
    constructor(label, handler, hoverService, tooltip) {
        super();
        this.element = $("a.pointer", {
            tabindex: 0
        }, label);
        this._register(
            hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), this.element, tooltip)
        );
    ...
    addEventHandlers(handler) {
        ...
        this._register(
            addDisposableListener(this.element, EventType.CLICK, wrappedHandler)
        );
...
SearchViewDataSource = ( __decorate([( __param(1, IConfigurationService))], SearchViewDataSource));
...
RefreshTreeController = ( __decorate([( __param(2, IFileService))], RefreshTreeController));
