...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14022, "Clear Search History")),
            category,
            f1: true
        });
    }
...
registerAction2(class CancelSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14023, "Cancel Search")),
            icon: searchStopIcon,
            category,
            f1: true,
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14025, "Collapse All")),
            category,
...
registerAction2(class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14026, "Expand All")),
            category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14027, "Clear Search Results")),
            category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14028, "View as Tree")),
            category,
...
registerAction2(class ViewAsListAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14029, "View as List")),
            category,
...
registerAction2(class SearchWithAIAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(14030, "Search with AI")),
            category,
            f1: true,
