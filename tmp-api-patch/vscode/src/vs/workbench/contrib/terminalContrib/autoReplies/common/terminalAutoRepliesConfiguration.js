...
var TerminalAutoRepliesSettingId;
...
const terminalAutoRepliesConfiguration = {
    [TerminalAutoRepliesSettingId.AutoReplies]: {
        ...
        additionalProperties: {
            oneOf: [{
                type: "string",
                description: ( localize(15227, "The reply to send to the process."))
            }, {
                type: "null"
            }]
        },
...
export { TerminalAutoRepliesSettingId, terminalAutoRepliesConfiguration };
