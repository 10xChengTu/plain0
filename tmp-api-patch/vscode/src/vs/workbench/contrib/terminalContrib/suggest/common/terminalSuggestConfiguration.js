...
const terminalSuggestConfiguration = {
    ...
    [TerminalSuggestSettingId.RunOnEnter]: {
        ...
        markdownEnumDescriptions: [( localize(15773, "Never run on `Enter`.")), ( localize(15774, "Run on `Enter` when the suggestion is typed in its entirety.")), ( localize(
            15775,
            "Run on `Enter` when the suggestion is typed in its entirety or when a file is typed without its extension included."
        )), ( localize(15776, "Always run on `Enter`."))],
        default: "never"
    },
    ...
    [TerminalSuggestSettingId.CdPath]: {
        ...
        markdownEnumDescriptions: [( localize(15784, "Disable the feature.")), ( localize(15785, "Enable the feature and use relative paths.")), ( localize(
            15786,
    ...
    [TerminalSuggestSettingId.InlineSuggestion]: {
        ...
        markdownEnumDescriptions: [( localize(15788, "Disable the feature.")), ( localize(
            15789,
        ...
        )), ( localize(15790, "Enable the feature and always put the inline suggestion on top."))],
        default: "alwaysOnTop"
    },
...
function registerTerminalSuggestProvidersConfiguration(providers) {
    ...
    if (!( providers.has("lsp"))) {
        providers.set("lsp", {
            id: "lsp",
            description: ( localize(15793, "Show suggestions from language servers."))
        });
    }
    ...
    for (const id of Array.from(( providers.keys())).sort()) {
        providersProperties[id] = {
            ...
            description: providers.get(id)?.description ?? ( localize(15794, "Show suggestions from {0}.", id))
        };
    }
    const defaultValue = {};
    ...
    terminalSuggestProvidersConfiguration = {
        ...
        order: 100,
        title: ( localize(15795, "Terminal Suggest Providers")),
        type: "object",
        properties: {
            [TerminalSuggestSettingId.Providers]: {
                restricted: true,
...
export { TerminalSuggestSettingId, normalizeQuickSuggestionsConfig, registerTerminalSuggestProvidersConfiguration, terminalSuggestConfigSection, terminalSuggestConfiguration, windowsDefaultExecutableExtensions };
