...
export declare abstract class SettingsTreeElement extends Disposable {
    ...
    private _tabbable;
    private readonly _onDidChangeTabbable;
    get onDidChangeTabbable(): import("../../../../base/common/event.js").Event<void>;
...
export declare class SettingsTreeSettingElement extends SettingsTreeElement {
     ...
     */
    isAgentsWindowReadOnly: boolean;
    tags?: Set<string>;
...
export declare class SettingsTreeModel implements IDisposable {
    ...
    constructor(_viewState: ISettingsEditorViewState, _isWorkspaceTrusted: boolean, _configurationService: IWorkbenchConfigurationService, _languageService: ILanguageService, _userDataProfileService: IUserDataProfileService, _productService: IProductService, _environmentService: IWorkbenchEnvironmentService);
    ...
    private disposeChildAndRecurse;
...
export declare class SearchResultModel extends SettingsTreeModel {
    ...
    private getUniqueSearchResultSettings;
    updateChildren(): void;
