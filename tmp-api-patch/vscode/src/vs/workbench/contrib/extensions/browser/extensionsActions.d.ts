...
import { IExtension, IExtensionContainer } from "../common/extensions.js";
import { IExtensionsWorkbenchService } from "../common/extensions.service.js";
import { InstallOptions, InstallOperation } from "../../../../platform/extensionManagement/common/extensionManagement.js";
import { IAllowedExtensionsService } from "../../../../platform/extensionManagement/common/extensionManagement.service.js";
...
export declare class ManageExtensionAction extends DropDownExtensionAction {
    ...
    constructor(instantiationService: IInstantiationService, extensionService: IExtensionService, contextKeyService: IContextKeyService, productService: IProductService);
...
export declare class EnableForWorkspaceAction extends ExtensionAction {
    ...
    static readonly LABEL: string;
    constructor(extensionsWorkbenchService: IExtensionsWorkbenchService, extensionEnablementService: IWorkbenchExtensionEnablementService, productService: IProductService);
    update(): void;
    run(): Promise<any>;
}
...
export declare class DisableForWorkspaceAction extends ExtensionAction {
    ...
    static readonly LABEL: string;
    constructor(workspaceContextService: IWorkspaceContextService, extensionsWorkbenchService: IExtensionsWorkbenchService, extensionEnablementService: IWorkbenchExtensionEnablementService, extensionService: IExtensionService, productService: IProductService);
    update(): void;
    run(): Promise<any>;
}
export declare class DisableGloballyAction extends ExtensionAction {
    ...
    static readonly LABEL: string;
    constructor(extensionsWorkbenchService: IExtensionsWorkbenchService, extensionEnablementService: IWorkbenchExtensionEnablementService, extensionService: IExtensionService, productService: IProductService);
    update(): void;
    run(): Promise<any>;
}
export declare class EnableAIFeaturesInWorkspaceAction extends ExtensionAction {
    private readonly productService;
    private readonly extensionsWorkbenchService;
    ...
    static readonly LABEL: string;
    constructor(productService: IProductService, extensionsWorkbenchService: IExtensionsWorkbenchService, configurationService: IConfigurationService, extensionEnablementService: IWorkbenchExtensionEnablementService);
    update(): void;
    run(): Promise<void>;
}
