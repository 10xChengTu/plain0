...
let ExeBasedRecommendations = class ExeBasedRecommendations extends ExtensionRecommendations {
    ...
    async doFetchImportantExeBasedRecommendations() {
        ...
        this._importantTips.forEach(
            tip => importantExeBasedRecommendations.set(tip.extensionId.toLowerCase(), tip)
        );
...
ExeBasedRecommendations = ( __decorate([( __param(0, IExtensionTipsService))], ExeBasedRecommendations));
