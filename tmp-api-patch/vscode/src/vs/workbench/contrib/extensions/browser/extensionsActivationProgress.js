...
let ExtensionActivationProgress = class ExtensionActivationProgress {
    constructor(extensionService, progressService, logService) {
        const options = {
            ...
            title: ( localize(10642, "Activating Extensions..."))
        };
        let deferred;
        let count = 0;
...
ExtensionActivationProgress = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IProgressService)), ( __param(2, ILogService))], ExtensionActivationProgress));
