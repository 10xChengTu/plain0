    ...
    constructor(
        ...
        if (workspaceTrustEnablementService.isWorkspaceTrustEnabled()) {
            workspaceTrustManagementService.workspaceTrustInitialized.then(() => {
                    ...
                    async participate(trusted) {
                        if (trusted) {
                            ...
                            if (environmentService.remoteAuthority) {
                                ...
                                const stopped = await extensionService.stopExtensionHosts(( localize(10296, "Changing workspace trust")));
                                await extensionEnablementService.updateExtensionsEnablementsWhenWorkspaceTrustChanges();
                                if (stopped) {
                ...
                this._register(
                    workspaceTrustManagementService.addWorkspaceTrustTransitionParticipant(workspaceTrustTransitionParticipant)
                );
            });
        }
    }
};
ExtensionEnablementWorkspaceTrustTransitionParticipant = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IHostService)), ( __param(2, IWorkbenchEnvironmentService)), ( __param(3, IWorkbenchExtensionEnablementService)), ( __param(4, IWorkspaceTrustEnablementService)), ( __param(5, IWorkspaceTrustManagementService))], ExtensionEnablementWorkspaceTrustTransitionParticipant));
