...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(10329, "Press Enter to manage extensions.")),
    helpEntries: [{
        description: ( localize(10330, "Manage Extensions"))
    }]
});
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(
    EditorPaneDescriptor.create(ExtensionEditor, ExtensionEditor.ID, ( localize(10331, "Extension"))),
    [( new SyncDescriptor(ExtensionsInput))]
);
const VIEW_CONTAINER = ( Registry.as(Extensions$1.ViewContainersRegistry)).registerViewContainer({
    id: VIEWLET_ID,
    title: ( localize2(10332, "Extensions")),
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        mnemonicTitle: ( localize(10333, "E&&xtensions")),
        keybindings: {
...
( Registry.as(Extensions$2.Configuration)).registerConfiguration({
    id: "extensions",
    order: 30,
    title: ( localize(10334, "Extensions")),
    type: "object",
    properties: {
        "extensions.autoUpdate": {
            ...
            )), ( localize(10336, "Extensions are not automatically updated."))],
            ...
            policy: {
                ...
                localization: {
                    ...
                    enumDescriptions: [{
                        ...
                        value: ( localize(10336, "Extensions are not automatically updated."))
                    }]
                }
            }
        },
        ...
        "extensions.webWorker": {
            ...
            enumDescriptions: [( localize(10344, "The Web Worker Extension Host will always be launched.")), ( localize(10345, "The Web Worker Extension Host will never be launched.")), ( localize(
                10346,
                "The Web Worker Extension Host will be launched when a web extension needs it."
            ))],
            description: ( localize(10347, "Enable web worker extension host.")),
            default: "auto"
        },
        "extensions.supportVirtualWorkspaces": {
            type: "object",
            markdownDescription: ( localize(10348, "Override the virtual workspaces support of an extension.")),
            patternProperties: {
                ...
                "([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$": {
                    ...
                    properties: {
                        "supported": {
                            ...
                            enumDescriptions: [( localize(10352, "Extension will always be enabled.")), ( localize(
                                10353,
        ...
        [ExtensionGalleryServiceUrlConfigKey]: {
            type: "string",
            description: ( localize(10362, "Configure the Marketplace service URL to connect to")),
            default: "",
            scope: ConfigurationScope.APPLICATION,
            tags: ["usesOnlineServices"],
            included: false,
            policy: {
                ...
                localization: {
                    description: {
                        ...
                        value: ( localize(10362, "Configure the Marketplace service URL to connect to"))
                    }
                }
            }
        },
...
CommandsRegistry.registerCommand(
    ...
    (accessor, extensionId, tab, preserveFocus, feature) => {
        ...
        if (extension) {
            ...
            throw ( new Error(( localize(10365, "Extension '{0}' not found.", extensionId))));
        }
    }
);
CommandsRegistry.registerCommand(
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(10366, "Install the given extension")),
        args: [{
            name: "extensionIdOrVSIXUri",
            description: ( localize(10367, "Extension id or VSIX resource uri")),
        ...
        try {
            if (typeof arg === "string") {
                ...
                if (extension?.enablementState === EnablementState.DisabledByExtensionKind) {
                    ...
                    if (!gallery) {
                        throw ( new Error(( localize(10365, "Extension '{0}' not found.", arg))));
                    }
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(10373, "Uninstall the given extension")),
        args: [{
            name: ( localize(10374, "Id of the extension to uninstall")),
            schema: {
                "type": "string"
            }
        }]
    ...
    handler: async (accessor, id) => {
        if (!id) {
            throw ( new Error(( localize(10375, "Extension id required."))));
        }
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(10378, "Search for a specific extension")),
        args: [{
            name: ( localize(10379, "Query to use in search")),
            schema: {
                "type": "string"
            }
        }]
...
let ExtensionsContributions = class ExtensionsContributions extends Disposable {
    ...
    registerQuickAccessProvider() {
        if (this.extensionManagementServerService.localExtensionManagementServer || this.extensionManagementServerService.remoteExtensionManagementServer || this.extensionManagementServerService.webExtensionManagementServer) {
            ( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
                ...
                placeholder: ( localize(10380, "Type the name of an extension to install or search.")),
                helpEntries: [{
                    description: ( localize(10381, "Install or Search Extensions"))
                }]
            });
        }
    }
    registerGlobalActions() {
        this._register(MenuRegistry.appendMenuItem(MenuId.MenubarPreferencesMenu, {
            command: {
                id: VIEWLET_ID,
                title: ( localize(10382, "&&Extensions"))
            },
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
            command: {
                id: VIEWLET_ID,
                title: ( localize(10383, "Extensions"))
            },
            group: "2_configuration",
            order: 3
        }));
        this.registerExtensionAction({
            ...
            title: ( localize2(10384, "Focus on Extensions View")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10385, "Install Extensions")),
            category: ExtensionsLocalizedLabel,
            menu: {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10389, "Check for Extension Updates")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(CONTEXT_HAS_GALLERY, ( ContextKeyExpr.or(
            ...
            run: async () => {
                ...
                if (outdated.length) {
                    ...
                    return this.dialogService.info(( localize(10390, "All extensions are up to date.")));
                }
            }
        });
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10391, "Enable Auto Update for Extensions")),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10392, "Disable Auto Update for Extensions")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10393, "Update All Extensions")),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10394, "Enable All Extensions")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10395, "Enable All Extensions for this Workspace")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10396, "Disable All Installed Extensions")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.or(
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10397, "Disable All Installed Extensions for this Workspace")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.notEqualsTo("empty")), ( ContextKeyExpr.or(
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10398, "Install from VSIX...")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
            ...
            run: async accessor => {
                ...
                const vsixPaths = await fileDialogService.showOpenDialog({
                    title: ( localize(10399, "Install from VSIX")),
                    filters: [{
                    ...
                    canSelectFiles: true,
                    canSelectMany: true,
                    openLabel: mnemonicButtonLabel(( localize(10400, "&&Install")))
                });
                if (vsixPaths) {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10401, "Install Extension VSIX")),
            menu: [{
            ...
            run: async (accessor, resources) => {
                ...
                if (requireReload) {
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(
                        ...
                        label: ( localize(10404, "Reload Now")),
                    ...
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(
                        ...
                        label: ( localize(10407, "Restart Extensions")),
                        run: () => extensionsWorkbenchService.updateRunningExtensions()
                    }]);
                } else {
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(10408, "Completed installing extensions.")) : ( localize(10409, "Completed installing extension.")), []);
                }
            }
        });
        this.registerExtensionAction({
            id: "workbench.extensions.action.installExtensionFromLocation",
            title: ( localize2(10410, "Install Extension from Location...")),
            ...
            run: async accessor => {
                ...
                if (isWeb) {
                    return (new Promise((c, e) => {
                        ...
                        quickPick.title = ( localize(10411, "Install Extension from Location"));
                        quickPick.customButton = true;
                        quickPick.customLabel = ( localize(10412, "Install"));
                        quickPick.placeholder = ( localize(10413, "Location of the web extension"));
                    ...
                    const extensionLocation = await fileDialogService.showOpenDialog({
                        ...
                        canSelectMany: false,
                        title: ( localize(10411, "Install Extension from Location"))
                    });
        ...
        MenuRegistry.appendMenuItem(extensionsSearchActionsMenu, {
            ...
            title: ( localize(10414, "Filter Extensions...")),
            group: "navigation",
            order: 2,
            icon: filterIcon
        });
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10415, "Show Featured Extensions")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(10422, "Recently Published"))
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10424, "Show Installed Extensions")),
            category: ExtensionsLocalizedLabel,
            f1: true,
            menu: [{
                id: extensionsFilterSubMenu,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(10429, "Updates"))
            },
            run: () => this.extensionsWorkbenchService.openSearch("@updates")
        });
        this.registerExtensionAction({
            id: LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID,
            title: ( localize2(10430, "Show Extensions Unsupported By Workspace")),
            category: ExtensionsLocalizedLabel,
            menu: [{
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER))
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(10435, "Disabled"))
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10437, "Clear Extensions Search Results")),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10439, "Install Workspace Recommended Extensions")),
            icon: installWorkspaceRecommendedIcon,
            menu: {
                id: MenuId.ViewTitle,
    ...
    registerContextMenuActions() {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10440, "Show Pre-Release Version")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10441, "Show Release Version")),
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
                order: 1,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10442, "Switch to Pre-Release Version")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10443, "Switch to Release Version")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10445, "Install (Do not Sync)")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "0_install",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10446, "Install Pre-Release (Do not Sync)")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "0_install",
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor, extensionId) => {
                ...
                if (extension) {
                    return runAction(
                        instantiationService.createInstance(InstallAnotherVersionAction, extension, false)
                    );
                }
            }
        });
        this.registerExtensionAction({
            ...
            run: async (accessor, extensionId) => {
                ...
                if (extension) {
                    const name = ( localize(10448, "Name: {0}", extension.displayName));
                    const id = ( localize(10449, "Id: {0}", extensionId));
                    const description = ( localize(10450, "Description: {0}", extension.description));
                    const verision = ( localize(10451, "Version: {0}", extension.version));
                    const publisher = ( localize(10452, "Publisher: {0}", extension.publisherDisplayName));
                    const link = extension.url ? ( localize(10453, "VS Marketplace Link: {0}", `${extension.url}`)) : null;
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10454, "Copy Extension ID")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "1_copy"
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10455, "Copy Link")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "1_copy",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10456, "Settings")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "2_configure",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10457, "Download VSIX")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10458, "Download Pre-Release VSIX")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(10459, "Download Specific Version VSIX...")),
            menu: {
                id: MenuId.ExtensionContext,
                when: ( ContextKeyExpr.and(ContextKeyExpr.not("extensionDisallowInstall"), ( ContextKeyExpr.has("isGalleryExtension")))),
                order: 2
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10460, "Account Preferences")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "2_configure",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10461, "Keyboard Shortcuts")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "2_configure",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10462, "Apply Extension to all Profiles")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10463, "Sync This Extension")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "2_configure",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10464, "Ignore Recommendation")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10465, "Undo Ignored Recommendation")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "3_recommendations",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10466, "Add to Workspace Recommendations")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "3_recommendations",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10467, "Remove from Workspace Recommendations")),
            menu: {
                id: MenuId.ExtensionContext,
                group: "3_recommendations",
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10468, "Add Extension to Workspace Recommendations")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10469, "Add Extension to Workspace Folder Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10470, "Add Extension to Workspace Ignored Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.isEqualTo("workspace")), ( ContextKeyExpr.equals("resourceScheme", Schemas.extension))))
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10471, "Add Extension to Workspace Folder Ignored Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.isEqualTo("folder")), ( ContextKeyExpr.equals("resourceScheme", Schemas.extension))))
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(10472, "Manage Trusted Extension Publishers")),
            category: EXTENSIONS_CATEGORY,
            f1: true,
            run: async accessor => {
                const quickInputService = accessor.get(IQuickInputService);
                ...
                const result = await quickInputService.pick(trustedPublisherItems, {
                    canPickMany: true,
                    title: ( localize(10473, "Manage Trusted Extension Publishers")),
                    placeHolder: ( localize(10474, "Choose which publishers to trust"))
                });
                if (result) {
...
registerAction2(class ExtensionsGallerySignInAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10475, "Sign in to access Extensions Marketplace")),
            menu: {
