...
import { buttonSecondaryBackground, buttonSecondaryForeground, buttonSecondaryHoverBackground, buttonSecondaryBorder, buttonSeparator, buttonBackground, buttonForeground, buttonHoverBackground } from '../../../../platform/theme/common/colors/inputColors.js';
...
let PromptExtensionInstallFailureAction = class PromptExtensionInstallFailureAction extends Action {
    ...
    async run() {
        ...
        if (this.error.name === ExtensionManagementErrorCode.Unsupported) {
            const productName = isWeb ? ( localize(10477, "{0} for the Web", this.productService.nameLong)) : this.productService.nameLong;
            ...
            const {
                ...
                message,
                primaryButton: ( localize(10479, "&&More Information")),
                cancelButton: ( localize(10480, "Close"))
            });
            if (confirmed) {
        ...
        if (ExtensionManagementErrorCode.ReleaseVersionNotFound === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    label: ( localize(10481, "Install Pre-Release")),
                    run: () => {
                ...
                cancelButton: ( localize(10482, "Cancel"))
            });
            return;
        }
        if ([
        ...
        if (ExtensionManagementErrorCode.PackageNotSigned === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    label: ( localize(10484, "Install Anyway")),
                    run: () => {
                        const installAction = this.instantiationService.createInstance(InstallAction, {
                            ...this.options,
        ...
        if (ExtensionManagementErrorCode.SignatureVerificationFailed === this.error.name) {
            await this.dialogService.prompt({
                ...
                detail: getErrorMessage(this.error),
                buttons: [{
                    label: ( localize(10486, "Learn More")),
                    ...
                    label: ( localize(10487, "Install Anyway (Don't Verify Signature)")),
                    run: () => {
                        const installAction = this.instantiationService.createInstance(InstallAction, {
                            ...this.options,
                            donotVerifySignature: true
        ...
        if (ExtensionManagementErrorCode.SignatureVerificationInternal === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    ...
                    label: ( localize(10488, "Report Issue")),
        ...
        if (downloadUrl) {
            ...
            promptChoices.push({
                label: ( localize(10494, "Try Downloading Manually...")),
                run: () => this.openerService.open(downloadUrl).then(() => {
                    this.notificationService.prompt(Severity$1.Info, ( localize(
                        ...
                        label: ( localize(10496, "Install from VSIX...")),
...
PromptExtensionInstallFailureAction = ( __decorate([( __param(5, IProductService)), ( __param(6, IOpenerService)), ( __param(7, INotificationService)), ( __param(8, IDialogService)), ( __param(9, ICommandService)), ( __param(10, ILogService)), ( __param(11, IExtensionManagementServerService)), ( __param(12, IInstantiationService)), ( __param(13, IExtensionGalleryService)), ( __param(14, IExtensionManifestPropertiesService)), ( __param(15, IWorkbenchIssueService))], PromptExtensionInstallFailureAction));
...
let InstallAction = class InstallAction extends ExtensionAction {
    ...
    constructor(
        ...
        super("extensions.install", ( localize(10497, "Install")), InstallAction_1.CLASS, false);
        ...
        this.update();
        this._register(
            allowedExtensionsService.onDidChangeAllowedExtensionsConfigValue(() => this.update())
        );
    ...
    async computeAndUpdateEnablement() {
        ...
        if (this.options.installPreReleaseVersion && (!this.extension.hasPreReleaseVersion || this.allowedExtensionsService.isAllowed({
    ...
    async run() {
        ...
        if (this.extension.gallery && !this.extension.gallery.isSigned && shouldRequireRepositorySignatureFor(
            this.extension.private,
            ...
            const {
                ...
                detail: ( localize(10498, "Extension is not signed.")),
                buttons: [{
                    label: ( localize(10484, "Install Anyway")),
                    run: () => {
        ...
        if (this.extension.deprecationInfo) {
            let detail = ( localize(10499, "This extension is deprecated as it is no longer being maintained."));
            ...
            if (this.extension.deprecationInfo.extension) {
                ...
                buttons.push({
                    label: ( localize(10501, "&&Open {0}", this.extension.deprecationInfo.extension.displayName)),
                    run: async () => {
                ...
                buttons.push({
                    label: ( localize(10503, "&&Configure Settings")),
                    run: async () => {
    ...
    getLabel(primary) {
        if (this.extension?.isWorkspaceScoped && this.extension.resourceExtension && this.contextService.isInsideWorkspace(this.extension.resourceExtension.location)) {
            return localize(10507, "Install Workspace Extension");
        }
        if (this.options.installPreReleaseVersion && this.extension?.hasPreReleaseVersion) {
            return primary ? ( localize(10508, "Install Pre-Release")) : ( localize(10509, "Install Pre-Release Version"));
        }
        if (this.extension?.hasPreReleaseVersion) {
            return primary ? ( localize(10497, "Install")) : ( localize(10510, "Install Release Version"));
        }
        return localize(10497, "Install");
    }
};
...
let InstallDropdownAction = class InstallDropdownAction extends ButtonWithDropDownExtensionAction {
    ...
    constructor(instantiationService, extensionManagementService) {
        super(
            `extensions.installActions`,
            InstallAction.CLASS,
            [[instantiationService.createInstance(InstallAction, {
                installPreReleaseVersion: extensionManagementService.preferPreReleases
            }), instantiationService.createInstance(InstallAction, {
                installPreReleaseVersion: !extensionManagementService.preferPreReleases
            })]]
        );
...
class InstallingLabelAction extends ExtensionAction {
    static {
        this.LABEL = ( localize(10511, "Installing"));
    }
    static {
...
let InstallInOtherServerAction = class InstallInOtherServerAction extends ExtensionAction {
    ...
    static {
        this.INSTALL_LABEL = ( localize(10497, "Install"));
    }
    static {
        this.INSTALLING_LABEL = ( localize(10511, "Installing"));
    }
    static {
    ...
    constructor(
        ...
        super(
            id,
            InstallInOtherServerAction_1.INSTALL_LABEL,
            InstallInOtherServerAction_1.Class,
            false
        );
        this.server = server;
    ...
    update() {
        ...
        if (this.canInstall()) {
            const extensionInOtherServer = this.extensionsWorkbenchService.installed.filter(
                e => areSameExtensions(e.identifier, this.extension.identifier) && e.server === this.server
            )[0];
...
InstallInOtherServerAction = InstallInOtherServerAction_1 = ( __decorate([( __param(3, IExtensionsWorkbenchService)), ( __param(4, IExtensionManagementServerService)), ( __param(5, IExtensionManifestPropertiesService))], InstallInOtherServerAction));
...
RemoteInstallAction = ( __decorate([( __param(1, IExtensionsWorkbenchService)), ( __param(2, IExtensionManagementServerService)), ( __param(3, IExtensionManifestPropertiesService))], RemoteInstallAction));
let LocalInstallAction = class LocalInstallAction extends InstallInOtherServerAction {
    ...
    getInstallLabel() {
        return localize(10513, "Install Locally");
    }
};
...
let WebInstallAction = class WebInstallAction extends InstallInOtherServerAction {
    ...
    getInstallLabel() {
        return localize(10514, "Install in Browser");
    }
};
...
let UninstallAction = class UninstallAction extends ExtensionAction {
    ...
    static {
        this.UninstallLabel = ( localize(10515, "Uninstall"));
    }
    static {
        this.UninstallingLabel = ( localize(10516, "Uninstalling"));
    }
    static {
    ...
    constructor(extensionsWorkbenchService, userDataProfilesService, dialogService) {
        super(
            ...
            UninstallAction_1.UninstallLabel,
            UninstallAction_1.UninstallClass,
            false
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
    ...
    update() {
        ...
        this.label = this.extension.local?.isApplicationScoped && this.userDataProfilesService.profiles.length > 1 ? ( localize(10517, "Uninstall (All Profiles)")) : UninstallAction_1.UninstallLabel;
    ...
    async run() {
        ...
        alert(( localize(10518, "Uninstalling extension {0} started.", this.extension.displayName)));
        try {
...
UninstallAction = UninstallAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IUserDataProfilesService)), ( __param(2, IDialogService))], UninstallAction));
let UpdateAction = class UpdateAction extends ExtensionAction {
    ...
    constructor(
        ...
        super(`extensions.update`, ( localize(10520, "Update")), UpdateAction_1.DisabledClass, false);
    ...
    update() {
        this.updateThrottler.queue(() => this.computeAndUpdateEnablement());
        if (this.extension) {
            this.label = this.verbose ? ( localize(10521, "Update to v{0}", this.extension.latestVersion)) : ( localize(10520, "Update"));
        }
    }
    async computeAndUpdateEnablement() {
        this.enabled = false;
    ...
    async run() {
        ...
        if (consent) {
            const {
                ...
                type: "warning",
                title: ( localize(10522, "Update {0} Extension", this.extension.displayName)),
                message: ( localize(10523, "{0}\n\nWould you like to update the extension?", consent)),
                buttons: [{
                    label: ( localize(10520, "Update")),
                    run: () => "update"
                }, {
                    label: ( localize(10524, "Review")),
                    run: () => "review"
                }, {
                    label: ( localize(10482, "Cancel")),
                    run: () => "cancel"
                }]
            });
            if (result === "cancel") {
...
UpdateAction = UpdateAction_1 = ( __decorate([( __param(1, IExtensionsWorkbenchService)), ( __param(2, IDialogService)), ( __param(3, IOpenerService)), ( __param(4, IInstantiationService))], UpdateAction));
let ToggleAutoUpdateForExtensionAction = class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize2(10527, "Auto Update"));
    }
    static {
    ...
    constructor(
        ...
        super(
            ToggleAutoUpdateForExtensionAction_1.ID,
            ToggleAutoUpdateForExtensionAction_1.LABEL.value,
            ToggleAutoUpdateForExtensionAction_1.DisabledClass
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        ...
        this._register(
            allowedExtensionsService.onDidChangeAllowedExtensionsConfigValue(e => this.update())
        );
        this.update();
    }
    update() {
    ...
    async run() {
        ...
        if (enableAutoUpdate) {
            alert(( localize(10528, "Enabled auto updates for", this.extension.displayName)));
        } else {
            alert(( localize(10529, "Disabled auto updates for", this.extension.displayName)));
        }
    }
};
ToggleAutoUpdateForExtensionAction = ToggleAutoUpdateForExtensionAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IWorkbenchExtensionEnablementService)), ( __param(2, IAllowedExtensionsService)), ( __param(3, IConfigurationService))], ToggleAutoUpdateForExtensionAction));
let ToggleAutoUpdatesForPublisherAction = class ToggleAutoUpdatesForPublisherAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10530, "Auto Update All (From Publisher)"));
    }
    constructor(extensionsWorkbenchService) {
        super(
            ToggleAutoUpdatesForPublisherAction_1.ID,
            ToggleAutoUpdatesForPublisherAction_1.LABEL
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
    }
    update() {}
...
ToggleAutoUpdatesForPublisherAction = ToggleAutoUpdatesForPublisherAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService))], ToggleAutoUpdatesForPublisherAction));
let MigrateDeprecatedExtensionAction = class MigrateDeprecatedExtensionAction extends ExtensionAction {
    ...
    constructor(small, extensionsWorkbenchService) {
        super("extensionsAction.migrateDeprecatedExtension", ( localize(10532, "Migrate")), MigrateDeprecatedExtensionAction_1.DisabledClass, false);
        this.small = small;
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.update();
    }
    update() {
        ...
        if (( this.extensionsWorkbenchService.local.some(e => areSameExtensions(e.identifier, {
            id
        })))) {
            return;
        }
        ...
        this.label = this.small ? ( localize(10534, "Migrate")) : this.tooltip;
    }
    async run() {
        if (!this.extension?.deprecationInfo?.extension) {
            return;
...
MigrateDeprecatedExtensionAction = MigrateDeprecatedExtensionAction_1 = ( __decorate([( __param(1, IExtensionsWorkbenchService))], MigrateDeprecatedExtensionAction));
...
DropDownExtensionAction = ( __decorate([( __param(4, IInstantiationService))], DropDownExtensionAction));
...
async function getContextMenuActionsGroups(extension, contextKeyService, instantiationService) {
    return instantiationService.invokeFunction(async accessor => {
        ...
        if (extension) {
            ...
            cksOverlay.push(["isExtensionAllowed", allowedExtensionsService.isAllowed({
                id: extension.identifier.id,
                publisherDisplayName: extension.publisherDisplayName
            }) === true]);
            cksOverlay.push(["isPreReleaseExtensionAllowed", allowedExtensionsService.isAllowed({
                id: extension.identifier.id,
                publisherDisplayName: extension.publisherDisplayName,
                prerelease: true
            }) === true]);
        ...
        const actionsGroups = menuService.getMenuActions(MenuId.ExtensionContext, contextKeyService.createOverlay(cksOverlay), {
...
let ManageExtensionAction = class ManageExtensionAction extends DropDownExtensionAction {
    ...
    constructor(instantiationService, extensionService, contextKeyService, productService) {
        ...
        this.productService = productService;
        this.tooltip = ( localize(10535, "Manage"));
        this.update();
    }
    async getActionGroups() {
        ...
        const isChatExtension = this.extension && ExtensionIdentifier.equals(
            this.extension.identifier.id,
...
ManageExtensionAction = ManageExtensionAction_1 = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IExtensionService)), ( __param(2, IContextKeyService)), ( __param(3, IProductService))], ManageExtensionAction));
...
let MenuItemExtensionAction = class MenuItemExtensionAction extends ExtensionAction {
    ...
    async run() {
        if (this.extension) {
            ...
            ) : this.extension.gallery ? getExtensionId(this.extension.gallery.publisher, this.extension.gallery.name) : this.extension.identifier.id;
            const extensionArg = {
                id: this.extension.identifier.id,
...
MenuItemExtensionAction = ( __decorate([( __param(1, IExtensionsWorkbenchService))], MenuItemExtensionAction));
let TogglePreReleaseExtensionAction = class TogglePreReleaseExtensionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10536, "Pre-Release"));
    }
    static {
    ...
    constructor(extensionsWorkbenchService, allowedExtensionsService) {
        super(
            TogglePreReleaseExtensionAction_1.ID,
            TogglePreReleaseExtensionAction_1.LABEL,
            TogglePreReleaseExtensionAction_1.DisabledClass
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.allowedExtensionsService = allowedExtensionsService;
        this._register(
    ...
    update() {
        ...
        if (this.extension.preRelease) {
            this.label = ( localize(10537, "Switch to Release Version"));
            this.tooltip = ( localize(10538, "This will switch and enable updates to release versions"));
        } else {
            this.label = ( localize(10539, "Switch to Pre-Release Version"));
            this.tooltip = ( localize(
                10540,
...
TogglePreReleaseExtensionAction = TogglePreReleaseExtensionAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IAllowedExtensionsService))], TogglePreReleaseExtensionAction));
let InstallAnotherVersionAction = class InstallAnotherVersionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10541, "Install Specific Version..."));
    }
    constructor(
        extension,
        whenInstalled,
        ...
        super(
            InstallAnotherVersionAction_1.ID,
            InstallAnotherVersionAction_1.LABEL,
    ...
    update() {
        this.enabled = !!this.extension && !this.extension.isBuiltin && !!this.extension.identifier.uuid && !this.extension.deprecationInfo && this.allowedExtensionsService.isAllowed({
            id: this.extension.identifier.id,
            publisherDisplayName: this.extension.publisherDisplayName
        }) === true;
    ...
    async run() {
        ...
        if (!allVersions.length) {
            await this.dialogService.info(( localize(10542, "This extension has no other versions.")));
            return;
        }
        const picks = ( allVersions.map((v, i) => {
            return {
                id: v.version,
                label: v.version,
                description: `${fromNow(( new Date(Date.parse(v.date))), true)}${v.isPreReleaseVersion ? ` (${( localize(10543, "pre-release"))})` : ""}${v.version === this.extension?.local?.manifest.version ? ` (${( localize(10544, "current"))})` : ""}`,
                ariaLabel: `${v.isPreReleaseVersion ? "Pre-Release version" : "Release version"} ${v.version}`,
                isPreReleaseVersion: v.isPreReleaseVersion
            };
        }));
        const pick = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(10545, "Select Version to Install")),
            matchOnDetail: true
        });
        if (pick) {
...
InstallAnotherVersionAction = InstallAnotherVersionAction_1 = ( __decorate([( __param(2, IExtensionsWorkbenchService)), ( __param(3, IWorkbenchExtensionManagementService)), ( __param(4, IExtensionGalleryService)), ( __param(5, IQuickInputService)), ( __param(6, IInstantiationService)), ( __param(7, IDialogService)), ( __param(8, IAllowedExtensionsService))], InstallAnotherVersionAction));
let EnableForWorkspaceAction = class EnableForWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10546, "Enable (Workspace)"));
    }
    constructor(extensionsWorkbenchService, extensionEnablementService, productService) {
        super(
            EnableForWorkspaceAction_1.ID,
            EnableForWorkspaceAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.extensionEnablementService = extensionEnablementService;
        this.productService = productService;
        this.tooltip = ( localize(10547, "Enable this extension only in this workspace"));
        this.update();
    }
    update() {
        this.enabled = false;
...
EnableForWorkspaceAction = EnableForWorkspaceAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IWorkbenchExtensionEnablementService)), ( __param(2, IProductService))], EnableForWorkspaceAction));
let EnableGloballyAction = class EnableGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10548, "Enable"));
    }
    constructor(extensionsWorkbenchService, extensionEnablementService, productService) {
        super(
            EnableGloballyAction_1.ID,
            EnableGloballyAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.extensionEnablementService = extensionEnablementService;
        this.productService = productService;
        this.tooltip = ( localize(10549, "Enable this extension"));
        this.update();
    }
    update() {
        this.enabled = false;
...
EnableGloballyAction = EnableGloballyAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IWorkbenchExtensionEnablementService)), ( __param(2, IProductService))], EnableGloballyAction));
let DisableForWorkspaceAction = class DisableForWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10550, "Disable (Workspace)"));
    }
    constructor(
        ...
        super(
            DisableForWorkspaceAction_1.ID,
            DisableForWorkspaceAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        ...
        this.extensionService = extensionService;
        this.productService = productService;
        this.tooltip = ( localize(10551, "Disable this extension only in this workspace"));
        this.update();
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
    }
    update() {
        this.enabled = false;
        if (this.extension && this.extension.local && !this.extension.isWorkspaceScoped && ( this.extensionService.extensions.some(e => areSameExtensions({
            id: e.identifier.value,
            uuid: e.uuid
        }, this.extension.identifier) && this.workspaceContextService.getWorkbenchState() !== WorkbenchState.EMPTY))) {
            if (ExtensionIdentifier.equals(
                this.extension.identifier.id,
                this.productService.defaultChatAgent?.chatExtensionId
            )) {
...
DisableForWorkspaceAction = DisableForWorkspaceAction_1 = ( __decorate([( __param(0, IWorkspaceContextService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IWorkbenchExtensionEnablementService)), ( __param(3, IExtensionService)), ( __param(4, IProductService))], DisableForWorkspaceAction));
let DisableGloballyAction = class DisableGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(10552, "Disable"));
    }
    constructor(
        extensionsWorkbenchService,
        extensionEnablementService,
        ...
        super(
            DisableGloballyAction_1.ID,
            DisableGloballyAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.extensionEnablementService = extensionEnablementService;
        this.extensionService = extensionService;
        this.productService = productService;
        this.tooltip = ( localize(10553, "Disable this extension"));
        this.update();
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
    }
    update() {
...
DisableGloballyAction = DisableGloballyAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IWorkbenchExtensionEnablementService)), ( __param(2, IExtensionService)), ( __param(3, IProductService))], DisableGloballyAction));
const CHAT_AI_DISABLED_SETTING = "chat.disableAIFeatures";
let EnableAIFeaturesGloballyAction = class EnableAIFeaturesGloballyAction extends ExtensionAction {
    static {
        EnableAIFeaturesGloballyAction_1 = this;
    }
    static {
        this.ID = "extensions.enableAIGlobally";
    }
    static {
        this.LABEL = ( localize(10554, "Enable AI Features"));
    }
    constructor(productService, configurationService) {
        super(
            EnableAIFeaturesGloballyAction_1.ID,
            EnableAIFeaturesGloballyAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.productService = productService;
        this.configurationService = configurationService;
        this.tooltip = ( localize(10555, "Enable AI features"));
        this.update();
...
EnableAIFeaturesGloballyAction = EnableAIFeaturesGloballyAction_1 = ( __decorate([( __param(0, IProductService)), ( __param(1, IConfigurationService))], EnableAIFeaturesGloballyAction));
let EnableAIFeaturesInWorkspaceAction = class EnableAIFeaturesInWorkspaceAction extends ExtensionAction {
    static {
        EnableAIFeaturesInWorkspaceAction_1 = this;
    }
    static {
        this.ID = "extensions.enableAIInWorkspace";
    }
    static {
        this.LABEL = ( localize(10556, "Enable AI Features (Workspace)"));
    }
    constructor(
        productService,
        extensionsWorkbenchService,
        ...
        super(
            EnableAIFeaturesInWorkspaceAction_1.ID,
            EnableAIFeaturesInWorkspaceAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.productService = productService;
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.configurationService = configurationService;
        this.extensionEnablementService = extensionEnablementService;
        this.tooltip = ( localize(10557, "Enable AI features in this workspace"));
        this.update();
        this._register(this.configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration(CHAT_AI_DISABLED_SETTING)) {
                this.update();
    ...
    async run() {
        ...
        if (this.configurationService.getValue(CHAT_AI_DISABLED_SETTING) === true) {
            await this.configurationService.updateValue(CHAT_AI_DISABLED_SETTING, false, ConfigurationTarget.WORKSPACE);
        }
    }
};
EnableAIFeaturesInWorkspaceAction = EnableAIFeaturesInWorkspaceAction_1 = ( __decorate([( __param(0, IProductService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IConfigurationService)), ( __param(3, IWorkbenchExtensionEnablementService))], EnableAIFeaturesInWorkspaceAction));
let DisableAIFeaturesGloballyAction = class DisableAIFeaturesGloballyAction extends ExtensionAction {
    static {
        DisableAIFeaturesGloballyAction_1 = this;
    }
    static {
        this.ID = "extensions.disableAIGlobally";
    }
    static {
        this.LABEL = ( localize(10558, "Disable AI Features"));
    }
    constructor(productService, configurationService) {
        super(
            DisableAIFeaturesGloballyAction_1.ID,
            DisableAIFeaturesGloballyAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.productService = productService;
        this.configurationService = configurationService;
        this.tooltip = ( localize(10559, "Disable AI features"));
        this.update();
        this._register(this.configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration(CHAT_AI_DISABLED_SETTING)) {
                this.update();
    ...
    update() {
        this.enabled = false;
        if (this.extension && ExtensionIdentifier.equals(
            this.extension.identifier.id,
            this.productService.defaultChatAgent?.chatExtensionId
        )) {
            this.enabled = this.extension.state === ExtensionState.Installed && this.configurationService.getValue(CHAT_AI_DISABLED_SETTING) !== true && this.extension.enablementState !== EnablementState.DisabledWorkspace;
        }
    }
    async run() {
...
DisableAIFeaturesGloballyAction = DisableAIFeaturesGloballyAction_1 = ( __decorate([( __param(0, IProductService)), ( __param(1, IConfigurationService))], DisableAIFeaturesGloballyAction));
let DisableAIFeaturesInWorkspaceAction = class DisableAIFeaturesInWorkspaceAction extends ExtensionAction {
    static {
        DisableAIFeaturesInWorkspaceAction_1 = this;
    }
    static {
        this.ID = "extensions.disableAIInWorkspace";
    }
    static {
        this.LABEL = ( localize(10560, "Disable AI Features (Workspace)"));
    }
    constructor(
        productService,
        extensionsWorkbenchService,
        ...
        super(
            DisableAIFeaturesInWorkspaceAction_1.ID,
            DisableAIFeaturesInWorkspaceAction_1.LABEL,
            ExtensionAction.LABEL_ACTION_CLASS
        );
        this.productService = productService;
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.extensionEnablementService = extensionEnablementService;
        this.extensionService = extensionService;
        this.tooltip = ( localize(10561, "Disable AI features in this workspace"));
        this.update();
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
    }
    update() {
        this.enabled = false;
        if (this.extension && this.extension.local && ExtensionIdentifier.equals(
            this.extension.identifier.id,
            this.productService.defaultChatAgent?.chatExtensionId
        )) {
            this.enabled = this.extension.state === ExtensionState.Installed && (this.extension.enablementState === EnablementState.EnabledGlobally || this.extension.enablementState === EnablementState.EnabledWorkspace) && this.extensionEnablementService.canChangeWorkspaceEnablement(this.extension.local);
    ...
    async run() {
        ...
        await this.extensionsWorkbenchService.updateRunningExtensions(( localize(10562, "Disabling AI features")));
    }
};
...
EnableDropDownAction = ( __decorate([( __param(0, IInstantiationService))], EnableDropDownAction));
...
DisableDropDownAction = ( __decorate([( __param(0, IInstantiationService))], DisableDropDownAction));
let ExtensionRuntimeStateAction = class ExtensionRuntimeStateAction extends ExtensionAction {
    ...
    constructor(
        ...
        super(
            ...
            "",
            ExtensionRuntimeStateAction_1.DisabledClass,
            false
        );
    ...
    update() {
        ...
        this.label = runtimeState.action === ExtensionRuntimeActionType.ReloadWindow ? ( localize(10563, "Reload Window")) : runtimeState.action === ExtensionRuntimeActionType.RestartExtensions ? ( localize(10564, "Restart Extensions")) : runtimeState.action === ExtensionRuntimeActionType.QuitAndInstall ? ( localize(10565, "Restart to Update")) : runtimeState.action === ExtensionRuntimeActionType.ApplyUpdate || runtimeState.action === ExtensionRuntimeActionType.DownloadUpdate ? ( localize(10566, "Update {0}", this.productService.nameShort)) : "";
    }
    async run() {
        const runtimeState = this.extension?.runtimeState;
...
ExtensionRuntimeStateAction = ExtensionRuntimeStateAction_1 = ( __decorate([( __param(0, IHostService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IUpdateService)), ( __param(3, IExtensionService)), ( __param(4, IProductService)), ( __param(5, ITelemetryService))], ExtensionRuntimeStateAction));
...
let SetColorThemeAction = class SetColorThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(10567, "Set Color Theme"));
    }
    static {
    ...
    constructor(
        ...
        super(
            SetColorThemeAction_1.ID,
            SetColorThemeAction_1.TITLE.value,
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(10568, "Select Color Theme")),
...
SetColorThemeAction = SetColorThemeAction_1 = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IWorkbenchThemeService)), ( __param(2, IQuickInputService)), ( __param(3, IWorkbenchExtensionEnablementService))], SetColorThemeAction));
let SetFileIconThemeAction = class SetFileIconThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(10569, "Set File Icon Theme"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
    }
    ...
    constructor(
        ...
        super(
            SetFileIconThemeAction_1.ID,
            SetFileIconThemeAction_1.TITLE.value,
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(10570, "Select File Icon Theme")),
...
SetFileIconThemeAction = SetFileIconThemeAction_1 = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IWorkbenchThemeService)), ( __param(2, IQuickInputService)), ( __param(3, IWorkbenchExtensionEnablementService))], SetFileIconThemeAction));
let SetProductIconThemeAction = class SetProductIconThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(10571, "Set Product Icon Theme"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
    }
    ...
    constructor(
        ...
        super(
            SetProductIconThemeAction_1.ID,
            SetProductIconThemeAction_1.TITLE.value,
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(10572, "Select Product Icon Theme")),
...
SetProductIconThemeAction = SetProductIconThemeAction_1 = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IWorkbenchThemeService)), ( __param(2, IQuickInputService)), ( __param(3, IWorkbenchExtensionEnablementService))], SetProductIconThemeAction));
let SetLanguageAction = class SetLanguageAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(10573, "Set Display Language"));
    }
    static {
    ...
    constructor(extensionsWorkbenchService) {
        super(
            SetLanguageAction_1.ID,
            SetLanguageAction_1.TITLE.value,
            SetLanguageAction_1.DisabledClass,
            false
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.update();
...
SetLanguageAction = SetLanguageAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService))], SetLanguageAction));
let ClearLanguageAction = class ClearLanguageAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(10574, "Clear Display Language"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} language`;
    }
    ...
    constructor(extensionsWorkbenchService, localeService) {
        super(
            ClearLanguageAction_1.ID,
            ClearLanguageAction_1.TITLE.value,
            ClearLanguageAction_1.DisabledClass,
            false
        );
        this.extensionsWorkbenchService = extensionsWorkbenchService;
...
ClearLanguageAction = ClearLanguageAction_1 = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, ILocaleService))], ClearLanguageAction));
let ShowRecommendedExtensionAction = class ShowRecommendedExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(10575, "Show Recommended Extension"));
    }
    constructor(extensionId, extensionWorkbenchService) {
        super(
            ShowRecommendedExtensionAction_1.ID,
            ShowRecommendedExtensionAction_1.LABEL,
            undefined,
            false
        );
...
ShowRecommendedExtensionAction = ShowRecommendedExtensionAction_1 = ( __decorate([( __param(1, IExtensionsWorkbenchService))], ShowRecommendedExtensionAction));
let InstallRecommendedExtensionAction = class InstallRecommendedExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(10576, "Install Recommended Extension"));
    }
    constructor(extensionId, instantiationService, extensionWorkbenchService) {
        super(
            InstallRecommendedExtensionAction_1.ID,
            InstallRecommendedExtensionAction_1.LABEL,
            undefined,
            false
        );
        this.instantiationService = instantiationService;
...
InstallRecommendedExtensionAction = InstallRecommendedExtensionAction_1 = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IExtensionsWorkbenchService))], InstallRecommendedExtensionAction));
let IgnoreExtensionRecommendationAction = class IgnoreExtensionRecommendationAction extends Action {
    ...
    constructor(extension, extensionRecommendationsManagementService) {
        ...
        this.tooltip = ( localize(10577, "Do not recommend this extension again"));
        this.enabled = true;
    }
    run() {
...
IgnoreExtensionRecommendationAction = IgnoreExtensionRecommendationAction_1 = ( __decorate([( __param(1, IExtensionIgnoredRecommendationsService))], IgnoreExtensionRecommendationAction));
let UndoIgnoreExtensionRecommendationAction = class UndoIgnoreExtensionRecommendationAction extends Action {
    ...
    constructor(extension, extensionRecommendationsManagementService) {
        ...
        this.tooltip = ( localize(10578, "Undo"));
        this.enabled = true;
    }
    run() {
...
UndoIgnoreExtensionRecommendationAction = UndoIgnoreExtensionRecommendationAction_1 = ( __decorate([( __param(1, IExtensionIgnoredRecommendationsService))], UndoIgnoreExtensionRecommendationAction));
let AbstractConfigureRecommendedExtensionsAction = class AbstractConfigureRecommendedExtensionsAction extends Action {
    ...
    openExtensionsFile(extensionsFileResource) {
        ...
        ) => this.getSelectionPosition(content, extensionsFileResource, ["recommendations"]).then(selection => this.editorService.openEditor({
    ...
    getOrUpdateWorkspaceConfigurationFile(workspaceConfigurationFile) {
        return Promise.resolve(this.fileService.readFile(workspaceConfigurationFile)).then(content => {
            ...
            if (!workspaceRecommendations || !workspaceRecommendations.recommendations) {
                ...
                }], true).then(() => this.fileService.readFile(workspaceConfigurationFile));
            }
            return content;
        });
    }
...
AbstractConfigureRecommendedExtensionsAction = ( __decorate([( __param(2, IWorkspaceContextService)), ( __param(3, IFileService)), ( __param(4, ITextFileService)), ( __param(5, IEditorService)), ( __param(6, IJSONEditingService)), ( __param(7, ITextModelService))], AbstractConfigureRecommendedExtensionsAction));
let ConfigureWorkspaceRecommendedExtensionsAction = class ConfigureWorkspaceRecommendedExtensionsAction extends AbstractConfigureRecommendedExtensionsAction {
    ...
    static {
        this.LABEL = ( localize(10580, "Configure Recommended Extensions (Workspace)"));
    }
    constructor(
        id,
        label,
...
ConfigureWorkspaceRecommendedExtensionsAction = ( __decorate([( __param(2, IFileService)), ( __param(3, ITextFileService)), ( __param(4, IWorkspaceContextService)), ( __param(5, IEditorService)), ( __param(6, IJSONEditingService)), ( __param(7, ITextModelService))], ConfigureWorkspaceRecommendedExtensionsAction));
let ConfigureWorkspaceFolderRecommendedExtensionsAction = class ConfigureWorkspaceFolderRecommendedExtensionsAction extends AbstractConfigureRecommendedExtensionsAction {
    ...
    static {
        this.LABEL = ( localize(10581, "Configure Recommended Extensions (Workspace Folder)"));
    }
    constructor(
        id,
        label,
...
ConfigureWorkspaceFolderRecommendedExtensionsAction = ( __decorate([( __param(2, IFileService)), ( __param(3, ITextFileService)), ( __param(4, IWorkspaceContextService)), ( __param(5, IEditorService)), ( __param(6, IJSONEditingService)), ( __param(7, ITextModelService)), ( __param(8, ICommandService))], ConfigureWorkspaceFolderRecommendedExtensionsAction));
let ExtensionStatusLabelAction = class ExtensionStatusLabelAction extends Action {
    ...
    computeLabel() {
        ...
        const canAddExtension = () => {
            const runningExtension = this.extensionService.extensions.filter(e => areSameExtensions({
                id: e.identifier.value,
                uuid: e.uuid
            }, this.extension.identifier))[0];
            if (this.extension.local) {
        ...
        const canRemoveExtension = () => {
            if (this.extension.local) {
                if (this.extensionService.extensions.every(e => !(areSameExtensions({
                    id: e.identifier.value,
                    uuid: e.uuid
                }, this.extension.identifier) && this.extension.server === this.extensionManagementServerService.getExtensionManagementServer(toExtension(e))))) {
                    return true;
                }
        ...
        if (currentEnablementState !== null) {
            ...
            if (!currentlyEnabled && enabled) {
                return canAddExtension() ? ( localize(10585, "Enabled")) : null;
            }
            if (currentlyEnabled && !enabled) {
                return canRemoveExtension() ? ( localize(10586, "Disabled")) : null;
            }
        }
        return null;
    }
...
ExtensionStatusLabelAction = ExtensionStatusLabelAction_1 = ( __decorate([( __param(0, IExtensionService)), ( __param(1, IExtensionManagementServerService)), ( __param(2, IWorkbenchExtensionEnablementService))], ExtensionStatusLabelAction));
let ToggleSyncExtensionAction = class ToggleSyncExtensionAction extends DropDownExtensionAction {
    ...
    update() {
        ...
        if (this.extension) {
            ...
            this.tooltip = isIgnored ? ( localize(10587, "This extension is ignored during sync")) : ( localize(10588, "This extension is synced"));
        }
    }
    async run() {
        return super.run([[( new Action(
            "extensions.syncignore",
            this.extensionsWorkbenchService.isExtensionIgnoredToSync(this.extension) ? ( localize(10589, "Sync this extension")) : ( localize(10590, "Do not sync this extension")),
            undefined,
            true,
...
ToggleSyncExtensionAction = ToggleSyncExtensionAction_1 = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IUserDataSyncEnablementService)), ( __param(3, IInstantiationService))], ToggleSyncExtensionAction));
let ExtensionStatusAction = class ExtensionStatusAction extends ExtensionAction {
    ...
    constructor(
        ...
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
        this._register(
            this.extensionFeaturesManagementService.onDidChangeAccessData(() => this.update())
        );
        this._register(
            allowedExtensionsService.onDidChangeAllowedExtensionsConfigValue(() => this.update())
        );
    ...
    async computeAndUpdateStatus() {
        ...
        if (this.extension.isMalicious) {
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(10591, "This extension was reported to be problematic."))))
            }, true);
            return;
        }
        if (this.extension.state === ExtensionState.Uninstalled && this.extension.gallery && !this.extension.gallery.isSigned && shouldRequireRepositorySignatureFor(
            this.extension.private,
            await this.extensionGalleryManifestService.getExtensionGalleryManifest()
        )) {
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(10592, "This extension is not signed by the Extension Marketplace."))))
            }, true);
            return;
        }
        if (this.extension.deprecationInfo) {
            if (this.extension.deprecationInfo.extension) {
                ...
                const link = `[${( localize(10594, "settings"))}](${createCommandUri("workbench.action.openSettings", ( this.extension.deprecationInfo.settings.map(setting => `@id:${setting}`)).join(" "))}})`;
                this.updateStatus({
                    icon: warningIcon,
                    message: ( new MarkdownString(( localize(
                        10595,
                ...
                const message = ( new MarkdownString(( localize(10596, "This extension is deprecated as it is no longer being maintained."))));
        ...
        if (this.extension.outdated) {
            ...
            if (this.extensionsWorkbenchService.isAutoUpdateDelayed(this.extension)) {
                const delay = fromNow(
                    Date.now() - this.extensionsWorkbenchService.getAutoUpdateDelay(),
                    false,
                    true
                );
                const updateAt = fromNow(
                    Date.now() + this.extensionsWorkbenchService.getAutoUpdateDelayRemaining(this.extension),
                    false,
                    true
                );
                this.updateStatus({
        ...
        if (this.extension.enablementState === EnablementState.DisabledByAllowlist) {
            ...
            if (result !== true) {
                this.updateStatus({
                    icon: warningIcon,
                    message: ( new MarkdownString(( localize(10600, "This extension is disabled because {0}", result.value))))
                }, true);
                return;
            }
        }
        if (this.extension.enablementState === EnablementState.DisabledByEnvironment) {
            this.updateStatus({
                message: ( new MarkdownString(( localize(10601, "This extension is disabled by the environment."))))
            }, true);
            return;
        }
        ...
        this.extension.enablementState === EnablementState.DisabledByTrustRequirement || (this.extension.enablementState === EnablementState.DisabledByExtensionDependency && this.workbenchExtensionEnablementService.getDependenciesEnablementStates(this.extension.local).every(
            ([, enablementState]) => this.workbenchExtensionEnablementService.isEnabledEnablementState(enablementState) || enablementState === EnablementState.DisabledByTrustRequirement
        )))) {
            this.enabled = true;
                    ...
                    if (this.extensionManifestPropertiesService.prefersExecuteOnWorkspace(this.extension.local.manifest)) {
                        if (this.extensionManagementServerService.remoteExtensionManagementServer) {
                            message = ( new MarkdownString(`${( localize(
                                ...
                                this.extensionManagementServerService.remoteExtensionManagementServer.label
                            ))} [${( localize(10486, "Learn More"))}](https://code.visualstudio.com/api/advanced-topics/remote-extensions#architecture-and-extension-kinds)`));
                        }
                    }
                }
        ...
        for (const feature of features) {
            ...
            const manageAccessLink = `[${( localize(10612, "Manage Access"))}](${createCommandUri(
    "extension.open",
    this.extension.identifier.id,
    ...
    feature.id
        ...
        if (this.extension.enablementState === EnablementState.DisabledByExtensionDependency) {
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(10618, "This extension depends on an extension that is disabled.")))).appendMarkdown(`&nbsp;[${( localize(10619, "Show Dependencies"))}](${createCommandUri(
    "extension.open",
    this.extension.identifier.id,
    ExtensionEditorTab.Dependencies
        ...
        const isRunning = ( this.extensionService.extensions.some(e => areSameExtensions({
            id: e.identifier.value,
            uuid: e.uuid
        }, this.extension.identifier)));
        if (!this.extension.isWorkspaceScoped && isEnabled && isRunning) {
            if (this.extension.enablementState === EnablementState.EnabledWorkspace) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(10620, "This extension is enabled for this workspace by the user."))))
                }, true);
                return;
            }
            if (this.extensionManagementServerService.localExtensionManagementServer && this.extensionManagementServerService.remoteExtensionManagementServer) {
                if (this.extension.server === this.extensionManagementServerService.remoteExtensionManagementServer) {
                    this.updateStatus({
                        message: ( new MarkdownString(( localize(10621, "Extension is enabled on '{0}'", this.extension.server.label))))
                    }, true);
                    return;
                }
            }
        ...
        if (!isEnabled && !isRunning) {
            if (this.extension.enablementState === EnablementState.DisabledGlobally) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(10622, "This extension is disabled globally by the user."))))
                }, true);
                return;
            }
            if (this.extension.enablementState === EnablementState.DisabledWorkspace) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(10623, "This extension is disabled for this workspace by the user."))))
                }, true);
                return;
            }
        }
...
ExtensionStatusAction = ExtensionStatusAction_1 = ( __decorate([( __param(0, IExtensionManagementServerService)), ( __param(1, ILabelService)), ( __param(2, ICommandService)), ( __param(3, IWorkspaceTrustEnablementService)), ( __param(4, IWorkspaceTrustManagementService)), ( __param(5, IExtensionsWorkbenchService)), ( __param(6, IExtensionService)), ( __param(7, IExtensionManifestPropertiesService)), ( __param(8, IWorkspaceContextService)), ( __param(9, IProductService)), ( __param(10, IAllowedExtensionsService)), ( __param(11, IWorkbenchExtensionEnablementService)), ( __param(12, IExtensionFeaturesManagementService)), ( __param(13, IExtensionGalleryManifestService)), ( __param(14, IConfigurationService))], ExtensionStatusAction));
let InstallSpecificVersionOfExtensionAction = class InstallSpecificVersionOfExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(10624, "Install Specific Version of Extension..."));
    }
    constructor(
        id = InstallSpecificVersionOfExtensionAction_1.ID,
        label = InstallSpecificVersionOfExtensionAction_1.LABEL,
        extensionsWorkbenchService,
        quickInputService,
        instantiationService,
        extensionEnablementService
    ...
    async run() {
        const extensionPick = await this.quickInputService.pick(this.getExtensionEntries(), {
            placeHolder: ( localize(10625, "Select Extension")),
            matchOnDetail: true
        });
...
InstallSpecificVersionOfExtensionAction = InstallSpecificVersionOfExtensionAction_1 = ( __decorate([( __param(2, IExtensionsWorkbenchService)), ( __param(3, IQuickInputService)), ( __param(4, IInstantiationService)), ( __param(5, IWorkbenchExtensionEnablementService))], InstallSpecificVersionOfExtensionAction));
let AbstractInstallExtensionsInServerAction = class AbstractInstallExtensionsInServerAction extends Action {
    ...
    async selectAndInstallExtensions() {
        ...
        if (localExtensionsToInstall.length) {
            ...
            quickPick.placeholder = ( localize(10626, "Select extensions to install"));
            ...
            this.notificationService.notify({
                ...
                message: ( localize(10627, "There are no extensions to install."))
            });
        }
    }
        ...
        if (selectedItems.length) {
            ...
            if (localExtensionsToInstall.length) {
                await this.progressService.withProgress({
                    ...
                    title: ( localize(10628, "Installing Extensions..."))
                }, () => this.installExtensions(localExtensionsToInstall));
                this.notificationService.info(( localize(10629, "Successfully installed extensions.")));
            }
        }
    }
};
AbstractInstallExtensionsInServerAction = ( __decorate([( __param(1, IExtensionsWorkbenchService)), ( __param(2, IQuickInputService)), ( __param(3, INotificationService)), ( __param(4, IProgressService))], AbstractInstallExtensionsInServerAction));
...
InstallLocalExtensionsInRemoteAction = ( __decorate([( __param(0, IExtensionsWorkbenchService)), ( __param(1, IQuickInputService)), ( __param(2, IProgressService)), ( __param(3, INotificationService)), ( __param(4, IExtensionManagementServerService)), ( __param(5, IExtensionGalleryService)), ( __param(6, IInstantiationService)), ( __param(7, IFileService)), ( __param(8, ILogService))], InstallLocalExtensionsInRemoteAction));
let InstallRemoteExtensionsInLocalAction = class InstallRemoteExtensionsInLocalAction extends AbstractInstallExtensionsInServerAction {
    ...
    get label() {
        return localize(10632, "Install Remote Extensions Locally...");
    }
    getQuickPickTitle() {
        return localize(10633, "Install Remote Extensions Locally");
    }
    getExtensionsToInstall(local) {
        return local.filter(
...
InstallRemoteExtensionsInLocalAction = ( __decorate([( __param(1, IExtensionsWorkbenchService)), ( __param(2, IQuickInputService)), ( __param(3, IProgressService)), ( __param(4, INotificationService)), ( __param(5, IExtensionManagementServerService)), ( __param(6, IExtensionGalleryService)), ( __param(7, IFileService)), ( __param(8, ILogService))], InstallRemoteExtensionsInLocalAction));
CommandsRegistry.registerCommand(
    "workbench.extensions.action.showExtensionsForLanguage",
    function(accessor, fileExtension) {
        const extensionsWorkbenchService = accessor.get(IExtensionsWorkbenchService);
...
}, ( localize(10637, "Button border color for extension actions.")));
registerColor("extensionButton.separator", buttonSeparator, ( localize(10638, "Button separator color for extension actions")));
