...
import { VIEWLET_ID, DefaultViewsContext, CONTEXT_EXTENSIONS_GALLERY_STATUS, CONTEXT_HAS_GALLERY, OUTDATED_EXTENSIONS_VIEW_ID, WORKSPACE_RECOMMENDATIONS_VIEW_ID, SearchMcpServersContext, SearchAgentPluginsContext, extensionsSearchActionsMenu, INSTALL_EXTENSION_FROM_VSIX_COMMAND_ID, AutoCheckUpdatesConfigurationKey, CloseExtensionDetailsOnViewChangeKey, AutoRestartConfigurationKey, ExtensionRuntimeActionType } from '../common/extensions.js';
...
const REMOTE_CATEGORY = ( localize2(10685, "Remote"));
let ExtensionsViewletViewsContribution = class ExtensionsViewletViewsContribution extends Disposable {
    ...
    registerViews() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10686, "Marketplace")),
    ...
    createDefaultExtensionsViewDescriptors() {
        ...
        for (const server of servers) {
            const getInstalledViewName = () => getViewName(( localize(10689, "Installed")), server);
                    ...
                    registerAction2(class InstallLocalExtensionsInRemoteAction2 extends Action2 {
                        constructor() {
                            super({
                                ...
                                get title() {
                                    return localize2(10690, "Install Local Extensions in '{0}'...", server.label);
                                },
                ...
                registerAction2(class InstallRemoteExtensionsInLocalAction2 extends Action2 {
                    constructor() {
                        super({
                            ...
                            title: ( localize2(10691, "Install Remote Extensions Locally...")),
                            category: REMOTE_CATEGORY,
                            f1: true
                        });
                    }
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10693, "Recommended")),
    ...
    createSearchExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10689, "Installed")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10696, "Recently Updated")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10701, "Workspace Unsupported")),
            ctorDescriptor: ( new SyncDescriptor(ExtensionsListView, [{}])),
    ...
    createRecommendedExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10702, "Workspace Recommendations")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10703, "Other Recommendations")),
    ...
    createBuiltinExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10706, "Programming Languages")),
            ctorDescriptor: ( new SyncDescriptor(StaticQueryExtensionsView, [{
    ...
    createUnsupportedWorkspaceExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10707, "Disabled in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10708, "Limited in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10709, "Disabled in Virtual Workspaces")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10710, "Limited in Virtual Workspaces")),
    ...
    createOtherLocalFilteredExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10711, "Deprecated")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(10712, "Restart Required")),
            ctorDescriptor: ( new SyncDescriptor(ExtensionsListView, [{}])),
...
ExtensionsViewletViewsContribution = ( __decorate([( __param(0, IExtensionManagementServerService)), ( __param(1, ILabelService)), ( __param(2, IContextKeyService))], ExtensionsViewletViewsContribution));
let ExtensionsViewPaneContainer = class ExtensionsViewPaneContainer extends ViewPaneContainer {
    constructor(
        ...
        extensionGalleryManifestService.getExtensionGalleryManifest().then(galleryManifest => {
            ...
            this._register(
                extensionGalleryManifestService.onDidChangeExtensionGalleryManifest(galleryManifest => {
                    this.extensionGalleryManifest = galleryManifest;
                    this.refresh();
                })
            );
    ...
    create(parent) {
        ...
        const placeholder = ( localize(10713, "Search Extensions in Marketplace"));
        const searchValue = this.searchViewletState["query.value"] ? this.searchViewletState["query.value"] : "";
        const searchContainer = append(this.header, $(".extensions-search-container"));
        this.searchBox = this._register(
            this.instantiationService.createInstance(SuggestEnabledInput, `${VIEWLET_ID}.searchbox`, searchContainer, {
                triggerCharacters: ["@"],
                sortKey: item => {
                    if (item.indexOf(":") === -1) {
                        return "a";
            ...
            }, placeholder, "extensions:searchinput", {
                placeholderText: placeholder,
                value: searchValue
            })
        );
        this.notificationContainer = append(this.header, $(".notification-container.hidden", {
            "tabindex": "0"
        }));
        this.renderNotificaiton();
        this._register(
            this.extensionsWorkbenchService.onDidChangeExtensionsNotification(() => this.renderNotificaiton())
        );
        ...
        this._register(
            this.instantiationService.createInstance(MenuWorkbenchToolBar, controlElement, extensionsSearchActionsMenu, {
                toolbarOptions: {
                    primaryGroup: () => true
                },
        ...
        this._register(new DragAndDropObserver(this.root, {
            ...
            onDrop: async e => {
                if (this.isSupportedDragElement(e)) {
                    hide(overlay);
                    const vsixs = coalesce(( (await this.instantiationService.invokeFunction(accessor => extractEditorsAndFilesDropData(accessor, e))).map(
        ...
        if (status && (query === this.searchBox?.getValue() || !this.searchMarketplaceExtensionsContextKey.get())) {
            ...
            if (status.extensions.length) {
                const showAction = append(messageText, $("span.message-text-action", {
                    "tabindex": "0",
                    "role": "button",
                    "aria-label": `${messagePlainText}. ${( localize(10714, "Click to Show"))}`
                }, ( localize(10715, "Show"))));
                this.notificationDisposables.value.add(
                    addDisposableListener(showAction, EventType.CLICK, () => this.search(query ?? ""))
                );
            ...
            if (dismiss) {
                const dismissLabel = ( localize(10716, "Dismiss"));
                const dismissButton = append(actionsContainer, $("span.dismiss-action.codicon.codicon-close", {
                    "tabindex": "0",
                    "role": "button",
    ...
    doSearch(refresh) {
        ...
        this.contextKeyService.bufferChangeEvents(() => {
            ...
            this.searchMarketplaceExtensionsContextKey.set(
                !!value && !ExtensionsListView.isLocalExtensionsQuery(value) && !isRecommendedExtensionsQuery && !this.searchMcpServersContextKey.get() && !this.searchAgentPluginsContextKey.get()
            );
    ...
    alertSearchResult(count, viewId) {
        ...
        case 1:
            if (view) {
                alert(( localize(10717, "1 extension found in the {0} section.", view.name.value)));
            } else {
                alert(( localize(10718, "1 extension found.")));
            }
            break;
        default:
            if (view) {
                alert(( localize(10719, "{0} extensions found in the {1} section.", count, view.name.value)));
            } else {
                alert(( localize(10720, "{0} extensions found.", count)));
            }
            break;
        }
    }
    ...
    onError(err) {
        ...
        if (/ECONNREFUSED/.test(message)) {
            ...
            )), [( new Action("open user settings", ( localize(10722, "Open User Settings")), undefined, true, () => this.preferencesService.openUserSettings()))]);
...
ExtensionsViewPaneContainer = ( __decorate([( __param(0, IWorkbenchLayoutService)), ( __param(1, ITelemetryService)), ( __param(2, IProgressService)), ( __param(3, IInstantiationService)), ( __param(4, IEditorGroupsService)), ( __param(5, IExtensionGalleryManifestService)), ( __param(6, IExtensionsWorkbenchService)), ( __param(7, IExtensionManagementServerService)), ( __param(8, INotificationService)), ( __param(9, IPaneCompositePartService)), ( __param(10, IThemeService)), ( __param(11, IConfigurationService)), ( __param(12, IStorageService)), ( __param(13, IWorkspaceContextService)), ( __param(14, IContextKeyService)), ( __param(15, IContextMenuService)), ( __param(16, IExtensionService)), ( __param(17, IViewDescriptorService)), ( __param(18, IPreferencesService)), ( __param(19, ICommandService)), ( __param(20, ILogService)), ( __param(21, IOpenerService))], ExtensionsViewPaneContainer));
let StatusUpdater = class StatusUpdater extends Disposable {
    constructor(
        ...
        this._register(Event.any(Event.debounce(
            ...
            undefined,
            this._store
        ), extensionsWorkbenchService.onDidChangeExtensionsNotification)(this.onServiceChange, this));
    }
    onServiceChange() {
        this.badgeHandle.clear();
        let badge;
        const extensionsNotification = this.extensionsWorkbenchService.getExtensionsNotification();
        if (extensionsNotification && extensionsNotification.severity === Severity$1.Warning) {
            badge = ( new WarningBadge(
                () => isMarkdownString(extensionsNotification.message) ? renderAsPlaintext(extensionsNotification.message) : extensionsNotification.message
            ));
        }
        if (!badge) {
            ...
            const outdated = this.extensionsWorkbenchService.outdated.reduce(
                (r, e) => r + (this.extensionEnablementService.isEnabled(e.local) && !actionRequired.includes(e) && !this.extensionsWorkbenchService.isAutoUpdateDelayed(e) ? 1 : 0),
                0
            );
            ...
            if (newBadgeNumber > 0) {
                let msg = "";
                if (outdated) {
                    msg += outdated === 1 ? ( localize(10723, "{0} requires update", outdated)) : ( localize(10724, "{0} require update", outdated));
                }
                if (outdated > 0 && actionRequired.length > 0) {
                    msg += ", ";
                }
                if (actionRequired.length) {
                    msg += actionRequired.length === 1 ? ( localize(10725, "{0} requires restart", actionRequired.length)) : ( localize(10726, "{0} require restart", actionRequired.length));
                }
...
StatusUpdater = ( __decorate([( __param(0, IActivityService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IWorkbenchExtensionEnablementService)), ( __param(3, IConfigurationService))], StatusUpdater));
let MaliciousExtensionChecker = class MaliciousExtensionChecker {
    ...
    loopCheckForMaliciousExtensions() {
        this.checkForMaliciousExtensions().then(() => timeout(1000 * 60 * 5)).then(() => this.loopCheckForMaliciousExtensions());
    }
    async checkForMaliciousExtensions() {
        try {
            ...
            if (maliciousExtensions.length) {
                await this.extensionsManagementService.uninstallExtensions(( maliciousExtensions.map(e => ({
                    extension: e[0],
                    options: {
                        remove: true
                    }
                ...
                for (const [extension, link] of maliciousExtensions) {
                    ...
                    if (shouldRestartExtensions || shouldReloadWindow) {
                        buttons.push({
                            label: shouldRestartExtensions ? ( localize(10727, "Restart Extensions")) : ( localize(10728, "Reload Now")),
                            run: () => shouldRestartExtensions ? this.extensionsWorkbenchService.updateRunningExtensions() : this.hostService.reload()
                        });
                    }
                    if (link) {
                        buttons.push({
                            label: ( localize(10729, "Learn More")),
...
MaliciousExtensionChecker = ( __decorate([( __param(0, IExtensionManagementService)), ( __param(1, IExtensionsWorkbenchService)), ( __param(2, IHostService)), ( __param(3, ILogService)), ( __param(4, INotificationService)), ( __param(5, ICommandService))], MaliciousExtensionChecker));
let ExtensionMarketplaceStatusUpdater = class ExtensionMarketplaceStatusUpdater extends Disposable {
    constructor(activityService, extensionGalleryManifestService) {
        ...
        this.updateBadge();
        this._register(
            this.extensionGalleryManifestService.onDidChangeExtensionGalleryManifestStatus(() => this.updateBadge())
        );
    }
    async updateBadge() {
        this.badgeHandle.clear();
        ...
        case ExtensionGalleryManifestStatus.RequiresSignIn:
            badge = ( new NumberBadge(1, () => ( localize(10731, "Sign in required to access marketplace"))));
            break;
        case ExtensionGalleryManifestStatus.AccessDenied:
            badge = ( new WarningBadge(() => ( localize(10732, "Access denied to marketplace"))));
            break;
        }
        if (badge) {
            this.badgeHandle.value = this.activityService.showViewContainerActivity(VIEWLET_ID, {
        ...
        if (status === ExtensionGalleryManifestStatus.RequiresSignIn) {
            const badge = ( new NumberBadge(1, () => ( localize(10733, "Sign in to access Marketplace"))));
...
ExtensionMarketplaceStatusUpdater = ( __decorate([( __param(0, IActivityService)), ( __param(1, IExtensionGalleryManifestService))], ExtensionMarketplaceStatusUpdater));
