...
ExtensionsCompletionItemsProvider = ( __decorate([( __param(0, IExtensionManagementService)), ( __param(1, ILanguageFeaturesService))], ExtensionsCompletionItemsProvider));
