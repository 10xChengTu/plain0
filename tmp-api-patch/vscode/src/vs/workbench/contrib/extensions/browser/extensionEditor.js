...
import { append, $, show, hide, setParentFlowTo } from '../../../../base/browser/dom.js';
import { ActionBar } from '../../../../base/browser/ui/actionbar/actionbar.js';
import { getDefaultHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegateFactory.js';
import { DomScrollableElement } from '../../../../base/browser/ui/scrollbar/scrollableElement.js';
import { CheckboxActionViewItem } from '../../../../base/browser/ui/toggle/toggle.js';
import { Action } from '../../../../base/common/actions.js';
import { insert, isFalsyOrEmpty } from '../../../../base/common/arrays.js';
...
import { Disposable, dispose, MutableDisposable, DisposableStore, toDisposable } from '../../../../base/common/lifecycle.js';
import { matchesScheme, Schemas } from '../../../../base/common/network.js';
import { isNative } from '../../../../base/common/platform.js';
import { isUndefined } from '../../../../base/common/types.js';
import { URI } from '../../../../base/common/uri.js';
import { generateUuid } from '../../../../base/common/uuid.js';
import * as extensionEditor from './media/extensionEditor.css';
...
import { FilterType, computeSize } from '../../../../platform/extensionManagement/common/extensionManagement.js';
...
import { textLinkForeground, textLinkActiveForeground } from '../../../../platform/theme/common/colors/baseColors.js';
import '../../../../platform/theme/common/colors/chartsColors.js';
import { editorBackground } from '../../../../platform/theme/common/colors/editorColors.js';
import { buttonHoverBackground, buttonForeground } from '../../../../platform/theme/common/colors/inputColors.js';
...
import { InstallDropdownAction, ExtensionEditorManageExtensionAction, ExtensionRuntimeStateAction, ExtensionStatusLabelAction, UpdateAction, SetColorThemeAction, SetFileIconThemeAction, SetProductIconThemeAction, SetLanguageAction, ClearLanguageAction, EnableDropDownAction, TogglePreReleaseExtensionAction, DisableDropDownAction, RemoteInstallAction, LocalInstallAction, WebInstallAction, InstallingLabelAction, ButtonWithDropDownExtensionAction, UninstallAction, MigrateDeprecatedExtensionAction, InstallAnotherVersionAction, ToggleAutoUpdateForExtensionAction, DropDownExtensionAction, ButtonWithDropdownExtensionActionViewItem, ExtensionStatusAction } from './extensionsActions.js';
...
import { ExtensionWidget, ExtensionIconWidget, RemoteBadgeWidget, PublisherWidget, ExtensionKindIndicatorWidget, InstallCountWidget, RatingsWidget, SponsorWidget, ExtensionStatusWidget, ExtensionRecommendationWidget, onClick } from './extensionsWidgets.js';
import { ExtensionState, ExtensionContainers, ExtensionEditorTab } from '../common/extensions.js';
...
class VersionWidget extends ExtensionWithDifferentGalleryVersionWidget {
    constructor(container, hoverService) {
        ...
        this._register(
            hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), this.element, ( localize(10253, "Extension Version")))
        );
        this.render();
    }
    render() {
...
let ExtensionEditor = class ExtensionEditor extends EditorPane {
    ...
    createEditor(parent) {
        ...
        this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), name, ( localize(10254, "Extension name")))
        );
        const versionWidget = ( new VersionWidget(title, this.hoverService));
        const preview = append(title, $("span.preview"));
        this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), preview, ( localize(10255, "Preview")))
        );
        preview.textContent = ( localize(10255, "Preview"));
        const builtin = append(title, $("span.builtin"));
        builtin.textContent = ( localize(10256, "Built-in"));
        ...
        extensionActionBar.push(actions, {
            icon: true,
            label: true
        });
        ...
        const extensionStatusWidget = this._register(this.instantiationService.createInstance(
        ...
        this._register(
            Event.any(extensionStatusWidget.onDidRender, recommendationWidget.onDidRender)(() => {
                if (this.dimension) {
        ...
        const onError = Event.chain(extensionActionBar.onDidRun, $ => ( $.map((
            {
                error
            }
    ...
    renderNavbar(extension, manifest, template, preserveFocus) {
        ...
        template.navbar.push(ExtensionEditorTab.Readme, ( localize(10257, "Details")), ( localize(10258, "Extension details, rendered from the extension's 'README.md' file")));
        if (manifest) {
            template.navbar.push(ExtensionEditorTab.Features, ( localize(10259, "Features")), ( localize(10260, "Lists features contributed by this extension")));
        }
        if (extension.hasChangelog()) {
            template.navbar.push(ExtensionEditorTab.Changelog, ( localize(10261, "Changelog")), ( localize(
                10262,
                "Extension update history, rendered from the extension's 'CHANGELOG.md' file"
            )));
        }
        if (extension.dependencies.length) {
            template.navbar.push(ExtensionEditorTab.Dependencies, ( localize(10263, "Dependencies")), ( localize(10264, "Lists extensions this extension depends on")));
        }
        if (manifest && manifest.extensionPack?.length && !this.shallRenderAsExtensionPack(manifest)) {
            template.navbar.push(ExtensionEditorTab.ExtensionPack, ( localize(10265, "Extension Pack")), ( localize(
                10266,
        ...
        try {
            ...
            this.contentDisposables.add(webview.onDidClickLink(link => {
                ...
                if (matchesScheme(link, Schemas.http) || matchesScheme(link, Schemas.https) || matchesScheme(link, Schemas.mailto)) {
                    ...
                    this.openerService.open(link, {
                        allowCommands: [ShowCurrentReleaseNotesActionId]
                    });
                }
            }));
            return webview;
    ...
    async openDetails(extension, contentContainer, token) {
        ...
        if (manifest && manifest.extensionPack?.length && this.shallRenderAsExtensionPack(manifest)) {
            ...
            activeElement = await this.openMarkdown(extension, this.extensionReadme.get(), ( localize(10267, "No README available.")), contentContainer, WebviewIndex.Readme, ( localize(10268, "Readme")), token);
        }
    ...
    async openExtensionPackReadme(extension, manifest, container, token) {
        ...
        const extensionPackReadme = append(container, $("div", {
            class: "extension-pack-readme"
        }));
        extensionPackReadme.style.margin = "0 auto";
        extensionPackReadme.style.maxWidth = "882px";
        const extensionPack = append(extensionPackReadme, $("div", {
        ...
        extensionPackHeader.textContent = ( localize(10269, "Extension Pack ({0})", manifest.extensionPack.length));
        const extensionPackContent = append(extensionPack, $("div", {
            class: "extension-pack-content"
        }));
        extensionPackContent.setAttribute("tabindex", "0");
        const readmeContent = append(extensionPackReadme, $("div.readme-content"));
        await Promise.all([
            this.renderExtensionPack(manifest, extensionPackContent, token),
            this.openMarkdown(extension, this.extensionReadme.get(), ( localize(10267, "No README available.")), readmeContent, WebviewIndex.Readme, ( localize(10268, "Readme")), token)
        ]);
        return {
            focus: () => extensionPackContent.focus()
        };
    }
    ...
    async openChangelog(extension, contentContainer, token) {
        const activeElement = await this.openMarkdown(extension, this.extensionChangelog.get(), ( localize(10270, "No Changelog available.")), contentContainer, WebviewIndex.Changelog, ( localize(10271, "Changelog")), token);
        return activeElement;
    }
    async openFeatures(extension, contentContainer, token) {
        ...
        const extensionFeaturesTab = this.contentDisposables.add(
            this.instantiationService.createInstance(ExtensionFeaturesTab, manifest, this.options?.feature)
        );
    ...
    openExtensionDependencies(extension, contentContainer, token) {
        ...
        if (isFalsyOrEmpty(extension.dependencies)) {
            append(contentContainer, $("p.nocontent")).textContent = ( localize(10272, "No Dependencies"));
        ...
        this.contentDisposables.add(scrollableContent);
        const dependenciesTree = this.instantiationService.createInstance(ExtensionsTree, ( new ExtensionData(
            extension,
            null,
...
ExtensionEditor = ExtensionEditor_1 = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IInstantiationService)), ( __param(3, IExtensionsWorkbenchService)), ( __param(4, IExtensionGalleryService)), ( __param(5, IThemeService)), ( __param(6, INotificationService)), ( __param(7, IOpenerService)), ( __param(8, IExtensionRecommendationsService)), ( __param(9, IStorageService)), ( __param(10, IExtensionService)), ( __param(11, IWebviewService)), ( __param(12, ILanguageService)), ( __param(13, IContextMenuService)), ( __param(14, IContextKeyService)), ( __param(15, IHoverService))], ExtensionEditor));
let AdditionalDetailsWidget = class AdditionalDetailsWidget extends Disposable {
    ...
    renderCategories(container, extension) {
        if (extension.categories.length) {
            ...
            append(
                categoriesContainer,
                $(".additional-details-title", undefined, ( localize(10273, "Categories")))
            );
            ...
            this.extensionGalleryManifestService.getExtensionGalleryManifest().then(manifest => {
                ...
                for (const category of extension.categories) {
                    const categoryElement = append(categoriesElement, $("span.category", {
                        tabindex: "0"
                    }, category));
    ...
    renderExtensionResources(container, extension) {
        ...
        if (extension.repository) {
            try {
                resources.push([( localize(10274, "Repository")), ThemeIcon.fromId(Codicon.repo.id), ( URI.parse(extension.repository))]);
            } catch (error) {}
        }
        if (extension.supportUrl) {
            try {
                resources.push([( localize(10275, "Issues")), ThemeIcon.fromId(Codicon.issues.id), ( URI.parse(extension.supportUrl))]);
            } catch (error) {}
        }
        if (extension.licenseUrl) {
            try {
                resources.push([( localize(10276, "License")), ThemeIcon.fromId(Codicon.linkExternal.id), ( URI.parse(extension.licenseUrl))]);
            } catch (error) {}
        }
        if (extension.publisherUrl) {
            resources.push([
                extension.publisherDisplayName,
                ThemeIcon.fromId(Codicon.linkExternal.id),
                extension.publisherUrl
            ]);
        }
        if (extension.url) {
            resources.push([( localize(10277, "Marketplace")), ThemeIcon.fromId(Codicon.linkExternal.id), ( URI.parse(extension.url))]);
        }
        if (resources.length || extension.publisherSponsorLink) {
            const extensionResourcesContainer = append(container, $(".resources-container.additional-details-element"));
            append(
                extensionResourcesContainer,
                $(".additional-details-title", undefined, ( localize(10278, "Resources")))
            );
    ...
    renderInstallInfo(container, extension) {
        ...
        append(
            ...
            $(".additional-details-title", undefined, ( localize(10279, "Installation")))
        );
        const installInfo = append(installInfoContainer, $(".more-info"));
        append(installInfo, $(
            ".more-info-entry",
            undefined,
            $("div.more-info-entry-name", undefined, ( localize(10280, "Identifier"))),
        ...
        if (extension.type !== ExtensionType.System) {
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(10281, "Version"))),
        ...
        if (extension.installedTimestamp) {
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(10282, "Last Updated"))),
                $("div", {
        ...
        if (!extension.isBuiltin && extension.source !== "gallery") {
            const element = $("div", undefined, extension.source === "vsix" ? ( localize(10283, "VSIX")) : ( localize(10284, "Local")));
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(10285, "Source"))),
                element
            ));
            if (isNative && extension.source === "resource" && extension.location.scheme === Schemas.file) {
                ...
                this.disposables.add(onClick(element, () => this.openerService.open(extension.location, {
                    openExternal: true
                })));
            }
        }
        if (extension.size) {
            ...
            append(
                installInfo,
                $(".more-info-entry", undefined, $("div.more-info-entry-name", {
                    title: ( localize(10286, "Size when installed"))
                }, ( localize(10287, "Size"))), element)
            );
        ...
        this.getCacheLocation(extension).then(cacheLocation => {
            ...
            computeSize(cacheLocation, this.fileService).then(cacheSize => {
                ...
                append(
                    installInfo,
                    $(".more-info-entry", undefined, $("div.more-info-entry-name", {
                        title: ( localize(10288, "Cache size"))
                    }, ( localize(10289, "Cache"))), element)
                );
                if (isNative && extension.location.scheme === Schemas.file) {
                    element.classList.add("link");
                    element.tabIndex = 0;
                    ...
                    this.disposables.add(onClick(element, () => this.openerService.open(cacheLocation.with({
                        scheme: Schemas.file
                    }), {
                        openExternal: true
                    })));
    ...
    renderMarketplaceInfo(container, extension) {
        ...
        append(
            moreInfoContainer,
            $(".additional-details-title", undefined, ( localize(10290, "Marketplace")))
        );
        ...
        if (gallery) {
            ...
            append(moreInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(10291, "Published"))),
                $("div", {
                ...
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(10292, "Last Released"))),
                $("div", {
...
AdditionalDetailsWidget = ( __decorate([( __param(2, IHoverService)), ( __param(3, IOpenerService)), ( __param(4, IUserDataProfilesService)), ( __param(5, IRemoteAgentService)), ( __param(6, IFileService)), ( __param(7, IUriIdentityService)), ( __param(8, IExtensionsWorkbenchService)), ( __param(9, IExtensionGalleryManifestService))], AdditionalDetailsWidget));
...
registerAction2(class StartExtensionEditorFindNextAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10294, "Find Next")),
            keybinding: {
...
registerAction2(class StartExtensionEditorFindPreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10295, "Find Previous")),
            keybinding: {
                when: ( ContextKeyExpr.and(contextKeyExpr, KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED)),
...
registerThemingParticipant((theme, collector) => {
    ...
    if (buttonHoverBackgroundColor) {
        collector.addRule(
            `.monaco-workbench .extension-editor .content > .details > .additional-details-container .categories-container > .categories > .category.clickable:hover { background-color: ${buttonHoverBackgroundColor}; border-color: ${buttonHoverBackgroundColor}; }`
        );
    }
    const buttonForegroundColor = theme.getColor(buttonForeground);
    if (buttonForegroundColor) {
        collector.addRule(
            `.monaco-workbench .extension-editor .content > .details > .additional-details-container .categories-container > .categories > .category.clickable:hover { color: ${buttonForegroundColor}; }`
        );
    }
});
