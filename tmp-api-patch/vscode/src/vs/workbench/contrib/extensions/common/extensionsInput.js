...
const ExtensionEditorIcon = registerIcon("extensions-editor-label-icon", Codicon.extensions, ( localize(10856, "Icon of the extensions editor label.")));
class ExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(10857, "Extension: {0}", this._extension.displayName);
    }
    getIcon() {
