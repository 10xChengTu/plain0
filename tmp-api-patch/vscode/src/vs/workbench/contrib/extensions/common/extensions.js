...
const EXTENSIONS_CATEGORY = ( localize2(10851, "Extensions"));
var ExtensionState;
...
const AutoUpdateDelayConfigurationKey = "extensions.autoUpdateDelay";
...
const CONTEXT_EXTENSIONS_GALLERY_STATUS = ( new RawContextKey("extensionsGalleryStatus", ExtensionGalleryManifestStatus.Unavailable));
...
export { AutoCheckUpdatesConfigurationKey, AutoRestartConfigurationKey, AutoUpdateConfigurationKey, AutoUpdateDelayConfigurationKey, CONTEXT_EXTENSIONS_GALLERY_STATUS, CONTEXT_HAS_GALLERY, CloseExtensionDetailsOnViewChangeKey, DefaultViewsContext, EXTENSIONS_CATEGORY, ExtensionContainers, ExtensionEditorTab, ExtensionResultsListFocused, ExtensionRuntimeActionType, ExtensionState, HasOutdatedExtensionsContext, INSTALL_ACTIONS_GROUP, INSTALL_EXTENSION_FROM_VSIX_COMMAND_ID, LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID, OUTDATED_EXTENSIONS_VIEW_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID, SearchAgentPluginsContext, SearchMcpServersContext, THEME_ACTIONS_GROUP, TOGGLE_IGNORE_EXTENSION_ACTION_ID, UPDATE_ACTIONS_GROUP, VIEWLET_ID, WORKSPACE_RECOMMENDATIONS_VIEW_ID, extensionsFilterSubMenu, extensionsSearchActionsMenu };
