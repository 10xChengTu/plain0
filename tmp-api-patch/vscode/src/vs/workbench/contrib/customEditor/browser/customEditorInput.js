...
let CustomEditorInput = class CustomEditorInput extends LazilyResolvedWebviewEditorInput {
    ...
    static create(instantiationService, init, group, options) {
        return instantiationService.invokeFunction(accessor => {
            ...
            const input = instantiationService.createInstance(CustomEditorInput_1, init, webview, {
    ...
    registerListeners() {
        ...
        this._register(
            this.fileService.onDidChangeFileSystemProviderRegistrations(e => this.onLabelEvent(e.scheme))
        );
        this._register(
            this.fileService.onDidChangeFileSystemProviderCapabilities(e => this.onLabelEvent(e.scheme))
        );
    ...
    copy() {
        return CustomEditorInput_1.create(this.instantiationService, {
            resource: this.resource,
            viewType: this.viewType,
            webviewTitle: this.getWebviewTitle(),
            preferredName: undefined,
            iconPath: this.iconPath
        }, this.group, this.webview.options);
    }
    isReadonly() {
        if (!this._modelRef) {
    ...
    async resolve() {
        ...
        if (!this._modelRef) {
            ...
            this._modelRef = this._register(assertReturnsDefined(
                await this.customEditorService.models.tryRetain(this.resource, this.viewType)
            ));
            this._register(
    ...
    claim(claimant, targetWindow, scopedContextKeyService) {
        if (this.doCanMove(targetWindow.vscodeWindowId) !== true) {
            throw createEditorOpenError(( localize(
                ...
                label: ( localize(9344, "Open in Original Window")),
                run: async () => {
...
CustomEditorInput = CustomEditorInput_1 = ( __decorate([( __param(3, IThemeService)), ( __param(4, IWebviewWorkbenchService)), ( __param(5, IInstantiationService)), ( __param(6, ILabelService)), ( __param(7, ICustomEditorService)), ( __param(8, IFileDialogService)), ( __param(9, IUndoRedoService)), ( __param(10, IFileService)), ( __param(11, IFilesConfigurationService)), ( __param(12, IEditorGroupsService)), ( __param(13, IWorkbenchLayoutService)), ( __param(14, ICustomEditorLabelService))], CustomEditorInput));
