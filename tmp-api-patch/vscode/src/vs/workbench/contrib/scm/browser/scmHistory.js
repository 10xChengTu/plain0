...
const historyItemRefColor = registerColor("scmGraph.historyItemRefColor", chartsBlue, ( localize(13752, "History item reference color.")));
const historyItemRemoteRefColor = registerColor("scmGraph.historyItemRemoteRefColor", chartsPurple, ( localize(13753, "History item remote reference color.")));
const historyItemBaseRefColor = registerColor("scmGraph.historyItemBaseRefColor", "#EA5C00", ( localize(13754, "History item base reference color.")));
const historyItemHoverDefaultLabelForeground = registerColor(
    "scmGraph.historyItemHoverDefaultLabelForeground",
    foreground,
    ( localize(13755, "History item hover default label foreground color."))
);
const historyItemHoverDefaultLabelBackground = registerColor(
    "scmGraph.historyItemHoverDefaultLabelBackground",
    badgeBackground,
    ( localize(13756, "History item hover default label background color."))
);
const historyItemHoverLabelForeground = registerColor(
    "scmGraph.historyItemHoverLabelForeground",
    PANEL_BACKGROUND,
    ( localize(13757, "History item hover label foreground color."))
);
registerColor("scmGraph.historyItemHoverAdditionsForeground", {
    ...
    hcDark: "#A1E3AD",
    hcLight: "#374E06"
}, ( localize(13758, "History item hover additions foreground color.")));
registerColor("scmGraph.historyItemHoverDeletionsForeground", {
    light: "#AD0707",
    dark: "#C74E39",
    hcDark: "#C74E39",
    hcLight: "#AD0707"
}, ( localize(13759, "History item hover deletions foreground color.")));
const colorRegistry = [registerColor("scmGraph.foreground1", "#FFB000", ( localize(13760, "Source control graph foreground color (1)."))), registerColor("scmGraph.foreground2", "#DC267F", ( localize(13761, "Source control graph foreground color (2)."))), registerColor("scmGraph.foreground3", "#994F00", ( localize(13762, "Source control graph foreground color (3)."))), registerColor("scmGraph.foreground4", "#40B0A6", ( localize(13763, "Source control graph foreground color (4)."))), registerColor("scmGraph.foreground5", "#B66DFF", ( localize(13764, "Source control graph foreground color (5).")))];
...
function toISCMHistoryItemViewModelArray(
    ...
    for (let index = 0; index < historyItems.length; index++) {
        ...
        references.sort((ref1, ref2) => compareHistoryItemRefs(
            ref1,
            ref2,
            currentHistoryItemRef,
            currentHistoryItemRemoteRef,
            ...
            if (beforeHistoryItemIndex !== -1 && afterHistoryItemIndex !== -1) {
                ...
                if (!incomingChangeMerged) {
                    ...
                    const incomingChangesHistoryItem = {
                        ...
                        subject: ( localize(13765, "Incoming Changes")),
                        message: ""
                    };
        ...
        if (addOutgoingChanges && currentHistoryItemRef?.revision && currentHistoryItemRef.revision !== mergeBase) {
            ...
            if (currentHistoryItemRefIndex !== -1) {
                const outgoingChangesHistoryItem = {
                    ...
                    subject: ( localize(13766, "Outgoing Changes")),
                    message: ""
                };
    ...
    if (includeReferences && historyItem.references?.length) {
        ...
        for (const reference of historyItem.references) {
            ...
            markdownString.appendMarkdown(
                `<span style="color:${labelForegroundColor};background-color:${labelBackgroundColor};border-radius:10px;">&nbsp;$(${labelIconId})&nbsp;`
            );
