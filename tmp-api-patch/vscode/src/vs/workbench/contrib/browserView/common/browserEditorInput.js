...
import { Verbosity, EditorInputCapabilities } from '../../../common/editor.js';
...
let BrowserEditorInput = class BrowserEditorInput extends EditorInput {
    ...
    static {
        this.DEFAULT_LABEL = ( localize(4949, "Browser"));
    }
    constructor(
        options,
        _resolveModel,
    ...
    getIcon() {
        if (this._model) {
            if (this._model.loading) {
                ...
                return ( URI.parse(
                    "data:image/svg+xml;utf8," + encodeURIComponent(LOADING_SPINNER_SVG(color?.toString()))
                ));
            }
    ...
    getName() {
        ...
        const name = hasTitle ? this.title : this.getDescription(Verbosity.SHORT) || BrowserEditorInput_1.DEFAULT_LABEL;
...
BrowserEditorInput = BrowserEditorInput_1 = ( __decorate([( __param(2, IThemeService)), ( __param(3, IInstantiationService)), ( __param(4, ITelemetryService)), ( __param(5, IBrowserViewWorkbenchService))], BrowserEditorInput));
