...
MultiDiffEditor = MultiDiffEditor_1 = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, ITelemetryService)), ( __param(3, IThemeService)), ( __param(4, IStorageService)), ( __param(5, IEditorService)), ( __param(6, IEditorGroupsService)), ( __param(7, ITextResourceConfigurationService)), ( __param(8, IEditorProgressService))], MultiDiffEditor));
...
WorkbenchUIElementFactory = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IContextKeyService))], WorkbenchUIElementFactory));
