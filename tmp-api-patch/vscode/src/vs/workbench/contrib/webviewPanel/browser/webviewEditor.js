...
import { createElement, setParentFlowTo, isHTMLElement, trackFocus } from '../../../../base/browser/dom.js';
...
const CONTEXT_ACTIVE_WEBVIEW_PANEL_ID = ( new RawContextKey("activeWebviewPanelId", "", {
    type: "string",
    description: ( localize(16687, "The viewType of the currently active webview panel."))
}));
let WebviewEditor = class WebviewEditor extends EditorPane {
    ...
    trackFocus(webview) {
        ...
        store.add(
            webviewContentFocusTracker.onDidFocus(() => this._onDidFocusWebview.fire())
        );
