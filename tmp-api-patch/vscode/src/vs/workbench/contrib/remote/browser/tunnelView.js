...
import { TunnelType, TunnelEditId, TUNNEL_VIEW_ID } from '../../../services/remote/common/remoteExplorerService.js';
...
import { TunnelPrivacyId, TunnelProtocol, isLocalhost, isAllInterfaces, isRemoteTunnel } from '../../../../platform/tunnel/common/tunnel.js';
...
import { TunnelSource, makeAddress, parseAddress, mapHasAddressLocalhostOrAllInterfaces, TunnelCloseReason, forwardedPortsViewEnabled } from '../../../services/remote/common/tunnelModel.js';
import { getDefaultHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegateFactory.js';
import { IHoverService } from '../../../../platform/hover/browser/hover.service.js';
import Severity$1 from '../../../../base/common/severity.js';

var TunnelPanel_1;
registerCss(tunnelView);
...
let TunnelViewModel = class TunnelViewModel {
    ...
    isEmpty() {
        return (this.detected.length === 0) && ((this.forwarded.length === 0) || (this.forwarded.length === 1 && (this.forwarded[0].tunnelType === TunnelType.Add) && !this.remoteExplorerService.getEditableData(undefined)));
    }
};
TunnelViewModel = ( __decorate([( __param(0, IRemoteExplorerService)), ( __param(1, ITunnelService))], TunnelViewModel));
...
class PortColumn {
    constructor() {
        this.label = ( localize(13515, "Port"));
        this.tooltip = ( localize(13516, "The label and remote port number of the forwarded port."));
        this.weight = 1;
        this.templateId = "actionbar";
    }
    project(row) {
...
class LocalAddressColumn {
    constructor() {
        this.label = ( localize(13517, "Forwarded Address"));
        this.tooltip = ( localize(13518, "The address that the forwarded port is available at."));
        this.weight = 1;
        this.templateId = "actionbar";
    }
    project(row) {
    ...
    static getHoverText(localAddress) {
        return function(configurationService) {
            ...
            if (editorConf.multiCursorModifier === "ctrlCmd") {
                if (isMacintosh) {
                    clickLabel = ( localize(13519, "option + click"));
                } else {
                    clickLabel = ( localize(13520, "alt + click"));
                }
            } else {
                if (isMacintosh) {
                    clickLabel = ( localize(13521, "cmd + click"));
                } else {
                    clickLabel = ( localize(13522, "ctrl + click"));
                }
            }
...
class RunningProcessColumn {
    constructor() {
        this.label = ( localize(13523, "Running Process"));
        this.tooltip = ( localize(13524, "The command line of the process that is using the port."));
        this.weight = 2;
        this.templateId = "actionbar";
    }
    project(row) {
...
class OriginColumn {
    constructor() {
        this.label = ( localize(13525, "Origin"));
...
class PrivacyColumn {
    constructor() {
        this.label = ( localize(13527, "Visibility"));
        this.tooltip = ( localize(13528, "The availability of the forwarded port."));
        this.weight = 1;
        this.templateId = "actionbar";
    }
    project(row) {
...
let ActionBarRenderer = class ActionBarRenderer {
    ...
    renderActionBarItem(element, templateData) {
        ...
        if (element.menuId) {
            ...
            let actions = getFlatActionBarActions(menu.getActions({
    ...
    renderInputBox(templateData, editableData) {
        ...
        const inputBox = ( new InputBox(container, this.contextViewService, {
            ariaLabel: ( localize(13529, "Press Enter to confirm or Escape to cancel.")),
            validationOptions: {
                validation: value => {
...
ActionBarRenderer = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IContextKeyService)), ( __param(2, IMenuService)), ( __param(3, IContextViewService)), ( __param(4, IRemoteExplorerService)), ( __param(5, ICommandService)), ( __param(6, IConfigurationService))], ActionBarRenderer));
class TunnelItem {
    static createFromTunnel(
        remoteExplorerService,
        tunnelService,
        tunnel,
        type = TunnelType.Forwarded,
        closeable
    ) {
    ...
    get processDescription() {
        ...
        if (this.runningProcess) {
            ...
            description = ( localize(13530, "Process information unavailable"));
        }
        return description;
    }
    get tooltipPostfix() {
    ...
    get iconTooltip() {
        ...
        if (!isAdd) {
            return `${this.processDescription ? ( localize(13533, "Port has running process.")) : ( localize(13534, "No running process."))}`;
        } else {
            return this.label;
        }
    }
    get portTooltip() {
        const isAdd = this.tunnelType === TunnelType.Add;
        if (!isAdd) {
            return `${this.name ? ( localize(13535, "Port labeled {0}. ", this.name)) : ""}`;
        } else {
            return "";
        }
    }
...
const TunnelViewFocusContextKey = ( new RawContextKey("tunnelViewFocus", false, ( localize(13537, "Whether the Ports view has focus."))));
...
let TunnelPanel = class TunnelPanel extends ViewPane {
    ...
    static {
        this.TITLE = ( localize2(13538, "Ports"));
    }
    constructor(
        viewModel,
        options,
    ...
    createTable() {
        ...
        this.table = this.instantiationService.createInstance(WorkbenchTable, "RemoteTunnels", widgetContainer, ( new TunnelTreeVirtualDelegate(this.remoteExplorerService)), columns, [actionBarRenderer], {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => ( localize(13539, "Tunnel View"))
            },
        ...
        this.tableDisposables.add(
            Event.debounce(this.viewModel.onForwardedPortsChanged, (_last, e) => e, 50)(() => {
...
TunnelPanel = TunnelPanel_1 = ( __decorate([( __param(2, IKeybindingService)), ( __param(3, IContextMenuService)), ( __param(4, IContextKeyService)), ( __param(5, IConfigurationService)), ( __param(6, IInstantiationService)), ( __param(7, IViewDescriptorService)), ( __param(8, IOpenerService)), ( __param(9, IQuickInputService)), ( __param(10, ICommandService)), ( __param(11, IMenuService)), ( __param(12, IThemeService)), ( __param(13, IRemoteExplorerService)), ( __param(14, IHoverService)), ( __param(15, ITunnelService)), ( __param(16, IContextViewService))], TunnelPanel));
...
(function(LabelTunnelAction) {
    ...
    LabelTunnelAction.LABEL = ( localize(13540, "Set Port Label"));
            ...
            if (tunnelContext) {
                ...
                return (new Promise(resolve => {
                    ...
                    remoteExplorerService.setEditable(tunnelItem, TunnelEditId.Label, {
                        ...
                        placeholder: ( localize(13541, "Port label")),
                        startingValue
                    });
                }));
            }
...
const invalidPortString = ( localize(13542, "Forwarded port should be a number or a host:port."));
const maxPortNumber = 65536;
const invalidPortNumberString = ( localize(13543, "Port number must be ≥ 0 and < {0}.", maxPortNumber));
const requiresSudoString = ( localize(13544, "May Require Sudo"));
const alreadyForwarded = ( localize(13545, "Port is already forwarded"));
...
(function(ForwardPortAction) {
    ...
    ForwardPortAction.LABEL = ( localize2(13546, "Forward a Port"));
    ForwardPortAction.TREEITEM_LABEL = ( localize(13547, "Forward Port"));
    const forwardPrompt = ( localize(13548, "Port number or address (eg. 3000 or 10.10.10.10:2000)."));
    function validateInput(remoteExplorerService, tunnelService, value, canElevate) {
        const parsed = parseAddress(value);
        if (!parsed) {
            return {
                content: invalidPortString,
    ...
    function error(notificationService, tunnelOrError, host, port) {
        if (!tunnelOrError) {
            ...
            notificationService.warn(( localize(13550, "Unable to forward {0}:{1}. {2}", host, port, tunnelOrError)));
        }
    }
                ...
                onFinish: async (value, success) => {
                    ...
                    if (success && (parsed = parseAddress(value))) {
                        remoteExplorerService.forward({
                            ...
                            tunnelOrError => error(notificationService, tunnelOrError, parsed.host, parsed.port)
                        );
                    }
                },
    ...
    function commandPaletteHandler() {
        return async (accessor, arg) => {
            ...
            const value = await quickInputService.input({
                ...
                validateInput: value => Promise.resolve(
                    validateInput(remoteExplorerService, tunnelService, value, tunnelService.canElevate)
                )
            });
            let parsed;
...
(function(ClosePortAction) {
    ...
    ClosePortAction.LABEL = ( localize2(13552, "Stop Forwarding Port"));
    function inlineHandler() {
        return async (accessor, arg) => {
            ...
            return Promise.all(( ports.map(port => remoteExplorerService.close({
    ...
    function commandPaletteHandler() {
        return async accessor => {
            ...
            const result = await quickInputService.pick(picks, {
                placeHolder: ( localize(13553, "Choose a port to stop forwarding"))
            });
...
(function(OpenPortInBrowserAction) {
    ...
    OpenPortInBrowserAction.LABEL = ( localize(13554, "Open in Browser"));
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
...
(function(OpenPortInPreviewAction) {
    ...
    OpenPortInPreviewAction.LABEL = ( localize(13555, "Preview in Editor"));
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
    ...
    async function run(model, openerService, externalOpenerService, key) {
        ...
        if (tunnel) {
            ...
            const opener = await externalOpenerService.getOpener(tunnel.localUri, {
                sourceUri
            }, CancellationToken.None);
            if (opener) {
                return opener.openExternalUri(tunnel.localUri, {
                    sourceUri
                }, CancellationToken.None);
            }
            return openerService.open(tunnel.localUri);
...
(function(OpenPortInBrowserCommandPaletteAction) {
    ...
    OpenPortInBrowserCommandPaletteAction.LABEL = ( localize(13556, "Open Port in Browser"));
    function handler() {
        return async (accessor, arg) => {
            const remoteExplorerService = accessor.get(IRemoteExplorerService);
            const tunnelService = accessor.get(ITunnelService);
            ...
            if (options.length === 0) {
                options.push({
                    label: ( localize(13557, "No ports currently forwarded. Open the Ports view to get started."))
                });
            } else {
                options.push({
                    label: ( localize(13558, "Open the Ports view..."))
                });
            }
            const picked = await quickPickService.pick(options, {
                placeHolder: ( localize(13559, "Choose the port to open"))
            });
            if (picked && picked.tunnel) {
                return OpenPortInBrowserAction.run(
                    model,
                    openerService,
                    makeAddress(picked.tunnel.remoteHost, picked.tunnel.remotePort)
                );
            } else if (picked) {
...
(function(CopyAddressAction) {
    ...
    CopyAddressAction.INLINE_LABEL = ( localize(13560, "Copy Local Address"));
    CopyAddressAction.COMMANDPALETTE_LABEL = ( localize(13561, "Copy Forwarded Port Address"));
    ...
    function commandPaletteHandler() {
        return async (accessor, arg) => {
            ...
            const result = await quickInputService.pick(makeTunnelPicks(tunnels, remoteExplorerService, tunnelService), {
                placeHolder: ( localize(13562, "Choose a forwarded port"))
            });
            if (result && result.tunnel) {
...
(function(ChangeLocalPortAction) {
    ...
    ChangeLocalPortAction.LABEL = ( localize(13563, "Change Local Address Port"));
    function validateInput(tunnelService, value, canElevate) {
        if (!value.match(/^[0-9]+$/)) {
            return {
                content: ( localize(13564, "Local port should be a number.")),
                severity: Severity$1.Error
            };
        ...
        return async (accessor, arg) => {
            ...
            if (tunnelContext) {
                ...
                remoteExplorerService.setEditable(tunnelItem, TunnelEditId.LocalPort, {
                    ...
                    placeholder: ( localize(13566, "New local port"))
                });
            }
        };
    }
...
(function(SetTunnelProtocolAction) {
    ...
    SetTunnelProtocolAction.LABEL_HTTP = ( localize(13567, "HTTP"));
    SetTunnelProtocolAction.LABEL_HTTPS = ( localize(13568, "HTTPS"));
...
MenuRegistry.appendMenuItem(MenuId.TunnelContext, ({
    ...
    title: ( localize(13569, "Port Visibility")),
...
MenuRegistry.appendMenuItem(MenuId.TunnelContext, ({
    ...
    title: ( localize(13570, "Change Port Protocol")),
