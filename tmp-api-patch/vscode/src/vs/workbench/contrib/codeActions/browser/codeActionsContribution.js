...
const createCodeActionsAutoSave = description => {
    return {
        ...
        )), ( localize(9030, "Triggers Code Actions only when explicitly saved")), ( localize(9031, "Never triggers Code Actions on save")), ( localize(
            9032,
...
const createNotebookCodeActionsAutoSave = description => {
    return {
        ...
        enumDescriptions: [( localize(9034, "Triggers Code Actions only when explicitly saved.")), ( localize(9035, "Never triggers Code Actions on save.")), ( localize(
            9036,
            "Triggers Code Actions only when explicitly saved. This value will be deprecated in favor of \"explicit\"."
        )), ( localize(
            9037,
...
CodeActionsContribution = ( __decorate([( __param(0, IKeybindingService)), ( __param(1, ILanguageFeaturesService))], CodeActionsContribution));
