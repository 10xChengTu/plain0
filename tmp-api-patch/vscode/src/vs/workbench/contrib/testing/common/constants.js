...
const testStateNames = {
    [TestResultState.Errored]: ( localize(16131, "Errored")),
    [TestResultState.Failed]: ( localize(16132, "Failed")),
    [TestResultState.Passed]: ( localize(16133, "Passed")),
    [TestResultState.Queued]: ( localize(16134, "Queued")),
    [TestResultState.Running]: ( localize(16135, "Running")),
    [TestResultState.Skipped]: ( localize(16136, "Skipped")),
    [TestResultState.Unset]: ( localize(16137, "Not yet run"))
};
const labelForTestInState = (label, state) => ( localize(16138, "{0} ({1})", stripIcons(label), testStateNames[state]));
const testConfigurationGroupNames = {
    [TestRunProfileBitset.Debug]: ( localize(16139, "Debug")),
    [TestRunProfileBitset.Run]: ( localize(16140, "Run")),
    [TestRunProfileBitset.Coverage]: ( localize(16141, "Coverage"))
};
var TestCommandId;
