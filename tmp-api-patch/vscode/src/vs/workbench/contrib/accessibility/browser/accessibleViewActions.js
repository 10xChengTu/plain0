...
class AccessibleViewNextAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4745, "Show Next in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewNextCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4746, "Accessible View: Next Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4747, "Accessible View: Previous Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4748, "Show Previous in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewGoToSymbolAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4749, "Go To Symbol in Accessible View"))
        });
    }
    run(accessor) {
...
const AccessibilityHelpAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
        ...
        group: "",
        title: ( localize(4750, "Open Accessibility Help")),
        order: 1
    }]
})));
const AccessibleViewAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
        menuId: MenuId.CommandPalette,
        group: "",
        title: ( localize(4751, "Open Accessible View")),
        order: 1
    }]
})));
class AccessibleViewDisableHintAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4752, "Disable Accessible View Hint"))
        });
    }
    run(accessor) {
...
class AccessibilityHelpConfigureKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4753, "Accessibility Help Configure Unassigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpConfigureAssignedKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4754, "Accessibility Help Configure Assigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpOpenHelpLinkAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4755, "Accessibility Help Open Help Link"))
        });
    }
    run(accessor) {
    ...
    constructor() {
        super({
            ...
            keybinding: {
                ...
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.Slash
                },
                weight: KeybindingWeight.WorkbenchContrib
            },
            icon: Codicon.check,
            ...
            title: ( localize(4756, "Accept Inline Completion"))
        });
    }
    async run(accessor) {
