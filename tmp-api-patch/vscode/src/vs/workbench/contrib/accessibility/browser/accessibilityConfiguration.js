...
import { workbenchConfigurationNodeBase, Extensions as Extensions$1 } from '../../../common/configuration.js';
import { AccessibilitySignal } from '../../../../platform/accessibilitySignal/browser/accessibilitySignalService.js';
import { AccessibilityVoiceSettingId, SPEECH_LANGUAGES } from '../../speech/common/speechService.js';
...
const accessibleViewInCodeBlock = ( new RawContextKey("accessibleViewInCodeBlock", undefined, undefined));
const accessibleViewContainsCodeBlocks = ( new RawContextKey("accessibleViewContainsCodeBlocks", undefined, undefined));
const accessibleViewHasUnassignedKeybindings = ( new RawContextKey("accessibleViewHasUnassignedKeybindings", undefined, undefined));
const accessibleViewHasAssignedKeybindings = ( new RawContextKey("accessibleViewHasAssignedKeybindings", undefined, undefined));
...
(function(AccessibilityVerbositySettingId) {
    ...
    AccessibilityVerbositySettingId["SessionsChanges"] = "accessibility.verbosity.sessionsChanges";
    AccessibilityVerbositySettingId["ChatQuestionCarousel"] = "accessibility.verbosity.chatQuestionCarousel";
    AccessibilityVerbositySettingId["Survey"] = "accessibility.verbosity.survey";
    AccessibilityVerbositySettingId["Automations"] = "accessibility.verbosity.automations";
...
const accessibilityConfigurationNodeBase = ( Object.freeze({
    id: "accessibility",
    title: ( localize(4546, "Accessibility")),
    type: "object"
}));
const soundFeatureBase = {
    ...
    "enum": ["auto", "on", "off"],
    "default": "auto",
    "enumDescriptions": [( localize(4547, "Enable sound when a screen reader is attached.")), ( localize(4548, "Enable sound.")), ( localize(4549, "Disable sound."))],
    tags: ["accessibility"]
};
...
const announcementFeatureBase = {
    ...
    )), ( localize(4551, "Disable announcement."))],
    tags: ["accessibility"]
};
...
const configuration = {
    ...
    properties: {
        ...
        [AccessibilityVerbositySettingId.DiffEditorActive]: {
            description: ( localize(4565, "Indicate when a diff editor becomes the active editor.")),
            ...baseVerbosityProperty
        },
        ...
        "accessibility.signalOptions.volume": {
            "description": ( localize(4576, "The volume of the sounds in percent (0-100).")),
            "type": "number",
            "minimum": 0,
            "maximum": 100,
            "default": 70,
        ...
        "accessibility.signalOptions.debouncePositionChanges": {
            "description": ( localize(4577, "Whether or not position changes should be debounced")),
            "type": "boolean",
            "default": false,
            "tags": ["accessibility"]
        },
        "accessibility.signalOptions.experimental.delays.general": {
            ...
            "properties": {
                "announcement": {
                    "description": ( localize(4578, "The delay in milliseconds before an announcement is made.")),
                    "type": "number",
                    "minimum": 0,
                    "default": 3000
                },
                "sound": {
                    "description": ( localize(4579, "The delay in milliseconds before a sound is played.")),
                    "type": "number",
                    "minimum": 0,
                    "default": 400
                }
        ...
        "accessibility.signals.lineHasBreakpoint": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4585, "Plays a sound when the active line has a breakpoint.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4586, "Announces when the active line has a breakpoint.")),
        ...
        "accessibility.signals.lineHasInlineSuggestion": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4588, "Plays a sound when the active line has an inline suggestion.")),
                    ...soundFeatureBase,
                    "default": "off"
                }
            }
        ...
        "accessibility.signals.nextEditSuggestion": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4590, "Plays a sound when there is a next edit suggestion.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4591, "Announces when there is a next edit suggestion.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.lineHasError": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4593, "Plays a sound when the active line has an error.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4594, "Announces when the active line has an error.")),
                    ...announcementFeatureBase,
                    default: "off"
                }
            }
        ...
        "accessibility.signals.lineHasWarning": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4599, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4600, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: "off"
                }
            }
        ...
        "accessibility.signals.positionHasError": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4602, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4603, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: "on"
                }
            }
        ...
        "accessibility.signals.positionHasWarning": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4605, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4606, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: "on"
                }
            }
        ...
        "accessibility.signals.onDebugBreak": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4608, "Plays a sound when the debugger stopped on a breakpoint.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4609, "Announces when the debugger stopped on a breakpoint.")),
                    ...announcementFeatureBase
                }
            }
        },
        ...
        "accessibility.signals.taskCompleted": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4614, "Plays a sound when a task is completed.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4615, "Announces when a task is completed.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.taskFailed": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4617, "Plays a sound when a task fails (non-zero exit code).")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4618, "Announces when a task fails (non-zero exit code).")),
                    ...announcementFeatureBase
                }
            }
        },
        ...
        "accessibility.signals.terminalQuickFix": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4626, "Plays a sound when terminal Quick Fixes are available.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4627, "Announces when terminal Quick Fixes are available.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.terminalBell": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4629, "Plays a sound when the terminal bell is ringing.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4630, "Announces when the terminal bell is ringing.")),
                    ...announcementFeatureBase
                }
            }
        },
        ...
        "accessibility.signals.chatEditModifiedFile": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4638, "Plays a sound when revealing a file with changes from chat edits")),
                    ...soundFeatureBase
                }
            }
        },
        ...
        "accessibility.signals.notebookCellFailed": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4643, "Plays a sound when a notebook cell execution fails.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4644, "Announces when a notebook cell execution fails.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.progress": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4646, "Plays a sound on loop while progress is occurring.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4647, "Alerts on loop while progress is occurring.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.chatRequestSent": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4649, "Plays a sound when a chat request is made.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4650, "Announces when a chat request is made.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.chatResponseReceived": {
            ...defaultNoAnnouncement,
            "description": ( localize(4651, "Plays a sound / audio cue when the response has been received.")),
            "properties": {
                "sound": {
                    "description": ( localize(4652, "Plays a sound on when the response has been received.")),
                    ...soundFeatureBase
                }
            }
        },
        "accessibility.signals.codeActionTriggered": {
            ...defaultNoAnnouncement,
            "description": ( localize(4653, "Plays a sound / audio cue - when a code action has been triggered.")),
            "properties": {
                "sound": {
                    "description": ( localize(4654, "Plays a sound when a code action has been triggered.")),
                    ...soundFeatureBase
                }
            }
        },
        "accessibility.signals.codeActionApplied": {
            ...defaultNoAnnouncement,
            "description": ( localize(4655, "Plays a sound / audio cue when the code action has been applied.")),
            "properties": {
                "sound": {
                    "description": ( localize(4656, "Plays a sound when the code action has been applied.")),
                    ...soundFeatureBase
                }
            }
        },
        "accessibility.signals.voiceRecordingStarted": {
            ...defaultNoAnnouncement,
            "description": ( localize(4657, "Plays a sound / audio cue when the voice recording has started.")),
            "properties": {
                "sound": {
                    "description": ( localize(4658, "Plays a sound when the voice recording has started.")),
                    ...soundFeatureBase
                }
            },
            "default": {
        ...
        "accessibility.signals.voiceRecordingStopped": {
            ...defaultNoAnnouncement,
            "description": ( localize(4659, "Plays a sound / audio cue when the voice recording has stopped.")),
            "properties": {
                "sound": {
                    "description": ( localize(4660, "Plays a sound when the voice recording has stopped.")),
                    ...soundFeatureBase,
                    default: "off"
                }
            }
        ...
        "accessibility.signals.clear": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4662, "Plays a sound when a feature is cleared.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4663, "Announces when a feature is cleared.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.editsUndone": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4665, "Plays a sound when edits have been undone.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4666, "Announces when edits have been undone.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.editsKept": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4668, "Plays a sound when edits are kept.")),
                    ...soundFeatureBase
                },
                "announcement": {
                    "description": ( localize(4669, "Announces when edits are kept.")),
                    ...announcementFeatureBase
                }
            }
        },
        "accessibility.signals.save": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4671, "Plays a sound when a file is saved.")),
                    "type": "string",
                    "enum": ["userGesture", "always", "never"],
                    "default": "never",
                    "enumDescriptions": [( localize(4672, "Plays the sound when a user explicitly saves a file.")), ( localize(4673, "Plays the sound whenever a file is saved, including auto save.")), ( localize(4674, "Never plays the sound."))]
                },
                "announcement": {
                    "description": ( localize(4675, "Announces when a file is saved.")),
                    "type": "string",
                    "enum": ["userGesture", "always", "never"],
                    "default": "never",
                    "enumDescriptions": [( localize(4676, "Announces when a user explicitly saves a file.")), ( localize(4677, "Announces whenever a file is saved, including auto save.")), ( localize(4678, "Never plays the announcement."))]
                }
            },
            default: {
                "sound": "never",
        ...
        "accessibility.signals.format": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4680, "Plays a sound when a file or notebook is formatted.")),
                    "type": "string",
                    "enum": ["userGesture", "always", "never"],
                    "default": "never",
                    "enumDescriptions": [( localize(4681, "Plays the sound when a user explicitly formats a file.")), ( localize(
                        4682,
                        "Plays the sound whenever a file is formatted, including if it is set to format on save, type, or, paste, or run of a cell."
                    )), ( localize(4683, "Never plays the sound."))]
                },
                "announcement": {
                    "description": ( localize(4684, "Announces when a file or notebook is formatted.")),
                    "type": "string",
                    "enum": ["userGesture", "always", "never"],
                    "default": "never",
                    "enumDescriptions": [( localize(4685, "Announces when a user explicitly formats a file.")), ( localize(
                        4686,
                        "Announces whenever a file is formatted, including if it is set to format on save, type, or, paste, or run of a cell."
                    )), ( localize(4687, "Never announces."))]
                }
            },
            default: {
                "sound": "never",
        ...
        "accessibility.signals.chatUserActionRequired": {
            ...
            "properties": {
                "sound": {
                    "description": ( localize(4689, "Plays a sound when user action is required in the chat.")),
                    "type": "string",
                    "enum": ["auto", "on", "off"],
                    "enumDescriptions": [( localize(4690, "Enable sound when a screen reader is attached.")), ( localize(4548, "Enable sound.")), ( localize(4549, "Disable sound."))]
                },
                "announcement": {
                    "description": ( localize(
                        4691,
        ...
        "accessibility.underlineLinks": {
            "type": "boolean",
            "description": ( localize(4692, "Controls whether links should be underlined in the workbench.")),
            "default": false
        },
    ...
    registry.registerConfiguration({
        ...
        properties: {
            ...
            [AccessibilityWorkbenchSettingId.HideAccessibleView]: {
                description: ( localize(4701, "Controls whether the Accessible View is hidden.")),
                type: "boolean",
                default: false,
                tags: ["accessibility"]
            },
...
let DynamicSpeechAccessibilityConfiguration = class DynamicSpeechAccessibilityConfiguration extends Disposable {
        ...
        registry.registerConfiguration({
            ...
            properties: {
                ...
                [AccessibilityVoiceSettingId.IgnoreCodeBlocks]: {
                    "markdownDescription": ( localize(4704, "Whether to ignore code snippets in text-to-speech synthesis.")),
                    "type": "boolean",
                    "default": false,
                    "tags": ["accessibility"]
                },
                ...
                [AccessibilityVoiceSettingId.AutoSynthesize]: {
                    ...
                    )), ( localize(4707, "Disable the feature."))],
                    "markdownDescription": ( localize(
                        4708,
    ...
    getLanguages() {
        return {
            ["auto"]: {
                name: ( localize(4709, "Auto (Use Display Language)"))
            },
            ...SPEECH_LANGUAGES
        };
    }
};
DynamicSpeechAccessibilityConfiguration = ( __decorate([( __param(0, ISpeechService))], DynamicSpeechAccessibilityConfiguration));
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations([{
    key: "audioCues.volume",
    migrateFn: (value, accessor) => {
        return [["accessibility.signalOptions.volume", {
            value
        }], ["audioCues.volume", {
            value: undefined
        }]];
...
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations([{
    ...
    migrateFn: value => {
        return [["accessibility.signalOptions.debouncePositionChanges", {
            value
...
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations([{
    ...
    migrateFn: (value, accessor) => {
        ...
        const result = [];
        if (!!volume) {
            result.push(["accessibility.signalOptions.volume", {
                value: volume
            }]);
        }
        if (!!delayGeneral) {
            result.push(["accessibility.signalOptions.experimental.delays.general", {
                value: delayGeneral
            }]);
        }
        if (!!delayError) {
            result.push(["accessibility.signalOptions.experimental.delays.errorAtPosition", {
                value: delayError
            }]);
        }
        if (!!delayWarning) {
            result.push(["accessibility.signalOptions.experimental.delays.warningAtPosition", {
                value: delayWarning
            }]);
        }
        if (!!debouncePositionChanges) {
            result.push(["accessibility.signalOptions.debouncePositionChanges", {
                value: debouncePositionChanges
            }]);
        }
        result.push(["accessibility.signalOptions", {
            value: undefined
        }]);
        return result;
    }
...
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations([{
    ...
    migrateFn: value => {
        ...
        return [[AccessibilityVoiceSettingId.AutoSynthesize, {
            value: newValue
        }]];
    }
}]);
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations([{
    ...
    migrateFn: (value, accessor) => {
        return [["accessibility.signals.progress", {
            value
...
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations(( AccessibilitySignal.allAccessibilitySignals.map(item => item.legacySoundSettingsKey ? ({
    ...
    migrateFn: (sound, accessor) => {
        ...
        configurationKeyValuePairs.push([`${item.legacySoundSettingsKey}`, {
            value: undefined
        }]);
        configurationKeyValuePairs.push([`${item.settingsKey}`, {
...
( Registry.as(Extensions$1.ConfigurationMigration)).registerConfigurationMigrations(( AccessibilitySignal.allAccessibilitySignals.filter(i => !!i.legacyAnnouncementSettingsKey && !!i.legacySoundSettingsKey).map(item => ({
    ...
    migrateFn: (announcement, accessor) => {
        ...
        configurationKeyValuePairs.push([`${item.legacyAnnouncementSettingsKey}`, {
            value: undefined
        }]);
        configurationKeyValuePairs.push([`${item.legacySoundSettingsKey}`, {
            value: undefined
...
export { AccessibilityVerbositySettingId, AccessibilityVoiceSettingId, AccessibilityWorkbenchSettingId, DynamicSpeechAccessibilityConfiguration, SpeechTimeoutDefault, ViewDimUnfocusedOpacityProperties, accessibilityConfigurationNodeBase, accessibilityHelpIsShown, accessibleViewContainsCodeBlocks, accessibleViewCurrentProviderId, accessibleViewGoToSymbolSupported, accessibleViewHasAssignedKeybindings, accessibleViewHasUnassignedKeybindings, accessibleViewInCodeBlock, accessibleViewIsShown, accessibleViewOnLastLine, accessibleViewSupportsNavigation, accessibleViewVerbosityEnabled, announcementFeatureBase, registerAccessibilityConfiguration, soundFeatureBase };
