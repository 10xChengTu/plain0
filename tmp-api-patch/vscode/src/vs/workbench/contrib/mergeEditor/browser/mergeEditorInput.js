...
let MergeEditorInput = class MergeEditorInput extends AbstractTextResourceEditorInput {
    ...
    getName() {
        return localize(12237, "Merging: {0}", super.getName());
    }
    async resolve() {
        if (!this._inputModel) {
    ...
    matches(otherInput) {
        ...
        if (isResourceMergeEditorInput(otherInput)) {
            return (this.editorId === otherInput.options?.override || otherInput.options?.override === undefined) && isEqual(this.base, otherInput.base.resource) && isEqual(this.input1.uri, otherInput.input1.resource) && isEqual(this.input2.uri, otherInput.input2.resource) && isEqual(this.result, otherInput.result.resource);
        }
        return false;
    }
...
MergeEditorInput = MergeEditorInput_1 = ( __decorate([( __param(4, IInstantiationService)), ( __param(5, IEditorService)), ( __param(6, ITextFileService)), ( __param(7, ILabelService)), ( __param(8, IFileService)), ( __param(9, IConfigurationService)), ( __param(10, IFilesConfigurationService)), ( __param(11, ITextResourceConfigurationService)), ( __param(12, ICustomEditorLabelService)), ( __param(13, ILogService))], MergeEditorInput));
