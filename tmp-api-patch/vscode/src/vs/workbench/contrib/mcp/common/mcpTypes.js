...
(function(McpCollectionDefinition) {
    function equals$1(a, b) {
        return a.id === b.id && a.remoteAuthority === b.remoteAuthority && a.label === b.label && a.trustBehavior === b.trustBehavior && equals(a.sandbox, b.sandbox);
    }
    McpCollectionDefinition.equals = equals$1;
    ...
    McpCollectionDefinition.isWorkspaceDiscovered = isWorkspaceDiscovered;
    function isVscodeMcpJson(collection) {
        return collection.id.startsWith(
            `${MCP_CONFIGURATION_COLLECTION_ID_PREFIX}${WORKSPACE_FOLDER_CONFIG_ID_PREFIX}`
        );
    }
    McpCollectionDefinition.isVscodeMcpJson = isVscodeMcpJson;
...
(function(McpServerDefinition) {
    ...
    function equals$2(a, b) {
        return a.id === b.id && a.label === b.label && a.cacheNonce === b.cacheNonce && equals$1(a.roots, b.roots, (a, b) => ( a.toString()) === ( b.toString())) && equals(a.launch, b.launch) && equals(a.presentation, b.presentation) && equals(a.variableReplacement, b.variableReplacement) && equals(a.devMode, b.devMode) && a.sandboxEnabled === b.sandboxEnabled;
    }
...
(function(McpConnectionState) {
    ...
    McpConnectionState.toString = s => {
        ...
        case Kind.Starting:
            return localize(12187, "Starting");
        case Kind.Running:
            return localize(12188, "Running");
        case Kind.Error:
            return localize(12189, "Error {0}", s.message);
        default:
            assertNever();
        }
    };
...
McpServerContainers = ( __decorate([( __param(1, IMcpWorkbenchService))], McpServerContainers));
...
export { ElicitationKind, HasInstalledMcpServersContext, IAutostartResult, InstalledMcpServersViewId, LazyCollectionState, MCP_CONFIGURATION_COLLECTION_ID_PREFIX, McpCapability, McpCollectionDefinition, McpCollectionSortOrder, McpConnectionFailedError, McpConnectionState, McpError, McpResourceURI, McpServerCacheState, McpServerContainers, McpServerDefinition, McpServerDefinitionVariableReplacement, McpServerEditorTab, McpServerEnablementState, McpServerInstallState, McpServerLaunch, McpServerStaticToolAvailability, McpServerTransportType, McpServerTrust, McpServersGalleryStatusContext, McpStartServerInteraction, McpToolName, McpToolResourceLinkMimeType, McpToolVisibility, MpcResponseError, UserInteractionRequiredError, extensionMcpCollectionPrefix, extensionPrefixedIdentifier, isMcpResourceTemplate, mcpOAuthClientSecretStorageKey, mcpPromptPrefix, mcpPromptReplaceSpecialChars };
