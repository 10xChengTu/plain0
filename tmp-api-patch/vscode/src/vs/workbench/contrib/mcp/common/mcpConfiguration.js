...
const discoverySourceLabel = {
    [DiscoverySource.ClaudeDesktop]: ( localize(12089, "Claude Desktop")),
    [DiscoverySource.Windsurf]: ( localize(12090, "Windsurf")),
    [DiscoverySource.CursorGlobal]: ( localize(12091, "Cursor (Global)")),
    [DiscoverySource.CursorWorkspace]: ( localize(12092, "Cursor (Workspace)"))
};
const discoverySourceSettingsLabel = {
    [DiscoverySource.ClaudeDesktop]: ( localize(12093, "Claude Desktop configuration (`claude_desktop_config.json`)")),
    [DiscoverySource.Windsurf]: ( localize(12094, "Windsurf configurations (`~/.codeium/windsurf/mcp_config.json`)")),
    [DiscoverySource.CursorGlobal]: ( localize(12095, "Cursor global configuration (`~/.cursor/mcp.json`)")),
    [DiscoverySource.CursorWorkspace]: ( localize(12096, "Cursor workspace configuration (`.cursor/mcp.json`)"))
};
...
var McpCollisionBehavior;
(function(McpCollisionBehavior) {
    McpCollisionBehavior["Disable"] = "disable";
    McpCollisionBehavior["Suffix"] = "suffix";
})(McpCollisionBehavior || (McpCollisionBehavior = {}));
                    ...
                    oneOf: [{
                        ...
                        properties: {
                            type: {
                                type: "string",
                                enum: ["node"],
                                description: ( localize(12100, "Debug the MCP server using Node.js."))
                            }
                        },
                        ...
                        properties: {
                            type: {
                                type: "string",
                                enum: ["debugpy"],
                                description: ( localize(12101, "Debug the MCP server using Python and debugpy."))
                            },
                            debugpyPath: {
                                type: "string",
                                description: ( localize(12102, "Path to the debugpy executable."))
                            }
                        },
                        additionalProperties: false
                    }]
...
const mcpStdioServerSchema = {
    ...
    properties: {
        type: {
            type: "string",
            enum: ["stdio"],
            description: ( localize(12103, "The type of the server."))
        },
        sandboxEnabled: {
            type: "boolean",
            default: false,
            description: ( localize(12104, "Whether to run the server in a sandboxed environment."))
        },
        command: {
            type: "string",
            description: ( localize(12105, "The command to run the server."))
        },
        cwd: {
            type: "string",
            description: ( localize(
        ...
        args: {
            type: "array",
            description: ( localize(12107, "Arguments passed to the server.")),
            items: {
                type: "string"
            }
        },
        envFile: {
            type: "string",
            description: ( localize(12108, "Path to a file containing environment variables for the server.")),
            examples: ["${workspaceFolder}/.env"]
        },
        env: {
            description: ( localize(12109, "Environment variables passed to the server.")),
...
const mcpServerSchema = {
    id: mcpSchemaId,
    type: "object",
    title: ( localize(12110, "Model Context Protocol Servers")),
    ...
    properties: {
        sandbox: {
            ...
            properties: {
                network: {
                    description: ( localize(12112, "Network access settings for the sandboxed server.")),
                    type: "object",
                    additionalProperties: false,
                    properties: {
                        allowedDomains: {
                ...
                oneOf: [mcpStdioServerSchema, {
                    ...
                    properties: {
                        ...
                        url: {
                            ...
                            format: "uri",
                            pattern: "^https?:\\/\\/.+",
                            patternErrorMessage: ( localize(12119, "The URL must start with 'http://' or 'https://'.")),
                            description: ( localize(12120, "The URL of the Streamable HTTP or SSE endpoint."))
                        },
                        headers: {
                            type: "object",
                            description: ( localize(12121, "Additional headers sent to the server.")),
                            additionalProperties: {
                                type: "string"
                            }
                        },
                        oauth: {
                            type: "object",
                            description: ( localize(12122, "OAuth configuration for authenticating with the server.")),
                            additionalProperties: false,
                            minProperties: 1,
                            properties: {
                                clientId: {
...
const mcpContributionPoint = {
    ...
    jsonSchema: {
        ...
        items: {
            ...
            properties: {
                id: {
                    description: ( localize(12126, "Unique ID for the collection.")),
                    type: "string"
                },
                label: {
                    description: ( localize(12127, "Display name for the collection.")),
                    type: "string"
                },
                when: {
                    description: ( localize(12128, "Condition which must be true to enable this collection.")),
                    type: "string"
                }
            }
        }
...
class McpServerDefinitionsProviderRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [( localize(12129, "ID")), ( localize(12130, "Name"))];
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    ...
    label: ( localize(12131, "MCP Servers")),
    access: {
        canToggle: false
    },
...
export { DiscoverySource, McpCollisionBehavior, allDiscoverySources, discoverySourceLabel, discoverySourceSettingsLabel, mcpActivationEvent, mcpConfigurationSection, mcpContributionPoint, mcpDiscoverySection, mcpEnterpriseManagedAuthIdpSection, mcpSchemaExampleServers, mcpServerCollisionBehaviorSection, mcpServerSamplingSection, mcpServerSchema, mcpStdioServerSchema };
