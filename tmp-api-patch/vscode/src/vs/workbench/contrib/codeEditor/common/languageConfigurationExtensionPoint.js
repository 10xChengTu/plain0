...
let LanguageConfigurationFileHandler = LanguageConfigurationFileHandler_1 = class LanguageConfigurationFileHandler extends Disposable {
    constructor(
        ...
        this._done = ( new Map());
        this._register(
            this._languageService.onDidRequestBasicLanguageFeatures(async languageIdentifier => {
        ...
        if (typeof source.lineComment !== "undefined") {
            if (typeof source.lineComment === "string") {
                ...
                if (typeof lineCommentObj.comment === "string") {
                    ...
                    console.warn(
                        `[${languageId}]: language configuration: expected \`comments.lineComment.comment\` to be a string.`
                    );
                }
            } else {
                console.warn(
                    `[${languageId}]: language configuration: expected \`comments.lineComment\` to be a string or an object with comment property.`
                );
            }
        }
...
LanguageConfigurationFileHandler = LanguageConfigurationFileHandler_1 = ( __decorate([( __param(0, ILanguageService)), ( __param(1, IExtensionResourceLoaderService)), ( __param(2, IExtensionService)), ( __param(3, ILanguageConfigurationService))], LanguageConfigurationFileHandler));
...
const schema = {
    ...
    definitions: {
        openBracket: {
            type: "string",
            description: ( localize(9128, "The opening bracket character or string sequence."))
        },
        closeBracket: {
            type: "string",
            description: ( localize(9129, "The closing bracket character or string sequence."))
        },
        bracketPair: {
            type: "array",
            items: [{
    ...
    properties: {
        comments: {
            ...
            description: ( localize(9130, "Defines the comment symbols")),
            type: "object",
            properties: {
                blockComment: {
                    type: "array",
                    description: ( localize(9131, "Defines how block comments are marked.")),
                    items: [{
                        type: "string",
                        description: ( localize(9132, "The character sequence that starts a block comment."))
                    }, {
                        type: "string",
                        description: ( localize(9133, "The character sequence that ends a block comment."))
                    }]
                },
                lineComment: {
                    type: "object",
                    description: ( localize(9134, "Configuration for line comments.")),
                    properties: {
                        comment: {
                            type: "string",
                            description: ( localize(9135, "The character sequence that starts a line comment."))
                        },
                        noIndent: {
                            type: "boolean",
            ...
            items: {
                oneOf: [{
                    ...
                    properties: {
                        ...
                        notIn: {
                            type: "array",
                            description: ( localize(9140, "Defines a list of scopes where the auto pairs are disabled.")),
                            items: {
                                enum: ["string", "comment"]
                            }
                        }
        ...
        wordPattern: {
            ...
            properties: {
                pattern: {
                    type: "string",
                    description: ( localize(9144, "The RegExp pattern used to match words.")),
                    default: ""
                },
                flags: {
                    type: "string",
                    description: ( localize(9145, "The RegExp flags used to match words.")),
                    default: "g",
                    pattern: "^([gimuy]+)$",
                    patternErrorMessage: ( localize(9146, "Must match the pattern `/^([gimuy]+)$/`."))
                }
            }
        },
        indentationRules: {
            ...
            description: ( localize(9147, "The language's indentation settings.")),
            type: "object",
            properties: {
                increaseIndentPattern: {
                    type: ["string", "object"],
                    ...
                    properties: {
                        pattern: {
                            type: "string",
                            description: ( localize(9149, "The RegExp pattern for increaseIndentPattern.")),
                            default: ""
                        },
                        flags: {
                            type: "string",
                            description: ( localize(9150, "The RegExp flags for increaseIndentPattern.")),
                            default: "",
                            pattern: "^([gimuy]+)$",
                            patternErrorMessage: ( localize(9151, "Must match the pattern `/^([gimuy]+)$/`."))
                        }
                    }
                },
                decreaseIndentPattern: {
                    ...
                    properties: {
                        pattern: {
                            type: "string",
                            description: ( localize(9153, "The RegExp pattern for decreaseIndentPattern.")),
                            default: ""
                        },
                        flags: {
                            type: "string",
                            description: ( localize(9154, "The RegExp flags for decreaseIndentPattern.")),
                            default: "",
                            pattern: "^([gimuy]+)$",
                            patternErrorMessage: ( localize(9155, "Must match the pattern `/^([gimuy]+)$/`."))
                        }
                    }
                },
                indentNextLinePattern: {
                    ...
                    properties: {
                        pattern: {
                            type: "string",
                            description: ( localize(9157, "The RegExp pattern for indentNextLinePattern.")),
                            default: ""
                        },
                        flags: {
                            type: "string",
                            description: ( localize(9158, "The RegExp flags for indentNextLinePattern.")),
                            default: "",
                            pattern: "^([gimuy]+)$",
                            patternErrorMessage: ( localize(9159, "Must match the pattern `/^([gimuy]+)$/`."))
                        }
                    }
                },
                unIndentedLinePattern: {
                    ...
                    properties: {
                        pattern: {
                            type: "string",
                            description: ( localize(9161, "The RegExp pattern for unIndentedLinePattern.")),
                            default: ""
                        },
                        flags: {
                            type: "string",
                            description: ( localize(9162, "The RegExp flags for unIndentedLinePattern.")),
                            default: "",
                            pattern: "^([gimuy]+)$",
                            patternErrorMessage: ( localize(9163, "Must match the pattern `/^([gimuy]+)$/`."))
                        }
                    }
                }
            }
        ...
        folding: {
            type: "object",
            description: ( localize(9164, "The language's folding settings.")),
            properties: {
                offSide: {
                    type: "boolean",
                    description: ( localize(
                    ...
                    properties: {
                        start: {
                            ...
                            properties: {
                                pattern: {
                                    type: "string",
                                    description: ( localize(9168, "The RegExp pattern for the start marker.")),
                                    default: ""
                                },
                                flags: {
                                    type: "string",
                                    description: ( localize(9169, "The RegExp flags for the start marker.")),
                                    default: "",
                                    pattern: "^([gimuy]+)$",
                                    patternErrorMessage: ( localize(9170, "Must match the pattern `/^([gimuy]+)$/`."))
                                }
                            }
                        },
                        end: {
                            ...
                            properties: {
                                pattern: {
                                    type: "string",
                                    description: ( localize(9172, "The RegExp pattern for the end marker.")),
                                    default: ""
                                },
                                flags: {
                                    type: "string",
                                    description: ( localize(9173, "The RegExp flags for the end marker.")),
                                    default: "",
                                    pattern: "^([gimuy]+)$",
                                    patternErrorMessage: ( localize(9174, "Must match the pattern `/^([gimuy]+)$/`."))
                                }
                            }
                        }
                    }
        ...
        onEnterRules: {
            type: "array",
            description: ( localize(9175, "The language's rules to be evaluated when pressing Enter.")),
            items: {
                type: "object",
                description: ( localize(9175, "The language's rules to be evaluated when pressing Enter.")),
                ...
                properties: {
                    beforeText: {
                        ...
                        properties: {
                            pattern: {
                                type: "string",
                                description: ( localize(9177, "The RegExp pattern for beforeText.")),
                                default: ""
                            },
                            flags: {
                                type: "string",
                                description: ( localize(9178, "The RegExp flags for beforeText.")),
                                default: "",
                                pattern: "^([gimuy]+)$",
                                patternErrorMessage: ( localize(9179, "Must match the pattern `/^([gimuy]+)$/`."))
                            }
                        }
                    },
                    afterText: {
                        ...
                        properties: {
                            pattern: {
                                type: "string",
                                description: ( localize(9181, "The RegExp pattern for afterText.")),
                                default: ""
                            },
                            flags: {
                                type: "string",
                                description: ( localize(9182, "The RegExp flags for afterText.")),
                                default: "",
                                pattern: "^([gimuy]+)$",
                                patternErrorMessage: ( localize(9183, "Must match the pattern `/^([gimuy]+)$/`."))
                            }
                        }
                    },
                    previousLineText: {
                        ...
                        properties: {
                            pattern: {
                                type: "string",
                                description: ( localize(9185, "The RegExp pattern for previousLineText.")),
                                default: ""
                            },
                            flags: {
                                type: "string",
                                description: ( localize(9186, "The RegExp flags for previousLineText.")),
                                default: "",
                                pattern: "^([gimuy]+)$",
                                patternErrorMessage: ( localize(9187, "Must match the pattern `/^([gimuy]+)$/`."))
                            }
                        }
                    },
                    action: {
                        type: ["string", "object"],
                        description: ( localize(9188, "The action to execute.")),
                        required: ["indent"],
                        default: {
                            "indent": "indent"
                        },
                        properties: {
                            indent: {
                                type: "string",
                                description: ( localize(9189, "Describe what to do with the indentation")),
                                default: "indent",
                                enum: ["none", "indent", "indentOutdent", "outdent"],
                                markdownEnumDescriptions: [( localize(9190, "Insert new line and copy the previous line's indentation.")), ( localize(
                                    9191,
...
LanguageConfigurationWorkbenchContribution = ( __decorate([( __param(0, IInstantiationService))], LanguageConfigurationWorkbenchContribution));
registerWorkbenchContribution2(
    LanguageConfigurationWorkbenchContribution.ID,
