    ...
    _update() {
        ...
        if (model.isTooLargeForTokenization()) {
            ...
            this._notificationService.prompt(Severity$1.Info, message, [{
                label: ( localize(9079, "Forcefully Enable Features")),
                run: () => {
                    this._configurationService.updateValue(`editor.largeFileOptimizations`, false).then(() => {
                        this._notificationService.info(( localize(9080, "Please reopen file in order for this setting to take effect.")));
                    }, err => {
