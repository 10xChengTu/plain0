...
TrimWhitespaceParticipant = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, ICodeEditorService))], TrimWhitespaceParticipant));
...
FinalNewLineParticipant = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, ICodeEditorService))], FinalNewLineParticipant));
...
TrimFinalNewLinesParticipant = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, ICodeEditorService))], TrimFinalNewLinesParticipant));
...
FormatOnSaveParticipant = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, ICodeEditorService)), ( __param(2, IInstantiationService))], FormatOnSaveParticipant));
let CodeActionOnSaveParticipant = class CodeActionOnSaveParticipant extends Disposable {
    ...
    async participate(model, context, progress, token) {
        ...
        progress.report({
            message: ( localize(9098, "Quick Fixes"))
        });
        ...
        for (const codeActionKind of codeActionsOnSave) {
            ...
            try {
                for (const action of actionsToRun.validActions) {
                    progress.report({
                        message: ( localize(9100, "Applying code action '{0}'.", action.action.title))
                    });
...
CodeActionOnSaveParticipant = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IInstantiationService)), ( __param(2, ILanguageFeaturesService)), ( __param(3, IHostService)), ( __param(4, IEditorService)), ( __param(5, ICodeEditorService))], CodeActionOnSaveParticipant));
let SaveParticipantsContribution = class SaveParticipantsContribution extends Disposable {
    ...
    registerSaveParticipants() {
        ...
        this._register(
            this.textFileService.files.addSaveParticipant(this.instantiationService.createInstance(CodeActionOnSaveParticipant))
        );
        this._register(
        ...
        this._register(
            this.textFileService.files.addSaveParticipant(this.instantiationService.createInstance(TrimFinalNewLinesParticipant))
        );
    }
};
SaveParticipantsContribution = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, ITextFileService))], SaveParticipantsContribution));
