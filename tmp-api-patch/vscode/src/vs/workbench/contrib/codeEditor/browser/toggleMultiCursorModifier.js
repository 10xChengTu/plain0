...
class ToggleMultiCursorModifierAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9103, "Toggle Multi-Cursor Modifier")),
            f1: true
        });
    }
    run(accessor) {
...
MultiCursorModifierContextKeyController = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IContextKeyService))], MultiCursorModifierContextKeyController));
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: ( localize(9104, "Switch to Alt+Click for Multi-Cursor"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: (isMacintosh ? ( localize(9105, "Switch to Cmd+Click for Multi-Cursor")) : ( localize(9106, "Switch to Ctrl+Click for Multi-Cursor")))
    },
