                ...
                symbolPick.attach = () => {
                    ...
                    const entry = {
                        ...
                        id: JSON.stringify({
                            ...
                            range: symbolPick.range.decoration
                        }),
        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(9091, "No matching entries"));
                    picker.items = [{
                        label,
                        index: -1,
...
GotoSymbolQuickAccessProvider = GotoSymbolQuickAccessProvider_1 = ( __decorate([( __param(0, IEditorService)), ( __param(1, IConfigurationService)), ( __param(2, ILanguageFeaturesService)), ( __param(3, IOutlineService)), ( __param(4, IOutlineModelService)), ( __param(5, IChatWidgetService))], GotoSymbolQuickAccessProvider));
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(9092, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(9093, "Go to &&Symbol in Editor..."))
            },
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(9094, "Type the name of a symbol to go to.")),
    helpEntries: [{
        description: ( localize(9095, "Go to Symbol in Editor")),
        prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
        commandId: GotoSymbolAction.ID,
        commandCenterOrder: 40
    }, {
        description: ( localize(9096, "Go to Symbol in Editor by Category")),
