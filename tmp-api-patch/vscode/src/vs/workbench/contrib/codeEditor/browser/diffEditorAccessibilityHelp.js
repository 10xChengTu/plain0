...
class DiffEditorAccessibilityHelp {
    ...
    getProvider(accessor) {
        ...
        const content = [( localize(9053, "You are in a diff editor.")), ( localize(
            9054,
        ...
        )), switchSides, diffEditorActiveAnnouncement, ( localize(
            9055,
        ...
        return ( new AccessibleContentProvider(AccessibleViewProviderId.DiffEditor, {
