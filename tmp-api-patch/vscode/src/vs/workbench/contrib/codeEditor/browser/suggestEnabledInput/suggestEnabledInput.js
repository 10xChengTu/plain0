...
let SuggestEnabledInput = class SuggestEnabledInput extends Widget {
    constructor(
        ...
        this.inputWidget = this._register(
            instantiationService.createInstance(CodeEditorWidget, this.stylingContainer, editorOptions, {
        ...
        this._register(Event.chain(this.inputWidget.onKeyDown, $ => $.filter(
...
SuggestEnabledInput = ( __decorate([( __param(6, IInstantiationService)), ( __param(7, IModelService)), ( __param(8, IContextKeyService)), ( __param(9, ILanguageFeaturesService)), ( __param(10, IConfigurationService))], SuggestEnabledInput));
...
SuggestEnabledInputWithHistory = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IModelService)), ( __param(3, IContextKeyService)), ( __param(4, ILanguageFeaturesService)), ( __param(5, IConfigurationService))], SuggestEnabledInputWithHistory));
let ContextScopedSuggestEnabledInputWithHistory = class ContextScopedSuggestEnabledInputWithHistory extends SuggestEnabledInputWithHistory {
    constructor(
        ...
        this._register(this.inputWidget.onDidChangeCursorPosition((
            {
                position
            }
        ) => {
...
ContextScopedSuggestEnabledInputWithHistory = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IModelService)), ( __param(3, IContextKeyService)), ( __param(4, ILanguageFeaturesService)), ( __param(5, IConfigurationService))], ContextScopedSuggestEnabledInputWithHistory));
