...
const EDITOR_WORD_WRAP = ( new RawContextKey("editorWordWrap", false, ( localize(9121, "Whether the editor is currently using word wrapping."))));
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(9122, "View: Toggle Word Wrap")),
...
ToggleWordWrapController = ( __decorate([( __param(1, IContextKeyService)), ( __param(2, ICodeEditorService))], ToggleWordWrapController));
...
DiffToggleWordWrapController = ( __decorate([( __param(1, ICodeEditorService))], DiffToggleWordWrapController));
...
EditorWordWrapContextKeyTracker = ( __decorate([( __param(0, IEditorService)), ( __param(1, ICodeEditorService)), ( __param(2, IContextKeyService))], EditorWordWrapContextKeyTracker));
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(9123, "Disable wrapping for this file")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(9124, "Enable wrapping for this file")),
        icon: Codicon.wordWrap
    },
    group: "navigation",
    order: 1,
