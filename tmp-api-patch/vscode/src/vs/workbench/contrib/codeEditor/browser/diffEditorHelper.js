            ...
            this._register(autorunWithStore((reader, store) => {
                if (onlyWhiteSpaceChange.read(reader)) {
                    const helperWidget = store.add(this._instantiationService.createInstance(
                        ...
                        ( localize(9056, "Show Whitespace Differences")),
                        null
                    ));
            ...
            this._register(this._diffEditor.onDidUpdateDiff(() => {
                ...
                if (diffComputationResult && diffComputationResult.quitEarly) {
                    this._notificationService.prompt(Severity$1.Warning, ( localize(
                        ...
                        label: ( localize(9058, "Remove Limit")),
                        run: () => {
                            this._textResourceConfigurationService.updateValue(
                                this._diffEditor.getModel().modified.uri,
...
DiffEditorHelperContribution = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, ITextResourceConfigurationService)), ( __param(3, INotificationService))], DiffEditorHelperContribution));
