...
const overviewRulerCommentingRangeForeground = registerColor("editorGutter.commentRangeForeground", {
...
const editorGutterCommentGlyphForeground = registerColor("editorGutter.commentGlyphForeground", {
    dark: editorForeground,
    light: editorForeground,
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(9212, "Editor gutter decoration color for commenting glyphs.")));
registerColor(
        ...
        const decorationOptions = {
            ...
            overviewRuler: {
                color: themeColorFromId(
                    this._threadHasDraft ? overviewRulerCommentDraftForeground : (this._threadState === CommentThreadState.Unresolved ? overviewRulerCommentUnresolvedForeground : overviewRulerCommentForeground)
                ),
