...
import { addDisposableListener, EventType, append, $, getClientArea, Dimension, getDomNodePagePosition } from '../../../../base/browser/dom.js';
...
let CommentThreadBody = class CommentThreadBody extends Disposable {
    ...
    async display() {
        ...
        this._register(
            addDisposableListener(this._commentsElement, EventType.KEY_DOWN, e => {
    ...
    _refresh() {
        ...
        if ((dimensions.height === 0 && dimensions.width === 0) || (Dimension.equals(this._containerClientArea, dimensions))) {
            return;
        }
    ...
    createNewCommentNode(comment) {
        ...
        disposables.add(
            newCommentNode.onDidClick(clickedNode => this._setFocusedComment(this._commentElements.findIndex(
...
CommentThreadBody = ( __decorate([( __param(9, ICommentService))], CommentThreadBody));
