...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9308, "Focus Comments view")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9309, "Clear filter text")),
            keybinding: {
                when: CommentsViewFilterFocusContextKey,
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9310, "Focus comments filter")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9311, "Show Unresolved")),
            category: ( localize(9312, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_UNRESOLVED,
                title: ( localize(9313, "Show Unresolved"))
            },
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(9314, "Show Resolved")),
            category: ( localize(9312, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_RESOLVED,
                title: ( localize(9315, "Show Resolved"))
            },
            menu: {
                id: viewFilterSubmenu,
                group: "1_filter",
