...
const collapseIcon = registerIcon("review-comment-collapse", Codicon.chevronUp, ( localize(9223, "Icon to collapse a review comment.")));
...
let CommentThreadHeader = class CommentThreadHeader extends Disposable {
    ...
    _fillHead() {
        ...
        this._collapseAction = ( new Action(CommentCommandId.Hide, ( localize(9224, "Collapse")), collapseClass, true, () => this._delegate.collapse()));
        ...
        this._register(
            addDisposableListener(this._headElement, EventType.CONTEXT_MENU, e => {
    ...
    createThreadLabel() {
        ...
        if (label === undefined) {
            if (!(this._commentThread.comments && this._commentThread.comments.length)) {
                label = ( localize(9225, "Start discussion"));
            }
        }
        if (label) {
...
CommentThreadHeader = ( __decorate([( __param(4, IContextKeyService)), ( __param(5, IInstantiationService)), ( __param(6, IContextMenuService))], CommentThreadHeader));
