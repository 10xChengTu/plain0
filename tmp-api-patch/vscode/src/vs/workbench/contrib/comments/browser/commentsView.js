...
let CommentsPanel = class CommentsPanel extends FilterViewPane {
    ...
    constructor(
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(9294, "Filter (e.g. text, author)")),
                ariaLabel: ( localize(9295, "Filter comments")),
    ...
    updateFilter() {
        ...
        this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(9296, "Showing {0} of {1}", filtered, total)));
    ...
    renderBody(container) {
        ...
        this._register(
            this.commentService.onDidDeleteDataProvider(this.onDataProviderDeleted, this)
        );
    ...
    makeCommentLocationLabel(file, range) {
        ...
        if (!range) {
            return localize(9297, "in {0}", fileLabel);
        }
    ...
    getReplyCountAsString(node, forAriaLabel) {
        return node.replies.length && !forAriaLabel ? ( localize(9305, " {0} replies,", node.replies.length)) : "";
    }
    createTree() {
        this.treeLabels = this._register(this.instantiationService.createInstance(ResourceLabels, this));
        this.tree = this._register(
            this.instantiationService.createInstance(CommentsList, this.treeLabels, this.treeContainer, {
                ...
                accessibilityProvider: {
                    getAriaLabel: element => {
                        if (element instanceof CommentsModel) {
                            return localize(9306, "Comments for current workspace");
                        }
