...
import { contrastBorder, disabledForeground } from '../../../../platform/theme/common/colors/baseColors.js';
...
const resolvedCommentBorder = registerColor("editorCommentsWidget.resolvedBorder", {
    ...
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(9204, "Color of borders and arrow for resolved comments.")));
const unresolvedCommentBorder = registerColor("editorCommentsWidget.unresolvedBorder", {
    ...
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(9205, "Color of borders and arrow for unresolved comments.")));
registerColor("editorCommentsWidget.rangeBackground", ( transparent(unresolvedCommentBorder, .1)), ( localize(9206, "Color of background for comment ranges.")));
