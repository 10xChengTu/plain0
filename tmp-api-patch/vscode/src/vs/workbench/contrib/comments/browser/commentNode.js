...
import { $, append, createElement, addDisposableListener, EventType, scheduleAtNextAnimationFrame, getWindow, getContentWidth, getContentHeight } from '../../../../base/browser/dom.js';
...
let CommentNode = class CommentNode extends Disposable {
    ...
    constructor(
        ...
        this._register(
            addDisposableListener(this._domNode, EventType.CONTEXT_MENU, e => {
    ...
    createHeader(commentDetailsContainer) {
        const header = append(
            ...
            $(`div.comment-title.${MOUSE_CURSOR_TEXT_CSS_CLASS_NAME}`)
        );
    ...
    getToolbarActions(menu) {
        const contributedActions = menu.getActions({
                ...
                return this._reactionActions.add(( new Action(
                    ...
                    async () => {
                        try {
                            ...
                            const error = e.message ? ( localize(9216, "Toggling the comment reaction failed: {0}.", e.message)) : ( localize(9217, "Toggling the comment reaction failed"));
    ...
    createReactionsContainer(commentDetailsContainer) {
        ...
        if (hasReactionHandler) {
            ...
            this._reactionsActionBar.value?.push(toggleReactionAction, {
                label: false,
                icon: true
            });
        }
...
CommentNode = ( __decorate([( __param(8, IInstantiationService)), ( __param(9, ICommentService)), ( __param(10, INotificationService)), ( __param(11, IContextMenuService)), ( __param(12, IContextKeyService)), ( __param(13, IConfigurationService)), ( __param(14, IHoverService)), ( __param(15, IKeybindingService)), ( __param(16, ITextModelService)), ( __param(17, IMarkdownRendererService))], CommentNode));
function fillInActions(
    groups,
    target,
    useAlternativeActions,
    isPrimaryGroup = group => group === "navigation"
) {
