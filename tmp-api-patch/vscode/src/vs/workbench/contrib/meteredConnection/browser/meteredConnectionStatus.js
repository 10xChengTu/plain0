...
let MeteredConnectionStatusContribution = class MeteredConnectionStatusContribution extends Disposable {
    ...
    getStatusBarEntry() {
        return {
            name: ( localize(12339, "Metered Connection")),
            text: "$(radio-tower)",
            ariaLabel: ( localize(12340, "Metered Connection Enabled")),
            tooltip: ( localize(
                12341,
            ...
            command: {
                ...
                title: ( localize(12342, "Configure"))
            },
