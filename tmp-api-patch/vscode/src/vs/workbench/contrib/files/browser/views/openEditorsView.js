...
import * as openeditors from './media/openeditors.css';
import { localize2, localize } from '../../../../../nls.js';
import { RunOnceScheduler } from '../../../../../base/common/async.js';
import { ActionRunner } from '../../../../../base/common/actions.js';
import { $ as $$1, append, isMouseEvent, getLargestChildWidth } from '../../../../../base/browser/dom.js';
...
import { GroupModelChangeKind, preventEditorClose, EditorCloseMethod, EditorResourceAccessor, Verbosity, SideBySideEditor } from '../../../../common/editor.js';
...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static {
        this.NAME = ( localize2(11233, "Open Editors"));
    }
    constructor(
        options,
        ...
        this._register(
            this.configurationService.onDidChangeConfiguration(e => this.onConfigurationChange(e))
        );
        this._register(
            this.workingCopyService.onDidChangeDirty(workingCopy => this.updateDirtyIndicator(workingCopy))
        );
    }
    registerUpdateEvents() {
        ...
        this._register(
            this.editorGroupService.onDidChangeActiveGroup(() => this.focusActiveEditor())
        );
    ...
    renderBody(container) {
        ...
        this.list = this.instantiationService.createInstance(WorkbenchList, "OpenEditors", container, delegate, [( new EditorGroupRenderer(this.keybindingService, this.instantiationService)), ( new OpenEditorRenderer(
            this.listLabels,
        ...
        this.editorGroupService.getGroups(GroupsOrder.GRID_APPEARANCE).forEach(g => {
            ...
            if (this.sortOrder === "alphabetical") {
                editors = editors.sort(
                    (first, second) => compareFileNamesDefault(first.editor.getName(), second.editor.getName())
                );
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(11234, "{0} unsaved", dirty));
...
OpenEditorsView = OpenEditorsView_1 = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IViewDescriptorService)), ( __param(3, IContextMenuService)), ( __param(4, IEditorGroupsService)), ( __param(5, IConfigurationService)), ( __param(6, IKeybindingService)), ( __param(7, IContextKeyService)), ( __param(8, IThemeService)), ( __param(9, ITelemetryService)), ( __param(10, IHoverService)), ( __param(11, IWorkingCopyService)), ( __param(12, IFilesConfigurationService)), ( __param(13, IOpenerService)), ( __param(14, IFileService))], OpenEditorsView));
...
class OpenEditorsDragAndDrop {
    ...
    drop(data, targetElement, _targetIndex, targetSector, originalEvent) {
        ...
        if (data instanceof ElementsDragAndDropData) {
            ...
            this.dropHandler.handleDrop(originalEvent, mainWindow, () => group, () => group.focus(), {
                index: targetEditorIndex
            });
        }
    }
...
OpenEditorsDragAndDrop.__decorator = ( __decorate([memoize], OpenEditorsDragAndDrop.prototype, "dropHandler", null));
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(11233, "Open Editors");
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11235, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.Digit0,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Digit0
                },
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(11236, "Flip Layout")),
            mnemonicTitle: ( localize(11237, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11238, "New Untitled Text File")),
            f1: false,
