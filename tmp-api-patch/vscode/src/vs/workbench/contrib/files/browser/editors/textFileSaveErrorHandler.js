...
let TextFileSaveErrorHandler = class TextFileSaveErrorHandler extends Disposable {
    ...
    constructor(
        ...
        this._register(
            textModelService.registerTextModelContentProvider(CONFLICT_RESOLUTION_SCHEME, provider)
        );
    ...
    registerListeners() {
        this._register(
            this.textFileService.files.onDidSave(e => this.onFileSavedOrReverted(e.model.resource))
        );
        this._register(
            this.textFileService.files.onDidRevert(model => this.onFileSavedOrReverted(model.resource))
        );
        this._register(
            this.editorService.onDidActiveEditorChange(() => this.onActiveEditorChanged())
        );
    }
    ...
    onSaveError(error, model, options) {
        ...
        if (fileOperationError.fileOperationResult === FileOperationResult.FILE_MODIFIED_SINCE) {
            if (this.activeConflictResolutionResource && isEqual(this.activeConflictResolutionResource, model.resource)) {
                ...
                primaryActions.push(
                    this.instantiationService.createInstance(SaveModelIgnoreModifiedSinceAction, model, options)
                );
            ...
            if (canSaveElevated && (isPermissionDenied || triedToUnlock)) {
                primaryActions.push(
                    this.instantiationService.createInstance(SaveModelElevatedAction, model, options, !!triedToUnlock)
                );
            }
            else if (isWriteLocked) {
                primaryActions.push(
                    this.instantiationService.createInstance(UnlockModelAction, model, options)
                );
            }
            else {
                primaryActions.push(
                    this.instantiationService.createInstance(RetrySaveModelAction, model, options)
                );
            }
...
TextFileSaveErrorHandler = ( __decorate([( __param(0, INotificationService)), ( __param(1, ITextFileService)), ( __param(2, IContextKeyService)), ( __param(3, IEditorService)), ( __param(4, ITextModelService)), ( __param(5, IInstantiationService)), ( __param(6, IStorageService))], TextFileSaveErrorHandler));
...
let ResolveConflictLearnMoreAction = class ResolveConflictLearnMoreAction extends Action {
    constructor(openerService) {
        super("workbench.files.action.resolveConflictLearnMore", ( localize(10894, "Learn More")));
...
ResolveConflictLearnMoreAction = ( __decorate([( __param(0, IOpenerService))], ResolveConflictLearnMoreAction));
let DoNotShowResolveConflictLearnMoreAction = class DoNotShowResolveConflictLearnMoreAction extends Action {
    constructor(storageService) {
        super(
            ...
            ( localize(10895, "Don't Show Again"))
        );
        this.storageService = storageService;
    }
...
DoNotShowResolveConflictLearnMoreAction = ( __decorate([( __param(0, IStorageService))], DoNotShowResolveConflictLearnMoreAction));
let ResolveSaveConflictAction = class ResolveSaveConflictAction extends Action {
    constructor(
        ...
        super("workbench.files.action.resolveConflict", ( localize(10896, "Compare")));
        this.model = model;
        this.editorService = editorService;
        this.notificationService = notificationService;
        this.instantiationService = instantiationService;
    ...
    async run() {
        if (!this.model.isDisposed()) {
            ...
            await TextFileContentProvider.open(resource, CONFLICT_RESOLUTION_SCHEME, editorLabel, this.editorService, {
                pinned: true
            });
            const actions = {
...
ResolveSaveConflictAction = ( __decorate([( __param(1, IEditorService)), ( __param(2, INotificationService)), ( __param(3, IInstantiationService)), ( __param(4, IProductService))], ResolveSaveConflictAction));
class SaveModelElevatedAction extends Action {
    constructor(model, options, triedToUnlock) {
        super(
            ...
            triedToUnlock ? isWindows ? ( localize(10898, "Overwrite as Admin...")) : ( localize(10899, "Overwrite as Sudo...")) : isWindows ? ( localize(10900, "Retry as Admin...")) : ( localize(10901, "Retry as Sudo..."))
        );
        this.model = model;
...
class RetrySaveModelAction extends Action {
    constructor(model, options) {
        super("workbench.files.action.saveModel", ( localize(10902, "Retry")));
        this.model = model;
        this.options = options;
    }
    async run() {
...
SaveModelAsAction = ( __decorate([( __param(1, IEditorService))], SaveModelAsAction));
class UnlockModelAction extends Action {
    constructor(model, options) {
        super("workbench.files.action.unlock", ( localize(10904, "Overwrite")));
        this.model = model;
        this.options = options;
    }
    async run() {
...
class SaveModelIgnoreModifiedSinceAction extends Action {
    constructor(model, options) {
        super("workbench.files.action.saveIgnoreModifiedSince", ( localize(10904, "Overwrite")));
        this.model = model;
        this.options = options;
    }
    async run() {
...
let ConfigureSaveConflictAction = class ConfigureSaveConflictAction extends Action {
    constructor(preferencesService) {
        super("workbench.files.action.configureSaveConflict", ( localize(10905, "Configure")));
...
ConfigureSaveConflictAction = ( __decorate([( __param(0, IPreferencesService))], ConfigureSaveConflictAction));
