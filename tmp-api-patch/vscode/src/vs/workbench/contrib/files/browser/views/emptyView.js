...
let EmptyView = class EmptyView extends ViewPane {
    ...
    static {
        this.NAME = ( localize2(11205, "No Folder Opened"));
    }
    constructor(
        options,
        themeService,
