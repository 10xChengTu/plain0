...
import * as explorerviewlet from './media/explorerviewlet.css';
...
import { Extensions, ViewContainerLocation, ViewContentGroups } from '../../../common/views.js';
...
registerCss(explorerviewlet);
const explorerViewIcon = registerIcon("explorer-view-icon", Codicon.files, ( localize(10906, "View icon of the explorer view.")));
const openEditorsViewIcon = registerIcon("open-editors-view-icon", Codicon.book, ( localize(10907, "View icon of the open editors view.")));
let ExplorerViewletViewsContribution = class ExplorerViewletViewsContribution extends Disposable {
    ...
    constructor(workspaceContextService, progressService) {
        ...
        progressService.withProgress({
            ...
            this.registerViews();
            this._register(
                workspaceContextService.onDidChangeWorkbenchState(() => this.registerViews())
            );
            this._register(
                workspaceContextService.onDidChangeWorkspaceFolders(() => this.registerViews())
            );
        });
    }
    registerViews() {
    ...
    createOpenEditorsViewDescriptor() {
        return {
            ...
            focusCommand: {
                ...
                keybindings: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyE)
                }
            }
        };
    }
...
ExplorerViewPaneContainer = ( __decorate([( __param(0, IWorkbenchLayoutService)), ( __param(1, ITelemetryService)), ( __param(2, IWorkspaceContextService)), ( __param(3, IStorageService)), ( __param(4, IConfigurationService)), ( __param(5, IInstantiationService)), ( __param(6, IContextKeyService)), ( __param(7, IThemeService)), ( __param(8, IContextMenuService)), ( __param(9, IExtensionService)), ( __param(10, IViewDescriptorService)), ( __param(11, ILogService))], ExplorerViewPaneContainer));
...
const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    id: VIEWLET_ID,
    title: ( localize2(10909, "Explorer")),
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: ( localize2(10909, "Explorer")),
        mnemonicTitle: ( localize(10910, "&&Explorer")),
        keybindings: {
            primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyE
        },
        order: 0
    }
...
const openFolder = ( localize(10911, "Open Folder"));
const addAFolder = ( localize(10912, "add a folder"));
const openRecent = ( localize(10913, "Open Recent"));
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(10916, "Connected to remote.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and((
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(10918, "You have not yet opened a folder.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and(
