...
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(
    EditorPaneDescriptor.create(TextFileEditor, TextFileEditor.ID, ( localize(11145, "Text File Editor"))),
    [( new SyncDescriptor(FileEditorInput))]
);
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(
    EditorPaneDescriptor.create(BinaryFileEditor, BinaryFileEditor.ID, ( localize(11146, "Binary File Editor"))),
    [( new SyncDescriptor(FileEditorInput))]
);
