...
import { ResourceContextKey, MultipleEditorsSelectedInGroupContext, IsSessionsWindowContext, WorkspaceFolderCountContext, ActiveEditorAvailableEditorIdsContext, DirtyWorkingCopiesContext, TwoEditorsSelectedInGroupContext, SelectedEditorsInGroupFileOrUntitledResourceContextKey, IsSandboxWorkspaceContext, HasWebFileSystemAccess, EnterMultiRootWorkspaceSupportContext, WorkbenchStateContext, ActiveEditorContext, SidebarFocusContext, ActiveEditorCanRevertContext } from '../../../common/contextkeys.js';
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    primary: KeyMod$1.Shift | KeyCode.Delete,
    mac: {
...
const copyPathCommand = {
    ...
    title: ( localize(10919, "Copy Path"))
};
const copyRelativePathCommand = {
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize(10920, "Copy Relative Path"))
};
const revealInSideBarCommand = {
    id: REVEAL_IN_EXPLORER_COMMAND_ID,
    title: ( localize(10921, "Reveal in Explorer View"))
};
...
appendSaveConflictEditorTitleAction("workbench.files.action.acceptLocalChanges", ( localize(10922, "Use your changes and overwrite file contents")), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction("workbench.files.action.revertLocalChanges", ( localize(10923, "Discard your changes and revert to file contents")), Codicon.discard, -9, revertLocalChangesCommand);
...
function appendToCommandPalette(
    {
        id,
        title,
        category,
...
appendToCommandPalette({
    id: COPY_PATH_COMMAND_ID,
    title: ( localize2(10924, "Copy Path of Active File")),
    category: Categories.File
}, ( IsSessionsWindowContext.negate()));
appendToCommandPalette({
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize2(10925, "Copy Relative Path of Active File")),
    category: Categories.File
}, ( IsSessionsWindowContext.negate()));
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    title: ( localize2(10926, "Save All in Group")),
    category: Categories.File
}, ( IsSessionsWindowContext.negate()));
appendToCommandPalette({
    id: SAVE_FILES_COMMAND_ID,
    title: ( localize2(10927, "Save All Files")),
    category: Categories.File
}, ( IsSessionsWindowContext.negate()));
appendToCommandPalette({
    id: REVERT_FILE_COMMAND_ID,
    title: ( localize2(10928, "Revert File")),
    category: Categories.File
}, ( IsSessionsWindowContext.negate()));
appendToCommandPalette({
    id: COMPARE_WITH_SAVED_COMMAND_ID,
    title: ( localize2(10929, "Compare Active File with Saved")),
    category: Categories.File,
    metadata: {
...
appendToCommandPalette({
    ...
    category: Categories.File,
    metadata: {
        description: ( localize2(10931, "Create a new folder or directory"))
    }
}, ( ContextKeyExpr.and(( WorkspaceFolderCountContext.notEqualsTo("0")), ( IsSessionsWindowContext.negate()))));
appendToCommandPalette({
...
const openToSideCommand = {
    ...
    title: ( localize(10932, "Open to the Side"))
};
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(10933, "Reopen Editor With..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(10928, "Revert File")),
        precondition: OpenEditorsDirtyEditorContext
    },
    when: ( ContextKeyExpr.and((
    OpenEditorsGroupContext.toNegated()), (
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: COMPARE_WITH_SAVED_COMMAND_ID,
        title: ( localize(10935, "Compare with Saved")),
        precondition: OpenEditorsDirtyEditorContext
    },
...
const compareResourceCommand = {
    ...
    title: ( localize(10936, "Compare with Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 20,
...
const selectForCompareCommand = {
    ...
    title: ( localize(10937, "Select for Compare"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 30,
...
const compareSelectedCommand = {
    ...
    title: ( localize(10938, "Compare Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 30,
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(10940, "Close Others"))
    },
    when: ( OpenEditorsGroupContext.toNegated())
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(10941, "Close Saved"))
    }
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "4_close",
    ...
    command: {
        ...
        title: ( localize(10942, "Close All"))
    }
});
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    ...
    command: {
        ...
        title: ( localize(10943, "Open With..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    ...
    alt: {
        id: DELETE_FILE_ID,
        title: ( localize(10945, "Delete Permanently"))
    },
...
for (const menuId of [MenuId.EmptyEditorGroupContext, MenuId.EditorTabsBarContext]) {
    MenuRegistry.appendMenuItem(menuId, {
        command: {
            id: NEW_UNTITLED_FILE_COMMAND_ID,
            title: ( localize(10946, "New Text File"))
        },
        group: "1_file",
        order: 10
    });
    MenuRegistry.appendMenuItem(menuId, {
        command: {
            ...
            title: ( localize(10947, "Open File..."))
        },
        group: "1_file",
        order: 20
    });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: NEW_UNTITLED_FILE_COMMAND_ID,
        title: ( localize(10948, "&&New Text File"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(10951, "Save A&&ll")),
        precondition: DirtyWorkingCopiesContext
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(10952, "A&&uto Save")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(10953, "Re&&vert File")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CLOSE_EDITOR_COMMAND_ID,
        title: ( localize(10954, "&&Close Editor")),
        precondition: ( ContextKeyExpr.or(ActiveEditorContext, ( ContextKeyExpr.and(FoldersViewVisibleContext, SidebarFocusContext))))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: "workbench.action.quickOpen",
        title: ( localize(10955, "Go to &&File..."))
    },
    order: 1
});
