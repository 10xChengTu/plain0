...
import { HotExitConfiguration, FILES_READONLY_FROM_PERMISSIONS_CONFIG, FILES_READONLY_EXCLUDE_CONFIG, FILES_READONLY_INCLUDE_CONFIG, AutoSaveConfiguration, FILES_ASSOCIATIONS_CONFIG, FILES_EXCLUDE_CONFIG } from '../../../../platform/files/common/files.js';
...
configurationRegistry.registerConfiguration({
    ...
    "properties": {
        [FILES_EXCLUDE_CONFIG]: {
            ...
            "additionalProperties": {
                "anyOf": [{
                    "type": "boolean",
                    "enum": [true, false],
                    "enumDescriptions": [( localize(11101, "Enable the pattern.")), ( localize(11102, "Disable the pattern."))],
        ...
        "files.eol": {
            "type": "string",
            "enum": ["\n", "\r\n", "auto"],
            "enumDescriptions": [( localize(11109, "LF")), ( localize(11110, "CRLF")), ( localize(11111, "Uses operating system specific end of line character."))],
            "default": "auto",
            "description": ( localize(11112, "The default end of line character.")),
            "scope": ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        "files.enableTrash": {
            "type": "boolean",
        ...
        "files.trimTrailingWhitespace": {
            "type": "boolean",
            "default": false,
            "description": ( localize(11114, "When enabled, will trim trailing whitespace when saving a file.")),
            "scope": ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        ...
        "files.autoSave": {
            ...
            "markdownEnumDescriptions": [( localize(11118, "An editor with changes is never automatically saved.")), ( localize(
                11119,
        ...
        "files.restoreUndoStack": {
            "type": "boolean",
            "description": ( localize(11132, "Restore the undo stack when a file is reopened.")),
            "default": true
        },
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        ...
        "editor.formatOnSaveMode": {
            ...
            "enumDescriptions": [( localize(11141, "Format the whole file.")), ( localize(
                11142,
