...
const SAVE_FILE_AS_LABEL = ( localize2(11057, "Save As..."));
const SAVE_FILE_COMMAND_ID = "workbench.action.files.save";
const SAVE_FILE_LABEL = ( localize2(11058, "Save"));
const SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID = "workbench.action.files.saveWithoutFormatting";
const SAVE_FILE_WITHOUT_FORMATTING_LABEL = ( localize2(11059, "Save without Formatting"));
const SAVE_ALL_COMMAND_ID = "saveAll";
const SAVE_ALL_LABEL = ( localize2(11060, "Save All"));
...
const REMOVE_ROOT_FOLDER_LABEL = ( localize(11061, "Remove Folder from Workspace"));
...
const NEW_UNTITLED_FILE_LABEL = ( localize2(11062, "New Untitled Text File"));
