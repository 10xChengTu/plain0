...
import { NewExplorerItem, ExplorerItem } from '../../common/explorerModel.js';
...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = ( localize(11210, "Explorer Section: {0}", this.name));
    ...
    renderBody(container) {
        ...
        this._register(
            addDisposableListener(getWindow(this.container), EventType.PASTE, async event => {
    ...
    createTree(container) {
        ...
        this.renderer = this.instantiationService.createInstance(
            ...
            container,
            explorerLabels,
            this.findProvider.highlightTree,
            updateWidth
        );
    ...
    async setTreeInput() {
        ...
        if (!this.decorationsProvider) {
            ...
            this._register(
                this.decorationService.registerDecorationsProvider(this.decorationsProvider)
            );
        }
    }
...
ExplorerView.__decorator = ( __decorate([memoize], ExplorerView.prototype, "fileCopiedContextKey", null));
ExplorerView.__decorator = ( __decorate([memoize], ExplorerView.prototype, "resourceCutContextKey", null));
ExplorerView = ExplorerView_1 = ( __decorate([( __param(1, IContextMenuService)), ( __param(2, IViewDescriptorService)), ( __param(3, IInstantiationService)), ( __param(4, IWorkspaceContextService)), ( __param(5, IProgressService)), ( __param(6, IEditorService)), ( __param(7, IEditorResolverService)), ( __param(8, IWorkbenchLayoutService)), ( __param(9, IKeybindingService)), ( __param(10, IContextKeyService)), ( __param(11, IConfigurationService)), ( __param(12, IDecorationsService)), ( __param(13, ILabelService)), ( __param(14, IThemeService)), ( __param(15, ITelemetryService)), ( __param(16, IHoverService)), ( __param(17, IExplorerService)), ( __param(18, IStorageService)), ( __param(19, IClipboardService)), ( __param(20, IFileService)), ( __param(21, IUriIdentityService)), ( __param(22, ICommandService)), ( __param(23, IOpenerService)), ( __param(24, IAccessibilityService))], ExplorerView));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(11212, "New Folder...")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11213, "Refresh Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(11214, "Forces a refresh of the Explorer."))
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11215, "Collapse Folders in Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(11216, "Folds all folders in the Explorer."))
            }
        });
    }
    run(accessor) {
