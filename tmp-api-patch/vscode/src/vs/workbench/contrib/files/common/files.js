...
const ExplorerViewletVisibleContext = ( new RawContextKey("explorerViewletVisible", true, {
    type: "boolean",
    description: ( localize(11245, "True when the EXPLORER viewlet is visible."))
}));
const FoldersViewVisibleContext = ( new RawContextKey("foldersViewVisible", true, {
    type: "boolean",
...
const ExplorerFolderContext = ( new RawContextKey("explorerResourceIsFolder", false, {
    type: "boolean",
    description: ( localize(11247, "True when the focused item in the EXPLORER is a folder."))
}));
const ExplorerResourceReadonlyContext = ( new RawContextKey("explorerResourceReadonly", false, {
    type: "boolean",
    description: ( localize(11248, "True when the focused item in the EXPLORER is read-only."))
}));
const ExplorerResourceWritableContext = ( ExplorerResourceReadonlyContext.toNegated());
const ExplorerResourceParentReadOnlyContext = ( new RawContextKey("explorerResourceParentReadonly", false, {
    type: "boolean",
    description: ( localize(11249, "True when the focused item in the EXPLORER's parent is read-only."))
}));
const ExplorerResourceAvailableEditorIdsContext = ( new RawContextKey("explorerResourceAvailableEditorIds", ""));
const ExplorerRootContext = ( new RawContextKey("explorerResourceIsRoot", false, {
    type: "boolean",
    description: ( localize(11250, "True when the focused item in the EXPLORER is a root folder."))
}));
const ExplorerResourceCut = ( new RawContextKey("explorerResourceCut", false, {
    type: "boolean",
    description: ( localize(11251, "True when an item in the EXPLORER has been cut for cut and paste."))
}));
const ExplorerResourceMoveableToTrash = ( new RawContextKey("explorerResourceMoveableToTrash", false, {
    type: "boolean",
    description: ( localize(11252, "True when the focused item in the EXPLORER can be moved to trash."))
}));
const FilesExplorerFocusedContext = ( new RawContextKey("filesExplorerFocus", true, {
    type: "boolean",
    description: ( localize(11253, "True when the focus is inside the EXPLORER view."))
}));
const OpenEditorsFocusedContext = ( new RawContextKey("openEditorsFocus", true, {
    type: "boolean",
    description: ( localize(11254, "True when the focus is inside the OPEN EDITORS view."))
}));
const ExplorerFocusedContext = ( new RawContextKey("explorerViewletFocus", true, {
    type: "boolean",
    description: ( localize(11255, "True when the focus is inside the EXPLORER viewlet."))
}));
const ExplorerFindProviderActive = ( new RawContextKey("explorerFindProviderActive", false, {
    type: "boolean",
    description: ( localize(11256, "True when the explorer tree is using the explorer find provider."))
}));
const ExplorerCompressedFocusContext = ( new RawContextKey("explorerViewletCompressedFocus", true, {
    type: "boolean",
    description: ( localize(
        11257,
...
const ExplorerCompressedFirstFocusContext = ( new RawContextKey("explorerViewletCompressedFirstFocus", true, {
    type: "boolean",
    description: ( localize(
        11258,
...
const ExplorerCompressedLastFocusContext = ( new RawContextKey("explorerViewletCompressedLastFocus", true, {
    type: "boolean",
    description: ( localize(
        11259,
...
const ViewHasSomeCollapsibleRootItemContext = ( new RawContextKey("viewHasSomeCollapsibleItem", false, {
    type: "boolean",
    description: ( localize(
        11260,
...
let TextFileContentProvider = TextFileContentProvider_1 = class TextFileContentProvider extends Disposable {
    ...
    static async open(resource, scheme, label, editorService, options) {
        await editorService.openEditor({
            original: {
                resource: TextFileContentProvider_1.resourceToTextFile(scheme, resource)
            },
            modified: {
                resource
            },
    ...
    async provideTextContent(resource) {
        ...
        if (!this.fileWatcherDisposable.value) {
            ...
            if (codeEditorModel) {
                disposables.add(
                    Event.once(codeEditorModel.onWillDispose)(() => this.fileWatcherDisposable.clear())
                );
            }
        }
...
TextFileContentProvider = TextFileContentProvider_1 = ( __decorate([( __param(0, ITextFileService)), ( __param(1, IFileService)), ( __param(2, ILanguageService)), ( __param(3, IModelService))], TextFileContentProvider));
class OpenEditor {
    static {
        this.COUNTER = 0;
    }
