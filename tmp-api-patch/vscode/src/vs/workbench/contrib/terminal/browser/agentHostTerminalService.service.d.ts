...
export interface IAgentHostTerminalService {
    ...
    */
    reconnectTerminals(newConnection: IAgentConnection, oldClientId: string): Promise<{
        recovered: number;
        total: number;
    }>;
    /**
