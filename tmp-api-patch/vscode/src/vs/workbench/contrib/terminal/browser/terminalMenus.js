...
function setupTerminalMenus() {
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            ...
            command: {
                ...
                title: ( localize(14861, "&&New Terminal"))
            },
            order: 1
        }
    }, {
        ...
        item: {
            ...
            command: {
                ...
                title: ( localize(14862, "New Terminal &&Window")),
        ...
        item: {
            ...
            command: {
                ...
                title: ( localize(14863, "&&Split Terminal")),
                precondition: ( ContextKeyExpr.has(TerminalContextKeyStrings.IsOpen))
            },
            order: 2,
            when: TerminalContextKeys.processSupported
        ...
        item: {
            ...
            command: {
                ...
                title: ( localize(14864, "Run &&Active File"))
            },
            order: 3,
            when: TerminalContextKeys.processSupported
        }
        ...
        item: {
            ...
            command: {
                ...
                title: ( localize(14865, "Run &&Selected Text"))
            },
            order: 4,
            when: TerminalContextKeys.processSupported
        }
    ...
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            command: {
                ...
                title: ( localize(14867, "Copy as HTML"))
            },
            group: TerminalContextMenuGroup.Edit,
            order: 2
        }
        ...
        item: {
            command: {
                ...
                title: ( localize(14870, "Select All"))
            },
            group: TerminalContextMenuGroup.Edit,
            order: 3
        }
    ...
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            command: {
                ...
                title: ( localize(14871, "New Terminal With Profile..."))
            },
            group: TerminalContextMenuGroup.Create
        }
    }, {
    ...
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            command: {
                ...
                title: ( localize2(14872, "Select Default Profile"))
            },
            group: "3_configure"
        }
    }, {
        ...
        item: {
            command: {
                ...
                title: ( localize(14873, "Configure Terminal Settings"))
            },
            group: "3_configure"
        }
    }, {
        ...
        item: {
            command: {
                ...
                title: ( localize(14875, "Configure Tasks..."))
            },
            when: TaskExecutionSupportedContext,
            group: "4_tasks",
            order: 2
    ...
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            command: {
                ...
                title: ( localize2(14876, "Switch Terminal"))
            },
            group: "navigation",
            order: 0,
        ...
        item: {
            ...
            when: ( ContextKeyExpr.and(
                ...
                ( ContextKeyExpr.or(( ContextKeyExpr.and(( ContextKeyExpr.equals(`config.${TerminalSettingId.TabsShowActiveTerminal}`, "singleTerminal")), ( ContextKeyExpr.equals(TerminalContextKeyStrings.GroupCount, 1)))), ( ContextKeyExpr.and(( ContextKeyExpr.equals(
                    `config.${TerminalSettingId.TabsShowActiveTerminal}`,
                    "singleTerminalOrNarrow"
                )), ( ContextKeyExpr.or(( ContextKeyExpr.equals(TerminalContextKeyStrings.GroupCount, 1)), ( ContextKeyExpr.has(TerminalContextKeyStrings.TabsNarrow)))))), ( ContextKeyExpr.and(( ContextKeyExpr.equals(`config.${TerminalSettingId.TabsShowActiveTerminal}`, "singleGroup")), ( ContextKeyExpr.equals(TerminalContextKeyStrings.GroupCount, 1)))), ( ContextKeyExpr.equals(`config.${TerminalSettingId.TabsShowActiveTerminal}`, "always"))))
            ))
        }
    }, {
        id: MenuId.ViewTitle,
        ...
        item: {
            command: {
                id: TerminalCommandId.Clear,
                title: ( localize(14877, "Clear Terminal")),
        ...
        item: {
            command: {
                id: TerminalCommandId.RunActiveFile,
                title: ( localize(14878, "Run Active File")),
                icon: Codicon.run
            },
            group: "navigation",
            order: 7,
        ...
        item: {
            command: {
                id: TerminalCommandId.RunSelectedText,
                title: ( localize(14879, "Run Selected Text")),
        ...
        item: {
            command: {
                ...
                title: ( localize(14880, "Start Dictation"))
            },
            group: "navigation",
            order: 9,
        ...
        item: {
            command: {
                ...
                title: ( localize(14881, "Stop Dictation"))
            },
            group: "navigation",
            order: 9,
    ...
    MenuRegistry.appendMenuItems([{
        ...
        item: {
            command: {
                ...
                title: ( localize(14883, "Change Icon..."))
            },
            group: TerminalContextMenuGroup.Edit
        }
    }, {
        ...
        item: {
            command: {
                ...
                title: ( localize(14884, "Change Color..."))
            },
            group: TerminalContextMenuGroup.Edit
        }
    }, {
        ...
        item: {
            command: {
                ...
                title: ( localize(14885, "Join Terminals"))
            },
        ...
        item: {
            ...
            when: ( ContextKeyExpr.and(
                ...
                TerminalContextKeys.splitTerminalTabFocused
            )),
            group: TerminalContextMenuGroup.Config
        }
    }, {
    ...
    for (const menuId of [MenuId.EditorTitle, MenuId.CompactWindowEditorTitle]) {
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StartVoice,
                title: ( localize(14886, "Start Dictation")),
                icon: Codicon.mic
            },
            group: "navigation",
            order: 9,
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StopVoice,
                title: ( localize(14887, "Stop Dictation")),
                icon: Codicon.run
            },
            group: "navigation",
            order: 10,
...
function getTerminalActionBarArgs(
    location,
    profiles,
    defaultProfileName,
    contributedProfiles,
    ...
    const splitLocation = (location === TerminalLocation.Editor || (typeof location === "object" && hasKey(location, {
        viewColumn: true
    ...
    if (location === TerminalLocation.Editor) {
        location = {
            viewColumn: ACTIVE_GROUP
        };
    }
    dropdownActions.push(disposableStore.add(( new Action(
        TerminalCommandId.New,
        terminalStrings.new,
        undefined,
        true,
        () => terminalService.createAndFocusTerminal()
    ))));
    dropdownActions.push(disposableStore.add(( new Action(
        TerminalCommandId.NewInNewWindow,
        terminalStrings.newInNewWindow.value,
        undefined,
        true,
        () => terminalService.createAndFocusTerminal({
            location: {
    ...
    if (dropdownActions.length > 0) {
        dropdownActions.push(( new SubmenuAction("split.profile", ( localize(14888, "Split Terminal with Profile")), submenuActions)));
        dropdownActions.push(( new Separator()));
    }
    const actions = dropdownMenu.getActions();
    dropdownActions.push(...Separator.join(...( actions.map(a => a[1]))));
    const dropdownAction = disposableStore.add(( new Action("refresh profiles", ( localize(14889, "Launch Profile...")), "codicon-chevron-down", true)));
    return {
        dropdownAction,
...
function addProfileActions(
    ...
    dropdownActions.push(disposableStore.add(( new Action(TerminalCommandId.NewWithProfile, isDefault ? ( localize(14890, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
        await terminalService.createAndFocusTerminal(options);
    }))));
    submenuActions.push(disposableStore.add(( new Action(TerminalCommandId.Split, isDefault ? ( localize(14890, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
...
function addContributedProfileActions(
    ...
    const title = isDefault ? ( localize(14890, "{0} (Default)", contributed.title.replace(/[\n\r\t]/g, ""))) : contributed.title.replace(/[\n\r\t]/g, "");
    dropdownActions.push(disposableStore.add(( new Action(
        "contributed",
        title,
        undefined,
    ...
    submenuActions.push(disposableStore.add(( new Action(
        "contributed-split",
        title,
        undefined,
        true,
...
export { TerminalContextMenuGroup, TerminalMenuBarGroup, getTerminalActionBarArgs, setupTerminalMenus };
