...
import { terminalHistoryConfiguration, defaultTerminalHistoryCommandsToSkipShell } from '../terminalContrib/history/common/terminal.history.js';
...
(function (TerminalContribSettingId) {
    ...
    TerminalContribSettingId["AgentSandboxWindowsEnabled"] = "chat.agent.sandbox.enabledWindows";
    TerminalContribSettingId["AgentSandboxAllowNetwork"] = "chat.agent.sandbox.allowNetwork";
    TerminalContribSettingId["AgentSandboxAllowUnsandboxedCommands"] = "chat.agent.sandbox.allowUnsandboxedCommands";
    TerminalContribSettingId["AgentSandboxRetryWithAllowNetworkRequests"] = "chat.agent.sandbox.retryWithAllowNetworkRequests";
    TerminalContribSettingId["AgentSandboxAllowAutoApprove"] = "chat.agent.sandbox.allowAutoApprove";
    ...
    TerminalContribSettingId["AgentSandboxWindowsFileSystem"] = "chat.agent.sandbox.fileSystem.windows";
...
export { TerminalContribCommandId, TerminalContribContextKeyStrings, TerminalContribSettingId, defaultTerminalContribCommandsToSkipShell, terminalContribConfiguration };
