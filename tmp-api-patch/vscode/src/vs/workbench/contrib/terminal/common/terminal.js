...
(function(TerminalCommandId) {
    ...
    TerminalCommandId["PastePwsh"] = "workbench.action.terminal.pastePwsh";
...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(14959, "Contributes terminal functionality.")),
        type: "object",
        properties: {
            profiles: {
                type: "array",
                description: ( localize(14960, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: "object",
                    required: ["id", "title"],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(14961, "The ID of the terminal profile provider.")),
                            type: "string"
                        },
                        title: {
                            description: ( localize(14962, "Title for this terminal profile.")),
                            type: "string"
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                properties: {
                                    light: {
                                        description: ( localize(14964, "Icon path when a light theme is used")),
                                        type: "string"
                                    },
                                    dark: {
                                        description: ( localize(14965, "Icon path when a dark theme is used")),
                                        type: "string"
                                    }
                                }
                            }]
...
export { DEFAULT_BOLD_FONT_WEIGHT, DEFAULT_COMMANDS_TO_SKIP_SHELL, DEFAULT_FONT_WEIGHT, DEFAULT_LETTER_SPACING, DEFAULT_LINE_HEIGHT, MAXIMUM_FONT_WEIGHT, MINIMUM_FONT_WEIGHT, MINIMUM_LETTER_SPACING, ProcessState, SUGGESTIONS_FONT_WEIGHT, TERMINAL_CONFIG_SECTION, TERMINAL_VIEW_ID, TerminalCommandId, isTerminalProcessManager, terminalContributionsDescriptor };
