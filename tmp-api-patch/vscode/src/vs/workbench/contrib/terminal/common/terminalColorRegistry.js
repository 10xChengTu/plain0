...
import { editorSelectionBackground, editorFindMatch, editorHoverHighlight, editorFindMatchHighlight, overviewRulerFindMatchForeground } from '../../../../platform/theme/common/colors/editorColors.js';
...
const TERMINAL_FOREGROUND_COLOR = registerColor("terminal.foreground", {
    ...
    hcDark: "#FFFFFF",
    hcLight: "#292929"
}, ( localize(14970, "The foreground color of the terminal.")));
const TERMINAL_CURSOR_FOREGROUND_COLOR = registerColor("terminalCursor.foreground", null, ( localize(14971, "The foreground color of the terminal cursor.")));
...
const TERMINAL_SELECTION_BACKGROUND_COLOR = registerColor("terminal.selectionBackground", editorSelectionBackground, ( localize(14973, "The selection background color of the terminal.")));
...
const TERMINAL_COMMAND_DECORATION_DEFAULT_BACKGROUND_COLOR = registerColor("terminalCommandDecoration.defaultBackground", {
    ...
    hcDark: "#ffffff80",
    hcLight: "#00000040"
}, ( localize(14976, "The default terminal command decoration background color.")));
...
const TERMINAL_OVERVIEW_RULER_CURSOR_FOREGROUND_COLOR = registerColor("terminalOverviewRuler.cursorForeground", "#A0A0A0CC", ( localize(14979, "The overview ruler cursor color.")));
...
const TERMINAL_OVERVIEW_RULER_BORDER_COLOR = registerColor("terminalOverviewRuler.border", editorOverviewRulerBorder, ( localize(14981, "The overview ruler left-side border color.")));
...
const TERMINAL_FIND_MATCH_BORDER_COLOR = registerColor("terminal.findMatchBorder", {
    ...
    hcDark: "#f38518",
    hcLight: "#0F4A85"
}, ( localize(14984, "Border color of the current search match in the terminal.")));
...
const TERMINAL_FIND_MATCH_HIGHLIGHT_BORDER_COLOR = registerColor("terminal.findMatchHighlightBorder", {
    ...
    hcDark: "#f38518",
    hcLight: "#0F4A85"
}, ( localize(14986, "Border color of the other search matches in the terminal.")));
const TERMINAL_OVERVIEW_RULER_FIND_MATCH_FOREGROUND_COLOR = registerColor("terminalOverviewRuler.findMatchForeground", {
    ...
    hcDark: "#f38518",
    hcLight: "#0F4A85"
}, ( localize(14987, "Overview ruler marker color for find matches in the terminal.")));
...
registerColor("terminal.initialHintForeground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(14990, "Foreground color of the terminal initial hint.")));
const ansiColorMap = {
    "terminal.ansiBlack": {
        index: 0,
        defaults: {
...
function registerColors() {
    for (const id in ansiColorMap) {
        ...
        ansiColorIdentifiers[entry.index] = registerColor(id, entry.defaults, ( localize(14991, "'{0}' ANSI color in the terminal.", colorName)));
    }
}
