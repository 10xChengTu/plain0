...
(function(TerminalContextKeys) {
    ...
    TerminalContextKeys.focus = ( new RawContextKey(TerminalContextKeyStrings.Focus, false, ( localize(15156, "Whether the terminal is focused."))));
    ...
    TerminalContextKeys.editorFocus = ( new RawContextKey(TerminalContextKeyStrings.EditorFocus, false, ( localize(15158, "Whether a terminal in the editor area is focused."))));
    TerminalContextKeys.count = ( new RawContextKey(TerminalContextKeyStrings.Count, 0, ( localize(15159, "The current number of terminals."))));
    ...
    TerminalContextKeys.tabsFocus = ( new RawContextKey(TerminalContextKeyStrings.TabsFocus, false, ( localize(15160, "Whether the terminal tabs widget is focused."))));
    ...
    TerminalContextKeys.altBufferActive = ( new RawContextKey(TerminalContextKeyStrings.AltBufferActive, false, ( localize(15162, "Whether the terminal's alt buffer is active."))));
    TerminalContextKeys.suggestWidgetVisible = ( new RawContextKey(TerminalContextKeyStrings.SuggestWidgetVisible, false, ( localize(15163, "Whether the terminal's suggest widget is visible."))));
    TerminalContextKeys.notFocus = ( TerminalContextKeys.focus.toNegated());
    TerminalContextKeys.viewShowing = ( new RawContextKey(TerminalContextKeyStrings.ViewShowing, false, ( localize(15164, "Whether the terminal view is showing"))));
    TerminalContextKeys.textSelected = ( new RawContextKey(TerminalContextKeyStrings.TextSelected, false, ( localize(15165, "Whether text is selected in the active terminal."))));
    TerminalContextKeys.textSelectedInFocused = ( new RawContextKey(TerminalContextKeyStrings.TextSelectedInFocused, false, ( localize(15166, "Whether text is selected in a focused terminal."))));
    ...
    TerminalContextKeys.tabsSingularSelection = ( new RawContextKey(TerminalContextKeyStrings.TabsSingularSelection, false, ( localize(15168, "Whether one terminal is selected in the terminal tabs list."))));
    TerminalContextKeys.splitTerminalTabFocused = ( new RawContextKey(TerminalContextKeyStrings.SplitTerminal, false, ( localize(15169, "Whether the focused tab's terminal is a split terminal."))));
    TerminalContextKeys.splitTerminalActive = ( new RawContextKey(TerminalContextKeyStrings.SplitPaneActive, false, ( localize(15170, "Whether the active terminal is a split pane."))));
    TerminalContextKeys.inTerminalRunCommandPicker = ( new RawContextKey(
        TerminalContextKeyStrings.InTerminalRunCommandPicker,
        false,
        ( localize(15171, "Whether the terminal run command picker is currently open."))
    ));
    TerminalContextKeys.terminalShellIntegrationEnabled = ( new RawContextKey(
        ...
        false,
        ( localize(15172, "Whether shell integration is enabled in the active terminal"))
    ));
