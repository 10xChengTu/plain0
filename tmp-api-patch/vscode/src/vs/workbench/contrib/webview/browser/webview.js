...
function areWebviewContentOptionsEqual(a, b) {
    return (a.allowMultipleAPIAcquire === b.allowMultipleAPIAcquire && a.allowScripts === b.allowScripts && a.allowForms === b.allowForms && a.forwardUntrustedKeypressEvents === b.forwardUntrustedKeypressEvents && equals(a.localResourceRoots, b.localResourceRoots, isEqual) && equals(
        a.portMapping,
        b.portMapping,
...
WebviewOriginStore = ( __decorate([( __param(1, IStorageService))], WebviewOriginStore));
...
ExtensionKeyedWebviewOriginStore = ( __decorate([( __param(1, IStorageService))], ExtensionKeyedWebviewOriginStore));
