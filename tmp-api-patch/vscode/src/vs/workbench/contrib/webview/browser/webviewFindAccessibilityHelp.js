...
class WebviewFindAccessibilityHelpProvider extends Disposable {
    constructor() {
        super(...arguments);
        this.id = AccessibleViewProviderId.WebviewFindHelp;
    ...
    provideContent() {
        const content = [];
        content.push(( localize(16652, "Accessibility Help: Webview Find")));
        ...
        content.push("");
        content.push(( localize(16654, "Current Search Status:")));
        content.push(( localize(16655, "You are searching the web content.")));
        content.push("");
        content.push(( localize(16656, "Inside the Webview Find Input (What It Does):")));
        content.push(( localize(
            16657,
        ...
        content.push("");
        content.push(( localize(16658, "What You Hear Each Time You Move to a Match:")));
        content.push(( localize(16659, "Each navigation step gives you a complete spoken update:")));
        content.push(( localize(
            16660,
        ...
        content.push("");
        content.push(( localize(16663, "Focus Behavior (Important):")));
        content.push(( localize(
            16664,
        ...
        content.push("");
        content.push(( localize(16667, "Keyboard Navigation Summary:")));
        content.push("");
        content.push(( localize(16668, "While focused IN the Find input:")));
        content.push(( localize(16669, "- Enter: Move to the next match while staying in the Find input.")));
        content.push(( localize(
            16670,
            "- Shift+Enter: Move to the previous match while staying in the Find input."
        )));
        content.push("");
        content.push(( localize(16671, "Find Options:")));
        content.push(( localize(16672, "- Match Case: Only exact case matches are included.")));
        content.push(( localize(16673, "- Whole Word: Only full words are matched.")));
        content.push(( localize(16674, "- Regular Expression: Use pattern matching for advanced searches.")));
        content.push("");
        content.push(( localize(16675, "Important About Webviews:")));
        content.push(( localize(
            16676,
        ...
        content.push("");
        content.push(( localize(16680, "Closing:")));
        content.push(( localize(
            16681,
...
export { WebviewFindAccessibilityHelp };
