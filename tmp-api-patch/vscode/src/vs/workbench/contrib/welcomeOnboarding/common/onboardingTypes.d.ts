 ...
 */
export declare enum OnboardingStepId {
 ...
 */
export declare function getOnboardingStepTitle(stepId: OnboardingStepId): string;
/**
 * Returns a localized subtitle for each step.
 */
export declare function getOnboardingStepSubtitle(stepId: OnboardingStepId): string;
/**
 * Ordered step IDs for the onboarding flow.
 */
export declare const ONBOARDING_STEPS: readonly OnboardingStepId[];
/**
 ...
 */
export declare enum AiCollaborationMode {
 ...
 */
export declare const ONBOARDING_AI_PREFERENCE_OPTIONS: readonly IAiPreferenceOption[];
/**
 * Storage key for persisting onboarding completion state.
 */
export declare const ONBOARDING_STORAGE_KEY = "welcomeOnboarding.state";
/**
 ...
 */
export declare const GHE_DOMAIN_REGEX: RegExp;
/**
 * Regex matching a full GHE instance URI (e.g. "https://octocat.ghe.com").
 */
export declare const GHE_FULL_URI_REGEX: RegExp;
export declare enum GheParseResultKind {
    Empty = "empty",
...
export type GheParseResult = {
    ...
    readonly kind: GheParseResultKind.FullUri;
    readonly resolvedUri: string;
} | {
 ...
 */
export declare function parseGheInstanceInput(value: string): GheParseResult;
