  ...
  static async load(input) {
    ...
    if (input instanceof Uint8Array) {
      ...
      if (globalThis.process?.versions.node) {
        const fs2 = shouldNotBeUsed("fs/promises");
...
var Module2 = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    var isDataURI =  __name((filename) => filename.startsWith(dataURIPrefix), "isDataURI");
    ...
    function instantiateAsync(binary2, binaryFile, imports, callback) {
      if (!binary2 && typeof WebAssembly.instantiateStreaming == "function" && !isDataURI(binaryFile) &&
    ...
    var UTF8ArrayToString =  __name((heapOrArray, idx, maxBytesToRead) => {
    ...
    var zeroMemory =  __name((address, size) => {
    ...
    var dynCallLegacy =  __name((sig, ptr, args2) => {
    ...
    var asyncLoad =  __name((url, onload, onerror, noRunDep) => {
    ...
    var __abort_js =  __name(() => {
      abort("");
    }, "__abort_js");
    __abort_js.sig = "v";
    var nowIsMonotonic = 1;
    var __emscripten_get_now_is_monotonic =  __name(() => nowIsMonotonic, "__emscripten_get_now_is_monotonic");
    __emscripten_get_now_is_monotonic.sig = "i";
    var __emscripten_memcpy_js =  __name((dest, src, num) => HEAPU8.copyWithin(dest, src, src + num), "__emscripten_memcpy_js");
    __emscripten_memcpy_js.sig = "vppp";
    var _emscripten_date_now =  __name(() => Date.now(), "_emscripten_date_now");
    _emscripten_date_now.sig = "d";
    var _emscripten_get_now;
    _emscripten_get_now =  __name(() => performance.now(), "_emscripten_get_now");
    ...
    var _emscripten_resize_heap =  __name((requestedSize) => {
      ...
      var alignUp =  __name((x, multiple) => x + (multiple - x % multiple) % multiple, "alignUp");
    ...
    _fd_close.sig = "ii";
    var convertI32PairToI53Checked =  __name((lo, hi) => hi + 2097152 >>> 0 < 4194305 - !!lo ? (lo >>> 0) + hi * 4294967296 : NaN, "convertI32PairToI53Checked");
    ...
    var _setThrew =  __name((a0, a1) => (_setThrew = wasmExports["setThrew"])(a0, a1), "_setThrew");
    var __emscripten_stack_restore =  __name((a0) => (__emscripten_stack_restore = wasmExports["_emscripten_stack_restore"])(a0), "__emscripten_stack_restore");
    var __emscripten_stack_alloc =  __name((a0) => (__emscripten_stack_alloc = wasmExports["_emscripten_stack_alloc"])(a0), "__emscripten_stack_alloc");
    var _emscripten_stack_get_current =  __name(() => (_emscripten_stack_get_current = wasmExports["emscripten_stack_get_current"])(), "_emscripten_stack_get_current");
    ...
    var calledRun;
    dependenciesFulfilled =  __name(function runCaller() {
      if (!calledRun) run();
...
export { CaptureQuantifier, LANGUAGE_VERSION, Language, LookaheadIterator, MIN_COMPATIBLE_VERSION, Node, Parser, Query, Tree, TreeCursor };
