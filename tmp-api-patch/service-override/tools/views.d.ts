import { type IViewContainerDescriptor, type IViewContainersRegistry, type IViewDescriptor, type IViewsRegistry, type ViewContainer, ViewContainerLocation } from "../../vscode/src/vs/workbench/common/views.js";
import type { BrandedService, ServicesAccessor } from "../../vscode/src/vs/platform/instantiation/common/instantiation.js";
...
import { type EditorInputFactoryObject, type RegisteredEditorInfo, type RegisteredEditorOptions, RegisteredEditorPriority, type RegisteredEditorPriorityInfo } from "../../vscode/src/vs/workbench/services/editor/common/editorResolverService.js";
import { EditorInput, type IEditorCloseHandler } from "../../vscode/src/vs/workbench/common/editor/editorInput.js";
import { EditorInputCapabilities, type IEditorOpenContext, type IEditorSerializer, Verbosity } from "../../vscode/src/vs/workbench/common/editor.js";
import type { IEditorOptions, IResourceEditorInput } from "../../vscode/src/vs/platform/editor/common/editor.js";
...
import { ConfirmResult } from "../../vscode/src/vs/platform/dialogs/common/dialogs.js";
import { AbstractResourceEditorInput } from "../../vscode/src/vs/workbench/common/editor/resourceEditorInput.js";
import { AbstractTextResourceEditorInput } from "../../vscode/src/vs/workbench/common/editor/textResourceEditorInput.js";
...
import { type IView, SplitView } from "../../vscode/src/vs/base/browser/ui/splitview/splitview.js";
import { type IEditorGroup } from "../../services.js";
type Label = string | {
    short: string;
    medium: string;
    long: string;
