...
export interface RegisterLocalExtensionResult extends RegisterExtensionResult {
    registerFileUrl: (path: string, url: string, metadataOrMimeType?: string | ExtensionFileMetadata) => IDisposable;
}
...
export declare function registerRemoteExtension(options: RegisterRemoteExtensionParams | string): Promise<RegisterRemoteExtensionResult>;
