...
const PATCH_CONTRACTS = Object.freeze([
	...
	Object.freeze({
		...
		sha256: "0f0b29444ba911b4c8c652012c1e876a3d4482fbaac6fb0815e225192afac98a",
		directImporter: true,
		snapshotEdgeCount: 6,
		shape: Object.freeze([
			...
			"@@ -26,6 +27,468 @@ function resourceForError(resource) {",
			"@@ -81,6 +544,7 @@ let FileService = class FileService extends Disposable {",
			"@@ -266,6 +730,21 @@ let FileService = class FileService extends Disposable {",
			"@@ -369,9 +848,11 @@ let FileService = class FileService extends Disposable {",
			"@@ -383,10 +864,39 @@ let FileService = class FileService extends Disposable {",
			"@@ -412,6 +922,9 @@ let FileService = class FileService extends Disposable {",
			"@@ -442,6 +955,57 @@ let FileService = class FileService extends Disposable {",
			"@@ -559,6 +1123,9 @@ let FileService = class FileService extends Disposable {",
			"@@ -600,6 +1167,57 @@ let FileService = class FileService extends Disposable {",
			"@@ -691,18 +1309,27 @@ let FileService = class FileService extends Disposable {",
			"@@ -717,6 +1344,8 @@ let FileService = class FileService extends Disposable {",
			"@@ -731,6 +1360,21 @@ let FileService = class FileService extends Disposable {",
			"@@ -780,6 +1424,7 @@ let FileService = class FileService extends Disposable {",
			"@@ -794,6 +1439,7 @@ let FileService = class FileService extends Disposable {",
			"@@ -974,6 +1620,8 @@ let FileService = class FileService extends Disposable {",
			"@@ -1154,14 +1802,54 @@ let FileService = class FileService extends Disposable {",
		]),
	}),
	Object.freeze({
