...
const PATCH_CONTRACTS = Object.freeze([
	...
	Object.freeze({
		...
		sha256: "5aafc3e41fc13c7e72c60da8b48893b4b5c5ed14883f6f669238ae62aadc8aec",
		directImporter: true,
		snapshotEdgeCount: 6,
		shape: Object.freeze([
			...
			"@@ -26,6 +26,399 @@ function resourceForError(resource) {",
			"@@ -81,6 +474,7 @@ let FileService = class FileService extends Disposable {",
			"@@ -266,6 +660,21 @@ let FileService = class FileService extends Disposable {",
			"@@ -369,9 +778,11 @@ let FileService = class FileService extends Disposable {",
			"@@ -383,10 +794,39 @@ let FileService = class FileService extends Disposable {",
			"@@ -412,6 +852,9 @@ let FileService = class FileService extends Disposable {",
			"@@ -442,6 +885,57 @@ let FileService = class FileService extends Disposable {",
			"@@ -559,6 +1053,9 @@ let FileService = class FileService extends Disposable {",
			"@@ -600,6 +1097,57 @@ let FileService = class FileService extends Disposable {",
			"@@ -1154,14 +1702,54 @@ let FileService = class FileService extends Disposable {",
		]),
	}),
	Object.freeze({
