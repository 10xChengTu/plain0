...
const PATCH_CONTRACTS = Object.freeze([
	Object.freeze({
		...
		sha256: "e25f901e0568ea0e7a77e1b1c0286306929a223832ef5e439508039f831e91a4",
		directImporter: true,
		...
		shape: Object.freeze([
			...
			"@@ -34,6 +34,40 @@ import { IProgressService } from '../../../../platform/progress/common/progress.",
			"@@ -255,22 +289,30 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			"@@ -283,10 +325,10 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			"@@ -353,7 +395,7 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			"@@ -369,7 +411,7 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			"@@ -389,7 +431,7 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			"@@ -687,9 +729,12 @@ let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel",
			...
			"@@ -30,6 +30,40 @@ import { IProgressService } from '../../../../platform/progress/common/progress.",
			"@@ -187,22 +221,30 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
			"@@ -213,10 +255,10 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
			"@@ -273,7 +315,7 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
			"@@ -289,7 +331,7 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
			"@@ -309,7 +351,7 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
			"@@ -741,9 +783,12 @@ let StoredFileWorkingCopy = class StoredFileWorkingCopy extends ResourceWorkingC",
		]),
	}),
	Object.freeze({
	...
	Object.freeze({
		...
		sha256: "e66da17c64d9f10010396149d3905cf7ed586933c214999c419c73c965eda877",
		directImporter: true,
		snapshotEdgeCount: 6,
		shape: Object.freeze([
			"diff --git a/vscode/src/vs/platform/files/common/fileService.js b/vscode/src/vs/platform/files/common/fileService.js",
			"@@ -26,6 +26,133 @@ function resourceForError(resource) {",
			"@@ -266,6 +393,21 @@ let FileService = class FileService extends Disposable {",
			"@@ -559,6 +701,9 @@ let FileService = class FileService extends Disposable {",
			"@@ -600,6 +745,50 @@ let FileService = class FileService extends Disposable {",
		]),
	}),
	Object.freeze({
