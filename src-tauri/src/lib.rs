...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::commands::workspace_pick_save_target,
            ...
            workspace::commands::workspace_publish_file,
            ...
            workspace::commands::workspace_prepare_trash,
