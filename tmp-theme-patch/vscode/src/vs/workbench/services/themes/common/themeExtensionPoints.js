...
import { ThemeTypeSelector } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/theme';

function registerColorThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        extensionPoint: "themes",
        jsonSchema: {
            description: ( localize(18127, "Contributes textmate color themes.")),
            type: "array",
            items: {
                type: "object",
                defaultSnippets: [{
                ...
                properties: {
                    id: {
                        description: ( localize(18128, "Id of the color theme as used in the user settings.")),
                        type: "string"
                    },
                    label: {
                        description: ( localize(18129, "Label of the color theme as shown in the UI.")),
                        type: "string"
                    },
                    uiTheme: {
...
function registerFileIconThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        ...
        jsonSchema: {
            description: ( localize(18132, "Contributes file icon themes.")),
            type: "array",
            items: {
                type: "object",
                defaultSnippets: [{
                ...
                properties: {
                    id: {
                        description: ( localize(18133, "Id of the file icon theme as used in the user settings.")),
                        type: "string"
                    },
                    label: {
                        description: ( localize(18134, "Label of the file icon theme as shown in the UI.")),
                        type: "string"
                    },
                    path: {
...
function registerProductIconThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        ...
        jsonSchema: {
            description: ( localize(18136, "Contributes product icon themes.")),
            type: "array",
            items: {
                type: "object",
                defaultSnippets: [{
                ...
                properties: {
                    id: {
                        description: ( localize(18137, "Id of the product icon theme as used in the user settings.")),
                        type: "string"
                    },
                    label: {
                        description: ( localize(18138, "Label of the product icon theme as shown in the UI.")),
                        type: "string"
                    },
                    path: {
                        description: ( localize(
...
class ThemeRegistry {
    ...
    onThemes(
        ...
        if (!Array.isArray(themeContributions)) {
            log?.error(( localize(18144, "Extension point `{0}` must be an array.", this.themesExtPoint.name)));
