...
const textmateColorSchema = {
    ...
    definitions: {
        ...
        settings: {
            type: "object",
            description: ( localize(18022, "Colors and styles for the token.")),
            properties: {
                foreground: {
                    type: "string",
                    description: ( localize(18023, "Foreground color for the token.")),
                    format: "color-hex",
                    default: "#ff0000"
                },
                background: {
                    type: "string",
                    deprecationMessage: ( localize(18024, "Token background colors are currently not supported."))
                },
                fontStyle: {
                    type: "string",
                    ...
                    defaultSnippets: [{
                        label: ( localize(18027, "None (clear inherited style)")),
                        bodyText: "\"\""
                    }, {
                        body: "italic"
                    }, {
    ...
    items: {
        ...
        properties: {
            name: {
                type: "string",
                description: ( localize(18031, "Description of the rule."))
            },
            scope: {
                description: ( localize(18032, "Scope selector against which this rule matches.")),
                anyOf: [{
                    enum: textMateScopes
                }, {
                    type: "string"
...
const colorThemeSchema = {
    ...
    properties: {
        colors: {
            description: ( localize(18033, "Colors in the workbench")),
        ...
        tokenColors: {
            anyOf: [{
                type: "string",
                description: ( localize(18034, "Path to a tmTheme file (relative to the current file)."))
            }, {
                description: ( localize(18035, "Colors for syntax highlighting")),
                $ref: textmateColorsSchemaId
            }]
        },
        semanticHighlighting: {
            type: "boolean",
            description: ( localize(18036, "Whether semantic highlighting should be enabled for this theme."))
        },
        semanticTokenColors: {
            type: "object",
            description: ( localize(18037, "Colors for semantic tokens")),
