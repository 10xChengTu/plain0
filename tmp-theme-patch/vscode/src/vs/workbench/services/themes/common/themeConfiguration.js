...
const colorThemeSettingSchema = {
    ...
    errorMessage: ( localize(18096, "Theme is unknown or not installed."))
};
...
const colorCustomizationsSchema = {
    type: "object",
    description: ( localize(18102, "Overrides colors from the currently selected color theme.")),
    allOf: [{
...
const fileIconThemeSettingSchema = {
    ...
    enum: [null],
    enumItemLabels: [( localize(18104, "None"))],
    enumDescriptions: [( localize(18105, "No file icons"))],
    errorMessage: ( localize(18106, "File icon theme is unknown or not installed."))
};
const productIconThemeSettingSchema = {
    type: ["string", "null"],
    default: ThemeSettingDefaults.PRODUCT_ICON_THEME,
    description: ( localize(18107, "Specifies the product icon theme used.")),
    enum: [ThemeSettingDefaults.PRODUCT_ICON_THEME],
    enumItemLabels: [( localize(18108, "Default"))],
    enumDescriptions: [( localize(18109, "Default"))],
    errorMessage: ( localize(18110, "Product icon theme is unknown or not installed."))
};
...
const tokenColorSchema = {
    type: "object",
    properties: {
        comments: tokenGroupSettings(( localize(18112, "Sets the colors and styles for comments"))),
        strings: tokenGroupSettings(( localize(18113, "Sets the colors and styles for strings literals."))),
        keywords: tokenGroupSettings(( localize(18114, "Sets the colors and styles for keywords."))),
        numbers: tokenGroupSettings(( localize(18115, "Sets the colors and styles for number literals."))),
        types: tokenGroupSettings(( localize(18116, "Sets the colors and styles for type declarations and references."))),
        ...
        textMateRules: {
            description: ( localize(18119, "Sets colors and styles using textmate theming rules (advanced).")),
            $ref: textmateColorsSchemaId
        },
        semanticHighlighting: {
            description: ( localize(18120, "Whether semantic highlighting should be enabled for this theme.")),
...
const semanticTokenColorSchema = {
    ...
    properties: {
        ...
        rules: {
            ...
            description: ( localize(18125, "Semantic token styling rules for this theme.")),
...
function updateColorThemeConfigurationSchemas(themes) {
    ...
    const themeSpecificWorkbenchColors = {
        properties: {}
    };
    const themeSpecificTokenColors = {
        properties: {}
    };
    const themeSpecificSemanticTokenColors = {
        properties: {}
    };
