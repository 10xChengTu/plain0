        ...
        const fileOperationParticipant = new (class {
                ...
                if (showPreview === undefined) {
                    ...
                    if (needsConfirmation) {
                        const {
                            ...
                            type: Severity.Info,
                            message,
                            primaryButton: ( localize(2763, "Show &&Preview")),
                            cancelButton: ( localize(2764, "Skip Changes"))
                        });
                        showPreview = true;
                        if (!confirmed) {
                            return;
                        ...
                        const {
                            ...
                            message,
                            buttons: [{
                                label: ( localize(2765, "&&OK")),
                                run: () => Choice.OK
                            }, {
                                label: ( localize(2763, "Show &&Preview")),
                                run: () => Choice.Preview
                            }],
                            cancelButton: {
                                label: ( localize(2764, "Skip Changes")),
                                run: () => Choice.Cancel
                            },
                            checkbox: {
                                label: ( localize(2766, "Do not ask me again"))
                            }
                        });
            ...
            _progressLabel(operation) {
                ...
                case FileOperation.CREATE:
                    return localize(2767, "Running 'File Create' participants...");
                case FileOperation.MOVE:
                    return localize(2768, "Running 'File Rename' participants...");
                case FileOperation.COPY:
                    return localize(2769, "Running 'File Copy' participants...");
                case FileOperation.DELETE:
                    return localize(2770, "Running 'File Delete' participants...");
                case FileOperation.WRITE:
                    return localize(2771, "Running 'File Write' participants...");
                }
            }
        })();
        this._listener.add(
...
registerAction2(class ResetMemento extends Action2 {
    constructor() {
        super({
            ...
            title: {
                value: ( localize(2772, "Reset choice for 'File operation needs preview'")),
