...
class ExtHostEditSessionIdentityCreateParticipant {
    ...
    async participate(workspaceFolder, token) {
        const p = ( new Promise((resolve, reject) => {
            setTimeout(() => reject(( new Error(( localize(2743, "Aborted onWillCreateEditSessionIdentity-event after 10000ms"))))), this.timeout);
...
EditSessionIdentityCreateParticipant = __decorate([extHostCustomer, ( __param(1, IInstantiationService)), ( __param(2, IEditSessionIdentityService))], EditSessionIdentityCreateParticipant);
