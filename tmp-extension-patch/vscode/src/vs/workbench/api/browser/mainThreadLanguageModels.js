...
import { CancellationError, transformErrorFromSerialization, transformErrorForSerialization } from '@codingame/monaco-vscode-api/vscode/vs/base/common/errors';
import { Emitter, Event } from '@codingame/monaco-vscode-api/vscode/vs/base/common/event';
import { equalSets } from '@codingame/monaco-vscode-api/vscode/vs/base/common/collections';
import { Disposable, DisposableStore, DisposableMap, toDisposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
...
let MainThreadLanguageModels = class MainThreadLanguageModels {
    ...
    _registerAuthenticationProvider(extension, auth) {
        ...
        const accountLabel = auth.accountLabel ?? ( localize(2773, "Language Models"));
        const disposables = ( new DisposableStore());
...
MainThreadLanguageModels = __decorate(
    [extHostNamedCustomer(MainContext.MainThreadLanguageModels), ( __param(1, ILanguageModelsService)), ( __param(2, ILogService)), ( __param(3, IProductService)), ( __param(4, IAuthenticationService)), ( __param(5, IAuthenticationAccessService)), ( __param(6, IExtensionService)), ( __param(7, ILanguageModelIgnoredFilesService))],
