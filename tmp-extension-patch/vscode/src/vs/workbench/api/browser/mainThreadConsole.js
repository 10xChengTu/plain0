...
import { isDevConsoleLogForwardingEnabled } from '@codingame/monaco-vscode-api/vscode/vs/platform/log/common/log';
...
MainThreadConsole = __decorate([extHostNamedCustomer(MainContext.MainThreadConsole), ( __param(1, IEnvironmentService)), ( __param(2, ILogService))], MainThreadConsole);
