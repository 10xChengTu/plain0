...
let MainThreadWorkspace = class MainThreadWorkspace extends Disposable {
    ...
    getStatusMessage(extensionName, addCount, removeCount) {
        ...
        if (wantsToAdd && !wantsToDelete) {
            if (addCount === 1) {
                message = ( localize(2804, "Extension '{0}' added 1 folder to the workspace", extensionName));
            } else {
                message = ( localize(
                    2805,
            ...
            if (removeCount === 1) {
                message = ( localize(2806, "Extension '{0}' removed 1 folder from the workspace", extensionName));
            } else {
                message = ( localize(
                    2807,
            ...
            message = ( localize(2808, "Extension '{0}' changed folders of the workspace", extensionName));
        }
        return message;
    }
