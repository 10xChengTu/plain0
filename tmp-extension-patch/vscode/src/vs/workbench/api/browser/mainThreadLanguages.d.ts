...
import { MainThreadLanguagesShape, ISyntaxHighlightingResultDto } from "@codingame/monaco-vscode-api/vscode/vs/workbench/api/common/extHost.protocol";
...
export declare class MainThreadLanguages extends Disposable implements MainThreadLanguagesShape {
    ...
    private readonly _textMateService;
    private readonly _proxy;
    private readonly _status;
    constructor(_extHostContext: IExtHostContext, _languageService: ILanguageService, _modelService: IModelService, _resolverService: ITextModelService, _languageStatusService: ILanguageStatusService, _textMateService: ITextMateTokenizationService, themeService: IThemeService);
