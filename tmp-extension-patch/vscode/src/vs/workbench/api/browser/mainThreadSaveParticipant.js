...
class ExtHostSaveParticipant {
    ...
    async participate(editorModel, context, _progress, token) {
        ...
        const p = ( new Promise((resolve, reject) => {
            setTimeout(() => reject(( new Error(( localize(2797, "Aborted onWillSaveTextDocument-event after 1750ms"))))), 1750);
...
SaveParticipant = __decorate([extHostCustomer, ( __param(1, IInstantiationService)), ( __param(2, ITextFileService))], SaveParticipant);
