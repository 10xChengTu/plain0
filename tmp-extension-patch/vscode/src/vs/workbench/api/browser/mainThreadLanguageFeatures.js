...
let MainThreadLanguageFeatures = MainThreadLanguageFeatures_1 = class MainThreadLanguageFeatures extends Disposable {
    ...
    $registerDocumentSymbolProvider(handle, selector, displayName) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentSymbolProvider.register(selector, {
                displayName,
    ...
    $registerCodeLensSupport(handle, selector, eventHandle) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.codeLensProvider.register(selector, provider)
        );
    }
    ...
    $registerDefinitionSupport(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.definitionProvider.register(selector, {
    ...
    $registerDeclarationSupport(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.declarationProvider.register(selector, {
    ...
    $registerImplementationSupport(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.implementationProvider.register(selector, {
    ...
    $registerTypeDefinitionSupport(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.typeDefinitionProvider.register(selector, {
    ...
    $registerEvaluatableExpressionProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.evaluatableExpressionProvider.register(selector, {
    ...
    $registerInlineValuesProvider(handle, selector, eventHandle) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.inlineValuesProvider.register(selector, provider)
        );
    }
    ...
    $registerDocumentHighlightProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentHighlightProvider.register(selector, {
    ...
    $registerMultiDocumentHighlightProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.multiDocumentHighlightProvider.register(selector, {
                selector: selector,
    ...
    $registerLinkedEditingRangeProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.linkedEditingRangeProvider.register(selector, {
    ...
    $registerCodeActionSupport(handle, selector, metadata, displayName, extensionId, supportsResolve) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.codeActionProvider.register(selector, provider)
        );
    }
    ...
    $registerDocumentFormattingSupport(handle, selector, extensionId, displayName) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentFormattingEditProvider.register(selector, {
                extensionId,
                displayName,
    ...
    $registerRangeFormattingSupport(handle, selector, extensionId, displayName, supportsRanges) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentRangeFormattingEditProvider.register(selector, {
                extensionId,
                displayName,
                provideDocumentRangeFormattingEdits: (model, range, options, token) => {
                    return this._proxy.$provideDocumentRangeFormattingEdits(handle, model.uri, range, options, token);
                },
                provideDocumentRangesFormattingEdits: !supportsRanges ? undefined : (model, ranges, options, token) => {
    ...
    $registerOnTypeFormattingSupport(handle, selector, autoFormatTriggerCharacters, extensionId) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.onTypeFormattingEditProvider.register(selector, {
                extensionId,
    ...
    $registerRenameSupport(handle, selector, supportResolveLocation) {
        this._registrations.set(handle, this._languageFeaturesService.renameProvider.register(selector, {
            ...
            resolveRenameLocation: supportResolveLocation ? (model, position, token) => this._proxy.$resolveRenameLocation(handle, model.uri, position, token) : undefined
        }));
    }
    $registerNewSymbolNamesProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.newSymbolNamesProvider.register(selector, {
    ...
    $registerDocumentSemanticTokensProvider(handle, selector, legend, eventHandle) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentSemanticTokensProvider.register(selector, ( new MainThreadDocumentSemanticTokensProvider(this._proxy, handle, legend, event)))
        );
    }
    ...
    $registerDocumentRangeSemanticTokensProvider(handle, selector, legend, eventHandle) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.documentRangeSemanticTokensProvider.register(selector, ( new MainThreadDocumentRangeSemanticTokensProvider(this._proxy, handle, legend, event)))
        );
    }
    ...
    $registerCompletionsProvider(handle, selector, triggerCharacters, supportsResolveDetails, extensionId) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.completionProvider.register(selector, provider)
        );
    }
    ...
    $registerSignatureHelpProvider(handle, selector, metadata) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.signatureHelpProvider.register(selector, {
    ...
    $registerInlayHintsProvider(handle, selector, supportsResolve, eventHandle, displayName) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.inlayHintsProvider.register(selector, provider)
        );
    }
    ...
    $registerDocumentLinkProvider(handle, selector, supportsResolve) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.linkProvider.register(selector, provider)
        );
    }
    ...
    $registerFoldingRangeProvider(handle, selector, extensionId, eventHandle) {
        ...
        this._registrations.set(
            handle,
            this._languageFeaturesService.foldingRangeProvider.register(selector, provider)
        );
    }
    ...
    $registerSelectionRangeProvider(handle, selector) {
        this._registrations.set(
            handle,
            this._languageFeaturesService.selectionRangeProvider.register(selector, {
    ...
    $setLanguageConfiguration(handle, languageId, _configuration) {
        ...
        if (this._languageService.isRegisteredLanguageId(languageId)) {
            this._registrations.set(
                handle,
                this._languageConfigurationService.register(languageId, configuration, 100)
            );
        }
    }
                        ...
                        edits: ( edits.map(edit => {
                            return {
                                ...
                                additionalEdit: edit.additionalEdit ? reviveWorkspaceEditDto(
                                    ...
                                    dataId => this.resolveFileData(request.id, dataId)
                                ) : undefined
                            };
                        })),
                        dispose: () => {
...
MainThreadPasteEditProvider = ( __decorate([( __param(3, IUriIdentityService))], MainThreadPasteEditProvider));
                ...
                edits: ( edits.map(edit => {
                    return {
                        ...
                        additionalEdit: reviveWorkspaceEditDto(
                            edit.additionalEdit,
                            this._uriIdentService,
                            dataId => this.resolveDocumentOnDropFileData(request.id, dataId)
                        )
                    };
                })),
                dispose: () => {
...
MainThreadDocumentOnDropEditProvider = ( __decorate([( __param(3, IUriIdentityService))], MainThreadDocumentOnDropEditProvider));
...
let ExtensionBackedInlineCompletionsProvider = class ExtensionBackedInlineCompletionsProvider extends Disposable {
    constructor(
        ...
        displayName,
        modelInfo,
        _supportsHandleEvents,
        _supportsSetModelId,
        _supportsOnDidChange,
        _supportsOnDidChangeModelInfo,
        providerOptions,
        _supportsSetProviderOption,
        _supportsOnDidChangeProviderOptions,
        _selector,
        _proxy,
        _languageFeaturesService,
        _aiEditTelemetryService,
        _instantiationService
    ) {
        super();
        this.handle = handle;
        ...
        this._register(
            this._languageFeaturesService.inlineCompletionsProvider.register(this._selector, this)
        );
    }
    ...
    async handleEndOfLifetime(completions, item, reason, lifetimeSummary) {
        ...
        if (this._supportsHandleEvents) {
            await this._proxy.$handleInlineCompletionEndOfLifetime(this.handle, completions.pid, item.idx, mapReason(reason, i => ({
                pid: i.pid,
                idx: i.idx
            })));
        }
        ...
        } else if (reason.kind === InlineCompletionEndOfLifeReasonKind.Rejected) {
            if (item.suggestionId !== undefined) {
        ...
        const endOfLifeSummary = {
            ...
            reason: reason.kind === InlineCompletionEndOfLifeReasonKind$1.Accepted ? "accepted" : reason.kind === InlineCompletionEndOfLifeReasonKind$1.Rejected ? "rejected" : reason.kind === InlineCompletionEndOfLifeReasonKind$1.Ignored ? "ignored" : undefined,
...
ExtensionBackedInlineCompletionsProvider = ( __decorate([( __param(17, ILanguageFeaturesService)), ( __param(18, IAiEditTelemetryService)), ( __param(19, IInstantiationService))], ExtensionBackedInlineCompletionsProvider));
