            ...
            openExternalUri: async (uri, ctx, token) => {
                try {
                    ...
                    if (!isCancellationError(e)) {
                        const openDefaultAction = ( new Action("default", ( localize(2801, "Open using default opener")), undefined, undefined, async () => {
                        ...
                        this.notificationService.notify({
                            ...
                            message: ( localize(2802, "Could not open uri with '{0}': {1}", id, (e.toString()))),
                            actions: {
