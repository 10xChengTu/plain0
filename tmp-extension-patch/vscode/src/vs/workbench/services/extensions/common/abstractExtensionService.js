...
let AbstractExtensionService = AbstractExtensionService_1 = class AbstractExtensionService extends Disposable {
            ...
            veto(value, reason) {
                ...
                if (typeof value === "boolean") {
                    ...
                    value.then(value => {
                        ...
                        vetoReasons.add(( localize(17647, "{0} (Error: {1})", reason, toErrorMessage(error))));
                    });
                }
            }
        });
        ...
        if (!veto) {
            ...
            if (!auto) {
                ...
                const {
                    ...
                    message: ( localize(17648, "Please confirm restart of extensions.")),
                    detail: vetoReasonsArray.length === 1 ? vetoReasonsArray[0] : vetoReasonsArray.join("\n -"),
                    primaryButton: ( localize(17649, "Restart Anyway"))
                });
                if (confirmed) {
                    return true;
                }
    ...
    async _onRemoteExtensionHostCrashed(extensionHost, reconnectionToken) {
        try {
            ...
            if (this._remoteCrashTracker.shouldAutomaticallyRestart()) {
                ...
                this._notificationService.status(( localize(17650, "The remote extension host terminated unexpectedly. Restarting...")), {
                    hideAfter: 5000
                });
                ...
                this._notificationService.prompt(Severity.Error, ( localize(
                    ...
                    label: ( localize(17652, "Restart Remote Extension Host")),
                    run: () => {
                        this._startExtensionHostsIfNecessary(false, Array.from(( this._allRequestedActivateEvents.keys())));
                    }
                }]);
    ...
    async getInspectPorts(extensionHostKind, tryEnableInspector) {
        const result = await Promise.all(( this._getExtensionHostManagers(extensionHostKind).map(async extHost => {
            ...
            if (portInfo !== undefined) {
                portInfo = {
                    ...portInfo,
                    devtoolsLabel: extHost.friendyName
                };
            }
            return portInfo;
        })));
    ...
    _doHandleExtensionPoints(affectedExtensions, onlyResolverExtensionPoints) {
        ...
        mark(
            onlyResolverExtensionPoints ? "code/willHandleResolverExtensionPoints" : "code/willHandleExtensionPoints"
        );
        ...
        mark(
            onlyResolverExtensionPoints ? "code/didHandleResolverExtensionPoints" : "code/didHandleExtensionPoints"
        );
    }
...
AbstractExtensionService = AbstractExtensionService_1 = ( __decorate([( __param(4, IInstantiationService)), ( __param(5, INotificationService)), ( __param(6, IWorkbenchEnvironmentService)), ( __param(7, ITelemetryService)), ( __param(8, IWorkbenchExtensionEnablementService)), ( __param(9, IFileService)), ( __param(10, IProductService)), ( __param(11, IWorkbenchExtensionManagementService)), ( __param(12, IWorkspaceContextService)), ( __param(13, IConfigurationService)), ( __param(14, IExtensionManifestPropertiesService)), ( __param(15, ILogService)), ( __param(16, IRemoteAgentService)), ( __param(17, IRemoteExtensionsScannerService)), ( __param(18, ILifecycleService)), ( __param(19, IRemoteAuthorityResolverService)), ( __param(20, IDialogService))], AbstractExtensionService));
...
function checkEnabledAndProposedAPI(
    logService,
...
function filterEnabledExtensions(logService, extensionEnablementService, extensions, ignoreWorkspaceTrust) {
    ...
    const enablementStates = extensionEnablementService.getEnablementStates(mappedExtensions, ignoreWorkspaceTrust ? {
        trusted: true
    } : undefined);
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: "activationEvents",
    label: ( localize(17653, "Activation Events")),
    access: {
        canToggle: false
    },
...
export { AbstractExtensionService, DeltaExtensionsQueueItem, ExtensionHostCrashTracker, ExtensionStatus, ImplicitActivationAwareReader, LocalExtensions, RemoteExtensions, ResolverExtensions, checkEnabledAndProposedAPI, filterEnabledExtensions, isResolverExtension };
