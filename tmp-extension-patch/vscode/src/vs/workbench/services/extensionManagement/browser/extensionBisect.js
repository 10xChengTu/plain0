...
let ExtensionBisectUi = class ExtensionBisectUi {
    ...
    _showBisectPrompt() {
        const goodPrompt = {
            label: ( localize(17540, "I can't reproduce")),
            run: () => this._commandService.executeCommand("extension.bisect.next", false)
        };
        const badPrompt = {
            label: ( localize(17541, "I can reproduce")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(17544, "Start Extension Bisect")),
    ...
    async run(accessor) {
        ...
        const res = await dialogService.confirm({
            message: ( localize(17545, "Extension Bisect")),
            detail: ( localize(
                17546,
            ...
            primaryButton: ( localize(17547, "&&Start Extension Bisect"))
        });
        if (res.confirmed) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(17548, "Continue Extension Bisect")),
            category: Categories.Help,
            f1: true,
    ...
    async run(accessor, seeingBad) {
        ...
        if (done.bad) {
            await dialogService.info(( localize(17549, "Extension Bisect")), ( localize(
                17550,
            ...
            const res = await dialogService.confirm({
                type: Severity.Info,
                message: ( localize(17549, "Extension Bisect")),
                primaryButton: ( localize(17551, "&&Report Issue & Continue")),
                cancelButton: ( localize(17552, "Continue")),
                detail: ( localize(
                    17553,
                ...
                checkbox: {
                    label: ( localize(17554, "Keep this extension disabled")),
                    checked: true
                }
            });
    ...
    async _checkForBad(dialogService, bisectService) {
        const {
            ...
            type: Severity.Info,
            message: ( localize(17555, "Extension Bisect")),
            detail: ( localize(
                17556,
                "Extension Bisect is active and has disabled {0} extensions. Check if you can still reproduce the problem and proceed by selecting from these options.",
            ...
            buttons: [{
                label: ( localize(17557, "I ca&&n't reproduce")),
                run: () => false
            }, {
                label: ( localize(17558, "I can &&reproduce")),
                run: () => true
            }, {
                label: ( localize(17559, "&&Stop Bisect")),
                run: () => undefined
            }],
            cancelButton: {
                label: ( localize(17560, "&&Cancel Bisect")),
                run: () => null
            }
        });
        return result;
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(17561, "Stop Extension Bisect")),
            category: Categories.Help,
            f1: true,
            precondition: ExtensionBisectUi.ctxIsBisectActive
        });
